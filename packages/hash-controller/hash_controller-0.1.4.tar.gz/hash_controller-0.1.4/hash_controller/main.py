...
class HashClient:
    ...
    def exist(customer_uuid: str, type: str, obj):
        ...
        Returns:
            list[bool]: True if the item exist, False if don't
        """
    ...
    @staticmethod
    def exist_many(customer_uuid: str, type: str, objs: list) -> (list[bool], bool):
        ...
        Returns:
            list[bool]: True if the item exist, False if don't
            bool: True if there is one object that don't exist, False if any of the items exist
        """
    ...
    @staticmethod
    def get_many(filter: dict = {}, date_comparasion: str = "$gt"):
        ...
        Args:
            ...
            date_comparasion (str, optional): _description_. Defaults to "".
