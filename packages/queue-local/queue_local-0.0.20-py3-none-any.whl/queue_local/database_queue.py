...
class DatabaseQueue(OurQueue, GenericCRUD):
    ...
    def __init__(self, schema_name: str = "queue", table_name: str = "queue_item_table", view_name: str = "queue_item_view",
        ...
        GenericCRUD.__init__(self, schema_name=schema_name, default_table_name=table_name,
    ...
    def push(self, json_data: dict) -> None:
        ...
        try:
            ...
            self.insert(json_data=json_data)
    ...
    def push_back(self, queue_item: dict) -> None:
        ...
        self.update_by_id(id_column_value=queue_item[self.id_column_name], json_data=json_data)
    ...
    def get(self, action_ids: tuple = ()) -> dict:
        ...
        try:
            ...
            self.update_by_where(where=update_where, order_by="created_timestamp", limit=1, json_data=json_data)
