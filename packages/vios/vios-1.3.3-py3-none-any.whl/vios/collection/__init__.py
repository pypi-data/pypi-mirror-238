...
from vios.systemq import StepStatus, Waveform, wave_eval
...
def submit(app: dict | Scan | Scanner, block: bool | float = False,
           shot: int = 0, reset: list = [], dry_run: bool = False,
           preview: list = [], plot: bool = False,
    ...
    Args:
        ...
        pllot (list, optional): 是否需要实时显示结果(1D或2D).
