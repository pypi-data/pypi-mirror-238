...
class FuncArgsInterpFactoryConfigSchema(Schema):
    ...
    func_search_control = fields.Nested(
        search_control_desc.dict_schema,
        required = True,
    )

    func_init_control = fields.Nested(
...
func_args_interp_config_example = {
    ...
    func_search_control_: search_control_desc.dict_example,
    func_init_control_: init_control_desc.dict_example,
}
