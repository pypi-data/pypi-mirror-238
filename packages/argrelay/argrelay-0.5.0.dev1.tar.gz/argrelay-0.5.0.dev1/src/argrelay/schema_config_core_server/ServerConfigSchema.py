...
plugin_instance_id_activate_order_dac_ = "plugin_instance_id_activate_order_dag"
    ...
    def make_object(
        ...
        **kwargs,
        ...
        return ServerConfig(
            ...
            plugin_instance_id_activate_order_dag = input_dict[plugin_instance_id_activate_order_dac_],
            plugin_instance_id_activate_list = serialize_dac_to_list(
                [plugin_id for plugin_id in input_dict[plugin_dict_].keys()],
                input_dict[plugin_instance_id_activate_order_dac_],
            ),
...
server_config_desc = TypeDesc(
    ...
    dict_example = {
        ...
        plugin_instance_id_activate_order_dac_: {
