...
class AbstractDelegator(AbstractPlugin):
    ...
    *   share data only via :class:`InvocationInput`
    ...
    def run_search_control(
        ...
        """
        TODO: base func: provide description, link to FS.
        """
    ...
    def run_interp_control(
        ...
        """
        Implements FS_78_91_27_22 interp control.

        TODO: base func: provide description, link to FS.

        Selects `plugin_id` for the next interpreter.
        """
        pass
