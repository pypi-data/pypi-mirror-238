...
class InterceptDelegator(AbstractDelegator):
    ...
    def get_supported_func_envelopes(
        ...
        func_envelopes = [{
            instance_data_: {
                func_id_: SpecialFunc.intercept_func.name,
            ...
            ReservedArgType.FuncId.name: SpecialFunc.intercept_func.name,
        }]
    ...
    def invoke_action(invocation_input: InvocationInput):
        if get_func_id_from_invocation_input(invocation_input) == SpecialFunc.intercept_func.name:
