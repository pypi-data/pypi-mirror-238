...
class ServerConfig:
    ...
    plugin_instance_id_activate_order_dag: dict[str, list[str]] = field()
    """
    DAG of `plugin_instance_id`-s with activation dependencies.
    Each `plugin_instance_id` is a key into `plugin_dict`.
    """

    plugin_instance_id_activate_list: list[str] = field()
    """
    List of `plugin_instance_id`-s in order of activation generated by serializing `plugin_instance_id_activate_order_dag`.
    Each `plugin_instance_id` is a key into `plugin_dict`.
    """
