...
from argrelay.schema_config_plugin.PluginEntrySchema import plugin_entry_desc, plugin_dependencies_
...
class ServerConfigSchema(Schema):
    ...
    def make_object(
        ...
        **kwargs,
        ...
        for plugin_instance_id in input_dict[plugin_dict_]:
            plugin_entry: PluginEntry = input_dict[plugin_dict_][plugin_instance_id]
