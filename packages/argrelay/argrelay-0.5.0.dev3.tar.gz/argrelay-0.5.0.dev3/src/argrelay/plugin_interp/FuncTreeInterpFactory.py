...
from argrelay.schema_config_plugin.PluginEntrySchema import enable_plugin_
...
class FuncTreeInterpFactory(FuncArgsInterpFactory):
    ...
    def load_func_envelopes(
        ...
        # TODO: clean up:
        print(f"{self.plugin_instance_id}: context_config: {context_config}")
        ...
        for delegator_plugin_id in context_config[delegator_plugin_ids_]:
            # TODO: Stub: review when `enable_plugin` implemented:
            # TODO: Deduplicate assertion with error message:
            assert delegator_plugin_id in server_config.action_delegators, f"plugin `{delegator_plugin_id}` must be activated via {enable_plugin_}"
            ...
            for func_envelope in func_envelopes:
                ...
                if func_id not in self.func_paths:
                    if func_id not in context_config[ignored_func_ids_list_]:
                        ...
                        # TODO: Remove this func from loading:
                        continue
        ...
        # TODO: clean up:
        print(f"{self.plugin_instance_id}: before: func_envelopes_index: {func_envelopes_index}")
        ...
        # TODO: clean up:
        print(f"{self.plugin_instance_id}: after: func_envelopes_index: {func_envelopes_index}")
