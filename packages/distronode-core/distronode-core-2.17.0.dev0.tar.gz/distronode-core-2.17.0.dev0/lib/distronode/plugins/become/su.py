    ...
    options:
        ...
        become_exe:
            ...
            ini:
              ...
              - section: su_become_plugin
                key: executable
            vars:
              - name: distronode_become_exe
              - name: distronode_su_exe
            env:
              - name: DISTRONODE_BECOME_EXE
              - name: DISTRONODE_SU_EXE
            keyword:
        ...
        prompt_l10n:
            description:
                ...
                - Do NOT add a colon (:) to your custom entries. Distronode adds a colon at the end of each prompt;
            ...
            vars:
              - name: distronode_su_prompt_l10n
            env:
              - name: DISTRONODE_SU_PROMPT_L10N
"""
