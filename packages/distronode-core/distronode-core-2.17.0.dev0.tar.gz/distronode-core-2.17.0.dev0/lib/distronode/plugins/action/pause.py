...
from distronode.errors import DistronodeError, DistronodePromptInterrupt, DistronodePromptNoninteractive
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        except DistronodePromptInterrupt:
            user_input = None
        except DistronodePromptNoninteractive:
            if seconds is None:
        ...
        if user_input is None:
            ...
            try:
                ...
                raise DistronodeError('user requested abort!')
