...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        results = merge_hash(results, self._execute_module(module_name='distronode.legacy.async_status', task_vars=task_vars, module_args=new_module_args))
