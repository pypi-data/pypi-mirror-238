...
DOCUMENTATION = '''
    name: default
    type: stdout
    short_description: default Distronode screen output
    version_added: historical
    description:
        - This is the default output callback for distronode-playbook.
...
from distronode.utils.color import colorize, hostcolor
