...
def _parse_clixml(data, stream="Error"):
    ...
    # https://github.com/distronode/distronode/issues/69550
    while data:
...
class ShellModule(ShellBase):
    ...
    # Used by various parts of Distronode to do Windows specific changes
    _IS_WINDOWS = True
    ...
    def build_module_command(self, env_string, shebang, cmd, arg_path=None):
        bootstrap_wrapper = pkgutil.get_data("distronode.executor.powershell", "bootstrap_wrapper.ps1")
