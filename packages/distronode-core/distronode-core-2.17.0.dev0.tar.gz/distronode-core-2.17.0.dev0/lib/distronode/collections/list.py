...
from distronode.cli.galaxy import with_collection_artifacts_manager
from distronode.galaxy.collection import find_existing_collections
        ...
        for coll_name in coll_filter:
            if '.' in coll_name:
                try:
                    ...
                    raise DistronodeError("Invalid collection pattern supplied: %s" % coll_name)
