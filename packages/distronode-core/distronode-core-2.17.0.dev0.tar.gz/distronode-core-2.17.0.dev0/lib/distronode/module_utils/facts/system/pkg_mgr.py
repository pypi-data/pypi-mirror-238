...
# distronode module, use that as the value for the 'name' key.
...
class PkgMgrFactCollector(BaseFactCollector):
    ...
    def _check_rh_versions(self, pkg_mgr_name, collected_facts):
        ...
        try:
            major_version = collected_facts['distronode_distribution_major_version']
            if collected_facts['distronode_distribution'] == 'Kylin Linux Advanced Server':
        ...
        if (
            (collected_facts['distronode_distribution'] == 'Fedora' and distro_major_ver < 23)
            or (collected_facts['distronode_distribution'] == 'Kylin Linux Advanced Server' and distro_major_ver < 10)
            or (collected_facts['distronode_distribution'] == 'Amazon' and distro_major_ver < 2022)
            or (collected_facts['distronode_distribution'] == 'TencentOS' and distro_major_ver < 3)
    ...
    def pkg_mgrs(self, collected_facts):
        ...
        if collected_facts['distronode_os_family'] == 'Altlinux':
