...
from distronode.module_utils.facts.utils import get_file_content, get_mount_size
...
from distronode.module_utils.six.moves import reduce
    ...
    def get_cpu_facts(self, collected_facts=None):
        ...
        for line in out.splitlines():
            ...
            if key == 'module:':
                ...
                # FIXME
                if collected_facts.get('distronode_machine') != 'i86pc':
                    processor += " @ " + clock_mhz + "MHz"
                if 'distronode_processor' not in collected_facts:
                    cpu_facts['processor'] = []
