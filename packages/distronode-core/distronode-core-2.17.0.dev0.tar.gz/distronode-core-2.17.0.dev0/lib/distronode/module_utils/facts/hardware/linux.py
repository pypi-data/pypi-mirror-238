...
from distronode.module_utils.common.text.formatters import bytes_to_human
from distronode.module_utils.facts.hardware.base import Hardware, HardwareCollector
from distronode.module_utils.facts.utils import get_file_content, get_file_lines, get_mount_size
...
class LinuxHardware(Hardware):
    ...
    def get_cpu_facts(self, collected_facts=None):
        ...
        if collected_facts.get('distronode_architecture', '').startswith(('armv', 'aarch', 'ppc')):
            i = processor_occurrence

        if collected_facts.get('distronode_architecture') == 's390x':
    ...
    def get_mount_info(self, mount, device, uuids):
        ...
        # https://github.com/distronode/distronode/issues/36077
