...
from distronode.module_utils.facts.network.base import Network, NetworkCollector
...
class LinuxNetwork(Network):
    ...
    def get_default_interfaces(self, ip_path, collected_facts=None):
        ...
        for v in 'v4', 'v6':
            if (v == 'v6' and collected_facts.get('distronode_os_family') == 'RedHat' and
                    collected_facts.get('distronode_distribution_version', '').startswith('4.')):
                continue
    ...
    def get_interfaces_info(self, ip_path, default_ipv4, default_ipv6):
        ...
        for path in glob.glob('/sys/class/net/*'):
            ...
            if rc == 0:
                ...
                # https://github.com/distronode/distronode/issues/50871
