...
from distronode.module_utils.six.moves.collections_abc import Hashable, Mapping, MutableMapping, Sequence  # pylint: disable=unused-import
...
def is_string(seq):
    ...
    # DistronodeVaultEncryptedUnicode inherits from Sequence, but is expected to be a string like object
