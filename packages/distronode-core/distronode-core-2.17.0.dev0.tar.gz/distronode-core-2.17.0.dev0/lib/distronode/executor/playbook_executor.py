...
from distronode.executor.task_queue_manager import TaskQueueManager, DistronodeEndPlay
...
from distronode.plugins.loader import become_loader, connection_loader, shell_loader
from distronode.playbook import Playbook
from distronode.template import Templar
from distronode.utils.helpers import pct_to_int
...
from distronode.utils.ssh_functions import set_default_transport
...
class PlaybookExecutor:
    ...
    basis for bin/distronode-playbook operation.
    '''
    ...
    def __init__(self, playbooks, inventory, variable_manager, loader, passwords):
        ...
        # Note: We run this here to cache whether the default distronode ssh
        # executable supports control persist.  Sometime in the future we may
        # need to enhance this to check that distronode_ssh_executable specified
        ...
        try:
            ...
            for playbook in self._playbooks:
                ...
                if playbook_collection:
                    ...
                    DistronodeCollectionConfig.default_collection = None
