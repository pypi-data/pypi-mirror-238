...
if t.TYPE_CHECKING:
    ...
    from distronode.galaxy.dependency_resolution.dataclasses import Candidate

from distronode.galaxy.collection.galaxy_api_proxy import MultiGalaxyAPIProxy
from distronode.galaxy.dependency_resolution.providers import CollectionDependencyProvider
from distronode.galaxy.dependency_resolution.reporters import CollectionDependencyReporter
from distronode.galaxy.dependency_resolution.resolvers import CollectionDependencyResolver
