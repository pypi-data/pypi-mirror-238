...
description:
    ...
    - For Windows targets, use the M(distronode.windows.win_reboot) module instead.
version_added: "2.7"
options:
  pre_reboot_delay:
    description:
  ...
  msg:
    ...
    type: str
    default: Reboot initiated by Distronode
...
attributes:
    ...
    platform:
        platforms: posix
seealso:
- module: distronode.windows.win_reboot
author:
