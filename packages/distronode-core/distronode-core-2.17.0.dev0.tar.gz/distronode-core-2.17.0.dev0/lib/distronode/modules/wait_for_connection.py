...
- This module makes use of internal distronode transport (and configuration) and the ping/win_ping module to guarantee correct end-to-end functioning.
...
attributes:
    ...
    platform:
        ...
        platforms: all
seealso:
- module: distronode.builtin.wait_for
