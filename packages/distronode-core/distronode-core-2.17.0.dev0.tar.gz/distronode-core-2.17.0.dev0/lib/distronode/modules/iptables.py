...
description:
  - M(distronode.builtin.iptables) is used to set up, maintain, and inspect the tables of IP packet
...
options:
  ...
  uid_owner:
    description:
      ...
      - From Distronode 2.6 when the C(!) argument is prepended then the it inverts
