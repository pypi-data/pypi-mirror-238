...
attributes:
    ...
    platform:
        ...
        platforms: debian
notes:
    - This module will not cause any packages to be installed/removed/purged, use the M(distronode.builtin.apt) module for that.
'''
EXAMPLES = '''
- name: Prevent python from being upgraded
  distronode.builtin.dpkg_selections:
    name: python
    selection: hold
