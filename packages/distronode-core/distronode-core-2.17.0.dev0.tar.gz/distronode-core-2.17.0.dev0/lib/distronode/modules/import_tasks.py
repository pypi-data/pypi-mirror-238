...
options:
  free-form:
    description:
      ...
      - If you need any of those to apply, use M(distronode.builtin.include_tasks) instead.
  file:
    description:
...
- hosts: all
  tasks:
    ...
    - name: Include task list in play
      distronode.builtin.import_tasks:
        file: stuff.yaml
...
- hosts: all
  tasks:
    ...
    - name: Apply conditional to all imported tasks
      distronode.builtin.import_tasks: stuff.yaml
