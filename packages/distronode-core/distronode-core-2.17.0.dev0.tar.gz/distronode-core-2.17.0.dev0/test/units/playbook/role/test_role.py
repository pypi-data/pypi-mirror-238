...
from distronode.playbook.role.include import RoleInclude
from distronode.playbook.role import hash_params
...
class TestRole(unittest.TestCase):
    ...
    @patch('distronode.playbook.role.definition.unfrackpath', mock_unfrackpath_noop)
    def test_load_role_with_tasks(self):

        fake_loader = DictDataLoader({
            "/etc/distronode/roles/foo_tasks/tasks/main.yml": """
    ...
    def test_load_role_with_tasks_dir_vs_file(self):
        ...
        fake_loader = DictDataLoader({
            "/etc/distronode/roles/foo_tasks/tasks/custom_main/foo.yml": """
            - command: bar
            """,
            "/etc/distronode/roles/foo_tasks/tasks/custom_main.yml": """
            - command: baz
            """,
        })
    ...
    def test_load_role_with_handlers(self):
        ...
        fake_loader = DictDataLoader({
            "/etc/distronode/roles/foo_handlers/handlers/main.yml": """
            - name: test handler
              shell: echo 'hello world'
            """,
        })
    ...
    def test_load_role_with_vars(self):
        ...
        fake_loader = DictDataLoader({
            "/etc/distronode/roles/foo_vars/defaults/main.yml": """
            foo: bar
            """,
            "/etc/distronode/roles/foo_vars/vars/main.yml": """
            foo: bam
            """,
        })
    ...
    def test_load_role_with_vars_dirs(self):
        ...
        fake_loader = DictDataLoader({
            "/etc/distronode/roles/foo_vars/defaults/main/foo.yml": """
            foo: bar
            """,
            "/etc/distronode/roles/foo_vars/vars/main/bar.yml": """
            foo: bam
            """,
        })
    ...
    def test_load_role_with_vars_nested_dirs(self):
        ...
        fake_loader = DictDataLoader({
            "/etc/distronode/roles/foo_vars/defaults/main/foo/bar.yml": """
            foo: bar
            """,
            "/etc/distronode/roles/foo_vars/vars/main/bar/foo.yml": """
            foo: bam
            """,
        })
    ...
    def test_load_role_with_vars_nested_dirs_combined(self):
        ...
        fake_loader = DictDataLoader({
            ...
            a: 1
            """,
            "/etc/distronode/roles/foo_vars/defaults/main/bar/foo.yml": """
            foo: bam
            b: 2
            """,
        })
    ...
    def test_load_role_with_vars_dir_vs_file(self):
        ...
        fake_loader = DictDataLoader({
            "/etc/distronode/roles/foo_vars/vars/main/foo.yml": """
            foo: bar
            """,
            "/etc/distronode/roles/foo_vars/vars/main.yml": """
            foo: bam
    ...
    def test_load_role_with_metadata(self):
        ...
        fake_loader = DictDataLoader({
            '/etc/distronode/roles/foo_metadata/meta/main.yml': """
                ...
                galaxy_info:
                  ...
                  c: 3
            """,
            '/etc/distronode/roles/bar_metadata/meta/main.yml': """
                dependencies:
                  - baz_metadata
            """,
            '/etc/distronode/roles/baz_metadata/meta/main.yml': """
                dependencies:
                  - bam_metadata
            """,
            '/etc/distronode/roles/bam_metadata/meta/main.yml': """
                dependencies: []
            """,
            '/etc/distronode/roles/bad1_metadata/meta/main.yml': """
                1
            """,
            '/etc/distronode/roles/bad2_metadata/meta/main.yml': """
                foo: bar
            """,
            '/etc/distronode/roles/recursive1_metadata/meta/main.yml': """
                dependencies: ['recursive2_metadata']
            """,
            '/etc/distronode/roles/recursive2_metadata/meta/main.yml': """
        ...
        self.assertRaises(DistronodeParserError, Role.load, i, play=mock_play)

        i = RoleInclude.load('bad2_metadata', play=mock_play, loader=fake_loader)
        self.assertRaises(DistronodeParserError, Role.load, i, play=mock_play)

        # TODO: re-enable this test once Distronode has proper role dep cycle detection
        ...
        # self.assertRaises(DistronodeError, Role.load, i, play=mock_play)
    ...
    def test_load_role_complex(self):
        ...
        fake_loader = DictDataLoader({
            "/etc/distronode/roles/foo_complex/tasks/main.yml": """
            - shell: echo 'hello world'
            """,
        })
