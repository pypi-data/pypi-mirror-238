...
from distronode.module_utils.common.warnings import deprecate, get_deprecation_messages
...
def deprecation_messages():
    return [
        ...
        {'msg': 'Second deprecation', 'version': None, 'collection_name': 'distronode.builtin'},
        {'msg': 'Third deprecation', 'version': '2.14', 'collection_name': None},
        {'msg': 'Fourth deprecation', 'version': '2.9', 'collection_name': None},
        {'msg': 'Fifth deprecation', 'version': '2.9', 'collection_name': 'distronode.builtin'},
        {'msg': 'Sixth deprecation', 'date': '2199-12-31', 'collection_name': None},
        {'msg': 'Seventh deprecation', 'date': '2199-12-31', 'collection_name': 'distronode.builtin'},
    ]
...
def test_deprecate_with_collection(reset):
    deprecate(msg='Deprecation message', collection_name='distronode.builtin')
    assert warnings._global_deprecations == [
        {'msg': 'Deprecation message', 'version': None, 'collection_name': 'distronode.builtin'}]
...
def test_deprecate_with_version_and_collection(reset):
    deprecate(msg='Deprecation message', version='2.14', collection_name='distronode.builtin')
    assert warnings._global_deprecations == [
        {'msg': 'Deprecation message', 'version': '2.14', 'collection_name': 'distronode.builtin'}]
...
def test_deprecate_with_date_and_collection(reset):
    deprecate(msg='Deprecation message', date='2199-12-31', collection_name='distronode.builtin')
    assert warnings._global_deprecations == [
        {'msg': 'Deprecation message', 'date': '2199-12-31', 'collection_name': 'distronode.builtin'}]
