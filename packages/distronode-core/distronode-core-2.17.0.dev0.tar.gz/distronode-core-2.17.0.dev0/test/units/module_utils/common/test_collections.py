...
from distronode.module_utils.six.moves.collections_abc import Sequence
from distronode.module_utils.common.collections import ImmutableDict, is_iterable, is_sequence
...
class FakeDistronodeVaultEncryptedUnicode(Sequence):
    __ENCRYPTED__ = True
...
TEST_STRINGS = TEST_STRINGS + tuple(s.encode('utf-8') for s in TEST_STRINGS) + (FakeDistronodeVaultEncryptedUnicode(u'foo'),)
