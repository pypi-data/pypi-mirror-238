...
from distronode.module_utils.common.arg_spec import ArgumentSpecValidator, ValidationResult
...
def test_valid_spec(arg_spec, parameters, expected, valid_params, mocker):
    mocker.patch('distronode.module_utils.common.validation.os.path.expanduser', return_value='/home/distronode/bin')
    mocker.patch('distronode.module_utils.common.validation.os.path.expandvars', return_value='/home/distronode/bin')
