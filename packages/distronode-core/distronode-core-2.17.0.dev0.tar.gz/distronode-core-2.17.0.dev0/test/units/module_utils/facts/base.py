# base unit test classes for distronode/module_utils/facts/ tests
# -*- coding: utf-8 -*-
#
...
class BaseFactsTest(unittest.TestCase):
    ...
    # a dict distronode_facts. Some fact collectors depend on facts gathered by
    # other collectors (like 'distronode_architecture' or 'distronode_system') which
