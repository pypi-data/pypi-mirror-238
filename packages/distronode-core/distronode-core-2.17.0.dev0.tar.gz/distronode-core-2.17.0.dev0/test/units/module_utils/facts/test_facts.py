...
from distronode.module_utils import facts
from distronode.module_utils.facts import hardware
from distronode.module_utils.facts import network
from distronode.module_utils.facts import virtual
...
class TestFactsLinuxHardwareGetMountFacts(unittest.TestCase):
    ...
    # we can test.
    @patch('distronode.module_utils.facts.hardware.linux.LinuxHardware._mtab_entries', return_value=MTAB_ENTRIES)
    @patch('distronode.module_utils.facts.hardware.linux.LinuxHardware._find_bind_mounts', return_value=BIND_MOUNTS)
    @patch('distronode.module_utils.facts.hardware.linux.LinuxHardware._lsblk_uuid', return_value=LSBLK_UUIDS)
    @patch('distronode.module_utils.facts.hardware.linux.LinuxHardware._udevadm_uuid', return_value=UDEVADM_UUID)
    ...
    @patch('distronode.module_utils.facts.hardware.linux.get_file_content', return_value=MTAB)
    ...
    @patch('distronode.module_utils.facts.hardware.linux.LinuxHardware._run_findmnt', return_value=(0, FINDMNT_OUTPUT, ''))
    ...
    @patch('distronode.module_utils.facts.hardware.linux.LinuxHardware._run_findmnt', return_value=(37, '', ''))
    ...
    @patch('distronode.module_utils.facts.hardware.linux.LinuxHardware._run_lsblk', return_value=(0, LSBLK_OUTPUT, ''))
    ...
    @patch('distronode.module_utils.facts.hardware.linux.LinuxHardware._run_lsblk', return_value=(37, LSBLK_OUTPUT, ''))
    ...
    @patch('distronode.module_utils.facts.hardware.linux.LinuxHardware._run_lsblk', return_value=(0, LSBLK_OUTPUT_2, ''))
