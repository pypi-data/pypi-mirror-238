...
from distronode.module_utils.facts.network import iscsi
...
def test_get_iscsi_info(mocker):
    ...
    mocker.patch('distronode.module_utils.facts.network.iscsi.get_bin_path', return_value='/usr/sbin/lsattr')
    ...
    mocker.patch('distronode.module_utils.facts.network.iscsi.get_bin_path', return_value='/opt/iscsi/bin/iscsiutil')
