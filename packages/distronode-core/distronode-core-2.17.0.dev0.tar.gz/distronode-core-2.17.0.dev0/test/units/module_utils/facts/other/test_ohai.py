# unit tests for distronode ohai fact collector
# -*- coding: utf-8 -*-
#
    ...
    "storage": {
      ...
      "default": {
        ...
        "volumes": {
          ...
          "centos5-distronode_default.img": {
            "key": "/var/lib/libvirt/images/centos5-distronode_default.img",
            "name": "centos5-distronode_default.img",
            "path": "/var/lib/libvirt/images/centos5-distronode_default.img",
            "allocation": 8986624,
            "capacity": 42949672960,
            "type": 0
          },
...
class TestOhaiCollector(BaseFactsTest):
    ...
    valid_subsets = ['ohai']
    fact_namespace = 'distronode_ohai'
    ...
    @patch('distronode.module_utils.facts.other.ohai.OhaiFactCollector.get_ohai_output')
    ...
    @patch('distronode.module_utils.facts.other.ohai.OhaiFactCollector.run_ohai')
