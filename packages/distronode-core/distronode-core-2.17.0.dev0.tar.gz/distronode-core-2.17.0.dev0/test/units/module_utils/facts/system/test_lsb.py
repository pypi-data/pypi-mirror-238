# unit tests for distronode system lsb fact collectors
# -*- coding: utf-8 -*-
#
...
class TestLSBFacts(BaseFactsTest):
    ...
    def test_etc_lsb_release(self):
        ...
        with patch('distronode.module_utils.facts.system.lsb.os.path.exists',
                   return_value=True):
            with patch('distronode.module_utils.facts.system.lsb.get_file_lines',
