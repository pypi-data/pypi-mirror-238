...
from distronode.module_utils.facts.hardware import linux
...
class TestFactsLinuxHardwareGetMountFacts(unittest.TestCase):
    ...
    @patch('distronode.module_utils.facts.hardware.linux.get_mount_size', side_effect=mock_get_mount_size)
