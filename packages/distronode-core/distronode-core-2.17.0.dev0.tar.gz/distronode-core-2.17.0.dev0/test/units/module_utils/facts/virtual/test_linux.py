...
from distronode.module_utils.facts.virtual import linux
...
def test_get_virtual_facts_bhyve(mocker):
    ...
    mocker.patch('distronode.module_utils.facts.virtual.linux.get_file_content', return_value='')
    mocker.patch('distronode.module_utils.facts.virtual.linux.get_file_lines', return_value=[])
