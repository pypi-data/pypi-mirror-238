...
def mock_os(mocker):
    ...
    os = mocker.patch('distronode.module_utils.basic.os')
...
def mock_subprocess(mocker):
    ...
    subprocess = mocker.patch('distronode.module_utils.basic.subprocess')
...
def test_run_command_fds(mocker, rc_am):
    subprocess_mock = mocker.patch('distronode.module_utils.basic.subprocess')
