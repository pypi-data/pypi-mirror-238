...
def test_deprecate(am, capfd, monkeypatch):
    ...
    am.deprecate('deprecation2', '2.3')  # pylint: disable=distronode-deprecated-no-collection-name
    am.deprecate('deprecation3', version='2.4')  # pylint: disable=distronode-deprecated-no-collection-name
    am.deprecate('deprecation4', date='2020-03-10')  # pylint: disable=distronode-deprecated-no-collection-name
    am.deprecate('deprecation5', collection_name='distronode.builtin')
    am.deprecate('deprecation6', '2.3', collection_name='distronode.builtin')
    am.deprecate('deprecation7', version='2.4', collection_name='distronode.builtin')
    am.deprecate('deprecation8', date='2020-03-10', collection_name='distronode.builtin')
    ...
    assert output['deprecations'] == [
        ...
        {u'msg': u'deprecation5', u'version': None, u'collection_name': 'distronode.builtin'},
        {u'msg': u'deprecation6', u'version': '2.3', u'collection_name': 'distronode.builtin'},
        {u'msg': u'deprecation7', u'version': '2.4', u'collection_name': 'distronode.builtin'},
        {u'msg': u'deprecation8', u'date': '2020-03-10', u'collection_name': 'distronode.builtin'},
