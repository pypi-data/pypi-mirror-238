...
from distronode.modules.service_facts import AIXScanService
...
class TestAIXScanService(unittest.TestCase):
    ...
    def setUp(self):
        self.mock1 = patch.object(basic.DistronodeModule, 'get_bin_path', return_value='/usr/sbin/lssrc')
        self.mock1.start()
        self.addCleanup(self.mock1.stop)
        self.mock2 = patch.object(basic.DistronodeModule, 'run_command', return_value=(0, LSSRC_OUTPUT, ''))
        self.mock2.start()
    ...
    def test_gather_services(self):
        svcmod = AIXScanService(basic.DistronodeModule)
