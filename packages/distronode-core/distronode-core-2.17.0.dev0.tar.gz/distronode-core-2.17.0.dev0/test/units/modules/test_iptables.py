...
from distronode.modules import iptables
from units.modules.utils import DistronodeExitJson, DistronodeFailJson, ModuleTestCase, set_module_args
...
class TestIptables(ModuleTestCase):
    ...
    def setUp(self):
        ...
        self.mock_get_bin_path = patch.object(basic.DistronodeModule, 'get_bin_path', get_bin_path)
    ...
    def test_without_required_parameters(self):
        ...
        with self.assertRaises(DistronodeFailJson):
            set_module_args({})
            iptables.main()
    ...
    def test_flush_table_without_chain(self):
        ...
        with patch.object(basic.DistronodeModule, 'run_command') as run_command:
            run_command.return_value = 0, '', ''  # successful execution, no output
            with self.assertRaises(DistronodeExitJson) as result:
                iptables.main()
...
# TODO ADD test policy with wrong choice fail
    ...
    def test_jump_tee_gateway_negative(self):
        ...
        with self.assertRaises(DistronodeFailJson) as e:
            iptables.main()
