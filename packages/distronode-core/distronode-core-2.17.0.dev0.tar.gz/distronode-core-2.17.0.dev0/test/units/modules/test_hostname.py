...
from distronode.modules import hostname
...
class TestHostname(ModuleTestCase):
    ...
    def test_stategy_get_never_writes_in_check_mode(self, isfile):
        ...
        set_module_args({'name': 'fooname', '_distronode_check_mode': True})
...
class TestRedhatStrategy(ModuleTestCase):
    def setUp(self):
        ...
        self.testdir = tempfile.mkdtemp(prefix='distronode-test-hostname-')
