...
class TestCliBuildVaultIds(unittest.TestCase):
    def setUp(self):
        self.tty_patcher = patch('distronode.cli.sys.stdin.isatty', return_value=True)
...
class TestCliSetupVaultSecrets(unittest.TestCase):
    def setUp(self):
        ...
        self.display_v_patcher = patch('distronode.cli.display.verbosity', return_value=6)
    ...
    @patch('distronode.cli.get_file_vault_secret')
    ...
    @patch('distronode.cli.PromptVaultSecret')
