...
from distronode.executor.play_iterator import HostState, PlayIterator, IteratingStates, FailedStates
...
class TestPlayIterator(unittest.TestCase):
    ...
    def test_play_iterator(self):
        fake_loader = DictDataLoader({
            ...
            """,
            '/etc/distronode/roles/test_role/tasks/main.yml': """
            - name: role task
            ...
            - block:
              ...
              - name: end of role nested block 2
                debug:
            """,
            '/etc/distronode/roles/test_role/tasks/foo.yml': """
