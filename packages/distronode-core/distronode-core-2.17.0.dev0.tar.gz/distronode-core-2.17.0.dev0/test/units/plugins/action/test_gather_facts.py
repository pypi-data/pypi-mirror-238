...
from distronode.plugins.action.gather_facts import ActionModule as GatherFactsAction
...
class TestNetworkFacts(unittest.TestCase):
    ...
    def test_network_gather_facts_smart_facts_module(self, mock_collection_metadata):
        self.fqcn_task_vars = {'distronode_network_os': 'ios'}
        ...
        self.assertEqual(
            ...
            ('distronode.legacy.ios_facts', {'distronode_network_os': 'ios'},)
        )

    @patch.object(module_common, '_get_collection_metadata', return_value={})
    def test_network_gather_facts_smart_facts_module_fqcn(self, mock_collection_metadata):
        self.fqcn_task_vars = {'distronode_network_os': 'cisco.ios.ios'}
        self.task.action = 'gather_facts'
        self.task.async_val = False
        self.task.args = {}
        ...
        self.assertEqual(
            get_module_args.call_args.args,
            ('cisco.ios.ios_facts', {'distronode_network_os': 'cisco.ios.ios'},)
        )
