...
import distronode.utils.display  # make available for monkeypatch
assert distronode.utils.display  # avoid reporting as unused

builtin_import = 'builtins.__import__'


def test_pause_curses_tigetstr_none(mocker, monkeypatch):
    monkeypatch.delitem(sys.modules, 'distronode.utils.display')
    ...
    mod = importlib.import_module('distronode.utils.display')
