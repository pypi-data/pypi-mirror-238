...
class TestVariableManager(unittest.TestCase):
    ...
    def test_basic_manager(self):
        ...
        # FIXME:  add the following ['distronode_version', 'distronode_playbook_python', 'groups']
    ...
    def test_variable_manager_precedence(self):
        ...
        fake_loader = DictDataLoader({
            # inventory1
            '/etc/distronode/inventory1': inventory1_filedata,
            # role defaults_only1
            '/etc/distronode/roles/defaults_only1/defaults/main.yml': """
            ...
            """,
            '/etc/distronode/roles/defaults_only1/tasks/main.yml': """
            - debug: msg="here i am"
            """,

            # role defaults_only2
            '/etc/distronode/roles/defaults_only2/defaults/main.yml': """
        ...
        inv1 = InventoryManager(loader=fake_loader, sources=['/etc/distronode/inventory1'])
        v = VariableManager(inventory=mock_inventory, loader=fake_loader)
        ...
        fake_loader.push("/etc/distronode/group_vars/all", """
        group_var_all: group_var_all_from_group_vars_all
        """)
        fake_loader.push("/etc/distronode/group_vars/group1", """
        group_var: group_var_from_group_vars_group1
        """)
        fake_loader.push("/etc/distronode/group_vars/group3", """
        # this is a dummy, which should not be used anywhere
        group_var: group_var_from_group_vars_group3
        """)
        fake_loader.push("/etc/distronode/host_vars/host1", """
    ...
    def test_variable_manager_role_vars_dependencies(self):
        ...
        fake_loader = DictDataLoader({
            # role common-role
            '/etc/distronode/roles/common-role/tasks/main.yml': """
            - debug: msg="{{role_var}}"
            """,
            ...
            # role role1
            '/etc/distronode/roles/role1/vars/main.yml': """
            role_var: "role_var_from_role1"
            """,
            '/etc/distronode/roles/role1/meta/main.yml': """
            dependencies:
              - { role: common-role }
            """,

            # role role2
            '/etc/distronode/roles/role2/vars/main.yml': """
            role_var: "role_var_from_role2"
            """,
            '/etc/distronode/roles/role2/meta/main.yml': """
            dependencies:
              - { role: common-role }
            """,
        })
