...
def get_pulp_distributions(module, distribution):
    ...
    distro_uri = module.params['galaxy_ng_server'] + 'pulp/api/v3/distributions/distronode/distronode/'
...
def get_pulp_repositories(module, repository):
    ...
    repo_uri = module.params['galaxy_ng_server'] + 'pulp/api/v3/repositories/distronode/distronode/'
...
def get_repo_collections(repository, module):
    collections_uri = module.params['galaxy_ng_server'] + 'v3/plugin/distronode/content/' + repository + '/collections/index/'
