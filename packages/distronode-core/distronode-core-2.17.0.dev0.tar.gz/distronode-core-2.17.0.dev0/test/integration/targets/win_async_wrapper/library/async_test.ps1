...
$sleep_delay_sec = Get-DistronodeParam -obj $parsed_args -name "sleep_delay_sec" -type "int" -default 0
$fail_mode = Get-DistronodeParam -obj $parsed_args -name "fail_mode" -type "str" -default "success" -validateset "success", "graceful", "exception"
