...
from distronode_collections.testns.testcoll.plugins.module_utils import leaf, secondary
# FIXME: this one needs pkginit synthesis to work
# from distronode_collections.testns.testcoll.plugins.module_utils.subpkg import submod
from distronode_collections.testns.testcoll.plugins.module_utils.subpkg_with_init import (thingtocall as spwi_thingtocall,
