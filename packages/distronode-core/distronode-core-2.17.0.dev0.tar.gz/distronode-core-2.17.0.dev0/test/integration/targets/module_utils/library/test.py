...
from distronode.module_utils.spam8.ham import bacon
from distronode.module_utils.spam8.ham import eggs
results['spam8'] = (bacon.data, eggs)

# Test that import of module_utils/qux1/quux.py using as works
from distronode.module_utils.qux1 import quux as two
results['qux1'] = two.data

# Test that importing qux2/quux.py and qux2/quuz.py using as works
from distronode.module_utils.qux2 import quux as three, quuz as four
results['qux2'] = (three.data, four.data)

# Test depth
from distronode.module_utils.a.b.c.d.e.f.g.h import data
