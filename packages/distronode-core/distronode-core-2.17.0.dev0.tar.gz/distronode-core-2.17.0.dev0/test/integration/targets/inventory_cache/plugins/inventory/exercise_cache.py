...
from distronode.plugins.inventory import BaseInventoryPlugin, Cacheable
...
class InventoryModule(BaseInventoryPlugin, Cacheable):
    ...
    def parse(self, inventory, loader, path, cache=None):
        ...
        try:
            ...
            raise DistronodeError("Failed to run cache tests: {0}".format(e)) from e
    ...
    def exercise_test_cache(self):
        ...
        if failed:
            raise DistronodeError(f"Cache tests failed: {', '.join(failed)}")
