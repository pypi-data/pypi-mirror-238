...
description:
  ...
  - As of Distronode 2.3 support was added for SmartOS and BSDs.
  - As of Distronode 2.4 support was added for macOS.
  - As of Distronode 2.9 support was added for AIX 6.1+
...
from distronode.module_utils.basic import DistronodeModule, get_distribution
    ...
    def diff(self, phase1='before', phase2='after'):
        ...
        Returns:
            diff: The difference of value between phase1 and phase2.
                ...
                `--diff` option of distronode-playbook.
        """
        diff = {phase1: {}, phase2: {}}
