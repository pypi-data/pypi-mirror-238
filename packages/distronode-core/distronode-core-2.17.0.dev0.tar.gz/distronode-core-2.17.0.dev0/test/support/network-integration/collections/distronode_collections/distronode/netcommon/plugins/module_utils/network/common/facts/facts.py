...
class FactsBase(object):
    ...
    def __init__(self, module):
        ...
        self.distronode_facts = {"distronode_network_resources": {}}
        self.distronode_facts["distronode_net_gather_network_resources"] = list()
        self.distronode_facts["distronode_net_gather_subset"] = list()
    ...
    def get_network_resources_facts(
        ...
        if restorun_subsets:
            ...
            for inst in instances:
                inst.populate_facts(self._connection, self.distronode_facts, data)
    ...
    def get_network_legacy_facts(
        ...
        if runable_subsets:
            ...
            for key, value in iteritems(facts):
                key = "distronode_net_%s" % key
                self.distronode_facts[key] = value
