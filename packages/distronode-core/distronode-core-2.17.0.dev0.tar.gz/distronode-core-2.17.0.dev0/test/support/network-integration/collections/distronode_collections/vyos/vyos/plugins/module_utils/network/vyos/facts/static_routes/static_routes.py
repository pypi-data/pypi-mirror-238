...
from distronode_collections.distronode.netcommon.plugins.module_utils.network.common import (
    utils,
)
from distronode_collections.vyos.vyos.plugins.module_utils.network.vyos.argspec.static_routes.static_routes import (
    Static_routesArgs,
)
from distronode_collections.vyos.vyos.plugins.module_utils.network.vyos.utils.utils import (
    get_route_type,
)
...
class Static_routesFacts(object):
    ...
    def populate_facts(self, connection, distronode_facts, data=None):
        """ Populate the facts for static_routes
        :param connection: the device connection
        :param distronode_facts: Facts dictionary
        ...
        distronode_facts["distronode_network_resources"].pop("static_routes", None)
        facts = {}
        if objs:
            facts["static_routes"] = []
        ...
        distronode_facts["distronode_network_resources"].update(facts)
        return distronode_facts
