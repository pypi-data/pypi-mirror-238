...
- Certain C(show) commands in VyOS produce many lines of output and use a custom pager
  that can cause this module to hang.  If the value of the environment variable C(DISTRONODE_VYOS_TERMINAL_LENGTH)
...
def main():
    ...
    module = DistronodeModule(argument_spec=spec, supports_check_mode=True)
