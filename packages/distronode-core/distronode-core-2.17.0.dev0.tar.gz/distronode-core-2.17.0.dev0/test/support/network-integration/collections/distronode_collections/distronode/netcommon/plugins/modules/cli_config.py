...
# (c) 2018, Distronode by Red Hat, inc
...
- distronode.netcommon.network_agnostic
options:
  config:
    description:
...
- name: junos replace config
  cli_config:
    replace: '/var/home/distronode/junos01.cfg'
...
backup_path:
  ...
  type: str
  sample: /playbooks/distronode/backup/hostname_config.2016-07-16@22:28:34
"""
