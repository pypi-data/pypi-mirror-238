...
RETURN = """
distronode_net_config:
  description: The running-config from the device
  returned: when config is configured
  type: str
distronode_net_commits:
  description: The set of available configuration revisions
  returned: when present
  type: list
distronode_net_hostname:
  description: The configured system hostname
  returned: always
  type: str
distronode_net_model:
  description: The device model string
  returned: always
  type: str
distronode_net_serialnum:
  description: The serial number of the device
  returned: always
  type: str
distronode_net_version:
  description: The version of the software running
  returned: always
  type: str
distronode_net_neighbors:
  description: The set of LLDP neighbors
  returned: when interface is configured
  type: list
distronode_net_gather_subset:
...
distronode_net_api:
  ...
  returned: always
  type: str
distronode_net_python_version:
  description: The Python version Distronode controller is using
  returned: always
  type: str
distronode_net_gather_network_resources:
...
from distronode_collections.vyos.vyos.plugins.module_utils.network.vyos.argspec.facts.facts import (
    FactsArgs,
)
from distronode_collections.vyos.vyos.plugins.module_utils.network.vyos.facts.facts import (
    Facts,
)
...
def main():
    ...
    distronode_facts, additional_warnings = result
    warnings.extend(additional_warnings)

    module.exit_json(distronode_facts=distronode_facts, warnings=warnings)
