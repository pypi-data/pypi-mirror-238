...
from distronode_collections.vyos.vyos.plugins.module_utils.network.vyos.argspec.firewall_rules.firewall_rules import (
    Firewall_rulesArgs,
)
...
class Firewall_rulesFacts(object):
    ...
    def populate_facts(self, connection, distronode_facts, data=None):
        ...
        distronode_facts["distronode_network_resources"].pop("firewall_rules", None)
        facts = {}
        if objs:
