...
from distronode_collections.vyos.vyos.plugins.module_utils.network.vyos.argspec.l3_interfaces.l3_interfaces import (
    L3_interfacesArgs,
)
...
class L3_interfacesFacts(object):
    ...
    def populate_facts(self, connection, distronode_facts, data=None):
        ...
        distronode_facts["distronode_network_resources"].pop("l3_interfaces", None)
        facts = {}
        if objs:
            facts["l3_interfaces"] = []
