# Copyright: (c) 2018, Matt Davis <mdavis@distronode.github.io>
...
from distronode.module_utils.common.validation import check_type_str, check_type_float
from distronode.plugins.action import ActionBase
from distronode.utils.display import Display

from distronode_collections.distronode.windows.plugins.plugin_utils._reboot import reboot_host
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        for names, check_func in [
            ...
            if value is not None:
                try:
                    ...
                    raise DistronodeError("Invalid value given for '%s': %s." % (names[0], to_native(e)))
        ...
        #     display.deprecated(dep_msg, date="2023-05-01", collection_name="distronode.windows")
