...
- name: Copy a single file as another user
  ...
  vars:
    distronode_become_user: user
    distronode_become_password: pass
    # The tmp dir must be set when using win_copy as another user
    # This ensures the become user will have permissions for the operation
    # Make sure to specify a folder both the distronode_user and the become_user have access to (i.e not %TEMP% which is user specific and requires Admin)
    distronode_remote_tmp: 'c:\tmp'
'''
