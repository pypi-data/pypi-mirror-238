...
#Requires -Module Distronode.ModuleUtils.CommandUtil
...
$raw_command_line = Get-DistronodeParam -obj $params -name "_raw_params" -type "str" -failifempty $true
$chdir = Get-DistronodeParam -obj $params -name "chdir" -type "path"
$executable = Get-DistronodeParam -obj $params -name "executable" -type "path"
$creates = Get-DistronodeParam -obj $params -name "creates" -type "path"
$removes = Get-DistronodeParam -obj $params -name "removes" -type "path"
$stdin = Get-DistronodeParam -obj $params -name "stdin" -type "str"
$no_profile = Get-DistronodeParam -obj $params -name "no_profile" -type "bool" -default $false
$output_encoding_override = Get-DistronodeParam -obj $params -name "output_encoding_override" -type "str"
