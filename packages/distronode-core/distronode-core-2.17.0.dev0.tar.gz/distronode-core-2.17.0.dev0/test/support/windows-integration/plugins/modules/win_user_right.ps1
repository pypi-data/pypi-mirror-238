...
$name = Get-DistronodeParam -obj $params -name "name" -type "str" -failifempty $true
$users = Get-DistronodeParam -obj $params -name "users" -type "list" -failifempty $true
$action = Get-DistronodeParam -obj $params -name "action" -type "str" -default "set" -validateset "add","remove","set"
...
$lsa_helper = New-Object -TypeName Distronode.LsaRightHelper
