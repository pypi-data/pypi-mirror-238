...
from distronode.template import is_template
...
def _ensure_default_collection(collection_list=None):
    ...
    if collection_list and 'distronode.builtin' not in collection_list and 'distronode.legacy' not in collection_list:
        collection_list.append('distronode.legacy')
