...
from distronode.playbook.helpers import load_list_of_tasks
...
class Block(Base, Conditional, CollectionSearch, Taggable, Notifiable, Delegatable):
    ...
    def _load_block(self, attr, ds):
        try:
            ...
            raise DistronodeParserError("A malformed block was encountered while loading a block", obj=self._ds, orig_exc=e)
    ...
    def _load_rescue(self, attr, ds):
        try:
            ...
            raise DistronodeParserError("A malformed block was encountered while loading rescue.", obj=self._ds, orig_exc=e)
    ...
    def _load_always(self, attr, ds):
        try:
            ...
            raise DistronodeParserError("A malformed block was encountered while loading always", obj=self._ds, orig_exc=e)

    def _validate_always(self, attr, name, value):
        if value and not self.block:
            raise DistronodeParserError("'%s' keyword cannot be used without 'block'" % name, obj=self._ds)
