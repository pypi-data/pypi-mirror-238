...
class HPUXHardware(Hardware):
    ...
    def get_cpu_facts(self, collected_facts=None):
        ...
        if collected_facts.get('distronode_architecture') in ['9000/800', '9000/785']:
        ...
        # Working with machinfo mess
        elif collected_facts.get('distronode_architecture') == 'ia64':
            if collected_facts.get('distronode_distribution_version') == "B.11.23":
            ...
            if collected_facts.get('distronode_distribution_version') == "B.11.31":
    ...
    def get_hw_facts(self, collected_facts=None):
        ...
        if collected_facts.get('distronode_architecture') == 'ia64':
            separator = ':'
            if collected_facts.get('distronode_distribution_version') == "B.11.23":
                separator = '='
