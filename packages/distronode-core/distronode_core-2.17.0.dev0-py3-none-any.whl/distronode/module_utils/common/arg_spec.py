...
from distronode.module_utils.common.warnings import deprecate, warn
...
from distronode.module_utils.errors import (
    AliasError,
    DistronodeValidationErrorMultiple,
    DeprecationError,
...
class ValidationResult:
    ...
    <distronode.module_utils.common.arg_spec.ArgumentSpecValidator.validate()>`
    ...
    def __init__(self, parameters):
        ...
        self._warnings = []
        self._aliases = {}
        self.errors = DistronodeValidationErrorMultiple()
        """
        :class:`~distronode.module_utils.errors.DistronodeValidationErrorMultiple` containing all
        :class:`~distronode.module_utils.errors.DistronodeValidationError` objects if there were
...
class ArgumentSpecValidator:
    ...
    def validate(self, parameters, *args, **kwargs):
        ...
        sanitized with :func:`~distronode.module_utils.common.parameters.sanitize_keys` before logging or displaying.
...
class ModuleArgumentSpecValidator(ArgumentSpecValidator):
    """Argument spec validation class used by :class:`DistronodeModule`.

    This is not meant to be used outside of :class:`DistronodeModule`. Use
