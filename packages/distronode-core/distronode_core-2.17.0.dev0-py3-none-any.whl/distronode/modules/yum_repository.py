...
options:
  async:
    description:
      ...
      - In distronode-core 2.11, 2.12, and 2.13 the default value is V(true).
...
notes:
  ...
  - "The O(ignore:params) parameter was removed in Distronode 2.5 due to circumventing Distronode's parameter
    handling"
'''

EXAMPLES = '''
- name: Add repository
  distronode.builtin.yum_repository:
    name: epel
...
- name: yum-clean-metadata
  distronode.builtin.command: yum clean metadata
...
from distronode.module_utils.six.moves import configparser
