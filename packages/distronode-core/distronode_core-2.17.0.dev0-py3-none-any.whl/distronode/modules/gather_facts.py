...
description:
     - This module takes care of executing the R(configured facts modules,FACTS_MODULES), the default is to use the M(distronode.builtin.setup) module.
     - This module is automatically called by playbooks to gather useful variables about remote hosts that can be used in playbooks.
     - It can also be executed directly by C(/usr/bin/distronode) to check what variables are available to a host.
     - Distronode provides many I(facts) about the system, automatically.
options:
    parallel:
        description:
...
# distronode all -m distronode.builtin.gather_facts --tree /tmp/facts
"""
