...
notes:
  ...
  - Group removal doesn't work if the group was installed with Distronode because
...
# because we need DistronodeModule object to use get_best_parsable_locale()
...
class DnfModule(YumDnf):
    """
    DNF Distronode module back-end implementation
    """
    ...
    def is_lockfile_pid_valid(self):
        ...
        # https://github.com/distronode/distronode/issues/57189
        return True
    ...
    def _ensure_dnf(self):
        ...
        self.module.fail_json(
            msg="Could not import the dnf python module using {0} ({1}). "
                ...
                "correct distronode_python_interpreter. (attempted {2})"
    ...
    def run(self):
        ...
        # This is not set in DistronodeModule() because the following shouldn't happen
