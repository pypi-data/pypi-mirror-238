...
attributes:
    ...
    core:
        ...
        support: partial
seealso:
- module: distronode.builtin.set_fact
...
- name: Load a variable file based on the OS type, or a default if not found. Using free-form to specify the file.
  ...
  vars:
    params:
      files:
        - '{{distronode_distribution}}.yaml'
        - '{{distronode_os_family}}.yaml'
        - default.yaml
      paths:
        - 'vars'

- name: Bare include (free-form)
  distronode.builtin.include_vars: myvars.yaml
