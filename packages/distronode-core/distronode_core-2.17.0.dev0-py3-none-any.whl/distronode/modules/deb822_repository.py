...
- name: Add repo using key from URL
  deb822_repository:
    ...
    suites: '{{ distronode_distribution_release }}'
    components: stable
    architectures: amd64
...
from distronode.module_utils.six import raise_from  # type: ignore[attr-defined]
from distronode.module_utils.urls import generic_urlparse
from distronode.module_utils.urls import open_url
from distronode.module_utils.urls import get_user_agent
from distronode.module_utils.urls import urlparse
