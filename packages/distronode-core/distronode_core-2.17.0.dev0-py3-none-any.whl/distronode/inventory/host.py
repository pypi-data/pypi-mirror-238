...
from distronode.inventory.group import Group, InventoryObjectType
from distronode.parsing.utils.addresses import patterns
from distronode.utils.vars import combine_vars, get_unique_id
...
class Host:
    ...
    def __init__(self, name=None, port=None, gen_uuid=True):
        ...
        if port:
            self.set_variable('distronode_port', int(port))
