...
class BecomeModule(BecomeBase):
    ...
    def build_become_command(self, cmd, shell):
        ...
        if self.get_option('become_pass'):
            self.prompt = '[sudo via distronode, key=%s] password:' % self._id
