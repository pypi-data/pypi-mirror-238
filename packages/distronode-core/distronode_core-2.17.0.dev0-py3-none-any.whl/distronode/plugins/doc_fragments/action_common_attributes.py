...
attributes:
    facts:
      description: Action returns an C(distronode_facts) dictionary that will update existing host facts
'''

    FILES = r'''
attributes:
    safe_file_operations:
      description: Uses Distronode's strict file operation functions to ensure proper permissions and avoid data corruption
    vault:
      description: Can automatically decrypt Distronode vaulted files
'''
