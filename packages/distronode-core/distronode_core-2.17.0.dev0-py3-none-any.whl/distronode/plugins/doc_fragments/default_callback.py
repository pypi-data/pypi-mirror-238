...
class ModuleDocFragment(object):
    ...
    options:
      display_skipped_hosts:
        ...
        default: yes
        env:
          - name: DISTRONODE_DISPLAY_SKIPPED_HOSTS
        ini:
      ...
      display_ok_hosts:
        ...
        default: yes
        env:
          - name: DISTRONODE_DISPLAY_OK_HOSTS
        ini:
      ...
      display_failed_stderr:
        ...
        default: no
        env:
          - name: DISTRONODE_DISPLAY_FAILED_STDERR
        ini:
      ...
      show_custom_stats:
        ...
        default: no
        env:
          - name: DISTRONODE_SHOW_CUSTOM_STATS
        ini:
      ...
      show_per_host_start:
        ...
        default: no
        env:
          - name: DISTRONODE_SHOW_PER_HOST_START
        ini:
      ...
      check_mode_markers:
        ...
        - "The markers are C(DRY RUN) at the beginning and ending of playbook execution (when calling C(distronode-playbook --check))
        and C(CHECK MODE) as a suffix at every play and task that is run in check mode."
        type: bool
        default: no
        version_added: '2.9'
        env:
          - name: DISTRONODE_CHECK_MODE_MARKERS
        ini:
      ...
      show_task_path_on_failure:
        ...
        default: no
        env:
          - name: DISTRONODE_SHOW_TASK_PATH_ON_FAILURE
        ini:
