...
DOCUMENTATION = '''
    name: minimal
    type: stdout
    short_description: minimal Distronode screen output
    version_added: historical
    description:
        - This is the default output callback used by the distronode command (ad-hoc)
...
class CallbackModule(CallbackBase):
    ...
    def v2_runner_on_ok(self, result):
        ...
        if result._task.action in C.MODULE_NO_JSON and 'distronode_job_id' not in result._result:
