        ...
        directory:
            ...
            ini:
                - section: callback_tree
                  key: directory
            env:
                - name: DISTRONODE_CALLBACK_TREE_DIR
            default: "~/.distronode/tree"
            type: path
    description:
        - "This callback is used by the Distronode (adhoc) command line option C(-t|--tree)."
...
from distronode.constants import TREE_DIR
