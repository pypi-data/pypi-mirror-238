    ...
    def run(self, tmp=None, task_vars=None):
        ...
        def ping_module_test(connect_timeout):
            ...
            if self._discovered_interpreter_key:
                task_vars['distronode_facts'].pop(self._discovered_interpreter_key, None)
            ...
            ping_result = self._execute_module(module_name='distronode.legacy.ping', module_args=dict(), task_vars=task_vars)
