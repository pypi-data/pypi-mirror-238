...
def distronode_eval_concat(nodes):
...
def distronode_native_concat(nodes):
    ...
    if len(head) == 1:
        ...
        if isinstance(out, DistronodeVaultEncryptedUnicode):
            return out.data
        ...
        if isinstance(out, NativeJinjaText):
            ...
            # See:
            # https://github.com/distronode/distronode/issues/70831
            # https://github.com/pallets/jinja/issues/1200
            # https://github.com/distronode/distronode/issues/70831#issuecomment-664190894
            return out
