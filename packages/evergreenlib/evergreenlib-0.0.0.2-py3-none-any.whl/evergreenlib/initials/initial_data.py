...
class Initials:
    ...
    def make_ap_df(self):
        ...
        self.AP_df['Entry date and time'] = self.AP_df['Entry Date'].astype(
            str) + " " + self.AP_df['Time']
        self.AP_df['Entry date and time'] = self.AP_df['Entry date and time'].astype(
            'datetime64[ns]')

        self.AP_df['DocumentNo'] = self.AP_df['DocumentNo'].str.split(
            ".").str.get(0)
