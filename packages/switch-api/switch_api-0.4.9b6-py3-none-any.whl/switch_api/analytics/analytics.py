...
def upsert_performance_statistics(api_inputs:ApiInputs, performance_project_id: uuid.UUID, standard_id: uuid.UUID,
    ...
    url = f"{api_inputs.api_projects_endpoint}/{api_inputs.api_project_id}/bencmarking/performanceProjects/{performance_project_id}/standards/{standard_id}/sites/statistics"
