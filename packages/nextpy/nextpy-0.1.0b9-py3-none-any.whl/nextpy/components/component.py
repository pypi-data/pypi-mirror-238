...
class Component(Base, ABC):
    ...
    def _render_out_of_band(self, base_state, events: bool = False) -> str | None:
        from nextpy.core.compiler.templates import REACTIVE_COMPONENT
        ...
        self.tag = tag_name
        self.render = render
        logger.debug(f"Final Return Code: {code}")
        return code
    ...
    def get_custom_code(self) -> Set[str]:
        ...
        logger.debug(f"get_custom_code: {custom_code}")
    ...
    def get_custom_components(
        ...
        logger.debug(f"custom_components: {custom_components}")
