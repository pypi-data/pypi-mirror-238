...
>
{Repository._version_and_date_as_markdown_note()}
...
'''
    ...
    def generate_markdown_docs(cls, heading=True):
        ...
        if heading:
            ...
            lines.append(cls._version_and_date_as_markdown_note())
            lines.append('>')
    ...
    def show_changes(self, terse=defaults.TERSE):  # pragma: no cover  (wrapper method)
    ...
    def show_changes_as_tables(self, terse=defaults.TERSE):  # pragma: no cover  (wrapper method)
