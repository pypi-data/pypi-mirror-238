...
def test_dry_run():
    ...
    # Act
    dry_run = proposed_changes.dry_run(one_line=False)
...
--------  ----  ----------------  ---------  --------------------
DELETE    123   ToDelete          None       None
CREATE    None  Test Site         None       None
UPDATE    123   [-Before-]+After  None       None
                +"""
    )
