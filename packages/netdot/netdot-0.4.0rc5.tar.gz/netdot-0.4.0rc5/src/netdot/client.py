...
from . import exceptions, parse, trace, validate, utils, defaults
...
class Client_v1(AbstractContextManager):
    ...
    def __init__(self, server, username, password, verify_ssl=(not defaults.SKIP_SSL), timeout=defaults.TIMEOUT):
