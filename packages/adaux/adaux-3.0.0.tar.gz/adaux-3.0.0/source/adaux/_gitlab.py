...
class GitlabSetter(ApiRequestCommunicator):
    ...
    def merge_request(self, mr_message: str = "") -> None:
        source_branch = self.ns.auxe.gitlab.current_branch
        target_branch = self.ns.auxe.gitlab.default_branch
        ...
        settings = dict(source_branch=source_branch, target_branch=target_branch)
