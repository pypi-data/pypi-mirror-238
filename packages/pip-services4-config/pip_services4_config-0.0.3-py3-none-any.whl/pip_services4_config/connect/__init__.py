# -*- coding: utf-8 -*-
"""
    pip_services4_config.connect.__init__
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    relevant helper classes (like :class:`ConnectionResolver <pip_services4_config.connect.ConnectionResolver.ConnectionResolver>`), for acquiring these parameters,
