...
class StakingL2(PrecompileContract):
    ...
    def create_staking(self,
        ...
        return self.aide.web3.subChain.stakingL2.create_staking(node_id, amount, benefit_address, name, detail,
                                                                electron_uri, rpc_uri, p2p_uri,
                                                                node_version, version_sign, bls_pubkey, bls_proof,
                                                                is_operator)
    ...
    def edit_staking(self,
        ...
        return self.aide.web3.subChain.stakingL2.edit_staking(node_id, benefit_address, node_name, detail)
