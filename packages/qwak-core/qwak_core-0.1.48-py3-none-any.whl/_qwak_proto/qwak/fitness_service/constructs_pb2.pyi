...
class BuildProperties(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["branch", b"branch", "build_id", b"build_id", "gpu_compatible", b"gpu_compatible", "model_id", b"model_id", "model_uri", b"model_uri", "tags", b"tags"]) -> None: ...
...
class GpuResources(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cpu", b"cpu", "gpu_amount", b"gpu_amount", "gpu_type", b"gpu_type", "memory_amount", b"memory_amount", "memory_units", b"memory_units"]) -> None: ...
