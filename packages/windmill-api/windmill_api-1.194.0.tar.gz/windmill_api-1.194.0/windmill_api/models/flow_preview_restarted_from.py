...
T = TypeVar("T", bound="FlowPreviewRestartedFrom")


@_attrs_define
class FlowPreviewRestartedFrom:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_preview_restarted_from = cls(
            flow_job_id=flow_job_id,
            step_id=step_id,
        )

        flow_preview_restarted_from.additional_properties = d
        return flow_preview_restarted_from
