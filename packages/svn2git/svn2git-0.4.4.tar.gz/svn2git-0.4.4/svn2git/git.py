...
class GitMigrationHelper:
    ...
    def clone(
        ...
        run_command(init_command if password is None else [f"echo {password}", init_command])
        ...
        run_command(fetch_command if password is None else [f"echo {password}", fetch_command])
    ...
    def fix_branches(
        self, branches: GitBranches, rebase: bool = False, trunk_branch: str = "trunk", password: Optional[str] = None
    ) -> None:
        """
        ...
        :param trunk_branch: The trunk branch (Default: trunk).
        :param password: The password for the SVN repository.
        """
        ...
        if rebase:
            ...
            run_command("git svn fetch" if password is None else [f"echo {password}", "git svn fetch"])
