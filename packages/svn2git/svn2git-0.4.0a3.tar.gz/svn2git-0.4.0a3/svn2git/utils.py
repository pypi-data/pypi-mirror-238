...
def run_command(command: str, exit_on_error: bool = True, return_stdout: bool = False) -> str:
    """
    ...
    process = subprocess.Popen(
        command.split(" "), stdout=subprocess.PIPE, stderr=subprocess.STDOUT, shell=True
    )  # nosec
