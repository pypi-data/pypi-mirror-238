...
class MetricValue(betterproto.Message):
    ...
    """
    Deprecated use values instead @exclude @inject_tag:
    `bigquery:"supporting_values"`
    """
...
class MetricValueValue(betterproto.Message):
    ...
    """@exclude @inject_tag: `bigquery:"name"`"""

    unit: str = betterproto.string_field(2)
    """@exclude @inject_tag: `bigquery:"unit"`"""

    number: float = betterproto.float_field(9, group="value")
    """@exclude @inject_tag: `bigquery:"number" json:"number"`"""

    count: int = betterproto.int64_field(10, group="value")
    """@exclude @inject_tag: `bigquery:"count" json:"count"`"""

    category: str = betterproto.string_field(11, group="value")
    """@exclude @inject_tag: `bigquery:"category"`"""
...
class Metric(betterproto.Message):
    ...
    """@exclude @inject_tag: `sql:"type:jsonb"""
    ...
    """
    @exclude @inject_tag: `gorm:"foreignKey:RelatedLayerId;references:Id"`
    """

    dimensions: List["Dimension"] = betterproto.message_field(7)
    """@exclude @inject_tag: `gorm:"-"`"""
...
class ValueSpec(betterproto.Message):
    ...
    """
    allows specifying that a value is nullable this is useful for values that
    are not always present it is recommended to add a separate value providing
    reason to why the value is not present null values might be seen downstream
    as 0 or "" values https://coda.io/d/_dK76Oc2iQoX/Data-Producer-
    Docs_suCU1#_lu1NZ Queries and exports will have specific default strategies
    for including/filtering null values
    """
