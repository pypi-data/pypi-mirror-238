...
class LocalByoWorkerInvocationServiceStub(betterproto.ServiceStub):
    ...
    async def trigger_dataset_extensions(
        ...
        *,
        ...
        return await self._unary_unary(
            "/unacast.byo.v1.LocalByoWorkerInvocationService/TriggerDatasetExtensions",
            betterproto_lib_google_protobuf_empty,
            betterproto_lib_google_protobuf.Empty,
            timeout=timeout,
            deadline=deadline,
...
class LocalByoWorkerInvocationServiceBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/unacast.byo.v1.LocalByoWorkerInvocationService/TriggerDatasetExtensions": grpclib.const.Handler(
