...
def parser_args():
    ...
    parser.add_argument('--file-formats', default=['.jpg', '.jpeg', '.png', '.JPEG', '.JPG', '.PNG'], type=str, help="文件格式")
    ...
    # 合并类别筛选数据
        ...
        return args
    elif args.function == 'rename':  # 把中文文件名称，重命名为英文
        return args
...
def main():
    ...
    if args.sync:  # 同步读写数据处理
        ...
        if args.function == 'rename':  # 对中文的文件名称，转英文
            data_info.get_english_name()
