...
class _BingImageSearch(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        count=None,
        countCol=None,
        errorCol="BingImageSearch_2cdde91deedb_error",
        freshness=None,
        freshnessCol=None,
        handler=None,
        height=None,
        ...
        offset=None,
        offsetCol=None,
        outputCol="BingImageSearch_2cdde91deedb_output",
        q=None,
        qCol=None,
        size=None,
        sizeCol=None,
        ...
        self._setDefault(errorCol="BingImageSearch_2cdde91deedb_error")
        self._setDefault(outputCol="BingImageSearch_2cdde91deedb_output")
