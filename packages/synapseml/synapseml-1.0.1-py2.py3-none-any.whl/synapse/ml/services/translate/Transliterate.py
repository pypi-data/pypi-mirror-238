...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Transliterate_bdc121b8bf81_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_bdc121b8bf81_output",
        ...
        self._setDefault(errorCol="Transliterate_bdc121b8bf81_error")
        self._setDefault(outputCol="Transliterate_bdc121b8bf81_output")
