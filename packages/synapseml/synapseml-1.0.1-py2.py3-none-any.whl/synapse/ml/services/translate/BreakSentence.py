...
class BreakSentence(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="BreakSentence_2da20fd00bc8_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="BreakSentence_2da20fd00bc8_output",
        script=None,
        scriptCol=None,
        ...
        self._setDefault(errorCol="BreakSentence_2da20fd00bc8_error")
        self._setDefault(outputCol="BreakSentence_2da20fd00bc8_output")
