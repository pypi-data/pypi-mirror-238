...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Detect_f723b645d475_error",
        handler=None,
        outputCol="Detect_f723b645d475_output",
        ...
        self._setDefault(errorCol="Detect_f723b645d475_error")
        self._setDefault(outputCol="Detect_f723b645d475_output")
