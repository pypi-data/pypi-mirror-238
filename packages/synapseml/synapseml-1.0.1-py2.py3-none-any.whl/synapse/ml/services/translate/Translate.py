...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Translate_af1a3f4c2871_error",
        fromLanguage=None,
        ...
        outputCol="Translate_af1a3f4c2871_output",
        ...
        self._setDefault(errorCol="Translate_af1a3f4c2871_error")
        self._setDefault(outputCol="Translate_af1a3f4c2871_output")
