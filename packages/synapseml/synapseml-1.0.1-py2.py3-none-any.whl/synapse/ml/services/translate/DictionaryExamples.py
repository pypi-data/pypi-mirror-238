...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DictionaryExamples_a5371952878b_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_a5371952878b_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_a5371952878b_error")
        self._setDefault(outputCol="DictionaryExamples_a5371952878b_output")
