...
class AddDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AddDocuments_14fe43dab778_error",
        handler=None,
        indexName=None,
        outputCol="AddDocuments_14fe43dab778_output",
        serviceName=None,
        ...
        self._setDefault(errorCol="AddDocuments_14fe43dab778_error")
        self._setDefault(outputCol="AddDocuments_14fe43dab778_output")
