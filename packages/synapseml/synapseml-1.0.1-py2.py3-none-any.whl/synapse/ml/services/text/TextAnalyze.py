...
class TextAnalyze(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextAnalyze_9bfb2e3fd5a0_error",
        ...
        outputCol="TextAnalyze_9bfb2e3fd5a0_output",
        ...
        self._setDefault(errorCol="TextAnalyze_9bfb2e3fd5a0_error")
        ...
        self._setDefault(outputCol="TextAnalyze_9bfb2e3fd5a0_output")
