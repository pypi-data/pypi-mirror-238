...
class NER(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="NER_e3e786985e26_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="NER_e3e786985e26_output",
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="NER_e3e786985e26_error")
        self._setDefault(outputCol="NER_e3e786985e26_output")
