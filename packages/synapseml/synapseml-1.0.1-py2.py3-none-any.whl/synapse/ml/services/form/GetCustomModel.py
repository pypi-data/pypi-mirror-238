...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GetCustomModel_077373888945_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_077373888945_output",
        ...
        self._setDefault(errorCol="GetCustomModel_077373888945_error")
        self._setDefault(outputCol="GetCustomModel_077373888945_output")
