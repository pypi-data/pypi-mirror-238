...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ListCustomModels_9606cbb5b8ae_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_9606cbb5b8ae_output",
        ...
        self._setDefault(errorCol="ListCustomModels_9606cbb5b8ae_error")
        self._setDefault(outputCol="ListCustomModels_9606cbb5b8ae_output")
