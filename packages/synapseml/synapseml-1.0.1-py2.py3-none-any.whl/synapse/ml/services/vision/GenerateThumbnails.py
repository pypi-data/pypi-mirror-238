...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GenerateThumbnails_1e7ba30ec3ac_error",
        handler=None,
        height=None,
        heightCol=None,
        imageBytes=None,
        ...
        imageUrl=None,
        imageUrlCol=None,
        outputCol="GenerateThumbnails_1e7ba30ec3ac_output",
        smartCropping=None,
        ...
        self._setDefault(errorCol="GenerateThumbnails_1e7ba30ec3ac_error")
        self._setDefault(outputCol="GenerateThumbnails_1e7ba30ec3ac_output")
