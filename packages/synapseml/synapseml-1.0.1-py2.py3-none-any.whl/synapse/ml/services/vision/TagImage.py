...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TagImage_a5671b5e4d80_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_a5671b5e4d80_output",
        ...
        self._setDefault(errorCol="TagImage_a5671b5e4d80_error")
        self._setDefault(outputCol="TagImage_a5671b5e4d80_output")
