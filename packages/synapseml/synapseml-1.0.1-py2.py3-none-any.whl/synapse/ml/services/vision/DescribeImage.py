...
class DescribeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DescribeImage_58192b7fbe7d_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        outputCol="DescribeImage_58192b7fbe7d_output",
        ...
        self._setDefault(errorCol="DescribeImage_58192b7fbe7d_error")
        self._setDefault(outputCol="DescribeImage_58192b7fbe7d_output")
