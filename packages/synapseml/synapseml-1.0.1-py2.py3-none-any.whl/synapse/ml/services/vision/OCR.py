...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OCR_e254e9a02a0d_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="OCR_e254e9a02a0d_output",
        ...
        self._setDefault(errorCol="OCR_e254e9a02a0d_error")
        self._setDefault(outputCol="OCR_e254e9a02a0d_output")
