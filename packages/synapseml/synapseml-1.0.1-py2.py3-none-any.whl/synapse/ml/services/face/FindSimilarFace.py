...
class FindSimilarFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="FindSimilarFace_95c87cbef910_error",
        faceId=None,
        faceIdCol=None,
        faceIds=None,
        faceIdsCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="FindSimilarFace_95c87cbef910_output",
        ...
        self._setDefault(errorCol="FindSimilarFace_95c87cbef910_error")
        self._setDefault(outputCol="FindSimilarFace_95c87cbef910_output")
