...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GroupFaces_65d413e31aee_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_65d413e31aee_output",
        ...
        self._setDefault(errorCol="GroupFaces_65d413e31aee_error")
        self._setDefault(outputCol="GroupFaces_65d413e31aee_output")
