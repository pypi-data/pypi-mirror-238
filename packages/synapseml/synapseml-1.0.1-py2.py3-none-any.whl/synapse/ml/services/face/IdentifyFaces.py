...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="IdentifyFaces_bf772366efd4_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_bf772366efd4_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_bf772366efd4_error")
        self._setDefault(outputCol="IdentifyFaces_bf772366efd4_output")
