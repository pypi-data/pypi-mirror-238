...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectFace_0cbf350e4b7f_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_0cbf350e4b7f_output",
        ...
        self._setDefault(errorCol="DetectFace_0cbf350e4b7f_error")
        self._setDefault(outputCol="DetectFace_0cbf350e4b7f_output")
