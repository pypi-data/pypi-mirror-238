...
class VerifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="VerifyFaces_9f1969e4d5d8_error",
        faceId=None,
        faceIdCol=None,
        faceId1=None,
        faceId1Col=None,
        ...
        outputCol="VerifyFaces_9f1969e4d5d8_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="VerifyFaces_9f1969e4d5d8_error")
        self._setDefault(outputCol="VerifyFaces_9f1969e4d5d8_output")
