...
class OpenAICompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAICompletion_ad8e9bf63353_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAICompletion_ad8e9bf63353_output",
        ...
        self._setDefault(errorCol="OpenAICompletion_ad8e9bf63353_error")
        self._setDefault(outputCol="OpenAICompletion_ad8e9bf63353_output")
