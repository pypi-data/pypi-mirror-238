...
class OpenAIChatCompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIChatCompletion_371630a5b667_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIChatCompletion_371630a5b667_output",
        ...
        self._setDefault(errorCol="OpenAIChatCompletion_371630a5b667_error")
        self._setDefault(outputCol="OpenAIChatCompletion_371630a5b667_output")
