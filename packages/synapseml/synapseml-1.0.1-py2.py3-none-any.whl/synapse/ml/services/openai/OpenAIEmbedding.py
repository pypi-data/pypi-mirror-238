...
class OpenAIEmbedding(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OpenAIEmbedding_a99d12c977b7_error",
        handler=None,
        outputCol="OpenAIEmbedding_a99d12c977b7_output",
        ...
        self._setDefault(errorCol="OpenAIEmbedding_a99d12c977b7_error")
        self._setDefault(outputCol="OpenAIEmbedding_a99d12c977b7_output")
