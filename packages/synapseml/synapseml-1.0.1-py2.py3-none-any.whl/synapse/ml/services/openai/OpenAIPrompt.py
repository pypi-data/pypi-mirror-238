...
class OpenAIPrompt(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIPrompt_86028c8b7661_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIPrompt_86028c8b7661_output",
        postProcessing="",
        ...
        self._setDefault(errorCol="OpenAIPrompt_86028c8b7661_error")
        self._setDefault(outputCol="OpenAIPrompt_86028c8b7661_output")
