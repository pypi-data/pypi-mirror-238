...
class AnalyzeText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="AnalyzeText_296dd08daaf3_error",
        handler=None,
        kind=None,
        language=None,
        languageCol=None,
        ...
        outputCol="AnalyzeText_296dd08daaf3_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="AnalyzeText_296dd08daaf3_error")
        self._setDefault(outputCol="AnalyzeText_296dd08daaf3_output")
