...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_03a8d1f34fb2_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_03a8d1f34fb2_output",
        ...
        self._setDefault(errorCol="CheckPointInPolygon_03a8d1f34fb2_error")
        self._setDefault(outputCol="CheckPointInPolygon_03a8d1f34fb2_output")
