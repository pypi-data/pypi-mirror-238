...
class TextAnalyze(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextAnalyze_4747868fb198_error",
        ...
        outputCol="TextAnalyze_4747868fb198_output",
        ...
        self._setDefault(errorCol="TextAnalyze_4747868fb198_error")
        ...
        self._setDefault(outputCol="TextAnalyze_4747868fb198_output")
