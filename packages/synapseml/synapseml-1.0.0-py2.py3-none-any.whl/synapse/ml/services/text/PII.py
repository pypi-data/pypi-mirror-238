...
class PII(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="PII_2f3202fb76b3_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="PII_2f3202fb76b3_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="PII_2f3202fb76b3_error")
        self._setDefault(outputCol="PII_2f3202fb76b3_output")
