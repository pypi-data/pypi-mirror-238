...
class FindSimilarFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="FindSimilarFace_55d355b0b493_error",
        faceId=None,
        faceIdCol=None,
        faceIds=None,
        faceIdsCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="FindSimilarFace_55d355b0b493_output",
        ...
        self._setDefault(errorCol="FindSimilarFace_55d355b0b493_error")
        self._setDefault(outputCol="FindSimilarFace_55d355b0b493_output")
