...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectFace_50ae41c0f3f2_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_50ae41c0f3f2_output",
        ...
        self._setDefault(errorCol="DetectFace_50ae41c0f3f2_error")
        self._setDefault(outputCol="DetectFace_50ae41c0f3f2_output")
