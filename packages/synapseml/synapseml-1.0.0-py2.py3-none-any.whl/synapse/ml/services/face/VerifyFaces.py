...
class VerifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="VerifyFaces_954b223255fe_error",
        faceId=None,
        faceIdCol=None,
        faceId1=None,
        faceId1Col=None,
        ...
        outputCol="VerifyFaces_954b223255fe_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="VerifyFaces_954b223255fe_error")
        self._setDefault(outputCol="VerifyFaces_954b223255fe_output")
