...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="IdentifyFaces_8b1bcf54c4d3_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_8b1bcf54c4d3_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_8b1bcf54c4d3_error")
        self._setDefault(outputCol="IdentifyFaces_8b1bcf54c4d3_output")
