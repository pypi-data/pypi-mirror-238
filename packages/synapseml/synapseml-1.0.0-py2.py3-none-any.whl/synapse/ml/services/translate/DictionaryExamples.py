...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DictionaryExamples_65222df7dc00_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_65222df7dc00_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_65222df7dc00_error")
        self._setDefault(outputCol="DictionaryExamples_65222df7dc00_output")
