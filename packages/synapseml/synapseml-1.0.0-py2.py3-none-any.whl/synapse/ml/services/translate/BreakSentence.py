...
class BreakSentence(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="BreakSentence_45c54dea6395_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="BreakSentence_45c54dea6395_output",
        script=None,
        scriptCol=None,
        ...
        self._setDefault(errorCol="BreakSentence_45c54dea6395_error")
        self._setDefault(outputCol="BreakSentence_45c54dea6395_output")
