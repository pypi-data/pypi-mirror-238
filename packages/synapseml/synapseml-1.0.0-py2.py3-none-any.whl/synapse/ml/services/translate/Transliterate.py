...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Transliterate_1cb56c86096c_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_1cb56c86096c_output",
        ...
        self._setDefault(errorCol="Transliterate_1cb56c86096c_error")
        self._setDefault(outputCol="Transliterate_1cb56c86096c_output")
