...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Translate_c35996b1b779_error",
        fromLanguage=None,
        ...
        outputCol="Translate_c35996b1b779_output",
        ...
        self._setDefault(errorCol="Translate_c35996b1b779_error")
        self._setDefault(outputCol="Translate_c35996b1b779_output")
