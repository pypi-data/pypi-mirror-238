...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Detect_edc224b416cf_error",
        handler=None,
        outputCol="Detect_edc224b416cf_output",
        ...
        self._setDefault(errorCol="Detect_edc224b416cf_error")
        self._setDefault(outputCol="Detect_edc224b416cf_output")
