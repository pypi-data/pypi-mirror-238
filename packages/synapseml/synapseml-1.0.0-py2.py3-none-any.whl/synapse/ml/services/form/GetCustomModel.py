...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GetCustomModel_e55a0f3c7a42_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_e55a0f3c7a42_output",
        ...
        self._setDefault(errorCol="GetCustomModel_e55a0f3c7a42_error")
        self._setDefault(outputCol="GetCustomModel_e55a0f3c7a42_output")
