...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ListCustomModels_7f92452da423_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_7f92452da423_output",
        ...
        self._setDefault(errorCol="ListCustomModels_7f92452da423_error")
        self._setDefault(outputCol="ListCustomModels_7f92452da423_output")
