...
class AnalyzeText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="AnalyzeText_e45875205ba3_error",
        handler=None,
        kind=None,
        language=None,
        languageCol=None,
        ...
        outputCol="AnalyzeText_e45875205ba3_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="AnalyzeText_e45875205ba3_error")
        self._setDefault(outputCol="AnalyzeText_e45875205ba3_output")
