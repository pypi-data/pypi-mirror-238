...
class OpenAIPrompt(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIPrompt_84547177d3bf_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIPrompt_84547177d3bf_output",
        postProcessing="",
        ...
        self._setDefault(errorCol="OpenAIPrompt_84547177d3bf_error")
        self._setDefault(outputCol="OpenAIPrompt_84547177d3bf_output")
