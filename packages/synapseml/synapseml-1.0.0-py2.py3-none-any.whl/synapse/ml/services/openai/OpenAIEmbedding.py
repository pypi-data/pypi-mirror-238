...
class OpenAIEmbedding(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OpenAIEmbedding_7840c03baa78_error",
        handler=None,
        outputCol="OpenAIEmbedding_7840c03baa78_output",
        ...
        self._setDefault(errorCol="OpenAIEmbedding_7840c03baa78_error")
        self._setDefault(outputCol="OpenAIEmbedding_7840c03baa78_output")
