...
class SpeechToText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="SpeechToText_4f3ea498ba70_error",
        format=None,
        formatCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="SpeechToText_4f3ea498ba70_output",
        profanity=None,
        profanityCol=None,
        ...
        self._setDefault(errorCol="SpeechToText_4f3ea498ba70_error")
        self._setDefault(outputCol="SpeechToText_4f3ea498ba70_output")
