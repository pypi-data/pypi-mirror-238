...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OCR_45fdf9072388_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="OCR_45fdf9072388_output",
        ...
        self._setDefault(errorCol="OCR_45fdf9072388_error")
        self._setDefault(outputCol="OCR_45fdf9072388_output")
