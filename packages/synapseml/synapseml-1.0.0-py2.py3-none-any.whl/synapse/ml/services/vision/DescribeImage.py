...
class DescribeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DescribeImage_fc13268b4f78_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        outputCol="DescribeImage_fc13268b4f78_output",
        ...
        self._setDefault(errorCol="DescribeImage_fc13268b4f78_error")
        self._setDefault(outputCol="DescribeImage_fc13268b4f78_output")
