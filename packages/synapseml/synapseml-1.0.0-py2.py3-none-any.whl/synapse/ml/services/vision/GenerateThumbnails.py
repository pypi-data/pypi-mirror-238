...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GenerateThumbnails_897fe8cd757b_error",
        handler=None,
        height=None,
        heightCol=None,
        imageBytes=None,
        ...
        imageUrl=None,
        imageUrlCol=None,
        outputCol="GenerateThumbnails_897fe8cd757b_output",
        smartCropping=None,
        ...
        self._setDefault(errorCol="GenerateThumbnails_897fe8cd757b_error")
        self._setDefault(outputCol="GenerateThumbnails_897fe8cd757b_output")
