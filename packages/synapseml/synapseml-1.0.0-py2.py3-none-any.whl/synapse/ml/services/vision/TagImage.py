...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TagImage_49b596865ef3_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_49b596865ef3_output",
        ...
        self._setDefault(errorCol="TagImage_49b596865ef3_error")
        self._setDefault(outputCol="TagImage_49b596865ef3_output")
