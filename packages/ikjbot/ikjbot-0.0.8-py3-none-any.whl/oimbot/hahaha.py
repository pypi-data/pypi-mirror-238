...
try:
    ...
    sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), 'lib', 'fortnitepy-master')))
...
print(crayons.blue(f'Discord server: https://discord.gg/hujdCzvNy5 - For support, questions, etc.'))
...
class PartyBot(commands.Bot):
    def __init__(self, device_id: str, account_id: str, secret: str, loop=asyncio.get_event_loop(), **kwargs) -> None:
        ...
        self.join_msg = "Hi {DISPLAY_NAME} \n - Join my discord : discord.com/lobbybot \n \n Use Code : 667 #AD"
