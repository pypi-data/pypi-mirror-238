...
auto setup_pyevaluation_result(py::module_ &module_) -> void {
    ...
    evaluation_result.def("get_evaluation_result", &pokerengine::get_evaluation_result);
    evaluation_result.def("get_evaluation_result_one", &pokerengine::get_evaluation_result_one);
}
} // namespace python
