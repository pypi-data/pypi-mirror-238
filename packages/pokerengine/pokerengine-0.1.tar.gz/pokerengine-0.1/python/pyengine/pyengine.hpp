...
auto setup_pyengine(py::module_ &module_) -> void {
    ...
    py::class_< pokerengine::engine< 0, 1 > >(engine, "EngineRake01", py::module_local())
                    ...
                    .def("start", &pokerengine::engine< 0, 1 >::start)
                    ...
                    .def("execute", &pokerengine::engine< 0, 1 >::execute_action)
                    .def_readonly("players", &pokerengine::engine< 0, 1 >::players)
                    .def_readonly("round", &pokerengine::engine< 0, 1 >::round)
                    .def_readonly("positions", &pokerengine::engine< 0, 1 >::positions)
                    .def_readonly("pot", &pokerengine::engine< 0, 1 >::pot)
