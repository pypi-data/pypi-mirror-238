...
from azureml.featurestore._utils._constants import PACKAGE_NAME, QUERY_MODE_DEFAULT, QUERY_MODE_DSL, QUERY_MODE_KEY
...
def get_offline_features(
    *, features: List[Feature], observation_data, timestamp_column: str, use_materialized_data: bool = True, **kwargs
    ...
    try:
        ...
        elif _is_private_preview_enabled() and query_mode == QUERY_MODE_DSL:
            from azureml.featurestore._offline_query import DslFeathrRetrievalJob
