...
class FeatureSourceFactory:
    ...
    def build_feature_source(self) -> FeatureSourceBase:
        if self.type == SourceType.CUSTOM:
            ...
            raise Exception(SOURCE_TYPE_NOT_SUPPORTED.format(self.type))
