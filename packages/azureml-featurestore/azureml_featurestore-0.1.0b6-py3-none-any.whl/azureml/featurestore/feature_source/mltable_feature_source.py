...
class MlTableFeatureSource(SimpleFeatureSource):
    """A mltable feature source
    ...
    def load(
        ...
        source_df = spark.read.mltable(self.path)
    ...
    def __repr__(self):
        ...
        return "MlTableFeatureSource({})".format(formatted_info)
