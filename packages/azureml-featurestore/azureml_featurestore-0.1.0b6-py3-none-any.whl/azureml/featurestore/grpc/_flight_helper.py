...
def initialize(features: List[Feature], credential, force, **kwargs):
    ...
    for feature in features:
        if not feature.feature_set_reference._materialization_settings.online_enabled:
            raise Exception(
                ONLINE_MATERIALIZATION_DISABLED.format(feature.feature_set_reference.name,feature.feature_set_reference.version)
            )
