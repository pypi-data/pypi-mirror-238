...
class OfflineStore(ABC):
    ...
    @abstractmethod
    def write_data(self, featureset: FeatureSet, df: "DataFrame", upsert: bool = True) -> int:
        pass
...
class OfflineStoreFactory:
    ...
    def make_offline_store(
        ...
        if offline_store_type == OfflineStoreType.AZURE_DATA_LAKE_GEN2:
            ...
            return AzureDataLakeOfflineStore(target=offline_store_target, connection_name=connection_name, location=location)
        else:
