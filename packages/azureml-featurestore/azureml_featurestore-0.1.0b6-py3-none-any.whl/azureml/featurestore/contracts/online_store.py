...
class OnlineStore:
    def __init__(self, target: str, type: OnlineStoreType, connection_name: str) -> None:
...
class OnlineStoreFactory:
    @staticmethod
    def make_online_store(online_store_type: OnlineStoreType, online_store_target: str, connection_name: str) -> OnlineStore:
