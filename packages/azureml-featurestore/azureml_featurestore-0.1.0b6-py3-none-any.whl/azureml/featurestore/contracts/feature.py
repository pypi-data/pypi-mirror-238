...
class Feature(object):
    ...
    def __init__(self, *, name, type: ColumnType, output_name=None, tags=None, description=None):
        self.name = name
        self.type = type
    ...
    def _to_dict(self):
        from azureml.featurestore.schema.feature_set_schema import Feature
        from marshmallow import EXCLUDE

        return dict(Feature(unknown=EXCLUDE, context={BASE_PATH_CONTEXT_KEY: "./"}).dump(self))
    ...
    def uri(self):
        ...
        return f"azureml://subscriptions/{feature_set_id.subscription_id}/resourceGroups/{feature_set_id.resource_group_name}/providers/Microsoft.MachineLearningServices/workspaces/{feature_set_id.workspace_name}/{feature_set_id.asset_type}/{feature_set_id.asset_name}/versions/{feature_set_id.asset_version}/features/{self.name}{query_string}"
