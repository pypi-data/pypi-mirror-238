...
class FeatureSource(Artifact):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        warn(
            "FeatureSource class will be deprecated, \
             please use classes under azureml.featurestore.feature_source"
        )

        if type == SourceType.CUSTOM:
            msg = "Custom type is not supported for FeatureSource class, \
                please use azureml.featurestore.feature_source.CustomFeatureSource"
