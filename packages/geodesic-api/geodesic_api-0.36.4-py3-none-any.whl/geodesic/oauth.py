...
class AuthManager:
    ...
    def credentials_path(self):
        ...
        credentials_path = os.path.expanduser(f"~/.config/geodesic/credentials.{cfg.name}")

        # does it not exist, but "credentials" does? (old credentials refresh token still there, leave it and use it)
    ...
    def authenticate(self, cli_authorization_code=None, quiet=False, cli_code_verifier=None):
