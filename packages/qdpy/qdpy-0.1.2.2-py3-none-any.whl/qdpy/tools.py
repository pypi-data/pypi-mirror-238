...
"""Basic operators and tools used to design QD or evolutionary algorithms."""
...
class Custom_Unpickler(pickle._Unpickler):
    """Custrom unpickler that automatically fixes class paths while opening older
    versions of qdpy.
    """
    current_modules = {"Individual": "qdpy.phenotype", "Fitness": "qdpy.phenotype"}
    
    def find_class(self, module, name):
        if name in Custom_Unpickler.current_modules:
            module = Custom_Unpickler.current_modules[name] #backward compatibility
