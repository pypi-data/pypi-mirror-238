...
class ProductConfiguration(object):
    ...
    def __init__(self, id=None, endpoint=None, displayedName_b64=None, description_b64=None, connection=None, runLimit=None, isReviewStatusChangeDisabled=None, confidentiality=None,):
        self.id = id
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.confidentiality = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.confidentiality is not None:
            oprot.writeFieldBegin('confidentiality', TType.I32, 8)
            oprot.writeI32(self.confidentiality)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class Product(object):
    ...
    def __init__(self, id=None, endpoint=None, displayedName_b64=None, description_b64=None, connected=None, accessible=None, administrating=None, databaseStatus=None, runCount=None, latestStoreToProduct=None, runLimit=None, admins=None, runStoreInProgress=None, confidentiality=None,):
        self.id = id
        self.endpoint = endpoint
        self.displayedName_b64 = displayedName_b64
        self.description_b64 = description_b64
    ...
    def write(self, oprot):
        ...
        if self.runStoreInProgress is not None:
            ...
            oprot.writeFieldEnd()
        if self.confidentiality is not None:
            oprot.writeFieldBegin('confidentiality', TType.I32, 14)
            oprot.writeI32(self.confidentiality)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
ProductConfiguration.thrift_spec = (
    ...
    (8, TType.I32, 'confidentiality', None, None, ),  # 8
)
...
Product.thrift_spec = (
    ...
    (14, TType.I32, 'confidentiality', None, None, ),  # 14
)
