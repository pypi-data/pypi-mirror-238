...
REQUIRES = ["aspose-3d==23.10.0",
            "aspose-barcode-for-python-via-net==23.10",
            "aspose-cad==23.9",
            "aspose-cells-python==23.10.0",
            "aspose-diagram-python==23.10.0",
            "Aspose.Email-for-Python-via-NET==23.9",
            "aspose-finance==23.10",
            "aspose-imaging-python-net==23.10.0",
            "aspose-ocr-python-net==23.10.1",
            "aspose-pdf==23.10.0",
