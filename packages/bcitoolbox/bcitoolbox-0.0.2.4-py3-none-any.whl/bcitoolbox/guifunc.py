...
def plot_Simu_disc(ifdata):
    ...
    plt.axvline(x=sti1, linestyle='--', color='b', label='Stimulus 1')
    plt.axvline(x=sti2, linestyle='--', color='r', label='Stimulus 2')
...
def open_welcome():
    ...
    version_label = tk.Label(window, text="Version 0.0.2.4", fg="gray")
