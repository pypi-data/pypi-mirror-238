...
class PlaceMixin:
    ...
    def search_places(self, keyword: str, page_no: int, page_size: int):
    ...
    def get_place(self, business_id):
    ...
    def get_restaurant(self, business_id):
    ...
    def get_place_summary(self, id: str, proxy=None):
    ...
    def get_menus(self, business_id):
