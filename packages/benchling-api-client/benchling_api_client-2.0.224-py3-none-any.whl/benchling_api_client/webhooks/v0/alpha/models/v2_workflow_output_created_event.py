...
class V2WorkflowOutputCreatedEvent:
    ...
    _event_type: Union[Unset, V2WorkflowOutputCreatedEventEventType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> Union[Unset, V2WorkflowOutputCreatedEventEventType]:
            event_type = UNSET
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(Union[Unset, V2WorkflowOutputCreatedEventEventType], UNSET)
