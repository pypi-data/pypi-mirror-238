...
class WebhookEnvelope:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_message() -> EventMessage:
            message = EventMessage.from_dict(d.pop("message"), strict=False)
        ...
        try:
            ...
            if strict:
                raise
            message = cast(EventMessage, UNSET)
    ...
    @message.setter
    def message(self, value: EventMessage) -> None:
        self._message = value
