...
from ..models.v2_assay_run_updated_fields_event_event_type import V2AssayRunUpdatedFieldsEventEventType
from ..types import UNSET, Unset

T = TypeVar("T", bound="V2AssayRunUpdatedFieldsEvent")


@attr.s(auto_attribs=True, repr=False)
class V2AssayRunUpdatedFieldsEvent:
    """  """

    _deprecated: bool
    _excluded_properties: List[str]
    _event_type: Union[Unset, V2AssayRunUpdatedFieldsEventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "V2AssayRunUpdatedFieldsEvent({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> Union[Unset, V2AssayRunUpdatedFieldsEventEventType]:
            event_type = UNSET
            _event_type = d.pop("eventType")
            if _event_type is not None and _event_type is not UNSET:
                try:
                    event_type = V2AssayRunUpdatedFieldsEventEventType(_event_type)
                except ValueError:
                    event_type = V2AssayRunUpdatedFieldsEventEventType.of_unknown(_event_type)
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(Union[Unset, V2AssayRunUpdatedFieldsEventEventType], UNSET)
        ...
        v2_assay_run_updated_fields_event = cls(
        ...
        v2_assay_run_updated_fields_event.additional_properties = d
        return v2_assay_run_updated_fields_event
    ...
    @property
    def event_type(self) -> V2AssayRunUpdatedFieldsEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: V2AssayRunUpdatedFieldsEventEventType) -> None:
