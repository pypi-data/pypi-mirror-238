...
from ..models.v2_workflow_output_updated_fields_event_event_type import (
    V2WorkflowOutputUpdatedFieldsEventEventType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="V2WorkflowOutputUpdatedFieldsEvent")


@attr.s(auto_attribs=True, repr=False)
class V2WorkflowOutputUpdatedFieldsEvent:
    """  """

    _deprecated: bool
    _excluded_properties: List[str]
    _event_type: Union[Unset, V2WorkflowOutputUpdatedFieldsEventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "V2WorkflowOutputUpdatedFieldsEvent({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> Union[Unset, V2WorkflowOutputUpdatedFieldsEventEventType]:
            event_type = UNSET
            _event_type = d.pop("eventType")
            if _event_type is not None and _event_type is not UNSET:
                try:
                    event_type = V2WorkflowOutputUpdatedFieldsEventEventType(_event_type)
                except ValueError:
                    event_type = V2WorkflowOutputUpdatedFieldsEventEventType.of_unknown(_event_type)
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(Union[Unset, V2WorkflowOutputUpdatedFieldsEventEventType], UNSET)
        ...
        v2_workflow_output_updated_fields_event = cls(
        ...
        v2_workflow_output_updated_fields_event.additional_properties = d
        return v2_workflow_output_updated_fields_event
    ...
    @property
    def event_type(self) -> V2WorkflowOutputUpdatedFieldsEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: V2WorkflowOutputUpdatedFieldsEventEventType) -> None:
