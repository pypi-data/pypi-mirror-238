...
class V2EntryUpdatedReviewRecordEvent:
    ...
    _event_type: Union[Unset, V2EntryUpdatedReviewRecordEventEventType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> Union[Unset, V2EntryUpdatedReviewRecordEventEventType]:
            event_type = UNSET
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(Union[Unset, V2EntryUpdatedReviewRecordEventEventType], UNSET)
