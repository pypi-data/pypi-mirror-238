...
from ..models.v2_workflow_task_group_created_event_event_type import V2WorkflowTaskGroupCreatedEventEventType
from ..types import UNSET, Unset

T = TypeVar("T", bound="V2WorkflowTaskGroupCreatedEvent")


@attr.s(auto_attribs=True, repr=False)
class V2WorkflowTaskGroupCreatedEvent:
    """  """

    _deprecated: bool
    _excluded_properties: List[str]
    _event_type: Union[Unset, V2WorkflowTaskGroupCreatedEventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "V2WorkflowTaskGroupCreatedEvent({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> Union[Unset, V2WorkflowTaskGroupCreatedEventEventType]:
            event_type = UNSET
            _event_type = d.pop("eventType")
            if _event_type is not None and _event_type is not UNSET:
                try:
                    event_type = V2WorkflowTaskGroupCreatedEventEventType(_event_type)
                except ValueError:
                    event_type = V2WorkflowTaskGroupCreatedEventEventType.of_unknown(_event_type)
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(Union[Unset, V2WorkflowTaskGroupCreatedEventEventType], UNSET)
        ...
        v2_workflow_task_group_created_event = cls(
        ...
        v2_workflow_task_group_created_event.additional_properties = d
        return v2_workflow_task_group_created_event
    ...
    @property
    def event_type(self) -> V2WorkflowTaskGroupCreatedEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: V2WorkflowTaskGroupCreatedEventEventType) -> None:
