...
from ..models.v2_request_created_event_event_type import V2RequestCreatedEventEventType
from ..types import UNSET, Unset

T = TypeVar("T", bound="V2RequestCreatedEvent")


@attr.s(auto_attribs=True, repr=False)
class V2RequestCreatedEvent:
    """  """

    _deprecated: bool
    _excluded_properties: List[str]
    _event_type: Union[Unset, V2RequestCreatedEventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "V2RequestCreatedEvent({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> Union[Unset, V2RequestCreatedEventEventType]:
            event_type = UNSET
            _event_type = d.pop("eventType")
            if _event_type is not None and _event_type is not UNSET:
                try:
                    event_type = V2RequestCreatedEventEventType(_event_type)
                except ValueError:
                    event_type = V2RequestCreatedEventEventType.of_unknown(_event_type)
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(Union[Unset, V2RequestCreatedEventEventType], UNSET)
        ...
        v2_request_created_event.additional_properties = d
        return v2_request_created_event
    ...
    @property
    def event_type(self) -> V2RequestCreatedEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: V2RequestCreatedEventEventType) -> None:
