...
T = TypeVar("T", bound="V2UpdateEventBase")


@attr.s(auto_attribs=True, repr=False)
class V2UpdateEventBase:
    """  """
    ...
    def __repr__(self):
        ...
        return "V2UpdateEventBase({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        v2_update_event_base.additional_properties = d
        return v2_update_event_base
