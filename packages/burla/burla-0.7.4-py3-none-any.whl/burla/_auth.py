...
CONFIG_PATH = Path(user_config_dir(appname="burla", appauthor="burla")) / Path("credentials.json")
...
def login():
    ...
    # TODO:
    # When on a remote server this command gets stuck trying to open the browser window
    # (because it cant?)
    # you need to detect if it's possible to open the window or not and print the URL if not,
    # I think.
    #
    # basically running `burla login` on a remote server prints nothing and waits and I think
    # times out.
    #
