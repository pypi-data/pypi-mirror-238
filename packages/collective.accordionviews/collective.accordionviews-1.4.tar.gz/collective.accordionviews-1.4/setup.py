# -*- coding: utf-8 -*-
"""Installer for the collective.accordionviews package."""
...
setup(
    ...
    url="https://github.com/collective/collective.accordionviews",
    project_urls={
        ...
        # 'Documentation': 'https://collective.accordionviews.readthedocs.io/en/latest/',
    },
    ...
    target = plone
    [console_scripts]
    update_locale = collective.accordionviews.locales.update:update_locale
    """,
)
