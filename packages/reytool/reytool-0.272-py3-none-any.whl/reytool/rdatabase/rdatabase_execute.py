...
class RDBExecute(object):
    ...
    def __call__(
        ...
        **kwargs: Any
        ...
        # Execute.
        if path is None:
            result = self._rdatabase(*args, **kwargs)

        # Selete.
        else:
            result = self._rdatabase.execute_select(path, *args, **kwargs)
    ...
    def __add__(
        ...
        if params.__class__ == tuple:
            result = self._rdatabase.execute_insert(path, *params)
    ...
    def __and__(
        ...
        # Update.
        if params.__class__ == tuple:
            result = self._rdatabase.execute_update(path, *params)
        elif params.__class__ == dict:
            result = self._rdatabase.execute_update(path, **params)
        else:
            result = self._rdatabase.execute_update(path, params)
    ...
    def __sub__(
        ...
        # Update.
        if params.__class__ == tuple:
            result = self._rdatabase.execute_delete(path, *params)
        elif params.__class__ == dict:
            result = self._rdatabase.execute_delete(path, **params)
        else:
            result = self._rdatabase.execute_delete(path, params)
    ...
    def __mul__(
        ...
        # Update.
        if params.__class__ == tuple:
            result = self._rdatabase.execute_copy(path, *params)
        elif params.__class__ == dict:
            result = self._rdatabase.execute_copy(path, **params)
        else:
            result = self._rdatabase.execute_copy(path, params)
    ...
    def __contains__(
        ...
        # Update.
        if params.__class__ == tuple:
            result = self._rdatabase.execute_exist(path, *params)
        elif params.__class__ == dict:
            result = self._rdatabase.execute_exist(path, **params)
        else:
            result = self._rdatabase.execute_exist(path, params)
    ...
    def __len__(
        ...
        # Update.
        result = self._rdatabase.execute_count(path)
