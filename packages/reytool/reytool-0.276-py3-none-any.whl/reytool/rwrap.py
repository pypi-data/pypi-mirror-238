...
def try_exc(
    ...
    *args: Any,
    ...
    _handle: Optional[Callable] = None,
    **kwargs: Any
) -> Optional[Any]: ...
...
def try_exc(
    ...
    **kwargs: Any
    ...
    _handle : Exception handle method.
        - `None` : Use `.rsystem.rexc.catch` method print exception text.
...
def wait(
    ...
    **kwargs: Any
    ...
    """
    Wait success, if timeout, throw exception.
    ...
    _timeout : Timeout seconds, if timeout, throw exception.
        - `None` : Infinite time.
        - `float` : Use this time.
