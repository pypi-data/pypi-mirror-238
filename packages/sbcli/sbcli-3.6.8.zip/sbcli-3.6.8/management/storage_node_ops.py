...
from management.controllers import lvol_controller
...
def add_node(cluster_id, node_ip, iface_name, data_nics_list, spdk_cpu_mask, spdk_mem, dev_split=1):
    db_controller = DBController()
...
def restart_storage_node(node_id, run_tests):
    ...
    for lvol_id in snode.lvols:
        lvol_controller.recreate_lvol(lvol_id)
...
def get_device_iostats(device_id, history):
    ...
    data = db_controller.get_device_stats(device, history)
    out = []
