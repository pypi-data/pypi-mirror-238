...
class RPCClient:
    ...
    def __init__(self, ip_address, port, username, password, timeout=10, retry=30):
    ...
    def transport_list(self):
        return self._request("nvmf_get_transports")
    ...
    def nvmf_subsystem_add_ns(self, nqn, dev_name):
        params = {
            "nqn": nqn,
            "namespace": {
                "bdev_name": dev_name
    ...
    def bdev_alceml_create(self, alceml_name, nvme_name, uuid):
        params = {
            "name": alceml_name,
            "cntr_path": nvme_name,
            "num_blocks": 0,
    ...
    def bdev_distrib_create(self, name, vuid, ndcs, npcs, num_blocks, block_size, alloc_names,
                            chunk_size, ha_comm_addrs=None, ha_inode_self=None):
        """"
        ...
        return self._request2("bdev_distrib_create", params)
