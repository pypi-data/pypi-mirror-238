...
setup(
    name='jaysun_tools',  # 必填，项目的名字，用户根据这个名字安装，pip install SpiderKeeper-new
    ...
    author_email='jaysun1015@outlook.com',  # 作者的有效邮箱地址
