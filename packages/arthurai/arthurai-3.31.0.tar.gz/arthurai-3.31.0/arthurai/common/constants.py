...
ENRICHMENTS_SPINNER_MESSAGE = "Waiting for the model's enrichments to be ready to receive inferences."
ENRICHMENTS_UPDATE_MESSAGE = "We are still working on getting your model's enrichments ready to accept inferences..."
ENRICHMENT_READY_OR_FAILED_STATES = [EnrichmentStatus.EnrichmentStatusDisabled,
                                     EnrichmentStatus.EnrichmentStatusTraining,
                                     EnrichmentStatus.EnrichmentStatusReady, EnrichmentStatus.EnrichmentStatusFailed]

PARQUET_INGESTIBLE_INPUT_TYPES = [InputType.Tabular, InputType.Image, InputType.NLP]  # excludes TimeSeries
PARQUET_INGESTIBLE_OUTPUT_TYPES = [OutputType.Regression, OutputType.Multiclass, OutputType.Multilabel,
                                   OutputType.ObjectDetection, OutputType.TokenSequence]  # excludes RankedList
