...
class Rolling(System.Object):
    ...
    @staticmethod
    def Sharpe(equityCurve: typing.Any, months: int) -> typing.Any:
        """
...
class ResultsUtil(System.Object):
    ...
    @staticmethod
    def EquityPoints(result: QuantConnect.Result, seriesName: str = "Equity") -> System.Collections.Generic.SortedList[datetime.datetime, float]:
        """
        Get the points, from the Series name given, in Strategy Equity chart
        
        :param result: Result object to extract the chart points
        :param seriesName: Series name from which the points will be extracted. By default is "Equity"
        """
        ...
