...
class Spectrum(ABC):
    ...
    def __init__(
        ...
        self.dataset = dataset.copy(deep=False)  #: The dataset that contains the spectral data.
    ...
    def peak_wavespeed(self, fmin=0., fmax=np.inf, use_spline=False, **kwargs) -> DataArray:
        """
    ...
    def peak_wavenumber(self,fmin=0.0,fmax=np.inf,use_spline=False,**kwargs) -> DataArray:
        """
