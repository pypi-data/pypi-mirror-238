...
from cargo2rpm.rpm import _requires_crate, _requires_feature
    ...
    [
        ...
        (
            "rustix-0.36.8.json",
            {
                ...
                "(crate(windows-sys/Win32_NetworkManagement_IpHelper) >= 0.45.0 with crate(windows-sys/Win32_NetworkManagement_IpHelper) < 0.46.0~)",
    ...
    [
        ...
        (
            ...
            "color",
            {
                ...
                "crate(concolor/std) = 0.0.11" if CARGO_BUGGY_RESOLVER else "(crate(concolor/std) = 0.0.11 if crate(concolor) = 0.0.11)",
        ...
        (
            ...
            "color-auto",
            {
                ...
                "crate(concolor/auto) = 0.0.11" if CARGO_BUGGY_RESOLVER else "(crate(concolor/auto) = 0.0.11 if crate(concolor) = 0.0.11)",
            },
        ),
        (
            "assert_fs-1.0.10.json",
        ...
        (
            ...
            "alloc",
            {
                ...
                else "((crate(serde/alloc) >= 1.0.85 with crate(serde/alloc) < 2.0.0~) if (crate(serde) >= 1.0.85 with crate(serde) < 2.0.0~))",
            },
        ),
        (
            "bstr-1.2.0.json",
        ...
        (
            ...
            "std",
            {
                ...
                if CARGO_BUGGY_RESOLVER
                else "((crate(serde/std) >= 1.0.85 with crate(serde/std) < 2.0.0~) if (crate(serde) >= 1.0.85 with crate(serde) < 2.0.0~))",
            },
        ),
        (
            "bstr-1.2.0.json",
        ...
        (
            ...
            "debug",
            {
                ...
                if CARGO_BUGGY_RESOLVER
                else "(crate(clap_derive/debug) = 4.1.0 if crate(clap_derive) = 4.1.0)",
            },
        ),
        (
            "clap-4.1.4.json",
            "deprecated",
            {
                ...
                if CARGO_BUGGY_RESOLVER
                else "(crate(clap_derive/deprecated) = 4.1.0 if crate(clap_derive) = 4.1.0)",
            },
        ),
        (
            "clap-4.1.4.json",
        ...
        (
            ...
            "unstable-v5",
            {
                ...
                if CARGO_BUGGY_RESOLVER
                else "(crate(clap_derive/unstable-v5) = 4.1.0 if crate(clap_derive) = 4.1.0)",
            },
        ),
        (
            "clap-4.1.4.json",
        ...
        (
            ...
            "std",
            {
                ...
                if CARGO_BUGGY_RESOLVER
                else "((crate(borsh/std) >= 0.9.0 with crate(borsh/std) < 0.10.0~) if (crate(borsh) >= 0.9.0 with crate(borsh) < 0.10.0~))",
                "(crate(bytecheck/std) >= 0.6.0 with crate(bytecheck/std) < 0.7.0~)"
                if CARGO_BUGGY_RESOLVER
                else "((crate(bytecheck/std) >= 0.6.0 with crate(bytecheck/std) < 0.7.0~) if (crate(bytecheck) >= 0.6.0 with crate(bytecheck) < 0.7.0~))",
                "(crate(byteorder/std) >= 1.0.0 with crate(byteorder/std) < 2.0.0~)"
                if CARGO_BUGGY_RESOLVER
                else "((crate(byteorder/std) >= 1.0.0 with crate(byteorder/std) < 2.0.0~) if (crate(byteorder) >= 1.0.0 with crate(byteorder) < 2.0.0~))",
                "(crate(bytes/std) >= 1.0.0 with crate(bytes/std) < 2.0.0~)"
                if CARGO_BUGGY_RESOLVER
                else "((crate(bytes/std) >= 1.0.0 with crate(bytes/std) < 2.0.0~) if (crate(bytes) >= 1.0.0 with crate(bytes) < 2.0.0~))",
                "(crate(rand/std) >= 0.8.0 with crate(rand/std) < 0.9.0~)"
                if CARGO_BUGGY_RESOLVER
                else "((crate(rand/std) >= 0.8.0 with crate(rand/std) < 0.9.0~) if (crate(rand) >= 0.8.0 with crate(rand) < 0.9.0~))",
                "(crate(rkyv/std) >= 0.7.0 with crate(rkyv/std) < 0.8.0~)"
                if CARGO_BUGGY_RESOLVER
                else "((crate(rkyv/std) >= 0.7.0 with crate(rkyv/std) < 0.8.0~) if (crate(rkyv) >= 0.7.0 with crate(rkyv) < 0.8.0~))",
                "(crate(serde/std) >= 1.0.0 with crate(serde/std) < 2.0.0~)"
                if CARGO_BUGGY_RESOLVER
                else "((crate(serde/std) >= 1.0.0 with crate(serde/std) < 2.0.0~) if (crate(serde) >= 1.0.0 with crate(serde) < 2.0.0~))",
                "(crate(serde_json/std) >= 1.0.0 with crate(serde_json/std) < 2.0.0~)"
                if CARGO_BUGGY_RESOLVER
                else "((crate(serde_json/std) >= 1.0.0 with crate(serde_json/std) < 2.0.0~) if (crate(serde_json) >= 1.0.0 with crate(serde_json) < 2.0.0~))",
            },
        ),
        (
            "rust_decimal-1.28.0.json",
        ...
        (
            ...
            "alloc",
            {
                ...
                if CARGO_BUGGY_RESOLVER
                else "((crate(serde/alloc) >= 1.0.126 with crate(serde/alloc) < 2.0.0~) if (crate(serde) >= 1.0.126 with crate(serde) < 2.0.0~))",
            },
        ),
        (
            "time-0.3.17.json",
            "formatting",
            {
                ...
                if CARGO_BUGGY_RESOLVER
                else "(crate(time-macros/formatting) = 0.2.6 if crate(time-macros) = 0.2.6)",
            },
        ),
        (
            "time-0.3.17.json",
            "large-dates",
            {
                ...
                if CARGO_BUGGY_RESOLVER
                else "(crate(time-macros/large-dates) = 0.2.6 if crate(time-macros) = 0.2.6)",
            },
        ),
        (
            "time-0.3.17.json",
        ...
        (
            ...
            "parsing",
            {
                ...
                if CARGO_BUGGY_RESOLVER
                else "(crate(time-macros/parsing) = 0.2.6 if crate(time-macros) = 0.2.6)",
            },
        ),
        (
            "time-0.3.17.json",
        ...
        (
            ...
            "serde",
            {
                ...
                if CARGO_BUGGY_RESOLVER
                else "(crate(time-macros/serde) = 0.2.6 if crate(time-macros) = 0.2.6)",
            },
        ),
        (
            "time-0.3.17.json",
        ...
        (
            ...
            "process",
            {
                ...
                "(crate(windows-sys/Win32_System_WindowsProgramming) >= 0.42.0 with crate(windows-sys/Win32_System_WindowsProgramming) < 0.43.0~)",
            },
        ),
        (
            "tokio-1.25.0.json",
