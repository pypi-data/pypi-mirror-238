...
class Converter(object):
    ...
    def convert_to_json_cusomize_16102023(self, input_data, output_dir, is_dir=True):
        ...
        required_images = ["cd466c2d-616e63275357830cb40a365a_16368833571.jpg","0834560e-616e63275357830cb40a365a_16363776651.jpg","54319e92-IMG_20231015_112036.jpg","8a3ec110-IMG_20231015_112103.jpg","ee6d76a2-IMG_20231015_111815.jpg"]
        for idx, item in enumerate(_records):
            ...
            if len(required_images)>0:
                if tail in required_images:
                    print(f"matched:{tail}")
