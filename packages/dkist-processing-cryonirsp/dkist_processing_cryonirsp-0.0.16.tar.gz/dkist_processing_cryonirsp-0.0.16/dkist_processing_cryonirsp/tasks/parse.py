...
from dkist_processing_cryonirsp.parsers.time import CryonirspNonDarkAndNonPolcalTaskExposureTimesBud
from dkist_processing_cryonirsp.parsers.time import CryonirspPickyDarkExposureTimesBud
...
class ParseL0CryonirspLinearizedData(ParseDataBase, InputDatasetMixin):
    ...
    def constant_buds(self) -> list[S]:
        ...
        return default_constant_bud_factory() + [
            ...
            CryonirspNonDarkAndNonPolcalTaskExposureTimesBud(),
            CryonirspPickyDarkExposureTimesBud(),
