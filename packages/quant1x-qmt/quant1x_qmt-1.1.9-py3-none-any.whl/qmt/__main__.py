...
import qmt.env
from qmt import utils
from qmt.callback import QmtTraderCallback
from qmt.context import QmtContext
...
def main() -> any:
    ...
    qmt_userdata_path = qmt.env.get_qmt_exec_path() + '/userdata_mini'
