...
#define __PYX_HAVE__rbfly___codec
#define __PYX_HAVE_API__rbfly___codec
/* Early includes */
#include <stdint.h>
#include "arpa/inet.h"
#include "_codec.h"
...
static CYTHON_INLINE uint16_t __pyx_f_5rbfly_6_codec_unpack_uint16(char const *__pyx_v_data) {
  uint16_t __pyx_r;
 ...
 */
  __pyx_r = ntohs((((uint16_t *)__pyx_v_data)[0]));
  goto __pyx_L0;
...
static CYTHON_INLINE uint32_t __pyx_f_5rbfly_6_codec_unpack_uint32(char const *__pyx_v_data) {
  uint32_t __pyx_r;
 ...
 */
  __pyx_r = ntohl((((uint32_t *)__pyx_v_data)[0]));
  goto __pyx_L0;
...
static CYTHON_INLINE uint64_t __pyx_f_5rbfly_6_codec_unpack_uint64(char const *__pyx_v_data) {
  uint64_t __pyx_r;
 ...
 */
  __pyx_r = be64toh((((uint64_t *)__pyx_v_data)[0]));
  goto __pyx_L0;
...
static CYTHON_INLINE void __pyx_f_5rbfly_6_codec_pack_uint16(char *__pyx_v_data, uint16_t __pyx_v_value) {
 ...
 */
  (((uint16_t *)__pyx_v_data)[0]) = htons(((uint16_t)__pyx_v_value));
...
static CYTHON_INLINE void __pyx_f_5rbfly_6_codec_pack_uint32(char *__pyx_v_data, uint32_t __pyx_v_value) {
 ...
 */
  (((uint32_t *)__pyx_v_data)[0]) = htonl(__pyx_v_value);
...
static CYTHON_INLINE void __pyx_f_5rbfly_6_codec_pack_uint64(char *__pyx_v_data, uint64_t __pyx_v_value) {
 ...
 */
  (((uint64_t *)__pyx_v_data)[0]) = htobe64(__pyx_v_value);
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_codec(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_codec(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__codec(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__codec(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__codec(void)", 0);
