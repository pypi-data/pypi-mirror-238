...
#define __PYX_HAVE__rbfly___buffer
#define __PYX_HAVE_API__rbfly___buffer
/* Early includes */
#include <stdint.h>
#ifdef _OPENMP
#include <omp.h>
...
static char *__pyx_f_5rbfly_7_buffer_buffer_claim(struct __pyx_t_5rbfly_7_buffer_Buffer *__pyx_v_buffer, Py_ssize_t __pyx_v_size) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("buffer_claim", 1);
 ...
 */
  __pyx_t_13 = 0;
  (__pyx_v_buffer[__pyx_t_13]).offset = ((__pyx_v_buffer[__pyx_t_13]).offset + __pyx_v_size);

  /* "rbfly/_buffer.pyx":41
 * 
 *     buffer[0].offset += size  # increased offset
 *     return &buffer[0].buffer[offset]  # return at current offset             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_r = (&((__pyx_v_buffer[0]).buffer[__pyx_v_offset]));
  goto __pyx_L0;
...
static CYTHON_INLINE uint8_t __pyx_f_5rbfly_7_buffer_buffer_get_uint8(struct __pyx_t_5rbfly_7_buffer_Buffer *__pyx_v_buffer) {
  uint8_t __pyx_r;
  char *__pyx_t_1;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
 ...
 */
  __pyx_t_1 = __pyx_f_5rbfly_7_buffer_buffer_claim(__pyx_v_buffer, 1); if (unlikely(__pyx_t_1 == ((char *)NULL) && PyErr_Occurred())) __PYX_ERR(0, 47, __pyx_L1_error)
  __pyx_r = ((uint8_t)(__pyx_t_1[0]));
  goto __pyx_L0;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("rbfly._buffer.buffer_get_uint8", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}

/* "rbfly/_buffer.pyx":49
 *     return <uint8_t> buffer_claim(buffer, 1)[0]
 * 
 * cdef inline char buffer_check_size(Buffer *buffer, uint32_t size):             # <<<<<<<<<<<<<<
 *     """
...
static CYTHON_INLINE char __pyx_f_5rbfly_7_buffer_buffer_check_size(struct __pyx_t_5rbfly_7_buffer_Buffer *__pyx_v_buffer, uint32_t __pyx_v_size) {
  char __pyx_r;

  /* "rbfly/_buffer.pyx":53
 *     Check if buffer allows to access `size` bytes from current offset.
 *     """
 ...
 * # vim: sw=4:et:ai
 */
  __pyx_r = (((__pyx_v_buffer[0]).offset + __pyx_v_size) <= (__pyx_v_buffer[0]).size);
  goto __pyx_L0;
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("buffer_claim", (void (*)(void))__pyx_f_5rbfly_7_buffer_buffer_claim, "char *(struct __pyx_t_5rbfly_7_buffer_Buffer *, Py_ssize_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("buffer_get_uint8", (void (*)(void))__pyx_f_5rbfly_7_buffer_buffer_get_uint8, "uint8_t (struct __pyx_t_5rbfly_7_buffer_Buffer *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("buffer_check_size", (void (*)(void))__pyx_f_5rbfly_7_buffer_buffer_check_size, "char (struct __pyx_t_5rbfly_7_buffer_Buffer *, uint32_t)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_buffer(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_buffer(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__buffer(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__buffer(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__buffer(void)", 0);
 ...
 */
  ...
  if (__Pyx_PyList_SET_ITEM(__pyx_t_2, 0, __pyx_n_s_RbFlyBufferError)) __PYX_ERR(0, 24, __pyx_L1_error);
