"use strict";
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([[4785],{
...
var dist_index_js_ = __webpack_require__(54192);
...
var lang_css_dist = __webpack_require__(64205);
// EXTERNAL MODULE: ../node_modules/@codemirror/lang-javascript/dist/index.js + 1 modules
var lang_javascript_dist = __webpack_require__(52979);
...
function htmlCompletionFor(schema, context) {
    let { state, pos } = context, around = (0,language_dist_index_js_.syntaxTree)(state).resolveInner(pos), tree = around.resolve(pos, -1);
...
const autoCloseTags = /*@__PURE__*/view_dist_index_js_.EditorView.inputHandler.of((view, from, to, text) => {
    ...
    let changes = state.changeByRange(range => {
        var _a, _b, _c;
        let { head } = range, around = (0,language_dist_index_js_.syntaxTree)(state).resolveInner(head, -1), name;
        ...
        if (text == ">" && around.name == "OpenTag") {
            if (((_b = (_a = around.parent) === null || _a === void 0 ? void 0 : _a.lastChild) === null || _b === void 0 ? void 0 : _b.name) != "CloseTag" &&
                ...
                return { range: state_dist_index_js_.EditorSelection.cursor(head + 1), changes: { from: head + (hasRightBracket ? 1 : 0), insert } };
            }
        }
            ...
            if (empty.from == head - 1 && ((_c = base.lastChild) === null || _c === void 0 ? void 0 : _c.name) != "CloseTag" &&
                ...
                return { range: state_dist_index_js_.EditorSelection.cursor(pos), changes: { from: head, insert } };
            }
        }
        return { range };
    });
...
//# sourceMappingURL=4785.61760054344c60afb3b4.js.map?v=61760054344c60afb3b4