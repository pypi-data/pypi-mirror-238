"use strict";
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([[9467],{
...
;// CONCATENATED MODULE: ../packages/console-extension/lib/foreign.js
...
const foreign = {
    ...
    requires: [console_lib_index_js_.IConsoleTracker, settingregistry_lib_index_js_.ISettingRegistry, translation_lib_index_js_.ITranslator],
    optional: [lib_index_js_.ICommandPalette],
    activate: activateForeign,
    autoStart: true
};
/* harmony default export */ const lib_foreign = (foreign);
function activateForeign(app, tracker, settingRegistry, translator, palette) {
    const trans = translator.load('jupyterlab');
    const { shell } = app;
    tracker.widgetAdded.connect((sender, widget) => {
        const console = widget.console;
        const handler = new console_lib_index_js_.ForeignHandler({
...
(function (Private) {
     ...
     */
    Private.foreignHandlerProperty = new properties_dist_index_es6_js_.AttachedProperty({
        name: 'foreignHandler',
        create: () => undefined
    });
})(Private || (Private = {}));

;// CONCATENATED MODULE: ../packages/console-extension/lib/index.js
// Copyright (c) Jupyter Development Team.
// Distributed under the terms of the Modified BSD License.
/**
...
const tracker = {
    ...
    provides: console_lib_index_js_.IConsoleTracker,
    requires: [
        console_lib_index_js_.ConsolePanel.IContentFactory,
...
const factory = {
    ...
    provides: console_lib_index_js_.ConsolePanel.IContentFactory,
    requires: [codeeditor_lib_index_js_.IEditorServices],
    autoStart: true,
    activate: (app, editorServices) => {
        const editorFactory = editorServices.factoryService.newInlineEditor;
        return new console_lib_index_js_.ConsolePanel.ContentFactory({ editorFactory });
    }
};
/**
...
const kernelStatus = {
    ...
    autoStart: true,
    requires: [console_lib_index_js_.IConsoleTracker, lib_index_js_.IKernelStatusModel],
...
const lineColStatus = {
    ...
    autoStart: true,
    requires: [console_lib_index_js_.IConsoleTracker, codeeditor_lib_index_js_.IPositionModel],
...
const completerPlugin = {
    ...
    autoStart: true,
    requires: [console_lib_index_js_.IConsoleTracker],
...
async function activateConsole(app, contentFactory, editorServices, rendermime, settingRegistry, restorer, filebrowser, mainMenu, palette, launcher, status, sessionDialogs_, formRegistry, translator_) {
    ...
    if (restorer) {
        void restorer.restore(tracker, {
            ...
            name: widget => { var _a; return (_a = widget.console.sessionContext.path) !== null && _a !== void 0 ? _a : dist_index_js_.UUID.uuid4(); },
            when: manager.ready
        });
    }
    ...
    async function createConsole(options) {
        var _a, _b;
        await manager.ready;
        const panel = new console_lib_index_js_.ConsolePanel({
            manager,
            contentFactory,
        ...
        execute: (args) => {
            ...
            if (widget) {
                ...
                return manager.ready.then(() => {
                    const model = (0,index_es6_js_.find)(manager.sessions.running(), item => {
    ...
    commands.addCommand(command, {
        ...
        icon: args => (args['isPalette'] ? undefined : ui_components_lib_index_js_.consoleIcon),
        execute: args => {
            var _a;
        ...
        execute: args => {
            ...
            return (0,lib_index_js_.showDialog)({
                ...
                buttons: [
                    ...
                    lib_index_js_.Dialog.warnButton({
...
//# sourceMappingURL=9467.4a70b63c8eff8777a2cb.js.map?v=4a70b63c8eff8777a2cb