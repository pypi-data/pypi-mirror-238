"use strict";
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([[9996],{
...
__webpack_require__.d(__webpack_exports__, {
  "Gettext": () => (/* reexport */ Gettext),
  "ITranslator": () => (/* reexport */ ITranslator),
  "ITranslatorConnector": () => (/* reexport */ ITranslatorConnector),
  "TranslationManager": () => (/* reexport */ TranslationManager),
  "TranslatorConnector": () => (/* reexport */ TranslatorConnector),
  "nullTranslator": () => (/* reexport */ nullTranslator),
  "requestTranslationsAPI": () => (/* reexport */ requestTranslationsAPI)
});

;// CONCATENATED MODULE: ../packages/translation/lib/utils.js
/*
...
;// CONCATENATED MODULE: ../packages/translation/lib/gettext.js
/* ----------------------------------------------------------------------------
| Copyright (c) Jupyter Development Team.
| Distributed under the terms of the Modified BSD License.
|
...
;// CONCATENATED MODULE: ../packages/translation/lib/base.js
// Copyright (c) Jupyter Development Team.
// Distributed under the terms of the Modified BSD License.
...
var index_js_ = __webpack_require__(1458);
...
;// CONCATENATED MODULE: ../packages/translation/lib/server.js
// Copyright (c) Jupyter Development Team.
// Distributed under the terms of the Modified BSD License.
...
async function requestTranslationsAPI(translationsUrl = '', locale = '', init = {}, serverSettings = undefined) {
    ...
    const requestUrl = lib_index_js_.URLExt.join(settings.baseUrl, translationsUrl, locale);
    let response;
    try {
...
;// CONCATENATED MODULE: ../packages/translation/lib/tokens.js
/* ----------------------------------------------------------------------------
| Copyright (c) Jupyter Development Team.
| Distributed under the terms of the Modified BSD License.
|----------------------------------------------------------------------------*/
 ...
 */
const ITranslatorConnector = new dist_index_js_.Token('@jupyterlab/translation:ITranslatorConnector', 'A service to connect to the server translation endpoint.');
class TranslatorConnector extends index_js_.DataConnector {
 ...
 */
const ITranslator = new dist_index_js_.Token('@jupyterlab/translation:ITranslator', 'A service to translate strings.');

;// CONCATENATED MODULE: ../packages/translation/lib/manager.js
// Copyright (c) Jupyter Development Team.
// Distributed under the terms of the Modified BSD License.
...
;// CONCATENATED MODULE: ../packages/translation/lib/index.js
// Copyright (c) Jupyter Development Team.
// Distributed under the terms of the Modified BSD License.
/**
...
//# sourceMappingURL=9996.30f75b7702c9ac49c3f7.js.map?v=30f75b7702c9ac49c3f7