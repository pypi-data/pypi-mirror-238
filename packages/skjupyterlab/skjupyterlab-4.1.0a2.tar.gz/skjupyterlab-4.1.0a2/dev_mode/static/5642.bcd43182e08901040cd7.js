"use strict";
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([[5642],{
...
;// CONCATENATED MODULE: ../node_modules/mermaid/dist/sankeyDiagram-6de1f9fe.js
...
const findOrCreateNode = (ID) => {
  ID = mermaid_0d192ec3.e.sanitizeText(ID, (0,mermaid_0d192ec3.c)());
  if (!nodesMap[ID]) {
...
const db = {
  nodesMap,
  getConfig: () => (0,mermaid_0d192ec3.c)().sankey,
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
const draw = function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,mermaid_0d192ec3.c)();
  const defaultSankeyConfig = mermaid_0d192ec3.I.sankey;
  let sandboxElement;
  ...
  (0,mermaid_0d192ec3.i)(svg, height, width, useMaxWidth);
...
//# sourceMappingURL=5642.bcd43182e08901040cd7.js.map?v=bcd43182e08901040cd7