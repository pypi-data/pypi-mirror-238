"use strict";
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([[6271],{
...
var index_js_ = __webpack_require__(42904);
...
var language_dist_index_js_ = __webpack_require__(25025);
...
class CompositeBlock {
    ...
    toTree(nodeSet, end = this.end) {
        ...
        let tree = new common_dist_index_js_.Tree(nodeSet.types[this.type], this.children, this.positions, end - this.from).balance({
...
const markdownHighlighting = (0,highlight_dist_index_js_.styleTags)({
    ...
    URL: highlight_dist_index_js_.tags.url,
...
var dist = __webpack_require__(4785);
    ...
    let dont = null, changes = state.changeByRange(range => {
        ...
        if (inner.item && emptyLine) {
            ...
            if (inner.node.firstChild.to >= pos ||
                ...
                return { range: index_js_.EditorSelection.cursor(pos + insert.length), changes: { from: line.from, insert } };
            }
        }
        ...
        return { range: index_js_.EditorSelection.cursor(from + insert.length), changes };
    });
    if (dont)
        return false;
...
const htmlNoMatch = /*@__PURE__*/(0,dist.html)({ matchClosingTags: false });
/**
...
function markdown(config = {}) {
    ...
    return new language_dist_index_js_.LanguageSupport(mkLang(parser.configure(extensions)), support);
}
...
//# sourceMappingURL=6271.fdaa1ee3cf4fd7cb766f.js.map?v=fdaa1ee3cf4fd7cb766f