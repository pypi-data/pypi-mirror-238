"use strict";
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([[7603,564],{
...
__webpack_require__.d(__webpack_exports__, {
  "ITerminal": () => (/* reexport */ ITerminal),
  "ITerminalTracker": () => (/* reexport */ ITerminalTracker),
...
;// CONCATENATED MODULE: ../packages/terminal/lib/tokens.js
 ...
 */
const ITerminalTracker = new index_js_.Token('@jupyterlab/terminal:ITerminalTracker', `A widget tracker for terminals.
...
var index_es6_js_ = __webpack_require__(92654);
...
var dist_index_es6_js_ = __webpack_require__(85755);
...
;// CONCATENATED MODULE: ../packages/terminal/lib/widget.js
// Copyright (c) Jupyter Development Team.
// Distributed under the terms of the Modified BSD License.
 ...
 */
class Terminal extends widgets_dist_index_es6_js_.Widget {
    /**
     ...
     */
    onFitRequest(msg) {
        const resize = widgets_dist_index_es6_js_.Widget.ResizeMessage.UnknownSize;
        dist_index_es6_js_.MessageLoop.sendMessage(this, resize);
    }
    /**
    ...
    _initializeTerm() {
        ...
        if (index_es6_js_.Platform.IS_MAC) {
            return;
        }
    ...
    async function createTerminal(options) {
        ...
        if (!Xterm_) {
            ...
            const [xterm_, fitAddon_, renderer_, weblinksAddon_] = await Promise.all([
                __webpack_require__.e(/* import() */ 4997).then(__webpack_require__.t.bind(__webpack_require__, 94997, 23)),
                __webpack_require__.e(/* import() */ 2758).then(__webpack_require__.t.bind(__webpack_require__, 72758, 23)),
                supportWebGL
                    ? __webpack_require__.e(/* import() */ 6467).then(__webpack_require__.t.bind(__webpack_require__, 6467, 23))
                    : __webpack_require__.e(/* import() */ 2094).then(__webpack_require__.t.bind(__webpack_require__, 12094, 23)),
                __webpack_require__.e(/* import() */ 4928).then(__webpack_require__.t.bind(__webpack_require__, 44928, 23))
            ]);
...
;// CONCATENATED MODULE: ../packages/terminal/lib/index.js
// Copyright (c) Jupyter Development Team.
// Distributed under the terms of the Modified BSD License.
/**
...
//# sourceMappingURL=7603.f561d40ad42eb4bee296.js.map?v=f561d40ad42eb4bee296