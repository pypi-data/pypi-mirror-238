"use strict";
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([[5058],{
...
const addElement = (name) => {
  if (elements[name] === void 0) {
    ...
    _mermaid_0d192ec3_js__WEBPACK_IMPORTED_MODULE_6__.l.info("Added new requirement: ", name);
  }
  latestElement = {};
...
const db = {
  ...
  VerifyType,
  Relationships,
  getConfig: () => (0,_mermaid_0d192ec3_js__WEBPACK_IMPORTED_MODULE_6__.c)().req,
  addRequirement,
  getRequirements,
  setNewReqId,
  setNewReqText,
...
const drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
  ...
  if (rel.type == diagObj.db.Relationships.CONTAINS) {
    svgPath.attr(
      "marker-start",
      "url(" + _mermaid_0d192ec3_js__WEBPACK_IMPORTED_MODULE_6__.e.getUrl(conf.arrowMarkerAbsolute) + "#" + rel.type + "_line_ending)"
    );
  } else {
    svgPath.attr("stroke-dasharray", "10,7");
    svgPath.attr(
      "marker-end",
      "url(" + _mermaid_0d192ec3_js__WEBPACK_IMPORTED_MODULE_6__.e.getUrl(conf.arrowMarkerAbsolute) + "#" + markers.ReqMarkers.ARROW + "_line_ending)"
    );
  }
...
const drawReqs = (reqs, graph, svgNode) => {
  Object.keys(reqs).forEach((reqName) => {
    ...
    _mermaid_0d192ec3_js__WEBPACK_IMPORTED_MODULE_6__.l.info("Added new requirement: ", reqName);
...
const draw = (text, id, _version, diagObj) => {
  conf = (0,_mermaid_0d192ec3_js__WEBPACK_IMPORTED_MODULE_6__.c)().requirement;
  ...
  (0,_mermaid_0d192ec3_js__WEBPACK_IMPORTED_MODULE_6__.i)(svg, height, width, conf.useMaxWidth);
...
//# sourceMappingURL=5058.f9b01d174abce3baecb8.js.map?v=f9b01d174abce3baecb8