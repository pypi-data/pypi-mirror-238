...
class TestFaceDetail(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FaceDetail:
        """Test FaceDetail
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FaceDetail`
        """
        model = FaceDetail()
        if include_optional:
            return FaceDetail(
