...
class TestRecordingListDTO(unittest.TestCase):
    """RecordingListDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecordingListDTO:
        """Test RecordingListDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecordingListDTO`
        """
        model = RecordingListDTO()
        if include_optional:
