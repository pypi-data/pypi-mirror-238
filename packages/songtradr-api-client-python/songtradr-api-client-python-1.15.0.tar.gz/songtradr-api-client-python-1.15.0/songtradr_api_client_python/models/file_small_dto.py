...
class FileSmallDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "id", "extension", "error_message", "folder", "fingerprintStatus", "fingerprintStartTime", "fingerprintEndTime", "inferenceStatus", "inferenceStartTime", "inferenceEndTime", "error_time", "objectKey", "uploadStartTime", "uploadEndTime"]
