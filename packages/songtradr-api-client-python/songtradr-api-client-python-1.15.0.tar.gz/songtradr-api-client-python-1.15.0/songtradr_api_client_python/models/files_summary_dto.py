...
class FilesSummaryDTO(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "fileDetailsSummary": [FieldSummaryDTO.from_dict(_item) for _item in obj.get("fileDetailsSummary")] if obj.get("fileDetailsSummary") is not None else None,
            "genreSummary": [GenresSummaryDTO.from_dict(_item) for _item in obj.get("genreSummary")] if obj.get("genreSummary") is not None else None,
            "tagSummary": [TagsSummaryDTO.from_dict(_item) for _item in obj.get("tagSummary")] if obj.get("tagSummary") is not None else None,
            "musicalFeaturesSummary": [FieldSummaryDTO.from_dict(_item) for _item in obj.get("musicalFeaturesSummary")] if obj.get("musicalFeaturesSummary") is not None else None,
