...
class RecordingApi:
    ...
    def search_recordings_granular(
        ...
        _param = self._search_recordings_granular_serialize(
            search_recording_granular_dto=search_recording_granular_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def search_recordings_granular_without_preload_content(
        self,
        search_recording_granular_dto: List[SearchRecordingGranularDTO],
        _request_timeout: Union[
            None,
    ...
    def _search_recordings_granular_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if search_recording_granular_dto is not None:
            _body_params = search_recording_granular_dto
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/public/recording/searchGranular',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
