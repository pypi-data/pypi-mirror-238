...
class AllowedValuesApi:
    ...
    @validate_call
    def genres_without_preload_content(
        self,
        genre_type: Annotated[StrictStr, Field(description="Type of the response should have.  Deprecated: level1Genre, level2Genre - use musicubeLevel1Genre, musicubeLevel2Genre instead.")],
        _request_timeout: Union[
            None,
    ...
    def _genres_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/allowedValues/genre',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def tags(
        ...
        """(Deprecated) All descriptive tags inside of tag-categories.
    ...
    def tags_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[CategoryMediumDTO]]:
        """(Deprecated) All descriptive tags inside of tag-categories.
    ...
    def _tags_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/allowedValues/tag',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
