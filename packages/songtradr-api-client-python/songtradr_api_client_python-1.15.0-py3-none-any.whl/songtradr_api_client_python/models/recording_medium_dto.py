...
class RecordingMediumDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["recordingPartyEntities", "isrc", "genres", "languageOfPerformance", "releaseDate", "titles", "tracks", "musicalFeatures", "spotifyId", "tags", "genrePredictions"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "recordingPartyEntities": [RecordingPartyDTO.from_dict(_item) for _item in obj.get("recordingPartyEntities")] if obj.get("recordingPartyEntities") is not None else None,
            "isrc": obj.get("isrc"),
            ...
            "musicalFeatures": MusicalFeaturesDTO.from_dict(obj.get("musicalFeatures")) if obj.get("musicalFeatures") is not None else None,
            ...
            "genrePredictions": [RecordingGenrePredictionDTO.from_dict(_item) for _item in obj.get("genrePredictions")] if obj.get("genrePredictions") is not None else None
        })
        return _obj
