...
class Instance(BaseModel):
    ...
    dominant_colors: Optional[List[DominantColor]] = Field(default=None, alias="dominantColors")
    __properties: ClassVar[List[str]] = ["boundingBox", "confidence", "dominantColors"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in dominant_colors (list)
        _items = []
        if self.dominant_colors:
            for _item in self.dominant_colors:
                if _item:
                    _items.append(_item.to_dict())
            _dict['dominantColors'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "dominantColors": [DominantColor.from_dict(_item) for _item in obj.get("dominantColors")] if obj.get("dominantColors") is not None else None
        })
        return _obj
