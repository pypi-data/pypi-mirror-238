...
class VideoRecognitionResponse(BaseModel):
    ...
    """ # noqa: E501
    labels: Optional[List[LabelDetection]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "labels": [LabelDetection.from_dict(_item) for _item in obj.get("labels")] if obj.get("labels") is not None else None,
            "faces": [FaceDetection.from_dict(_item) for _item in obj.get("faces")] if obj.get("faces") is not None else None
        })
        return _obj
