...
class RGpdfconverter:
    '''Command line interface for ``RGpdfconverter``.'''
    ...
    def convert(pdf_file:str, docx_file:str=None, password:str=None, start:int=0, end:int=None, pages:list=None, **kwargs):
        ...
        .. note::
            Refer to :py:meth:`~RGpdfconverter.converter.Converter.convert` for detailed description on above arguments.
        '''
...
parse = RGpdfconverter.convert


def main():
    import fire
    fire.Fire(RGpdfconverter)
