...
class LightningappInstanceServiceApi(object):
    ...
    def lightningapp_instance_service_complete_multipart_upload_project_artifact(self, body: 'MultipartCompleteBody', project_id: 'str', **kwargs) -> 'V1CompleteMultipartUploadProjectArtifactResponse':  # noqa: E501
        """lightningapp_instance_service_complete_multipart_upload_project_artifact  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lightningapp_instance_service_complete_multipart_upload_project_artifact(body, project_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param MultipartCompleteBody body: (required)
        :param str project_id: (required)
        :return: V1CompleteMultipartUploadProjectArtifactResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.lightningapp_instance_service_complete_multipart_upload_project_artifact_with_http_info(body, project_id, **kwargs)  # noqa: E501
        else:
            (data) = self.lightningapp_instance_service_complete_multipart_upload_project_artifact_with_http_info(body, project_id, **kwargs)  # noqa: E501
            return data

    def lightningapp_instance_service_complete_multipart_upload_project_artifact_with_http_info(self, body: 'MultipartCompleteBody', project_id: 'str', **kwargs) -> 'V1CompleteMultipartUploadProjectArtifactResponse':  # noqa: E501
        """lightningapp_instance_service_complete_multipart_upload_project_artifact  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lightningapp_instance_service_complete_multipart_upload_project_artifact_with_http_info(body, project_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method lightningapp_instance_service_complete_multipart_upload_project_artifact" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `lightningapp_instance_service_complete_multipart_upload_project_artifact`")  # noqa: E501
        # verify the required parameter 'project_id' is set
        if ('project_id' not in params or
                params['project_id'] is None):
            raise ValueError("Missing the required parameter `project_id` when calling `lightningapp_instance_service_complete_multipart_upload_project_artifact`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/projects/{projectId}/storage/multipart/complete', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='V1CompleteMultipartUploadProjectArtifactResponse',  # noqa: E501
    ...
    def lightningapp_instance_service_create_multipart_upload_project_artifact(self, body: 'StorageMultipartBody', project_id: 'str', **kwargs) -> 'V1CreateMultipartUploadProjectArtifactResponse':  # noqa: E501
        """lightningapp_instance_service_create_multipart_upload_project_artifact  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lightningapp_instance_service_create_multipart_upload_project_artifact(body, project_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param StorageMultipartBody body: (required)
        :param str project_id: (required)
        :return: V1CreateMultipartUploadProjectArtifactResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.lightningapp_instance_service_create_multipart_upload_project_artifact_with_http_info(body, project_id, **kwargs)  # noqa: E501
        else:
            (data) = self.lightningapp_instance_service_create_multipart_upload_project_artifact_with_http_info(body, project_id, **kwargs)  # noqa: E501
            return data

    def lightningapp_instance_service_create_multipart_upload_project_artifact_with_http_info(self, body: 'StorageMultipartBody', project_id: 'str', **kwargs) -> 'V1CreateMultipartUploadProjectArtifactResponse':  # noqa: E501
        """lightningapp_instance_service_create_multipart_upload_project_artifact  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lightningapp_instance_service_create_multipart_upload_project_artifact_with_http_info(body, project_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method lightningapp_instance_service_create_multipart_upload_project_artifact" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `lightningapp_instance_service_create_multipart_upload_project_artifact`")  # noqa: E501
        # verify the required parameter 'project_id' is set
        if ('project_id' not in params or
                params['project_id'] is None):
            raise ValueError("Missing the required parameter `project_id` when calling `lightningapp_instance_service_create_multipart_upload_project_artifact`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/projects/{projectId}/storage/multipart', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='V1CreateMultipartUploadProjectArtifactResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
