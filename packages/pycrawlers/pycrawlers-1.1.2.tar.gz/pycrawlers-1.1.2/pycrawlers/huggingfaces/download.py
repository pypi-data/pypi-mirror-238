...
class HuggingFace(object):
    ...
    def get_more_files_info(self, url: str, last_name: str, base_crawl_url: str, dir_name: str):
        ...
        if resp.status_code in [200, 304]:
            ...
            for r in resp_js:
                ...
                if file_name:
                    ...
                    file_urls.append(base_crawl_url + file_name)
