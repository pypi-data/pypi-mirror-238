...
def autocluster(data,labels=None,clusters=None):
    if labels is None:
        ...
        dat=pd.DataFrame(columns=['model','size','silhouette','davies-bouldin','calinski-harabasz'])
        dat['model']=model
        dat['size']=clusters
        silhouette=[]
        davies=[]
        ...
        for i in model:
            if i=='kmeans':
                ...
                d=davies_bouldin_score(x,a)
                c=calinski_harabasz_score(x,a)
                silhouette.append(s)
                davies.append(d)
                calinski.append(c)
            elif i=='kmeans-elkan':
                ...
                s=silhouette_score(x,mn)
                d=davies_bouldin_score(x,mn)
                c=calinski_harabasz_score(x,mn)
                silhouette.append(s)
                davies.append(d)
                calinski.append(c)
