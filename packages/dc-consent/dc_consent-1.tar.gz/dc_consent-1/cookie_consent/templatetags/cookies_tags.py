...
def cookie_consent(context):
    ...
    if not request.cookie_consent.submitted:
        ...
        cookie_ctx = {
            ...
            "cookie_modal_title":       cookie_modal_title,
            "cookie_modal_description": cookie_modal_description,
            "cookie_modal_form_action": cookie_modal_form_action,
            "cookie_modal_form":        cookie_modal_form,
