...
def create_command_temp(instr: Union[Instrument, None] = None) -> ICommand:
    '''
...
def create_command_field(instr: Union[Instrument, None] = None) -> ICommand:
    '''
...
def create_command_chamber(instr: Union[Instrument, None] = None) -> ICommand:
    '''
...
def create_command_sdo(instr: Union[Instrument, None] = None) -> ICommand:
    '''
