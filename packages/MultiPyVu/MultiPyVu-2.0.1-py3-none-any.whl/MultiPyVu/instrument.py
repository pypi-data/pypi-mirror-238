        ...
        if not self.scaffolding_mode:
            ...
            if detected_name != instrument_name:
                if instrument_name == '':
                    ...
                    msg += f'{detected_name} running. Either leave out a specific'
                    msg += 'MultiVu flavor and use the detected one, or have the '
                    msg += 'specified flavor match the running instance.'
