...
class MultiPyVuException(Exception):
    '''
...
class pwin_com_error(Exception):
    ...
    def __init__(self, err: Exception):
        ...
        if param_num == 6:
            param = 'SDO Error'
        msg = 'Error when attempting to call ReadSDO()/WriteSDO(): '
        msg += f'\'{err.args[1]}\' in the {param} parameter.'
        self.message = msg
