...
class ProjectBase(ProjectString):
    ...
    def write_api_add(self, url, method="POST", headers=None, data=None, name=None):
        ...
        self.get_this_fun_list()
        self.write_api(row2, _update=False, type=2)
        self.write_sql(fun_name, _update=False)
        self.write_assert(fun_name, _update=False)
        self.write_api_fun(fun_name, _update=False)
        self.write_testcase(fun_name, _update=False)
