...
function GetOciSubcommands_jms() {
    $ociSubcommands = @{
        ...
        'jms fleet' = 'change-compartment create delete generate-agent-deploy-script get list request-crypto-analyses request-java-migration-analyses request-jfr-recordings request-performance-tuning-analyses summarize-resource-inventory update'
