...
class StreamApi(object):
    ...
    def create_stream(
        ...
        stream_name: Annotated[
            ...
            Field(
                ...,
                description='Name of the stream. Must be less than 32 characters long. Allowed characters are: a-z, A-Z, 0-9, "-" and "_". ',
            ),
        ],
        ...
        **kwargs
        ...
        :param stream_name: Name of the stream. Must be less than 32 characters long. Allowed characters are: a-z, A-Z, 0-9, \"-\" and \"_\".  (required)
    ...
    @validate_arguments
    def list_streams(self, **kwargs) -> List[str]:  # noqa: E501
        """Get list of all streams  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_streams(async_req=True)
        >>> result = thread.get()
        ...
        return self.list_streams_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def list_streams_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Get list of all streams  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_streams_with_http_info(async_req=True)
        >>> result = thread.get()
