...
def test_std_bound_test():
    ...
    V3 = va.Validation(df, data_label = ['data.x.x_1', 'data.x.x_2','data.x.x_3'], param_label = 'data.time', 
    ...
    V3_bin = va.Validation(df, data_label = ['data.x.x_1', 'data.x.x_2','data.x.x_3'], param_label = 'data.time', 
                      method = 'bin', num = 50, units = 'm')
    ...
    V = va.Validation(df, data_label = ['data.y.y_1'], param_label = 'data.y.y_3', 
                        method = 'bin', num = 50, units = 'm', omit_nan_rows = False)
    V3 = va.Validation(df, data_label = ['data.y.y_1', 'data.y.y_2'], param_label = 'data.y.y_3', 
...
def test_norm_test():
    ...
    log, table, fig = V.norm_test(norm_type = 'Linf', limits = 10)
