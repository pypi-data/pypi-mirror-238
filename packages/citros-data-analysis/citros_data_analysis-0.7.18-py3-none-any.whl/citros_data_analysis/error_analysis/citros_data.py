...
class CitrosData:
    ...
    def _set_data(self, dataset):
        ...
        dataset : Series or DataFrame
            May containe dicts or lists in rows or their combination (dict of lists, list of dics, etc)
        '''
        k = []
    ...
    def _get_index(self, n_bins, param_label, min_lim = None, max_lim = None, show_fig = False):
        ...
        n_bins : int
            Number of bins.
        param_label : str
            Label of the column on the basis of which the indixes will be calculated.
        min_lim : float
    ...
    def _get_mu(self, X, ret_nonan = False):
        ...
        ret_nonan : bool, default False
            Specifies if the `X` cleaned from rows containing numpy.nan values should be returnd.
    ...
    def _group_data(self, new_indexes, bins_dict, flag_x):
        '''
        Group data accordinag to id values in `new_indexes` and calculate mean values of the each group.
    ...
    def _plot_1Dstatistics(self, statistics, filter_st, ax = None, n_std = 3, num_data = 0, ylabel = None, std_color = 'r', 
        ...
        statistics : pandas.DataFrame
            DataFrame with coulmns [`x_label`,'mean','sigma'], see function get_statistic(...).
