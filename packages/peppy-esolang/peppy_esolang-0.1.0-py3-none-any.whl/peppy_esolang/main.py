...
def main(file: click.File, debug: bool, input: int) -> int:
    """
    A Python implementation of the pepp*erdine esoteric programming language.
    Built on top of https://github.com/kosayoda/chickenpy/tree/master
