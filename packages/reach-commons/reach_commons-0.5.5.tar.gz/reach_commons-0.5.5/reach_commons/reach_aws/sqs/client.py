...
class HubspotSQSMessage:
    ...
    def send_business_message(self, business_id, delay_seconds=1):
        return self.send_message(
            object_name="business", object_id=business_id, delay_seconds=delay_seconds
        )

    def send_user_message(self, user_id, delay_seconds=1):
        return self.send_message(
            object_name="user", object_id=user_id, delay_seconds=delay_seconds
        )

    def send_user_business_message(self, user_id, business_id, delay_seconds=1):
        return self.send_message(
            object_name="user_business",
            object_id=user_id,
