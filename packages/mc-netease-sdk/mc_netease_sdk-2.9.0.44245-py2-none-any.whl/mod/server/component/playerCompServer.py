...
class PlayerCompServer(BaseComponent):
    ...
    def SetOperateDoorsAndSwitchesAbility(self, canOperate):
        # type: (bool) -> bool
        """
        设置玩家能否与门和开关交互，该接口的设置会存档，影响生存、创造、冒险模式
        """
        pass
    ...
    def SetOpenContainersAbility(self, canOpen):
        # type: (bool) -> bool
        """
        设置玩家能否打开容器，该接口的设置会存档，影响生存、创造、冒险模式
        """
        pass
    ...
    def SetAttackPlayersAbility(self, canAttack):
        # type: (bool) -> bool
        """
        设置玩家能否攻击其他玩家，该接口的设置会存档，影响生存、创造、冒险模式
        """
        pass
    ...
    def SetAttackMobsAbility(self, canAttack):
        # type: (bool) -> bool
        """
        设置玩家能否攻击生物，该接口的设置会存档，影响生存、创造、冒险模式
        """
        pass

    def SetAsOperator(self, isOperator):
        # type: (bool) -> bool
        """
        设置玩家是否为管理员，即是否给予OP权限，该接口的设置会存档，影响生存、创造、冒险模式
        """
        pass
    ...
    def SetTeleportAbility(self, canTeleport):
        # type: (bool) -> bool
        """
        设置玩家能否使用TP指令，该接口的设置会存档，影响生存、创造、冒险模式
        """
        pass
