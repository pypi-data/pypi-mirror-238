...
class MatcherBenny(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatcherBenny:
        """Create an instance of MatcherBenny from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatcherBenny:
        """Create an instance of MatcherBenny from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatcherBenny.parse_obj(obj)

        _obj = MatcherBenny.parse_obj({
