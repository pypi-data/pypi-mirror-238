...
class AlertListItemDTOBenny(BaseModel):
    """
    AlertListItemDTOBenny
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlertListItemDTOBenny:
        """Create an instance of AlertListItemDTOBenny from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AlertListItemDTOBenny:
        """Create an instance of AlertListItemDTOBenny from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AlertListItemDTOBenny.parse_obj(obj)

        _obj = AlertListItemDTOBenny.parse_obj({
