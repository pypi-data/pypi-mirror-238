...
class AddInviteFormBenny(BaseModel):
    """
    AddInviteFormBenny
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddInviteFormBenny:
        """Create an instance of AddInviteFormBenny from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddInviteFormBenny:
        """Create an instance of AddInviteFormBenny from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddInviteFormBenny.parse_obj(obj)

        _obj = AddInviteFormBenny.parse_obj({
