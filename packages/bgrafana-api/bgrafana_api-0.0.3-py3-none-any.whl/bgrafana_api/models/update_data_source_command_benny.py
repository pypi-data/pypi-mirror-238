...
class UpdateDataSourceCommandBenny(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateDataSourceCommandBenny:
        """Create an instance of UpdateDataSourceCommandBenny from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateDataSourceCommandBenny:
        """Create an instance of UpdateDataSourceCommandBenny from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateDataSourceCommandBenny.parse_obj(obj)

        _obj = UpdateDataSourceCommandBenny.parse_obj({
