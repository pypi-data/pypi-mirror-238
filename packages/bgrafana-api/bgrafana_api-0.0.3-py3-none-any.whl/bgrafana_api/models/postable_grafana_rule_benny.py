...
class PostableGrafanaRuleBenny(BaseModel):
    """
    PostableGrafanaRuleBenny
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostableGrafanaRuleBenny:
        """Create an instance of PostableGrafanaRuleBenny from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostableGrafanaRuleBenny:
        """Create an instance of PostableGrafanaRuleBenny from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostableGrafanaRuleBenny.parse_obj(obj)

        _obj = PostableGrafanaRuleBenny.parse_obj({
