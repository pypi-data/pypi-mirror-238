...
class RuleBenny(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RuleBenny:
        """Create an instance of RuleBenny from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RuleBenny:
        """Create an instance of RuleBenny from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RuleBenny.parse_obj(obj)

        _obj = RuleBenny.parse_obj({
