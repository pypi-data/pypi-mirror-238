...
class OpsGenieConfigBenny(BaseModel):
    """
    OpsGenieConfigBenny
    """
    ...
    responders: Optional[conlist(OpsGenieConfigResponderBennyBenny)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OpsGenieConfigBenny:
        """Create an instance of OpsGenieConfigBenny from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OpsGenieConfigBenny:
        """Create an instance of OpsGenieConfigBenny from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OpsGenieConfigBenny.parse_obj(obj)

        _obj = OpsGenieConfigBenny.parse_obj({
            ...
            "responders": [OpsGenieConfigResponderBennyBenny.from_dict(_item) for _item in obj.get("responders")] if obj.get("responders") is not None else None,
