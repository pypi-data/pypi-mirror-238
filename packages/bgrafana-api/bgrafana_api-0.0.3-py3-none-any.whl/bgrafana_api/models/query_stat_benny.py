...
class QueryStatBenny(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueryStatBenny:
        """Create an instance of QueryStatBenny from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueryStatBenny:
        """Create an instance of QueryStatBenny from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueryStatBenny.parse_obj(obj)

        _obj = QueryStatBenny.parse_obj({
            "color": obj.get("color"),
