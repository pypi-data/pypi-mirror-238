...
class SearchResultItemBenny(BaseModel):
    """
    SearchResultItemBenny
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchResultItemBenny:
        """Create an instance of SearchResultItemBenny from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SearchResultItemBenny:
        """Create an instance of SearchResultItemBenny from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchResultItemBenny.parse_obj(obj)

        _obj = SearchResultItemBenny.parse_obj({
