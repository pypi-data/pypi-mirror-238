...
class LegacyAlertBenny(BaseModel):
    """
    LegacyAlertBenny
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LegacyAlertBenny:
        """Create an instance of LegacyAlertBenny from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LegacyAlertBenny:
        """Create an instance of LegacyAlertBenny from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LegacyAlertBenny.parse_obj(obj)

        _obj = LegacyAlertBenny.parse_obj({
