...
class ItemBenny(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ItemBenny:
        """Create an instance of ItemBenny from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ItemBenny:
        """Create an instance of ItemBenny from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ItemBenny.parse_obj(obj)

        _obj = ItemBenny.parse_obj({
            "title": obj.get("title"),
            "type": obj.get("type"),
            "value": obj.get("value")
        })
