...
class UserProfileDTOBenny(BaseModel):
    """
    UserProfileDTOBenny
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserProfileDTOBenny:
        """Create an instance of UserProfileDTOBenny from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserProfileDTOBenny:
        """Create an instance of UserProfileDTOBenny from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserProfileDTOBenny.parse_obj(obj)

        _obj = UserProfileDTOBenny.parse_obj({
