...
import bgrafana_api.models
from bgrafana_api import rest
from bgrafana_api.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(bgrafana_api.models, klass)
