...
class PostableApiAlertingConfig(BaseModel):
    ...
    receivers: Optional[conlist(PostableApiReceiver)] = Field(None, description="Override with our superset receiver type")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostableApiAlertingConfig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostableApiAlertingConfig:
        """Create an instance of PostableApiAlertingConfig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostableApiAlertingConfig.parse_obj(obj)

        _obj = PostableApiAlertingConfig.parse_obj({
