...
class PostableSilence(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostableSilence:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostableSilence:
        """Create an instance of PostableSilence from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostableSilence.parse_obj(obj)

        _obj = PostableSilence.parse_obj({
