...
class TestReceiversConfigBodyParams(BaseModel):
    """
    TestReceiversConfigBodyParams
    """
    alert: Optional[TestReceiversConfigAlertParams] = None
    receivers: Optional[conlist(PostableApiReceiver)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestReceiversConfigBodyParams:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestReceiversConfigBodyParams:
        """Create an instance of TestReceiversConfigBodyParams from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestReceiversConfigBodyParams.parse_obj(obj)

        _obj = TestReceiversConfigBodyParams.parse_obj({
