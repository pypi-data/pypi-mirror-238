...
class CreateOrUpdateConfigCmd(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateOrUpdateConfigCmd:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateOrUpdateConfigCmd:
        """Create an instance of CreateOrUpdateConfigCmd from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateOrUpdateConfigCmd.parse_obj(obj)

        _obj = CreateOrUpdateConfigCmd.parse_obj({
