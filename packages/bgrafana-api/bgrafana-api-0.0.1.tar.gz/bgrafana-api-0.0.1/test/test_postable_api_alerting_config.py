...
from bgrafana-api.models.postable_api_alerting_config import PostableApiAlertingConfig  # noqa: E501

class TestPostableApiAlertingConfig(unittest.TestCase):
    """PostableApiAlertingConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostableApiAlertingConfig:
        """Test PostableApiAlertingConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostableApiAlertingConfig`
        """
        model = PostableApiAlertingConfig()  # noqa: E501
        if include_optional:
    ...
    def testPostableApiAlertingConfig(self):
        """Test PostableApiAlertingConfig"""
