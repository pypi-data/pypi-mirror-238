...
from bgrafana-api.models.pushover_config import PushoverConfig  # noqa: E501

class TestPushoverConfig(unittest.TestCase):
    """PushoverConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PushoverConfig:
        """Test PushoverConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PushoverConfig`
        """
        model = PushoverConfig()  # noqa: E501
        if include_optional:
