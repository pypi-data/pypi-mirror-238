...
from bgrafana-api.models.http_client_config import HTTPClientConfig  # noqa: E501

class TestHTTPClientConfig(unittest.TestCase):
    """HTTPClientConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HTTPClientConfig:
        """Test HTTPClientConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HTTPClientConfig`
        """
        model = HTTPClientConfig()  # noqa: E501
        if include_optional:
