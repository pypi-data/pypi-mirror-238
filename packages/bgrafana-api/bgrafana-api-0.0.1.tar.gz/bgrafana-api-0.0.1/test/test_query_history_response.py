...
from bgrafana-api.models.query_history_response import QueryHistoryResponse  # noqa: E501
...
class TestQueryHistoryResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> QueryHistoryResponse:
        ...
        """
        model = QueryHistoryResponse()  # noqa: E501
        if include_optional:
            return QueryHistoryResponse(
                result = bgrafana-api.models.query_history_dto.QueryHistoryDTO(
                    comment = '', 
                    created_at = 56, 
                    created_by = 56, 
                    datasource_uid = '', 
