...
from bgrafana-api.models.sns_config import SNSConfig  # noqa: E501

class TestSNSConfig(unittest.TestCase):
    """SNSConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SNSConfig:
        """Test SNSConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SNSConfig`
        """
        model = SNSConfig()  # noqa: E501
        if include_optional:
            return SNSConfig(
                api_url = '',
                attributes = {
