...
from bgrafana-api.models.gettable_user_config import GettableUserConfig  # noqa: E501

class TestGettableUserConfig(unittest.TestCase):
    """GettableUserConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GettableUserConfig:
        """Test GettableUserConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GettableUserConfig`
        """
        model = GettableUserConfig()  # noqa: E501
        if include_optional:
            return GettableUserConfig(
                alertmanager_config = bgrafana-api.models.gettable_api_alerting_config.GettableApiAlertingConfig(
    ...
    def testGettableUserConfig(self):
        """Test GettableUserConfig"""
