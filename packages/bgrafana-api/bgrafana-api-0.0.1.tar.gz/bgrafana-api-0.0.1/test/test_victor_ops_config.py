...
from bgrafana-api.models.victor_ops_config import VictorOpsConfig  # noqa: E501

class TestVictorOpsConfig(unittest.TestCase):
    """VictorOpsConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VictorOpsConfig:
        """Test VictorOpsConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VictorOpsConfig`
        """
        model = VictorOpsConfig()  # noqa: E501
        if include_optional:
