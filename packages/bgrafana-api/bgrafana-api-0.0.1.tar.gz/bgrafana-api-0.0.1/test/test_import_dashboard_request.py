...
from bgrafana-api.models.import_dashboard_request import ImportDashboardRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ImportDashboardRequest:
        ...
        if include_optional:
            return ImportDashboardRequest(
                ...
                folder_uid = '',
                inputs = [
                    bgrafana-api.models.import_dashboard_input_definition_of_input_parameters_when_importing_a_dashboard/.ImportDashboardInput definition of input parameters when importing a dashboard.(
                        name = '', 
                        plugin_id = '', 
                        type = '', 
                        value = '', )
