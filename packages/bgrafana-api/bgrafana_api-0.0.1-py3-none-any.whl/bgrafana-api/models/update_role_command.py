...
class UpdateRoleCommand(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateRoleCommand:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateRoleCommand:
        """Create an instance of UpdateRoleCommand from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateRoleCommand.parse_obj(obj)

        _obj = UpdateRoleCommand.parse_obj({
