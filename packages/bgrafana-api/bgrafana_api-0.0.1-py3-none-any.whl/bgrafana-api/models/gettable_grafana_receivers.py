...
class GettableGrafanaReceivers(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GettableGrafanaReceivers:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GettableGrafanaReceivers:
        """Create an instance of GettableGrafanaReceivers from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GettableGrafanaReceivers.parse_obj(obj)

        _obj = GettableGrafanaReceivers.parse_obj({
