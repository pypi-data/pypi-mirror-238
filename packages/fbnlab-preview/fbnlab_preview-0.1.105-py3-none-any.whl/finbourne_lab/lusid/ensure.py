...
class HoldingsData(BaseLusidData):
    ...
    @staticmethod
    def build_holdings_adjustments_request(n_transactions, instrument_identifiers, properties=None):
...
class QutoesData(BaseLusidData):
    ...
    @staticmethod
    def build_upsert_quote_request_key_pairs(instrument_ids):
