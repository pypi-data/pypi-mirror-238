        ...
        for coord, (t0, t1), params, unknowns, resids in expected:
            ...
            if params is not None:
                for param in params:
                    ...
                    assert isinstance(tuple(saved_results[param[0]])[1], float)
                    saved_results[param[0]] = list(saved_results[param[0]])
                    saved_results[param[0]][1] = round(saved_results[param[0]][1], 1)
            ...
            if unknowns is not None:
                for unknown in unknowns:
                    ...
                    assert isinstance(tuple(saved_results[unknown[0]])[1], float)
                    saved_results[unknown[0]] = list(saved_results[unknown[0]])
                    saved_results[unknown[0]][1] = round(saved_results[unknown[0]][1], 1)
