...
#    BSD license.
import importlib
from openmdao.networkx.utils import open_file, make_str
...
def pydot_from_networkx(N):
    ...
    warn('pydot_from openmdao.networkx is replaced by to_pydot', DeprecationWarning)
    return to_pydot(N)
...
def pydot_layout(G,prog='neato',root=None, **kwds):
    ...
    if D=="":  # no data returned
        ...
        print("P=pydot_from openmdao.networkx(G)")
