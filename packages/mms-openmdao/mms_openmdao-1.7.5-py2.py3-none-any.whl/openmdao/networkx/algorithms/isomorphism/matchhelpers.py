...
Examples
--------
>>> import openmdao.networkx.algorithms.isomorphism as iso
...
>>> from openmdao.networkx.algorithms.isomorphism.matchhelpers import close
>>> from openmdao.networkx.algorithms.isomorphism import generic_node_match
