...
from ..operators.nes import NesOperator
...
def dag():
    with DAG(
        ...
        NesOperator(
            ...
            input_nb="https://github.com/sktaiflow/notebooks/blob/master/test/pip_test.ipynb",
            # input_nb="tests/operator_nes_test.ipynb",
