...
from mcli.utils.utils_config import (BaseSubmissionConfig, ComputeConfig, ComputeTranslation, DictTranslation,
    ...
    def to_create_run_api_input(self) -> Dict[str, Dict[str, Any]]:
        ...
        for field_name, value in asdict(self).items():
            ...
            if field_name == 'env_variables':
                ...
                value = DictTranslation.to_mapi(value)
    ...
    def from_mapi_response(cls, response: Dict[str, Any]) -> RunConfig:
        ...
        for k, v in cls._property_translations.items():
            ...
            if v == 'env_variables':
                ...
                value = DictTranslation.from_mapi(value)
            data[v] = value
