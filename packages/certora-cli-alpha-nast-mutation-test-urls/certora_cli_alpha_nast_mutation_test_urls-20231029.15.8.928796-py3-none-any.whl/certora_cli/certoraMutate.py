...
def collect(args: argparse.Namespace) -> bool:
    ...
    if any(
        [
            ...
            (mutant[Constants.RULE_REPORT_LINK] is None and mutant[Constants.LINK] is None) or
            (mutant[Constants.RULE_REPORT_LINK] and not valid_link(mutant[Constants.RULE_REPORT_LINK])) or
            (mutant[Constants.LINK] and not valid_link(mutant[Constants.LINK]))
    ...
    for mutant in mutants_objs:
        mutant_link = mutant[Constants.RULE_REPORT_LINK]
        if mutant_link is None:
            mutant_link = mutant[Constants.LINK]
