...
class LoraData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoraData:
        """Create an instance of LoraData from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoraData:
        """Create an instance of LoraData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoraData.parse_obj(obj)

        _obj = LoraData.parse_obj(
            {
