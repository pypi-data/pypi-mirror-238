...
from dql.sql.types import JSON, Boolean, Float, Int, String
...
def test_dataset_meta_with_custom_columns(cloud_test_catalog, dogs_registered_dataset):
    ...
    # additional columns added to dataset
    custom_columns = [
        sa.Column("col_integer", Int()),
        sa.Column("col_float", Float()),
        sa.Column("col_string", String()),
        sa.Column("col_json", JSON()),
        sa.Column("col_boolean", Boolean()),
    ]
