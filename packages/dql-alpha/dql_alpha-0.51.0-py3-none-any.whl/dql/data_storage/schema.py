...
PARTITION_COLUMN_SIZE = "partition_size"
PARTITION_UNIQUE_ID = "partition_uid"

partition_col_names = [PARTITION_COLUMN_ID, PARTITION_COLUMN_SIZE, PARTITION_UNIQUE_ID]


def partition_columns() -> Sequence["sa.Column"]:
    return [
        sa.Column(PARTITION_COLUMN_ID, sa.Integer),
        sa.Column(PARTITION_COLUMN_SIZE, sa.Integer),
        sa.Column(PARTITION_UNIQUE_ID, sa.Integer),
    ]
