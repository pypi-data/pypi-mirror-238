...
class _AllowedMembers(ReactiveMutableSet[str]):
    def __init__(
        self, data: Iterable[str], /, *, column_key: ColumnKey, role: Role
    ) -> None:
        super().__init__(data)
...
class Role:
    def __init__(
        ...
        /,
        *,
        restrictions: Mapping[ColumnKey, Iterable[str]],
        _service: Service,
    ):
    ...
    @restrictions.setter
    def restrictions(
        self, value: Union[Mapping[ColumnKey, Iterable[str]], Restrictions], /
    ) -> None:
        self._restrictions = (
            value
    ...
    def _restrictions_from_mapping(
        self, restrictions: Mapping[ColumnKey, Iterable[str]], /
    ) -> Restrictions:
        return Restrictions(
            {
                key: _AllowedMembers(
