...
def finetune_runner(component_args: Namespace) -> None:
    ...
    trainer_callbacks.append(SaveExtraFilesToCheckpoints(model_name=component_args.model_name,
                                                         input_model_path=component_args.model_name_or_path,
                                                         pytorch_output_folder=component_args.pytorch_model_folder))
    # init trainer
