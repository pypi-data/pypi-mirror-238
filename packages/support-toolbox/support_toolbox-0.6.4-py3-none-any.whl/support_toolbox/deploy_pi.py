...
import os
import configparser
from support_toolbox.utils.helper import PRIVATE_API_URLS, get_api_url_location
...
def deploy_service_accounts(api_url, api_token, site_slug, circleci_api_token):
...
def run():
    ...
    while True:
        ...
        if selection == 'y':
            ...
            public_slug, metrics_org = deploy_metrics(api_url, admin_token, public_slug)
            ...
            deploy_service_accounts(api_url, admin_token, public_slug, circleci_api_token)
