...
class Netorca:
    ...
    def validate_filters(self, url: str, filters: Dict):
        ...
        options.append("limit")  # limit is always available option
    ...
    def get_service_items_dependent(self, filters: dict = None) -> dict:
        return self.caller("service_items_dependent", "get", filters=filters)
