...
class EMObjectConfig:
    ...
    Args:
        ...
        segmentation_version: required, segmentation version
        biomarker_version: required, biomarker expression version
...
def add_layer_from_enable_db(
    ...
    """Builds a layer from the Enable database.
