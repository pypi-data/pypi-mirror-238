...
from unctl.version import check
...
def unctl_process_args():
    ...
    parser.add_argument("-v", "--version", action="version", version=version("unctl"))
...
def unctl():
    ...
    loader = ChecksLoader(root_dir=root_dir, checks_dir="unctl/checks")
