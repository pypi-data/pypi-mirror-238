...
def lai_to_csv_field(eop_paths:list, fields_path:str, outdir:str, nfields:int = None, n_jobs:int = 8, delete_tmp:bool=True, tmpdir:str = "/tmp"):
...
def lai_to_csv_field_append(npy_path:str, bbox_path:str, fields_path:str, outdir:str, n_jobs:int=8):
    ...
    lai_to_csv_field([tmp_eop_path], fields_path, outdir=outdir, n_jobs=n_jobs)
