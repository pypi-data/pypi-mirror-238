...
config.fileConfig(fname="logger_config.properties", defaults={'logfilename': "logs/marketdataapi_logs.log"}, disable_existing_loggers=False)
...
class Symbol(ABC):
    ...
    def get_option_chain(self, ason_date=None, expiration_date=None, from_date=None, to_date=None, month=None,
                         year=None, include_weekly=False, include_monthly=False, include_quarterly=False, dte=None, delta=None,
