...
from void_terminal.request_llms.local_llm_class import LocalLLMHandle, get_local_llm_predict_fns, SingletonLocalLLM

from void_terminal.request_llms.chatglmoonx import ChatGLMModel, chat_template
...
class GetONNXGLMHandle(LocalLLMHandle):
    ...
    def load_model_and_tokenizer(self):
        # 🏃‍♂️🏃‍♂️🏃‍♂️ Subprocess execution
        import os, glob
        if not len(glob.glob("./request_llms/ChatGLM-6b-onnx-u8s8/chatglm-6b-int8-onnx-merged/*.bin")) >= 7: # The model has seven bin files
