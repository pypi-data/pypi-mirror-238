...
def main():
    ...
    description =  "Github source code is open source and updated[Address 🚀](https://github.com/binary-husky/gpt_academic), "
    description += "Thanks to the enthusiastic[Developers ❤️](https://github.com/binary-husky/gpt_academic/graphs/contributors)."
    description += "</br></br>Please refer to the FAQ for common questions[Project Wiki](https://github.com/binary-husky/gpt_academic/wiki), "
    description += "If you encounter a bug, please go to[Bug Feedback](https://github.com/binary-husky/gpt_academic/issues)."
    ...
    customize_btns = {}
    predefined_btns = {}
    with gr.Blocks(title="GPT academic optimization", theme=set_theme, analytics_enabled=False, css=advanced_css) as demo:
        gr.HTML(title_html)
    ...
    # If you need to run under the second-level path
