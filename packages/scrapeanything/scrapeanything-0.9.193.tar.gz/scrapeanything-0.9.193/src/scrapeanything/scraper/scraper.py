...
class Scraper:
    ...
    def xPath(self, path, element=None, pos=0, dataType=None, prop=None, explode=None, condition=None, substring=None, transform=None, replace=None, join=None, timeout=0, is_error: bool=True):
    ...
    def click(self, path: str, element: any=None, timeout: int=0, pos: int=0, is_error: bool=True) -> any:
        return self.on_click(path=path, element=element, timeout=timeout, pos=pos, is_error=is_error)
