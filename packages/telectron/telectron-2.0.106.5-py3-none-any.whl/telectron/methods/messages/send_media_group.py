                            ...
                            raw.functions.messages.UploadMedia(
                                ...
                                media=raw.types.InputMediaUploadedDocument(
                                    ...
                                    attributes=[
                                        ...
                                        raw.types.DocumentAttributeFilename(file_name=file_names[e] or os.path.basename(i.media))
                                    ]
                                )
                            )
                        )
                        ...
                        raw.functions.messages.UploadMedia(
                            ...
                            media=raw.types.InputMediaUploadedDocument(
                                ...
                                attributes=[
                                    ...
                                    raw.types.DocumentAttributeFilename(file_name=file_names[e] or getattr(i.media, "name", "video.mp4"))
                                ]
                            )
                        )
                    )
                        ...
                        raw.functions.messages.UploadMedia(
                            ...
                            media=raw.types.InputMediaUploadedDocument(
                                ...
                                attributes=[
                                    ...
                                    raw.types.DocumentAttributeFilename(file_name=file_names[e] or getattr(i.media, "name", "audio.mp3"))
                                ]
                            )
                        )
                    )
                    ...
                    media = await self.invoke(
                        raw.functions.messages.UploadMedia(
                            ...
                            media=raw.types.InputMediaUploadedDocument(
                                ...
                                thumb=await self.save_file(i.thumb),
                                attributes=[
                                    raw.types.DocumentAttributeFilename(file_name=file_names[e] or getattr(i.media, "name", "file.zip"))
                                ]
                            )
                        )
                    )
