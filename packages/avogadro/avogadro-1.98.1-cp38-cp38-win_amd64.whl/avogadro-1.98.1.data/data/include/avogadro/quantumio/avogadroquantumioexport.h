...
#      define AVOGADROQUANTUMIO_EXPORT __declspec(dllexport)
#    else
        /* We are using this library */
#      define AVOGADROQUANTUMIO_EXPORT __declspec(dllimport)
#    endif
#  endif
...
#  define AVOGADROQUANTUMIO_DEPRECATED __declspec(deprecated)
#endif
