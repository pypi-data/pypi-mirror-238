...
query_logger = logging.getLogger("active_wrapper.connection.queries")
connection_logger = logging.getLogger("active_wrapper.connection")


def run(wrapped):
    """
    Special decactive_wrapper encapsulating query method.
    """
...
class Connection(ConnectionInterface):
    ...
    def get_schema_builder(self):
        ...
        :rtype: active_wrapper.schema.builder.SchemaBuilder
        """
