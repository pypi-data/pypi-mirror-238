...
class SchemaGrammar(Grammar):
    ...
    def compile_rename_column(self, blueprint, command, connection):
        ...
        :type connection: active_wrapper.connections.Connection
    ...
    def _get_renamed_diff(self, blueprint, command, column, schema):
        ...
        :type column: active_wrapper.dbal.Column

        :param schema: The schema
        :type schema: active_wrapper.dbal.SchemaManager

        :rtype: active_wrapper.dbal.TableDiff
        """
    ...
    def _get_table_with_column_changes(self, blueprint, table):
        ...
        :type table: active_wrapper.dbal.table.Table

        :rtype: active_wrapper.dbal.table.Table
        """
        table = table.clone()
    ...
    def _get_column_for_change(self, table, fluent):
        ...
        :rtype: active_wrapper.dbal.column.Column
        """
    ...
    def platform(self):
        ...
        :rtype: active_wrapper.dbal.platforms.platform.Platform
        """
