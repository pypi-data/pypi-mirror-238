...
class Model(object):
    ...
    def add_global_scope(cls, scope, implementation=None):
        ...
        :type scope: active_wrapper.orm.scopes.scope.Scope or callable or str
    ...
    def has_global_scope(cls, scope):
        ...
        :param scope: The scope to register
        :type scope: active_wrapper.orm.scopes.scope.Scope or str
        """
    ...
    def get_connection(self):
        ...
        :rtype: active_wrapper.connections.Connection
        """
