...
class Migrator(object):
    def __init__(self, repository, resolver):
        ...
        :type resolver: active_wrapper.database_manager.DatabaseManager
        """
    ...
    def _pretend_to_run(self, migration, method):
        ...
        :type migration: active_wrapper.migrations.migration.Migration
    ...
    def _resolve(self, path, migration_file):
        ...
        :rtype: active_wrapper.migrations.migration.Migration
        """
