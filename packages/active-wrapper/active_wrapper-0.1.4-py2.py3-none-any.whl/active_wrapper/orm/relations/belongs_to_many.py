...
import active_wrapper.orm.model
...
class BelongsToMany(Relation):
    ...
    def get(self, columns=None):
        ...
        :rtype: active_wrapper.Collection
        """
        if columns is None:
            columns = ["*"]
    ...
    def _clean_pivot_attributes(self, model):
        ...
        :type model: active_wrapper.Model
        """
        values = {}
        delete_keys = []
    ...
    def get_relation_count_query(self, query, parent):
        ...
        :type query: active_wrapper.orm.Builder
        :type parent: active_wrapper.orm.Builder

        :rtype: active_wrapper.orm.Builder
        """
    ...
    def create(self, _attributes=None, _joining=None, _touch=True, **attributes):
        ...
        :rtype: active_wrapper.orm.Model
        """
        if _attributes is not None:
            attributes.update(_attributes)
    ...
    def attach(self, id, attributes=None, touch=True):
        ...
        """
        if isinstance(id, active_wrapper.orm.Model):
            id = id.get_key()
    ...
    def detach(self, ids=None, touch=True):
        ...
        """
        if isinstance(ids, active_wrapper.orm.model.Model):
            ids = ids.get_key()
