...
from compiloor.services.environment.constants import (
...
from compiloor.services.logger.messages import ALREADY_INITIALIZED_MSG, NOT_INITIALIZED_MSG
...
def initialize_directory(force: bool = False) -> None:
    ...
    try:
        ...
        # open(f"{_abs_main_dir}/finding-template.md", "w").write(BASE_FINDING_MD_TEMPLATE)
