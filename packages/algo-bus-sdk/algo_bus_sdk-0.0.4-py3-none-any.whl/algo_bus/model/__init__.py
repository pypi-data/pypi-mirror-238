...
from algo_bus.model.enum_class import Exchange, OrderSide, OrderStatus, FillStatus, ReportType, ParentOrderStatus, OrderPriceType, InstructionStatus
        ...
        for key in json_dict:
            if hasattr(self, key):
                if key == "messageType":
                    ...
                    setattr(self, key, ParentOrderStatus[json_dict[key]])
...
class CustomEncoder(json.JSONEncoder):
    def default(self, o):
        if isinstance(o, (Exchange, OrderSide, MessageType, OrderStatus, OrderPriceType, InstructionStatus, FillStatus, ReportType, ParentOrderStatus)):
            return str(o.name)
