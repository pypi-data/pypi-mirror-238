...
if platform.system() == "Linux":
	...
	def init(bitrate: Bitrate, *, channel: 'str|None' = None, bustype: 'str|None' = None) -> can.Bus:
		if bustype is None:
			bustype = "socketcan"
		if channel is None:
			channel = "can0"
		...
		bus: can.Bus = can.Bus(channel, bustype=bustype)
		buses.append(bus)
		return bus
	...
	def init(bitrate: Bitrate, *, channel: 'str|None' = None, bustype: 'str|None' = None) -> can.Bus:
		...
		bus: can.Bus = can.Bus(channel, bustype=bustype, bitrate=bitrate.value)
		buses.append(bus)
		return bus
