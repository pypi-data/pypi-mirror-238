...
class ResultsetGetResponseItem(object):
    ...
    def __init__(self, created_at=None, data=None, dataset_access_type=None, dataset_id=None, error=None, is_frozen=None, is_top_level=None, last_updated_at=None, name=None, num_frames=None, tags=None, version=None, vseq=None, local_vars_configuration=None):  # noqa: E501
