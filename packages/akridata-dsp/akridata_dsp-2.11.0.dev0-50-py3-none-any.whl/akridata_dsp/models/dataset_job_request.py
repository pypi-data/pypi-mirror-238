...
class DatasetJobRequest(object):
    ...
    def __init__(self, access_type=None, advanced_config=None, attributes=None, data_type=None, dataset_id=None, dataset_name=None, dataset_version=None, date=None, distance_metric=None, error=None, extra_capabilities=None, fail_reason=None, grid_size=None, is_compare_job=None, is_detail_available=None, is_resubmit_allowed=None, is_text_search_request=False, is_text_search_supported=None, job_type=None, kseg_allowed_modes=None, last_access_time=None, namespace=None, ownername=None, patch_supported=None, patches=None, permissions=None, pipeline_id=None, pipeline_name=None, pipeline_type='default', reqid=None, reqname=None, request_source_meta=None, request_summary=None, saliency_map_config=None, status=None, supported_clusterers=None, text_search_character_limit=None, text_search_pipeline=None, tunables=None, tunables_default=None, version=None, vseq_config=None, local_vars_configuration=None):  # noqa: E501
