...
class QWebEngineCookieStore(QtCore.QObject):
    ...
    def setCookieFilter(self, filterCallback: typing.Callable[[FilterRequest], bool] = ...) -> None: ...
...
class QWebEngineGlobalSettings(PyQt6.sip.simplewrapper):
    ...
    class DnsMode(PyQt6.sip.simplewrapper):
        ...
        serverTemplates = ... # type: typing.Iterable[typing.Optional[str]]
...
class QWebEngineHttpRequest(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def postRequest(url: QtCore.QUrl, postData: typing.Dict[typing.Optional[str], typing.Optional[str]]) -> 'QWebEngineHttpRequest': ...
...
class QWebEngineLoadingInfo(PyQt6.sip.simplewrapper):
    ...
    def responseHeaders(self) -> typing.Dict[QtCore.QByteArray, typing.List[QtCore.QByteArray]]: ...
...
class QWebEnginePage(QtCore.QObject):
    ...
    @typing.overload
    def runJavaScript(self, scriptSource: typing.Optional[str], worldId: int = ..., resultCallback: typing.Callable[[typing.Optional[str]], None] = ...) -> None: ...
    @typing.overload
    ...
    def findText(self, subString: typing.Optional[str], options: 'QWebEnginePage.FindFlag' = ..., resultCallback: typing.Callable[[bool], None] = ...) -> None: ...
...
class QWebEngineScriptCollection(PyQt6.sip.simplewrapper):
    ...
    def find(self, name: typing.Optional[str]) -> typing.List[QWebEngineScript]: ...
...
class QWebEngineUrlRequestInfo(PyQt6.sip.simplewrapper):
    ...
    def httpHeaders(self) -> typing.Dict[QtCore.QByteArray, QtCore.QByteArray]: ...
...
class QWebEngineUrlRequestJob(QtCore.QObject):
    ...
    def setAdditionalResponseHeaders(self, additionalResponseHeaders: typing.Dict[typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview], typing.Sequence[typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]]]) -> None: ...
