...
setuptools.setup(
    ...
    install_requires=['pandas==1.5.3', 'pandas-datareader==0.10.0', 'scipy==1.10.1', 'yfinance==0.2.14',
                      'pandas_market_calendars==4.1.4', 'pyfolio-reloaded==0.9.5', 'pyportfolioopt==1.5.5',
                      'cvxpy==1.3.2'],
