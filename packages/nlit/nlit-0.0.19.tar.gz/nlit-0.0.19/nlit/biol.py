...
__all__ = ['OBS', 'VAR', 'OBSM', 'VARM', 'OBSP', 'VARP', 'UNS', 'LAYER', 'LAYERS', 'MITO', 'RIBO', 'CELL', 'CELLS', 'BARCODE',
           ...
           'X_DETECTED', 'X_SCALED_NORMALIZED', 'ADATA', 'MATRIX', 'FEATURES', 'SENSITIVITY', 'FILTERED_MATRIX', 'SEQ',
           'SEQRUN', 'SEQRUNS', 'FIRST_SENS', 'UNIQUE_SENS', 'UNIQUE_SENSITIVITY', 'UNIQUE_SENSITIVITIES']
