...
__all__ = ["toTensor", "toRange", "toList",
           ...
           "toFloat", "toInt", "toBytes", "toHtml", "toAscii", "toHash", "toCsv", "toAudio"]
import re, k1lib, math, os, numpy as np, io, base64, unicodedata, inspect
    ...
    def __ror__(self, it):                                                       # toHtml
        if hasPIL:                                                               # toHtml
            if isinstance(it, PIL.Image.Image):                                  # toHtml
                it = it | toBytes(dataType="PNG") | cli.aS(base64.b64encode) | cli.op().decode() # toHtml
