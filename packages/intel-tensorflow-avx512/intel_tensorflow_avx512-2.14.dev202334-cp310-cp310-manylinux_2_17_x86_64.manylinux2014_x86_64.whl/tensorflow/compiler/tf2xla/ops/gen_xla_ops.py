...
def xla_call_module(args, version, module, Sout, Tout, dim_args_spec=[], platforms=[], function_list=[], has_token_input_output=False, disabled_checks=[], name=None):
...
def xla_call_module_eager_fallback(args, version, module, Sout, Tout, dim_args_spec, platforms, function_list, has_token_input_output, disabled_checks, name, ctx):
  version = _execute.make_int(version, "version")
  module = _execute.make_str(module, "module")
  if not isinstance(Sout, (list, tuple)):
    raise TypeError(
