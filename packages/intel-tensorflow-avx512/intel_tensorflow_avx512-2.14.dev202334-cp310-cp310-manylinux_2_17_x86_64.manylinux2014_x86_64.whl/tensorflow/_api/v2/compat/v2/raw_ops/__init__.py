...
from tensorflow.python.ops.gen_nn_ops import Gelu
from tensorflow.python.ops.gen_nn_ops import GeluGrad
...
from tensorflow.python.ops.gen_rnn_ops import AUGRUBlockCell
