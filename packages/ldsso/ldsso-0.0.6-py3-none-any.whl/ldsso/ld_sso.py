...
class SSO:
    ...
    LD_SSO_SERVICE_API = "http://sso.10.86.14.200.nip.io/"
    LD_KEYCLOAK_CLIENT_ID = "bosch-label-select"
    LD_NAMESPACE = "bosch-label-select"
    LD_HOSTNAME = "func-list-label-task-aaa-bbb"
