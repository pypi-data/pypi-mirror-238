...
class pco_etl:
    ...
    def load_people_api(self):
        ...
        api = '/people/v2/people?per_page=100&include=addresses'
        
        people_data = pco_etl.extract_data(self, api)
    ...
    def load_giving_api(self):
        ...
        import numpy as np
        from datetime import datetime
        api = '/giving/v2/donations?include=designations&per_page=100'
        funds_api = '/giving/v2/funds?per_page=100'
        
        giving_data = pco_etl.extract_data(self, api = api)
        ...
        donations_des = pco_etl.get_pco_include(self, api = api)
        ...
        funds = pco_etl.expand_dataset(funds_data)
        ...
        # Join funds back to the giving table
        giving_data = pd.merge(
            left=giving_data,
            right=funds,
            left_on='fund_id',
        ...
        giving_data = giving_data[[
            ...
            'fund_id', 'alloc_amount_cents', 'fund_name']]
    ...
    def load_campus_api(self):
        ...
        import numpy as np
        from datetime import datetime
        api = '/giving/v2/campuses?per_page=100'
        
        campus_data = pco_etl.extract_data(self, api = api)
    ...
    def load_address_api(self):
        ...
        import numpy as np
        from datetime import datetime
        api = '/people/v2/addresses?per_page=100'
        
        address_data = pco_etl.extract_data(self, api = api)
    ...
    def load_field_api(self):
        ...
        import numpy as np
        from datetime import datetime
        api = '/people/v2/field_data?per_page=100'
        
        api_def = '/people/v2/field_definitions?per_page=100'
        
        field_data = pco_etl.extract_data(self, api = api)
    ...
    def load_checkins_api(self):
        ...
        import numpy as np
        from datetime import datetime
        api = '/check-ins/v2/check_ins?per_page=100&include=event_periods&include=attendance_types'
        
        checkin_data = pco_etl.extract_data(self, api = api)
