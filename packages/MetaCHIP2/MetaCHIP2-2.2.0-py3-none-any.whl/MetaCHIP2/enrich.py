...
MetaCHIP2 enrich -o circos_1.pdf -i cir_plot_matrix.csv
MetaCHIP2 enrich -o circos_2.pdf -l detected_HGTs.txt -g grouping.txt
        ...
        if os.path.isdir(file_in) is False:
            ...
            for input_file in input_file_name_list:
                ...
                list_for_multiple_arguments_COG.append([pwd_input_file, pwd_cog_20_fa, protein_to_cog_dict,
                                                        ...
                                                        output_folder, 1, run_diamond, evalue_cutoff])
...
if __name__ == '__main__':
    ...
    parser.add_argument('-faa',     required=True,                              help='faa files of MAGs, produced by Prokka')
    parser.add_argument('-x',       required=True,                              help='file extension, default: faa')
    parser.add_argument('-hgt1',    required=True,                              help='amino acid sequences of HGTs, required')
    parser.add_argument('-hgt2',    required=False, default=None,               help='amino acid sequences of HGTs, e.g., predicted with a different approach, optional')
    parser.add_argument('-db_dir',  required=True,                              help='COG_db_dir')
    ...
    parser.add_argument('-e',       required=False, default=0.001, type=float,  help='evalue cutoff, default: 0.001')
    parser.add_argument('-desc',    required=False, action='store_true',        help='include functional description in x-axis labels')
...
/usr/local/bin/python3.7 /Users/songweizhi/PycharmProjects/MetaCHIP2/MetaCHIP2/enrich.py -faa faa_files -x faa -o demo_1HGT -db_dir /Users/songweizhi/DB/COG2020 -t 10 -diamond -f -hgt1 zHGTs.faa

cd /Users/songweizhi/Desktop/enrichHGT
/usr/local/bin/python3.7 /Users/songweizhi/PycharmProjects/MetaCHIP2/MetaCHIP2/enrich.py -faa faa_files -x faa -o demo_2HGT -db_dir /Users/songweizhi/DB/COG2020 -t 10 -diamond -f -hgt1 zHGTs.faa -hgt2 zHGTs_mmseqs.faa
