...
class IdentifierType(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('schemeID', 'xsd:normalizedString', 0, 1, {'use': 'optional', 'name': 'schemeID'}),
        MemberSpec_('schemeName', 'xsd:string', 0, 1, {'use': 'optional', 'name': 'schemeName'}),
        MemberSpec_('schemeAgencyID', 'xsd:normalizedString', 0, 1, {'use': 'optional', 'name': 'schemeAgencyID'}),
        MemberSpec_('schemeAgencyName', 'xsd:string', 0, 1, {'use': 'optional', 'name': 'schemeAgencyName'}),
        MemberSpec_('schemeVersionID', 'xsd:normalizedString', 0, 1, {'use': 'optional', 'name': 'schemeVersionID'}),
        MemberSpec_('schemeDataURI', 'xsd:anyURI', 0, 1, {'use': 'optional', 'name': 'schemeDataURI'}),
        MemberSpec_('schemeURI', 'xsd:anyURI', 0, 1, {'use': 'optional', 'name': 'schemeURI'}),
...
class BillOfResourcesIDType(IdentifierType):
    ...
    def has__content(self):
        if (
            ...
            super(BillOfResourcesIDType, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='BillOfResourcesIDType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='BillOfResourcesIDType')
        outfile.write('>')
        self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_, pretty_print=pretty_print)
        outfile.write(self.convert_unicode(self.valueOf_))
        outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='BillOfResourcesIDType'):
        super(BillOfResourcesIDType, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='BillOfResourcesIDType')
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='BillOfResourcesIDType', fromsubclass_=False, pretty_print=True):
        super(BillOfResourcesIDType, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
        ...
        return self
    def _buildAttributes(self, node, attrs, already_processed):
        super(BillOfResourcesIDType, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
...
class BillOfMaterialIDType(IdentifierType):
    ...
    def has__content(self):
        if (
            (1 if type(self.valueOf_) in [int,float] else self.valueOf_) or
            super(BillOfMaterialIDType, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='BillOfMaterialIDType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='BillOfMaterialIDType')
        outfile.write('>')
        self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_, pretty_print=pretty_print)
        outfile.write(self.convert_unicode(self.valueOf_))
        outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='BillOfMaterialIDType'):
        super(BillOfMaterialIDType, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='BillOfMaterialIDType')
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='BillOfMaterialIDType', fromsubclass_=False, pretty_print=True):
        super(BillOfMaterialIDType, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
        ...
        return self
    def _buildAttributes(self, node, attrs, already_processed):
        super(BillOfMaterialIDType, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
