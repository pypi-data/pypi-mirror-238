...
class GetUserReq(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('sequence', 'xsd:unsignedLong', 0, 1, {'use': 'optional', 'name': 'sequence'}),
        MemberSpec_('value01', 'xsd:string', 0, 1, {'use': 'optional', 'name': 'value01'}),
        MemberSpec_('value02', 'xsd:integer', 0, 1, {'use': 'optional', 'name': 'value02'}),
        MemberSpec_('value03', 'xsd:string', 0, 1, {'use': 'optional', 'name': 'value03'}),
        MemberSpec_('value04', 'xsd:integer', 0, 1, {'use': 'optional', 'name': 'value04'}),
        MemberSpec_('value05', 'xsd:string', 0, 1, {'use': 'optional', 'name': 'value05'}),
        MemberSpec_('value06', 'xsd:integer', 0, 1, {'use': 'optional', 'name': 'value06'}),
        MemberSpec_('value07', 'xsd:integer', 0, 1, {'use': 'optional', 'name': 'value07'}),
        MemberSpec_('value08', 'xsd:string', 0, 1, {'use': 'optional', 'name': 'value08'}),
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='GetUserReq', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='GetUserReq')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='GetUserReq', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='GetUserReq'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='GetUserReq', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
