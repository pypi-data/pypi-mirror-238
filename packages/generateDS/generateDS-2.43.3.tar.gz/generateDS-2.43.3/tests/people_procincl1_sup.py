...
class person(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('id', 'xs:integer', 0, 1, {'use': 'optional', 'name': 'id'}),
        MemberSpec_('ratio', 'xs:float', 0, 1, {'use': 'optional', 'name': 'ratio'}),
        MemberSpec_('fruit', 'xs:string', 0, 1, {'use': 'optional', 'name': 'fruit'}),
        MemberSpec_('vegetable', 'xs:string', 0, 1, {'use': 'optional', 'name': 'vegetable'}),
...
class specialperson(person):
    ...
    def has__content(self):
        if (
            super(specialperson, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='specialperson', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='specialperson')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='specialperson', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='specialperson'):
        super(specialperson, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='specialperson')
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='specialperson', fromsubclass_=False, pretty_print=True):
        super(specialperson, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
        ...
        return self
    def _buildAttributes(self, node, attrs, already_processed):
        super(specialperson, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(specialperson, self)._buildChildren(child_, node, nodeName_, True)
        pass
...
class param(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('name', 'xs:NCName', 0, 1, {'use': 'optional', 'name': 'name'}),
        MemberSpec_('sid', 'xs:NCName', 0, 1, {'use': 'optional', 'name': 'sid'}),
        MemberSpec_('flow', 'FlowType', 0, 1, {'use': 'optional', 'name': 'flow'}),
        MemberSpec_('semantic', 'xs:token', 0, 1, {'use': 'optional', 'name': 'semantic'}),
        MemberSpec_('type_', 'xs:NMTOKEN', 0, 0, {'use': 'required', 'name': 'type_'}),
...
class booster(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('member_id', 'xs:string', 0, 1, {'use': 'optional', 'name': 'member-id'}),
        MemberSpec_('firstname', 'xs:string', 0, 0, {'name': 'firstname', 'type': 'xs:string'}, None),
        MemberSpec_('lastname', 'xs:string', 0, 0, {'name': 'lastname', 'type': 'xs:string'}, None),
...
class info(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('type_', 'xs:integer', 0, 1, {'use': 'optional', 'name': 'type_'}),
        MemberSpec_('rating', 'xs:float', 0, 1, {'use': 'optional', 'name': 'rating'}),
    ]
    subclass = None
    superclass = None
...
class vehicle(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='vehicle', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='vehicle')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='vehicle', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='vehicle'):
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            already_processed.add('xsi:type')
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
            if ":" not in self.extensiontype_:
                ...
                outfile.write(' xsi:type="%s"' % self.extensiontype_)
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='vehicle', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class automobile(vehicle):
    ...
    def has__content(self):
        if (
            ...
            super(automobile, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='automobile', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='automobile')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='automobile', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='automobile'):
        super(automobile, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='automobile')
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='automobile', fromsubclass_=False, pretty_print=True):
        super(automobile, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def build(self, node, gds_collector_=None):
        ...
        return self
    def _buildAttributes(self, node, attrs, already_processed):
        super(automobile, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        super(automobile, self)._buildChildren(child_, node, nodeName_, True)
...
class airplane(vehicle):
    ...
    def has__content(self):
        if (
            ...
            super(airplane, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='airplane', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='airplane')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='airplane', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='airplane'):
        super(airplane, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='airplane')
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='airplane', fromsubclass_=False, pretty_print=True):
        super(airplane, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def build(self, node, gds_collector_=None):
        ...
        return self
    def _buildAttributes(self, node, attrs, already_processed):
        super(airplane, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        super(airplane, self)._buildChildren(child_, node, nodeName_, True)
# end class airplane
...
class programmer(person):
    ...
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('language', 'xs:string', 0, 1, {'use': 'optional', 'name': 'language'}),
        MemberSpec_('area', 'xs:string', 0, 1, {'use': 'optional', 'name': 'area'}),
        MemberSpec_('attrposint', 'xs:positiveInteger', 0, 1, {'use': 'optional', 'name': 'attrposint'}),
        MemberSpec_('attrnonposint', 'xs:nonPositiveInteger', 0, 1, {'use': 'optional', 'name': 'attrnonposint'}),
        MemberSpec_('attrnegint', 'xs:negativeInteger', 0, 1, {'use': 'optional', 'name': 'attrnegint'}),
        MemberSpec_('attrnonnegint', 'xs:nonNegativeInteger', 0, 1, {'use': 'optional', 'name': 'attrnonnegint'}),
...
class java_programmer(programmer):
    ...
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('nick_name', 'xs:string', 0, 1, {'use': 'optional', 'name': 'nick-name'}),
        MemberSpec_('status', 'xs:string', 0, 1, {'use': 'optional', 'name': 'status'}),
