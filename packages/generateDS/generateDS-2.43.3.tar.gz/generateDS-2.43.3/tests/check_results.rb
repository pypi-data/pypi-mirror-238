...
$commands = [
  ...
  "diff -u simpletype_list1_sub.py simpletype_list2_sub.py",
  "diff -u simpletype_list1_sup.py simpletype_list2_sup.py",
  "diff -u relative_import1_sup.py relative_import2_sup.py",
  "diff -u relative_import1_sub.py relative_import2_sub.py",
  "diff -u anycontent1_sup.py anycontent2_sup.py",
  "diff -u anycontent1_sub.py anycontent2_sub.py",
  "diff -u doc_strings1_sub.py doc_strings2_sub.py",
  "diff -u recursive_generator_method1_sup.py recursive_generator_method2_sup.py",
  "diff -u recursive_generator_method1_sub.py recursive_generator_method2_sub.py",
  "diff -u episodic_second2.py episodic_second.py",
  "diff -u people_graphql1.py people_graphql2.py",
  "diff -u type_substitution1.py type_substitution2.py",
]
