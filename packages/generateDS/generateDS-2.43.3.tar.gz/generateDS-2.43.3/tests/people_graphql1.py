...
#   ('--member-specs', 'dict')
#   ('-f', '')
#   ('--graphql', 'people:people')
#   ('-o', 'tests/people_graphql2.py')
#
# Command line arguments:
#   tests/people.xsd
#
# Command line:
#   generateDS.py --no-dates --no-versions --silence --member-specs="dict" -f --graphql="people:people" -o "tests/people_graphql2.py" tests/people.xsd
#
...
# strawberry
import typing as typing_
import strawberry as strawberry_
from strawberry.schema.config import StrawberryConfig as StrawberryConfig_
from typing import List as List_
from typing import Annotated as Annotated_
from strawberry import lazy as lazy_
from strawberry.types import Info as Info_
Gds_graphql_root_obj = None
...
class people(GeneratedsSuper):
    ...
    member_data_items_ = {
        'comments': MemberSpec_('comments', 'comments', 1, 0, {'maxOccurs': 'unbounded', 'name': 'comments', 'type': 'comments'}, None),
        'person': MemberSpec_('person', 'person', 1, 0, {'maxOccurs': 'unbounded', 'name': 'person', 'type': 'person'}, None),
        'programmer': MemberSpec_('programmer', 'programmer', 1, 0, {'maxOccurs': 'unbounded', 'name': 'programmer', 'type': 'programmer'}, None),
        'python_programmer': MemberSpec_('python_programmer', 'python-programmer', 1, 0, {'maxOccurs': 'unbounded', 'name': 'python-programmer', 'type': 'python-programmer'}, None),
        'java_programmer': MemberSpec_('java_programmer', 'java-programmer', 1, 0, {'maxOccurs': 'unbounded', 'name': 'java-programmer', 'type': 'java-programmer'}, None),
    }
    subclass = None
    superclass = None
    ...
    def get_gql_obj(self):
        return self.gql_this_obj
    def gds_fill_gql_obj(self):
        self.gql_this_obj.comments = []
        for gds_item in self.get_comments():
            gql_item = gds_item.gds_make_gql_obj()
            self.gql_this_obj.comments.append(gql_item)
        self.gql_this_obj.person = []
        for gds_item in self.get_person():
            gql_item = gds_item.gds_make_gql_obj()
            self.gql_this_obj.person.append(gql_item)
        self.gql_this_obj.programmer = []
        for gds_item in self.get_programmer():
            gql_item = gds_item.gds_make_gql_obj()
            self.gql_this_obj.programmer.append(gql_item)
        self.gql_this_obj.python_programmer = []
        for gds_item in self.get_python_programmer():
            gql_item = gds_item.gds_make_gql_obj()
            self.gql_this_obj.python_programmer.append(gql_item)
        self.gql_this_obj.java_programmer = []
        for gds_item in self.get_java_programmer():
            gql_item = gds_item.gds_make_gql_obj()
            self.gql_this_obj.java_programmer.append(gql_item)
    def gds_make_gql_obj(self):
        self.gql_this_obj = GdsGraphQL_people()
        self.gds_fill_gql_obj()
        return self.gql_this_obj
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='people', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='people')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='people', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='people'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='people', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class comments(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'emp': MemberSpec_('emp', 'xs:string', 1, 0, {'maxOccurs': 'unbounded', 'name': 'emp', 'type': 'xs:string'}, None),
    ...
    def get_gql_obj(self):
        return self.gql_this_obj
    def gds_fill_gql_obj(self):
        self.gql_this_obj.emp = []
        for gds_item in self.get_emp():
            self.gql_this_obj.emp.append(gds_item)
    def gds_make_gql_obj(self):
        self.gql_this_obj = GdsGraphQL_comments()
        self.gds_fill_gql_obj()
        return self.gql_this_obj
    def has__content(self):
        if (
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='comments', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='comments')
        outfile.write('>')
        self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_, pretty_print=pretty_print)
        outfile.write(self.convert_unicode(self.valueOf_))
        outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='comments'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='comments', fromsubclass_=False, pretty_print=True):
...
class person(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'value': MemberSpec_('value', 'xs:string', 0, 1, {'use': 'optional', 'name': 'value'}),
        'id': MemberSpec_('id', 'xs:integer', 0, 1, {'use': 'optional', 'name': 'id'}),
        'ratio': MemberSpec_('ratio', 'xs:float', 0, 1, {'use': 'optional', 'name': 'ratio'}),
        'fruit': MemberSpec_('fruit', 'xs:string', 0, 1, {'use': 'optional', 'name': 'fruit'}),
        'vegetable': MemberSpec_('vegetable', 'xs:string', 0, 1, {'use': 'optional', 'name': 'vegetable'}),
        'name': MemberSpec_('name', 'xs:string', 0, 0, {'name': 'name', 'type': 'xs:string'}, None),
        'interest': MemberSpec_('interest', 'xs:string', 1, 0, {'maxOccurs': 'unbounded', 'name': 'interest', 'type': 'xs:string'}, None),
        'category': MemberSpec_('category', 'xs:integer', 0, 0, {'name': 'category', 'type': 'xs:integer'}, None),
        'agent': MemberSpec_('agent', 'agent', 1, 0, {'maxOccurs': 'unbounded', 'name': 'agent', 'type': 'agent'}, None),
        'promoter': MemberSpec_('promoter', 'booster', 1, 0, {'maxOccurs': 'unbounded', 'name': 'promoter', 'type': 'booster'}, None),
        'description': MemberSpec_('description', 'xs:string', 0, 0, {'name': 'description', 'type': 'xs:string'}, None),
    }
    subclass = None
    superclass = None
    ...
    def get_gql_obj(self):
        return self.gql_this_obj
    def gds_fill_gql_obj(self):
        self.gql_this_obj.interest = []
        for gds_item in self.get_interest():
            self.gql_this_obj.interest.append(gds_item)
        self.gql_this_obj.agent = []
        for gds_item in self.get_agent():
            gql_item = gds_item.gds_make_gql_obj()
            self.gql_this_obj.agent.append(gql_item)
        self.gql_this_obj.promoter = []
        for gds_item in self.get_promoter():
            gql_item = gds_item.gds_make_gql_obj()
            self.gql_this_obj.promoter.append(gql_item)
        self.gql_this_obj.name = self.get_name()
        self.gql_this_obj.category = self.get_category()
        self.gql_this_obj.description = self.get_description()
        self.gql_this_obj.value = self.get_value()
        self.gql_this_obj.id = self.get_id()
        self.gql_this_obj.ratio = self.get_ratio()
        self.gql_this_obj.fruit = self.get_fruit()
        self.gql_this_obj.vegetable = self.get_vegetable()
    def gds_make_gql_obj(self):
        self.gql_this_obj = GdsGraphQL_person()
        self.gds_fill_gql_obj()
        return self.gql_this_obj
    def has__content(self):
        if (
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='person', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='person')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='person', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='person'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='person', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class programmer(person):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'language': MemberSpec_('language', 'xs:string', 0, 1, {'use': 'optional', 'name': 'language'}),
        'area': MemberSpec_('area', 'xs:string', 0, 1, {'use': 'optional', 'name': 'area'}),
        'attrposint': MemberSpec_('attrposint', 'xs:positiveInteger', 0, 1, {'use': 'optional', 'name': 'attrposint'}),
        'attrnonposint': MemberSpec_('attrnonposint', 'xs:nonPositiveInteger', 0, 1, {'use': 'optional', 'name': 'attrnonposint'}),
        'attrnegint': MemberSpec_('attrnegint', 'xs:negativeInteger', 0, 1, {'use': 'optional', 'name': 'attrnegint'}),
        'attrnonnegint': MemberSpec_('attrnonnegint', 'xs:nonNegativeInteger', 0, 1, {'use': 'optional', 'name': 'attrnonnegint'}),
        'email': MemberSpec_('email', 'xs:string', 0, 0, {'name': 'email', 'type': 'xs:string'}, None),
        'elposint': MemberSpec_('elposint', 'xs:positiveInteger', 0, 0, {'name': 'elposint', 'type': 'xs:positiveInteger'}, None),
        'elnonposint': MemberSpec_('elnonposint', 'xs:nonPositiveInteger', 0, 0, {'name': 'elnonposint', 'type': 'xs:nonPositiveInteger'}, None),
        'elnegint': MemberSpec_('elnegint', 'xs:negativeInteger', 0, 0, {'name': 'elnegint', 'type': 'xs:negativeInteger'}, None),
        'elnonnegint': MemberSpec_('elnonnegint', 'xs:nonNegativeInteger', 0, 0, {'name': 'elnonnegint', 'type': 'xs:nonNegativeInteger'}, None),
        'eldate': MemberSpec_('eldate', 'xs:date', 0, 0, {'name': 'eldate', 'type': 'xs:date'}, None),
        'eldatetime': MemberSpec_('eldatetime', 'xs:dateTime', 0, 0, {'name': 'eldatetime', 'type': 'xs:dateTime'}, None),
        'eltoken': MemberSpec_('eltoken', 'xs:token', 0, 0, {'name': 'eltoken', 'type': 'xs:token'}, None),
        'elshort': MemberSpec_('elshort', 'xs:short', 0, 0, {'name': 'elshort', 'type': 'xs:short'}, None),
        'ellong': MemberSpec_('ellong', 'xs:long', 0, 0, {'name': 'ellong', 'type': 'xs:long'}, None),
        'elparam': MemberSpec_('elparam', 'param', 0, 0, {'name': 'elparam', 'type': 'param'}, None),
        'elarraytypes': MemberSpec_('elarraytypes', ['ArrayTypes', 'xs:NMTOKEN'], 0, 0, {'name': 'elarraytypes', 'type': 'xs:NMTOKEN'}, None),
    }
    subclass = None
    superclass = person
    ...
    def get_gql_obj(self):
        return self.gql_this_obj
    def gds_fill_gql_obj(self):
        self.gql_this_obj.email = self.get_email()
        self.gql_this_obj.elposint = self.get_elposint()
        self.gql_this_obj.elnonposint = self.get_elnonposint()
        self.gql_this_obj.elnegint = self.get_elnegint()
        self.gql_this_obj.elnonnegint = self.get_elnonnegint()
        self.gql_this_obj.eldate = self.get_eldate()
        self.gql_this_obj.eldatetime = self.get_eldatetime()
        self.gql_this_obj.eltoken = self.get_eltoken()
        self.gql_this_obj.elshort = self.get_elshort()
        self.gql_this_obj.ellong = self.get_ellong()
        self.gql_this_obj.elparam = self.get_elparam()
        self.gql_this_obj.elarraytypes = self.get_elarraytypes()
        self.gql_this_obj.language = self.get_language()
        self.gql_this_obj.area = self.get_area()
        self.gql_this_obj.attrposint = self.get_attrposint()
        self.gql_this_obj.attrnonposint = self.get_attrnonposint()
        self.gql_this_obj.attrnegint = self.get_attrnegint()
        self.gql_this_obj.attrnonnegint = self.get_attrnonnegint()
        super().gds_fill_gql_obj()
    def gds_make_gql_obj(self):
        self.gql_this_obj = GdsGraphQL_programmer()
        self.gds_fill_gql_obj()
        return self.gql_this_obj
    ...
    def has__content(self):
        if (
            ...
            super(programmer, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='programmer', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='programmer')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='programmer', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='programmer'):
        super(programmer, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='programmer')
        ...
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            ...
            if ":" not in self.extensiontype_:
                ...
                outfile.write(' xsi:type="%s"' % self.extensiontype_)
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='programmer', fromsubclass_=False, pretty_print=True):
        super(programmer, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'xsi:type' not in already_processed:
            already_processed.add('xsi:type')
            self.extensiontype_ = value
        super(programmer, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'email':
            value_ = child_.text
            ...
            self.validate_ArrayTypes(self.elarraytypes)
        super(programmer, self)._buildChildren(child_, node, nodeName_, True)
# end class programmer


class param(GeneratedsSuper):
    """param -- Finding flow attribute unneccesary in practice. A unnamed parameter is unbound/skipped.
    
    """
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'id': MemberSpec_('id', 'xs:string', 0, 1, {'use': 'optional', 'name': 'id'}),
        'name': MemberSpec_('name', 'xs:NCName', 0, 1, {'use': 'optional', 'name': 'name'}),
        'sid': MemberSpec_('sid', 'xs:NCName', 0, 1, {'use': 'optional', 'name': 'sid'}),
        'flow': MemberSpec_('flow', 'FlowType', 0, 1, {'use': 'optional', 'name': 'flow'}),
        'semantic': MemberSpec_('semantic', 'xs:token', 0, 1, {'use': 'optional', 'name': 'semantic'}),
        'type_': MemberSpec_('type_', 'xs:NMTOKEN', 0, 0, {'use': 'required', 'name': 'type_'}),
    ...
    def gds_fill_gql_obj(self):
        self.gql_this_obj.id = self.get_id()
        self.gql_this_obj.name = self.get_name()
        self.gql_this_obj.sid = self.get_sid()
        self.gql_this_obj.flow = self.get_flow()
        self.gql_this_obj.semantic = self.get_semantic()
        self.gql_this_obj.type_ = self.get_type()
    def gds_make_gql_obj(self):
        self.gql_this_obj = GdsGraphQL_param()
        self.gds_fill_gql_obj()
        return self.gql_this_obj
    def has__content(self):
        if (
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='param', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='param')
        outfile.write('>')
        self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_, pretty_print=pretty_print)
        outfile.write(self.convert_unicode(self.valueOf_))
        outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='param'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='param', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class python_programmer(programmer):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'nick_name': MemberSpec_('nick_name', 'xs:string', 0, 1, {'use': 'optional', 'name': 'nick-name'}),
        'favorite_editor': MemberSpec_('favorite_editor', 'xs:string', 0, 0, {'name': 'favorite-editor', 'type': 'xs:string'}, None),
    }
    subclass = None
    ...
    def get_gql_obj(self):
        return self.gql_this_obj
    def gds_fill_gql_obj(self):
        self.gql_this_obj.favorite_editor = self.get_favorite_editor()
        self.gql_this_obj.nick_name = self.get_nick_name()
        super().gds_fill_gql_obj()
    def gds_make_gql_obj(self):
        self.gql_this_obj = GdsGraphQL_python_programmer()
        self.gds_fill_gql_obj()
        return self.gql_this_obj
    def has__content(self):
        if (
            self.favorite_editor is not None or
            super(python_programmer, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='python-programmer', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='python-programmer')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='python-programmer', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='python-programmer'):
        super(python_programmer, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='python-programmer')
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='python-programmer', fromsubclass_=False, pretty_print=True):
        super(python_programmer, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        super(python_programmer, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        super(python_programmer, self)._buildChildren(child_, node, nodeName_, True)
...
class java_programmer(programmer):
    ...
    member_data_items_ = {
        'nick_name': MemberSpec_('nick_name', 'xs:string', 0, 1, {'use': 'optional', 'name': 'nick-name'}),
        'status': MemberSpec_('status', 'xs:string', 0, 1, {'use': 'optional', 'name': 'status'}),
        'favorite_editor': MemberSpec_('favorite_editor', 'xs:string', 0, 0, {'name': 'favorite-editor', 'type': 'xs:string'}, None),
    }
    subclass = None
    superclass = programmer
    ...
    def gds_fill_gql_obj(self):
        self.gql_this_obj.favorite_editor = self.get_favorite_editor()
        self.gql_this_obj.nick_name = self.get_nick_name()
        self.gql_this_obj.status = self.get_status()
        super().gds_fill_gql_obj()
    def gds_make_gql_obj(self):
        self.gql_this_obj = GdsGraphQL_java_programmer()
        self.gds_fill_gql_obj()
        return self.gql_this_obj
    def has__content(self):
        if (
            self.favorite_editor is not None or
            super(java_programmer, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='java-programmer', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='java-programmer')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='java-programmer', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='java-programmer'):
        super(java_programmer, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='java-programmer')
        if self.nick_name is not None and 'nick_name' not in already_processed:
            already_processed.add('nick_name')
            outfile.write(' nick-name=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.nick_name), input_name='nick-name')), ))
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='java-programmer', fromsubclass_=False, pretty_print=True):
        super(java_programmer, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'status' not in already_processed:
            already_processed.add('status')
            self.status = value
        super(java_programmer, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'favorite-editor':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'favorite_editor')
            ...
            self.favorite_editor = value_
            self.favorite_editor_nsprefix_ = child_.prefix
        super(java_programmer, self)._buildChildren(child_, node, nodeName_, True)
...
class agent(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = {
        'firstname': MemberSpec_('firstname', 'xs:string', 0, 0, {'name': 'firstname', 'type': 'xs:string'}, None),
        'lastname': MemberSpec_('lastname', 'xs:string', 0, 0, {'name': 'lastname', 'type': 'xs:string'}, None),
        'priority': MemberSpec_('priority', 'xs:float', 0, 0, {'name': 'priority', 'type': 'xs:float'}, None),
        'info': MemberSpec_('info', 'info', 0, 0, {'name': 'info', 'type': 'info'}, None),
    }
    subclass = None
    superclass = None
    ...
    def get_gql_obj(self):
        return self.gql_this_obj
    def gds_fill_gql_obj(self):
        self.gql_this_obj.firstname = self.get_firstname()
        self.gql_this_obj.lastname = self.get_lastname()
        self.gql_this_obj.priority = self.get_priority()
        self.gql_this_obj.info = self.get_info()
    def gds_make_gql_obj(self):
        self.gql_this_obj = GdsGraphQL_agent()
        self.gds_fill_gql_obj()
        return self.gql_this_obj
    def has__content(self):
        if (
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='agent', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='agent')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='agent', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='agent'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='agent', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class special_agent(GeneratedsSuper):
    ...
    def gds_fill_gql_obj(self):
        ...
        self.gql_this_obj.info = self.get_info()
    def gds_make_gql_obj(self):
        self.gql_this_obj = GdsGraphQL_special_agent()
        self.gds_fill_gql_obj()
        return self.gql_this_obj
    def has__content(self):
        if (
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='special-agent', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='special-agent')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='special-agent', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='special-agent'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='special-agent', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class booster(GeneratedsSuper):
    ...
    member_data_items_ = {
        'firstname': MemberSpec_('firstname', 'xs:string', 0, 0, {'name': 'firstname', 'type': 'xs:string'}, None),
        'lastname': MemberSpec_('lastname', 'xs:string', 0, 0, {'name': 'lastname', 'type': 'xs:string'}, None),
        'other_name': MemberSpec_('other_name', 'xs:float', 0, 0, {'name': 'other-name', 'type': 'xs:float'}, None),
        'class_': MemberSpec_('class_', 'xs:float', 0, 0, {'name': 'class', 'type': 'xs:float'}, None),
        'other_value': MemberSpec_('other_value', 'xs:float', 1, 0, {'maxOccurs': 'unbounded', 'name': 'other-value', 'type': 'xs:float'}, None),
        'type_': MemberSpec_('type_', 'xs:float', 1, 0, {'maxOccurs': 'unbounded', 'name': 'type', 'type': 'xs:float'}, None),
        'client_handler': MemberSpec_('client_handler', 'client-handlerType', 1, 0, {'maxOccurs': 'unbounded', 'name': 'client-handler', 'type': 'client-handlerType'}, None),
    }
    subclass = None
    superclass = None
    ...
    def get_gql_obj(self):
        return self.gql_this_obj
    def gds_fill_gql_obj(self):
        self.gql_this_obj.other_value = []
        for gds_item in self.get_other_value():
            self.gql_this_obj.other_value.append(gds_item)
        self.gql_this_obj.type_ = []
        for gds_item in self.get_type():
            self.gql_this_obj.type_.append(gds_item)
        self.gql_this_obj.client_handler = []
        for gds_item in self.get_client_handler():
            gql_item = gds_item.gds_make_gql_obj()
            self.gql_this_obj.client_handler.append(gql_item)
        self.gql_this_obj.firstname = self.get_firstname()
        self.gql_this_obj.lastname = self.get_lastname()
        self.gql_this_obj.other_name = self.get_other_name()
        self.gql_this_obj.class_ = self.get_class()
    def gds_make_gql_obj(self):
        self.gql_this_obj = GdsGraphQL_booster()
        self.gds_fill_gql_obj()
        return self.gql_this_obj
    def has__content(self):
        if (
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='booster', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='booster')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='booster', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='booster'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='booster', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class info(GeneratedsSuper):
    ...
    member_data_items_ = {
        ...
        'type_': MemberSpec_('type_', 'xs:integer', 0, 1, {'use': 'optional', 'name': 'type_'}),
        'rating': MemberSpec_('rating', 'xs:float', 0, 1, {'use': 'optional', 'name': 'rating'}),
    }
    subclass = None
    superclass = None
    ...
    def gds_fill_gql_obj(self):
        self.gql_this_obj.name = self.get_name()
        self.gql_this_obj.type_ = self.get_type()
        self.gql_this_obj.rating = self.get_rating()
    def gds_make_gql_obj(self):
        self.gql_this_obj = GdsGraphQL_info()
        self.gds_fill_gql_obj()
        return self.gql_this_obj
    def has__content(self):
        if (
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='info', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='info')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='info', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='info'):
        if self.name is not None and 'name' not in already_processed:
            already_processed.add('name')
            outfile.write(' name=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.name), input_name='name')), ))
        if self.type_ is not None and 'type_' not in already_processed:
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='info', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class client_handlerType(GeneratedsSuper):
    ...
    member_data_items_ = {
        ...
        'refid': MemberSpec_('refid', 'xs:integer', 0, 0, {'name': 'refid', 'type': 'xs:integer'}, None),
    }
    subclass = None
    superclass = None
    ...
    def get_gql_obj(self):
        return self.gql_this_obj
    def gds_fill_gql_obj(self):
        self.gql_this_obj.fullname = self.get_fullname()
        self.gql_this_obj.refid = self.get_refid()
    def gds_make_gql_obj(self):
        self.gql_this_obj = GdsGraphQL_client_handlerType()
        self.gds_fill_gql_obj()
        return self.gql_this_obj
    def has__content(self):
        if (
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='client-handlerType', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='client-handlerType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='client-handlerType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='client-handlerType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='client-handlerType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
GdsGraphQL_Module_ = f"{sys.argv[2]}"

@strawberry_.type
class GdsGraphQL_people:
    comments: List_[Annotated_["GdsGraphQL_comments", lazy_(GdsGraphQL_Module_)]] | None = None
    person: List_[Annotated_["GdsGraphQL_person", lazy_(GdsGraphQL_Module_)]] | None = None
    programmer: List_[Annotated_["GdsGraphQL_programmer", lazy_(GdsGraphQL_Module_)]] | None = None
    python_programmer: List_[Annotated_["GdsGraphQL_python_programmer", lazy_(GdsGraphQL_Module_)]] | None = None
    java_programmer: List_[Annotated_["GdsGraphQL_java_programmer", lazy_(GdsGraphQL_Module_)]] | None = None

@strawberry_.type
class GdsGraphQL_comments:
    emp: List_[str | None] = None
    @strawberry_.field
    def character_content(self) -> str :
        return self.valueOf_

@strawberry_.type
class GdsGraphQL_person:
    name: str | None = None
    interest: List_[str | None] = None
    category: int | None = None
    promoter: List_[Annotated_["GdsGraphQL_booster", lazy_(GdsGraphQL_Module_)]] | None = None
...
@strawberry_.type
class GdsGraphQL_programmer(GdsGraphQL_person):
    email: str | None = None
    elposint: int | None = None
    elnonposint: int | None = None
    elnegint: int | None = None
    elnonnegint: int | None = None
    eldate: datetime_.date | None = None
    eldatetime: datetime_.datetime | None = None
    eltoken: str | None = None
    elshort: int | None = None
    ellong: int | None = None
    elparam: Annotated_["GdsGraphQL_param", lazy_(GdsGraphQL_Module_)] | None = None
    elarraytypes: str | None = None
    language: str | None = None
    area: str | None = None
    attrposint: int | None = None
    attrnonposint: int | None = None
    attrnegint: int | None = None
    attrnonnegint: int | None = None

@strawberry_.type
class GdsGraphQL_param:
    id: str | None = None
    name: str | None = None
    sid: str | None = None
    flow: str | None = None
...
@strawberry_.type
class GdsGraphQL_python_programmer(GdsGraphQL_programmer):
    favorite_editor: str | None = None
    nick_name: str | None = None

@strawberry_.type
class GdsGraphQL_java_programmer(GdsGraphQL_programmer):
    favorite_editor: str | None = None
    nick_name: str | None = None
    status: str | None = None

@strawberry_.type
class GdsGraphQL_agent:
    firstname: str | None = None
    lastname: str | None = None
    priority: float | None = None
    info: Annotated_["GdsGraphQL_info", lazy_(GdsGraphQL_Module_)] | None = None

@strawberry_.type
class GdsGraphQL_special_agent:
    firstname: str | None = None
    lastname: str | None = None
    priority: float | None = None
    info: Annotated_["GdsGraphQL_info", lazy_(GdsGraphQL_Module_)] | None = None
...
@strawberry_.type
class GdsGraphQL_booster:
    firstname: str | None = None
    lastname: str | None = None
    other_name: float | None = None
    class_: float | None = None
    other_value: List_[float | None] = None
    type_: List_[float | None] = None
    client_handler: List_[Annotated_["GdsGraphQL_client_handlerType", lazy_(GdsGraphQL_Module_)]] | None = None

@strawberry_.type
class GdsGraphQL_info:
    name: str | None = None
    type_: int | None = None
    rating: float | None = None

@strawberry_.type
class GdsGraphQL_client_handlerType:
    fullname: str | None = None
    refid: int | None = None


GraphQL_firsttime = True
GraphQL_gds_data_root = None
GraphQL_gds_root_class = None
GraphQL_data_root = None
GraphQL_xml_root_node = None

def gds_graphql_initialize(graphQL_gds_env):
    global GraphQL_firsttime, GraphQL_gds_data_root, GraphQL_gds_root_class, GraphQL_data_root, GraphQL_xml_root_node
    #import ipdb; ipdb.set_trace()
    if GraphQL_firsttime:
        GraphQL_firsttime = False
        inFileName = graphQL_gds_env
        if not inFileName:
            sys.exit('*** Must set environment variable -- GRAPHQL_ARGS="input_xml_data.xml"')
        rootObj, rootClass, doc = parseGraphQL(inFileName)
        GraphQL_xml_root_node = doc.getroot()
        GraphQL_gds_data_root = rootObj
        GraphQL_gds_root_class = rootClass
        # GraphQL_data_root = GraphQL_gds_data_root.gds_make_gql_obj()
        GraphQL_data_root = GraphQL_gds_data_root
    return GraphQL_data_root

def get_gds_graphql_obj():
    return GraphQL_data_root

@strawberry_.type
class Query:
    people: GdsGraphQL_people = strawberry_.field(resolver=get_gds_graphql_obj)

schema = strawberry_.Schema(query=Query, config=StrawberryConfig_(auto_camel_case=False))
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
##     if not silence:
##         sys.stdout.write('#from people_graphql2 import *\n\n')
##         sys.stdout.write('import people_graphql2 as model_\n\n')
...
GraphQL_gds_env = os.getenv('GRAPHQL_ARGS')
if GraphQL_gds_env:
    gds_graphql_initialize(GraphQL_gds_env)
