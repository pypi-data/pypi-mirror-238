...
class tomato_programmer(tomato_person):
    ...
    def has__content(self):
        if (
            ...
            super(tomato_programmer, self).has__content()
        ):
            return True
        else:
            return False
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='programmer'):
        super(tomato_programmer, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='programmer')
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='programmer', fromsubclass_=False, pretty_print=True):
        super(tomato_programmer, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'xsi:type' not in already_processed:
            already_processed.add('xsi:type')
            self.extensiontype_ = value
        super(tomato_programmer, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'email':
            value_ = child_.text
            ...
            self.validate_ArrayTypes(self.elarraytypes)
        super(tomato_programmer, self)._buildChildren(child_, node, nodeName_, True)
...
class tomato_python_programmer(tomato_programmer):
    ...
    def has__content(self):
        if (
            ...
            super(tomato_python_programmer, self).has__content()
        ):
            return True
        else:
            return False
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='python-programmer'):
        super(tomato_python_programmer, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='python-programmer')
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='python-programmer', fromsubclass_=False, pretty_print=True):
        super(tomato_python_programmer, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        super(tomato_python_programmer, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        super(tomato_python_programmer, self)._buildChildren(child_, node, nodeName_, True)
...
class tomato_java_programmer(tomato_programmer):
    ...
    def has__content(self):
        if (
            self.favorite_editor is not None or
            super(tomato_java_programmer, self).has__content()
        ):
            return True
        else:
            return False
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='java-programmer'):
        super(tomato_java_programmer, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='java-programmer')
        if self.nick_name is not None and 'nick_name' not in already_processed:
            already_processed.add('nick_name')
            outfile.write(' nick-name=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.nick_name), input_name='nick-name')), ))
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='java-programmer', fromsubclass_=False, pretty_print=True):
        super(tomato_java_programmer, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'status' not in already_processed:
            already_processed.add('status')
            self.status = value
        super(tomato_java_programmer, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'favorite-editor':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'favorite_editor')
            ...
            self.favorite_editor = value_
            self.favorite_editor_nsprefix_ = child_.prefix
        super(tomato_java_programmer, self)._buildChildren(child_, node, nodeName_, True)
