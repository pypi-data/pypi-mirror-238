...
class tGeoData(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('extraHeight', 'xs:double', 0, 1, {'use': 'optional', 'name': 'extraHeight'}),
        MemberSpec_('extraData', 'tFloat', 0, 1, {'use': 'optional', 'name': 'extraData'}),
        MemberSpec_('doubleListData', 'tDoubleListRestriction', 0, 0, {'use': 'required', 'name': 'doubleListData'}),
        MemberSpec_('integerListData', 'tIntegerListRestriction', 0, 1, {'use': 'optional', 'name': 'integerListData'}),
        MemberSpec_('floatListData', 'tFloatListRestriction', 0, 1, {'use': 'optional', 'name': 'floatListData'}),
        MemberSpec_('dateTimeListData', 'tDateTimeListRestriction', 0, 1, {'use': 'optional', 'name': 'dateTimeListData'}),
        MemberSpec_('dateListData', 'tDateListRestriction', 0, 1, {'use': 'optional', 'name': 'dateListData'}),
        MemberSpec_('timeListData', 'tTimeListRestriction', 0, 1, {'use': 'optional', 'name': 'timeListData'}),
        MemberSpec_('booleanListData', 'tBooleanListRestriction', 0, 1, {'use': 'optional', 'name': 'booleanListData'}),
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='tGeoData', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='tGeoData')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='tGeoData', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='tGeoData'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='tGeoData', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'doubleListData' not in already_processed:
            already_processed.add('doubleListData')
            self.gds_validate_double_list(value, node, 'doubleListData')
        ...
        if value is not None and 'integerListData' not in already_processed:
            already_processed.add('integerListData')
            self.gds_validate_integer_list(value, node, 'integerListData')
        ...
        if value is not None and 'floatListData' not in already_processed:
            already_processed.add('floatListData')
            self.gds_validate_float_list(value, node, 'floatListData')
        ...
        if value is not None and 'booleanListData' not in already_processed:
            already_processed.add('booleanListData')
            self.gds_validate_boolean_list(value, node, 'booleanListData')
