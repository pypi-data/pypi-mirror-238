...
class dummy(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('test_ref_attr', 'xs:integer', 0, 1, {'use': 'optional', 'name': 'test_ref_attr'}),
        MemberSpec_('test_normal_attr', 'xs:integer', 0, 1, {'use': 'optional', 'name': 'test_normal_attr'}),
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='dummy', pretty_print=True):
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='dummy')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='dummy', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='dummy'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='dummy', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
