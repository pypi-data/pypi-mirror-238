...
def fake_phone(value: str) -> bool:
    ...
    return any(
        fake in value
        for fake in (
            '0000', '1111', '2222', '3333', '4444', '5555', '6666', '8888',
            '77777', # KZ: 7777
            '9999', '1234', '9876',
...
def fake_login(value: str) -> bool:
    ...
    return any(
        ...
        for fake in (
            ...
            'ыва', 'фыв', 'йцу',
            'aaaa', 'bbb', 'ccc', 'rrr', 'zzz',
            'ааа', 'ббб', 'ввв', 'ггг', 'ддд', 'еее', 'ёёё', 'жжж', 'ззз',
            'иии', 'ййй', 'ккк', 'ллл', 'ммм', 'ннн', 'ооо', 'ппп', 'ррр',
            'ссс', 'ттт', 'ууу', 'ффф', 'ххх', 'ццц', 'ччч', 'шшш', 'щщщ',
            'ъъъ', 'ыыы', 'ььь', 'эээ', 'ююю', 'яяя',
        )
    )
