...
class NbData:  # pylint: disable=R0902
    ...
    def __init__(self, **kwargs):
        ...
        ipam
        :param aggregates: List of ipam/aggregates objects.
        :param asn_ranges: List of ipam/asn-ranges objects.
        :param asns: List of ipam/asns objects.
        :param ip_addresses: List of ipam/ip-addresses objects.
        :param prefixes: List of ipam/prefixes objects.
        :param rirs: List of ipam/rirs objects.
        :param vlans: List of ipam/vlans objects.

        dcim
        :param sites: List of dcim/sites objects.
        :param devices: List of dcim/devices objects.

        circuits
        :param circuit_types: List of circuits/circuit_types objects.
        :param circuits: List of circuits/circuits objects.
        :param providers: List of circuits/providers objects.
        :param circuit_terminations: List of circuits/circuit-terminations objects.

        tenancy
        :param tenant_groups: List of tenancy/tenant-groups objects.
        :param tenants: List of tenancy/tenants objects.
        ...
        self.rirs: LDAny = list(kwargs.get("rirs") or [])
    ...
    def _join_aggregates(self) -> None:
        """Join aggregates.
    ...
    def _join_asn_ranges(self) -> None:
        """Join asn_ranges.
    ...
    def _join_rirs(self) -> None:
        """Stub."""

    def _join_ip_addresses(self) -> None:
        """Join ip-addresses.
