...
class Ipam:  # pylint: disable=R0902,R0903
    ...
    class IpAddresses(Base):
        ...
        def get(self, **kwargs) -> LDAny:
            ...
            :param parent: Parent Prefix. IP addresses that are part of this prefix.
    ...
    class Rirs(Base):
        ...
        # noinspection PyIncorrectDocstring
        def get(self, **kwargs) -> LDAny:
            """Get ipam/rirs/ objects.

            WEB UI filter parameters
            ------------------------

            :param q: RIR substring.
            :type q: str or List[str]
            :example q: ["10.0.0.", "10.31.65."]

            :param is_private: Private.
