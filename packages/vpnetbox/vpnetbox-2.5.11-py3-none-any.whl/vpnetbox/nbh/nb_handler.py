...
class NbHandler:  # pylint: disable=R0904
    ...
    def get_rirs(self, **kwargs) -> None:
        """Get Netbox ipam/rirs objects by using the filter parameters in kwargs.

        :param kwargs: Filter parameters are described in the RIRs object.
        :return: None. Update self object.
        """
        self.nbd.rirs = self.api.ipam.rirs.get(**kwargs)
