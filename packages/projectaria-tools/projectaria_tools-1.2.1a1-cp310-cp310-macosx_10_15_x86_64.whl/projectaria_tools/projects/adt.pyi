...
class AriaDigitalTwinDataProvider:
    ...
    def get_aria_3d_pose_by_timestamp_ns(self, device_timestamp_ns: int, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> Aria3dPoseDataWithDt:
        ...
        """
    def get_aria_all_streams(self) -> list[projectaria_tools.core.stream_id.StreamId]:
        """
        ...
        """
    def get_aria_camera_calibration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.calibration.CameraCalibration | None:
        """
        Get the camera calibration of an Aria camera, including intrinsics, distortion params,and projection functions.
        """
    def get_aria_device_capture_timestamps_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> list[int]:
        """
        Get all timestamps (in ns) of all observations of an Aria sensor, in `TimeDomain::DeviceTime`.
        """
    def get_aria_image_by_timestamp_ns(self, device_time_stamp_ns: int, stream_id: projectaria_tools.core.stream_id.StreamId, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> AriaImageDataWithDt:
        """
        Query an Aria camera image by timestamp
        """
    def get_aria_transform_device_camera(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> SE3:
        """
        Get the pose of an Aria camera in the device coordinate frame.
        """
    def get_depth_image_by_timestamp_ns(self, device_timestamp_ns: int, stream_id: projectaria_tools.core.stream_id.StreamId, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> DepthDataWithDt:
        """
    ...
    def get_instance_info_by_id(self, instance_id: int) -> InstanceInfo:
        ...
        """
    def get_object_2d_boundingboxes_by_timestamp_ns(self, device_timestamp_ns: int, stream_id: projectaria_tools.core.stream_id.StreamId, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> BoundingBox2dDataWithDt:
        """
    ...
    def get_object_ids(self) -> list[int]:
        ...
        """
    def get_segmentation_image_by_timestamp_ns(self, device_timestamp_ns: int, stream_id: projectaria_tools.core.stream_id.StreamId, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> SegmentationDataWithDt:
        """
        Query a camera's segmentation image by timestamp
        """
    def get_skeleton_2d_boundingboxes_by_timestamp_ns(self, device_timestamp_ns: int, stream_id: projectaria_tools.core.stream_id.StreamId, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> BoundingBox2dDataWithDt:
        """
    ...
    def get_start_time_ns(self) -> int:
        ...
        """
    def get_synthetic_image_by_timestamp_ns(self, device_timestamp_ns: int, stream_id: projectaria_tools.core.stream_id.StreamId, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> SyntheticDataWithDt:
        """
