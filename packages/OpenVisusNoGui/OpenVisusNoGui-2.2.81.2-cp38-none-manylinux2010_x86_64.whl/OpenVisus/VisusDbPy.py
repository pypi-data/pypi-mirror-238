...
class Access(object):
    ...
    @staticmethod
    def getBlockFilename(filename_template, field, time, compression, blockid, reverse_filename):
        return _VisusDbPy.Access_getBlockFilename(filename_template, field, time, compression, blockid, reverse_filename)

    def guessCompression(self, field):
        return _VisusDbPy.Access_guessCompression(self, field)

    def setWritingMode(self):
        return _VisusDbPy.Access_setWritingMode(self)
