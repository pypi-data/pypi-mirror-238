...
class Input(itemBase):
    def __init__(self, screen: Screen, xy=(0, 0), wh=(200, 50), InputType="text", color="white"):
    ...
    def _text(self):
        if self.IT == "text":
            return pygame.font.SysFont("Ariel", self.wh[1]-20, True).render(self.text, False, "black")
        elif self.IT == "password":
            return pygame.font.SysFont("Ariel", self.wh[1]-20, True).render("*"*len(self.text), False, "black")
