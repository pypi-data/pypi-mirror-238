...
class GearToolkitContext:
    ...
    def init_logging(self, default_config_name=None, update_config=None):
        ...
        if default_config_name == "debug":
            # NOTE: The "filename" key defaults to "job.log" in the default config.
            #       This enables tests to run without having to specify or create a
            #       /flywheel/v0/output directory.
