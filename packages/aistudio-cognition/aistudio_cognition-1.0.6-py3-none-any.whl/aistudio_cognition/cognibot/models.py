...
class AIStudioDeploymentType(Enum):
    MINIKUBE = "Minikube"
    AZURE = "Azure"
    ON_PREM = "On-Prem"

    @classmethod
    def from_str(cls, deployment_type):
        if deployment_type.lower() == "minikube":
            return cls.MINIKUBE
        elif deployment_type.lower() == "azure":
            return cls.AZURE
        elif deployment_type.lower() == "on-prem":
            return cls.ON_PREM
...
class Cognibot:
    ...
    deployment_type: AIStudioDeploymentType
    skills: list[Skill]
