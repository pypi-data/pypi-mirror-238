...
# -*- encoding: utf-8 -*-
'''
@File     : DIANN_quantification_L_20200210.py
@Time     : 2023/05/02 00:06:20
@Author   : RanPeng 
...
def TsvHandle(csvs):
    ...
    return pd.merge(
        gene_grouped, gene_data, how='inner', left_index=True, right_on='Symbol',
    )
...
if __name__ == "__main__":
    ...
    q = 0.05
    path = "/Volumes/Samsung_T5/immuno_threapy/download/"
    out_path = (
        '/Volumes/Samsung_T5/immuno_threapy/pep_cv03_rawdata_20230510_ge2_q0.05-1/'
    )
