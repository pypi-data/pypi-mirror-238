...
class OdpClient(BaseModel):
    ...
    def create_file(
        self, file_name: str, dataset_name: str, mime_type: str, metadata: Dict, geo_location: Dict, delay: int = 5
    ):
        ...
        return next(
            self._request(
                ...
                json={"name": file_name, "mime_type": mime_type, "metadata": metadata, "geo_location": geo_location},
            )
        )
