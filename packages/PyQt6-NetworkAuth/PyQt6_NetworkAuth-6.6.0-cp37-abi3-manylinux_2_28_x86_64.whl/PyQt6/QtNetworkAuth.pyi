...
class QAbstractOAuth(QtCore.QObject):
    ...
    def resourceOwnerAuthorization(self, url: QtCore.QUrl, parameters: typing.Dict[typing.Optional[str], typing.Sequence[typing.Any]]) -> None: ...
    ...
    def deleteResource(self, url: QtCore.QUrl, parameters: typing.Dict[typing.Optional[str], typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    def put(self, url: QtCore.QUrl, parameters: typing.Dict[typing.Optional[str], typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    def post(self, url: QtCore.QUrl, parameters: typing.Dict[typing.Optional[str], typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    def get(self, url: QtCore.QUrl, parameters: typing.Dict[typing.Optional[str], typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    def head(self, url: QtCore.QUrl, parameters: typing.Dict[typing.Optional[str], typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
...
class QAbstractOAuth2(QAbstractOAuth):
    ...
    def get(self, url: QtCore.QUrl, parameters: typing.Dict[typing.Optional[str], typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    def head(self, url: QtCore.QUrl, parameters: typing.Dict[typing.Optional[str], typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    def createAuthenticatedUrl(self, url: QtCore.QUrl, parameters: typing.Dict[typing.Optional[str], typing.Any] = ...) -> QtCore.QUrl: ...
...
class QOAuth1(QAbstractOAuth):
    ...
    @staticmethod
    def generateAuthorizationHeader(oauthParams: typing.Dict[typing.Optional[str], typing.Any]) -> QtCore.QByteArray: ...
    @staticmethod
    def nonce() -> QtCore.QByteArray: ...
    @typing.overload
    def setup(self, request: typing.Optional[QtNetwork.QNetworkRequest], signingParameters: typing.Dict[typing.Optional[str], typing.Any], operation: QtNetwork.QNetworkAccessManager.Operation) -> None: ...
    @typing.overload
    def setup(self, request: typing.Optional[QtNetwork.QNetworkRequest], signingParameters: typing.Dict[typing.Optional[str], typing.Any], operationVerb: typing.Union[QtCore.QByteArray, bytes, bytearray, memoryview]) -> None: ...
    def requestTokenCredentials(self, operation: QtNetwork.QNetworkAccessManager.Operation, url: QtCore.QUrl, temporaryToken: typing.Tuple[typing.Optional[str], typing.Optional[str]], parameters: typing.Dict[typing.Optional[str], typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    def requestTemporaryCredentials(self, operation: QtNetwork.QNetworkAccessManager.Operation, url: QtCore.QUrl, parameters: typing.Dict[typing.Optional[str], typing.Any] = ...) -> typing.Optional[QtNetwork.QNetworkReply]: ...
    ...
    @typing.overload
    def setTokenCredentials(self, tokenCredentials: typing.Tuple[typing.Optional[str], typing.Optional[str]]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setClientCredentials(self, clientCredentials: typing.Tuple[typing.Optional[str], typing.Optional[str]]) -> None: ...
    @typing.overload
...
class QOAuth1Signature(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, url: QtCore.QUrl = ..., method: 'QOAuth1Signature.HttpRequestMethod' = ..., parameters: typing.Dict[typing.Optional[str], typing.Sequence[typing.Any]] = ...) -> None: ...
    @typing.overload
    def __init__(self, url: QtCore.QUrl, clientSharedKey: typing.Optional[str], tokenSecret: typing.Optional[str], method: 'QOAuth1Signature.HttpRequestMethod' = ..., parameters: typing.Dict[typing.Optional[str], typing.Sequence[typing.Any]] = ...) -> None: ...
    @typing.overload
    ...
    def setParameters(self, parameters: typing.Dict[typing.Optional[str], typing.Sequence[typing.Any]]) -> None: ...
...
class QOAuth2AuthorizationCodeFlow(QAbstractOAuth2):
    ...
    def buildAuthenticateUrl(self, parameters: typing.Dict[typing.Optional[str], typing.Sequence[typing.Any]] = ...) -> QtCore.QUrl: ...
