...
def build_lambda_sched(optimizer, config):
...
class StepLearningRateScheduler(LearningRateScheduler):
    def __init__(self, optimizer, initial, interval, factor):
        self.initial = initial
        self.interval = interval
        self.factor = factor
        self.scheduler = LambdaLR(optimizer, lr_lambda=self._lr_lambda_func)
    
    def _lr_lambda_func(self, epoch):
...
class LambdaLearningRateSchedule(LearningRateScheduler):
    def __init__(self, sched_config):
        specs = sched_config["params"]
...
class WarmupCosineLearningRateSchedule(LearningRateScheduler):
