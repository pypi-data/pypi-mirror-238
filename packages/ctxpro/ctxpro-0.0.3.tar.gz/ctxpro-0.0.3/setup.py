...
def install_ctxpro(**kwargs):
    setup(
        ...
        long_description= "CTXPRO is a rule-based toolkit for annotating examples of ambiguity found in parallel documents."
                            "It further provides access to the MultiPro evaluation sets and scoring scripts.",
        ...
        entry_points={
            'console_scripts': [
                'ctxpro = ctxpro.annotate:main',
                'ctxpro-score = ctxpro.score:main',
                'ctxpro-gen = ctxpro.generate:main',
                'ctxpro-list = ctxpro.datasets:main'
            ],
        },
    )
