...
class Cell(Element, Layout):
    ...
    def _set_style(self, table, indexes):
        ...
        if self.border_width and self.border_color:
            cell.borders.top.width = Pt(self.border_width['top'])
            cell.borders.top.color.rgb = RGBColor(*self.border_color['top'])

            cell.borders.bottom.width = Pt(self.border_width['bottom'])
            cell.borders.bottom.color.rgb = RGBColor(*self.border_color['bottom'])

            cell.borders.left.width = Pt(self.border_width['left'])
            cell.borders.left.color.rgb = RGBColor(*self.border_color['left'])

            cell.borders.right.width = Pt(self.border_width['right'])
            cell.borders.right.color.rgb = RGBColor(*self.border_color['right'])
