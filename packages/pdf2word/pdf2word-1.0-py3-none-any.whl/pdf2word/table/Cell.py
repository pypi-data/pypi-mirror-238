...
class Cell(Element, Layout):
    ...
    def _set_style(self, table, indexes):
        ...
        if self.border_width and self.border_color:
            cell.borders.top.width = Pt(self.border_width[0])
            cell.borders.top.color.rgb = RGBColor(*self.border_color[0])

            cell.borders.bottom.width = Pt(self.border_width[2])
            cell.borders.bottom.color.rgb = RGBColor(*self.border_color[2])

            cell.borders.left.width = Pt(self.border_width[3])
            cell.borders.left.color.rgb = RGBColor(*self.border_color[3])

            cell.borders.right.width = Pt(self.border_width[1])
            cell.borders.right.color.rgb = RGBColor(*self.border_color[1])
