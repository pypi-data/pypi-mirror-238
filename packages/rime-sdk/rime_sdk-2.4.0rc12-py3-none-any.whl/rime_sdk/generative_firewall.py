...
class GenerativeFirewall:
    ...
    Args:
        ...
        auth_token: str
            The Auth Token used to authenticate to backend services.
    ...
    Example:
        .. code-block:: python
            ...
            firewall = GenerativeFirewall("my_vpc.rime.com", "api-key")   # using api-key, or,
            firewall = GenerativeFirewall("my_vpc.rime.com", "", "auth-token")   # using auth-token
    """
