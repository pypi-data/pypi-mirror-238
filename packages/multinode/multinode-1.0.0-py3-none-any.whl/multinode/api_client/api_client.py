...
import multinode.api_client.models
from multinode.api_client import rest
from multinode.api_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(multinode.api_client.models, klass)
