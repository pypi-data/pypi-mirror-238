...
class PreparedFunctionDetails(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PreparedFunctionDetails:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PreparedFunctionDetails:
        """Create an instance of PreparedFunctionDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PreparedFunctionDetails.parse_obj(obj)

        _obj = PreparedFunctionDetails.parse_obj({
            "type": obj.get("type"),
