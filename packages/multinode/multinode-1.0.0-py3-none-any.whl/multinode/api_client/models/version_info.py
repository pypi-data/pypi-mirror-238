...
class VersionInfo(BaseModel):
    ...
    functions: conlist(FunctionInfoForVersion) = Field(...)
    __properties = ["project_name", "version_id", "creation_time", "functions"]
    ...
    def from_dict(cls, obj: dict) -> VersionInfo:
        ...
        _obj = VersionInfo.parse_obj({
            ...
            "functions": [FunctionInfoForVersion.from_dict(_item) for _item in obj.get("functions")] if obj.get("functions") is not None else None
        })
        return _obj
