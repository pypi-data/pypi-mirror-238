...
from multinode.api_client.models.projects_list import ProjectsList  # noqa: E501
...
class TestProjectsList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProjectsList:
        ...
        """
        model = ProjectsList()  # noqa: E501
        if include_optional:
            return ProjectsList(
                projects = [
                    multinode.api_client.models.project_info.ProjectInfo(
                        project_name = '', 
