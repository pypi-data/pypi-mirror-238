...
from multinode.api_client.models.http_validation_error import HTTPValidationError  # noqa: E501
    ...
    def make_instance(self, include_optional) -> HTTPValidationError:
        ...
        if include_optional:
            return HTTPValidationError(
                detail = [
                    multinode.api_client.models.validation_error.ValidationError(
                        loc = [
                            null
                            ], 
                        msg = '', 
