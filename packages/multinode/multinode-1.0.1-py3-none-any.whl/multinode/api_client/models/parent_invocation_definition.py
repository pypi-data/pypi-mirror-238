...
class ParentInvocationDefinition(BaseModel):
    ...
    __properties = ["function_name", "invocation_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ParentInvocationDefinition:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ParentInvocationDefinition:
        """Create an instance of ParentInvocationDefinition from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ParentInvocationDefinition.parse_obj(obj)

        _obj = ParentInvocationDefinition.parse_obj({
