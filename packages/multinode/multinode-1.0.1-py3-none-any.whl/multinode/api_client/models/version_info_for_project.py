...
class VersionInfoForProject(BaseModel):
    ...
    __properties = ["version_id", "creation_time"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VersionInfoForProject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VersionInfoForProject:
        """Create an instance of VersionInfoForProject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VersionInfoForProject.parse_obj(obj)

        _obj = VersionInfoForProject.parse_obj({
