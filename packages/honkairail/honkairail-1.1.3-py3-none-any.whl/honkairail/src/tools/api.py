...
from .modalV2 import StarRailApiDataV2, ua,data_stats,data_weapon,data_avatar,data_relict_sets
from . import translate, modalV2
...
async def get_full(lang, uid,v):
    if lang == "ua":
        lang = "ru"
        ua_val = True
        modalV2.data_stats,modalV2.data_weapon,modalV2.data_avatar,modalV2.data_relict_sets,modalV2.data_paths,modalV2.data_element, = await translate.get_translate_data()
    else:
        ua_val = False
