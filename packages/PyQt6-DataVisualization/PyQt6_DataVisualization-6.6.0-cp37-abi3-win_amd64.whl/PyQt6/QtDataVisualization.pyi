...
class QAbstract3DGraph(QtGui.QWindow):
    ...
    def hasSeries(self, series: typing.Optional['QAbstract3DSeries']) -> bool: ...
...
class Q3DTheme(QtCore.QObject):
    ...
    def setLightColor(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    def setLabelBackgroundColor(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def labelTextColor(self) -> QtGui.QColor: ...
    def setLabelTextColor(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def windowColor(self) -> QtGui.QColor: ...
    def setWindowColor(self, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    def setBaseColors(self, colors: typing.Iterable[typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]]) -> None: ...
...
class QBar3DSeries(QAbstract3DSeries):
    ...
    def setRowColors(self, colors: typing.Iterable[typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]]) -> None: ...
    def rowColors(self) -> typing.List[QtGui.QColor]: ...
