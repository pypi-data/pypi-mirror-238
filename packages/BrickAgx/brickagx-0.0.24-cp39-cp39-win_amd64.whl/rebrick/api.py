...
class AgxToBrickMapper(object):
    ...
    def __init__(self):
        r"""__init__(AgxToBrickMapper self) -> AgxToBrickMapper"""
        _BrickAgxPyApi.AgxToBrickMapper_swiginit(self, _BrickAgxPyApi.new_AgxToBrickMapper())
...
class ClickOutputListener(agxSDK.StepEventListener):
    ...
    def robot_name_from(self, robot_output_signal):
        r"""
        robot_name_from(ClickOutputListener self, Signals_RobotOutputSignal robot_output_signal) -> std::string

        Parameters
        ----------
        robot_output_signal: Robotics::Signals::RobotOutputSignal const &
...
def parse_and_evaluate_file(bundle_paths, brick_file, modelname):
    r"""
    parse_and_evaluate_file(std::string const & bundle_paths, std::string const & brick_file, std::string const & modelname) -> std::pair< std::shared_ptr< Brick::Core::Object >,Brick::Errors >
    ...
    """
    return _BrickAgxPyApi.parse_and_evaluate_file(bundle_paths, brick_file, modelname)
...
def map_brick_object(simulation, object, brick_file, debug_tnc_path):
    r"""
    map_brick_object(Simulation simulation, std::shared_ptr< Brick::Core::Object > object, std::string const & brick_file, std::string const & debug_tnc_path) -> std::pair< agxSDK::AssemblyRef,Brick::Errors >
