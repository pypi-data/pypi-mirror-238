...
if __name__ == "__main__":
    ...
    # layer = datasource.GetLayer()
    #
    georeader = GeoReader("https://mapping.moray.gov.uk/arcgis/services/OpenData/OpenData/MapServer/WFSServer?Service=WFS")
    layer_list = georeader.list_layers()
    print(layer_list)
    layers = georeader.get_layers()
    layer_name = layers[2].layer_or_file_name
