...
from ksxt.market.krx.stock import KrxStockItem, KrxStockMarket
...
class KospiItem(KrxStockItem):
    ...
    @property
    def kospi200_apnt_cls_name(self) -> str:
...
class _KospiItem(Base):
    '''KOSPI 종목 정보'''
    __tablename__ = 'kospi'
    excd = Column(String, default='kospi')
...
class Kospi(KrxStockMarket[KospiItem, _KospiItem]):
