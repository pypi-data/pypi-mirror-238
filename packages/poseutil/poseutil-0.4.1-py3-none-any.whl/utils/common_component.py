...
def getHipCenter(pose):
    ...
    return pose_measure.getHipCenterPoint().y
...
def getPoseHeight(pose, dimension=XYZ):
    ...
    hip_knee = pose_measure.getHipKneeDistance(dimension, AVG)
    knee_ankle = pose_measure.getKneeAnkleDistance(dimension, AVG)
