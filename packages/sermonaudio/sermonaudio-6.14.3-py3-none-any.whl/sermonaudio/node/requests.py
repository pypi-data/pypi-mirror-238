...
class Node(API):
    ...
    def get_sermons(
        ...
        **kwargs,
        ...
        :param lite_broadcaster: If true, return a minimal Broadcaster object with fewer fields,
        just the ones needed to display a sermon.
        :param lite: If true, return a minimal lite sermon object with only display fields.
        ...
        update_kwargs_for_key(
            ...
            "params",
            {
                ...
                "liteBroadcaster": lite_broadcaster,
                "lite": lite,
            },
        )

        model = models.LiteSermon if lite else models.Sermon

        return cls.get_node(
            path,
            parse_func=lambda res: cls.PaginatedResponse(page, page_size, parse_node(res), model.parse),
            **kwargs,
        )
    ...
    def get_sermon(
        ...
        **kwargs,
    ) -> Optional[Union[models.Sermon, models.LiteSermon]]:
        ...
        just the ones needed to display a sermon.
        :param lite: If true, return a minimal lite sermon object with only display fields.
        :param allow_unpublished: If false, return a 404 not found if the specified sermon_id is not published.
        :param kwargs: Additional arguments to pass to the underlying get method.
        ...
        params = {"liteBroadcaster": lite_broadcaster, "lite": lite, "allowUnpublished": allow_unpublished}

        return cls.get(
            join_url_path(URL_PATH, "sermons", str(sermon_id)),
            parse_func=lambda res: model.parse(res.json()) if res.ok else None,
            params=params,
            **kwargs,
        )
    ...
    def delete_media(cls, sermon_id: str, media_type: models.MediaClass, **kwargs) -> Response:  # pragma: no cover
        ...
        return cls.post(join_url_path("jobs", "delete"), json=params, **kwargs)
    ...
    @classmethod
    def get_sermon_event_types(
        cls, broadcaster_id: str = None, include_unpublished: bool = False, **kwargs
    ) -> List[models.SermonEventTypeDetail]:
        ...
        """
        update_kwargs_for_key(
            kwargs, "params", {"broadcaster_id": broadcaster_id, "includeUnpublished": include_unpublished}
        )
        return cls.get(
    ...
    def get_series_list(
        ...
        filter_by: models.SeriesFilter = models.SeriesFilter.DEFAULT,
        **kwargs,
    ) -> PaginatedResponse:  # noqa: F821
        ...
        update_kwargs_for_key(
            kwargs,
            "params",
            {"page": page, "pageSize": page_size, "sort_by": sort_by.value, "filterBy": filter_by.value},
        )
    ...
    @classmethod
    def get_webcasts_in_progress_lite(
        cls, broadcaster_id: str = None, show_pending: bool = False, show_hidden: bool = False, **kwargs
    ) -> List[models.WebcastLite]:
        """Fetches a list of webcasts that are currently in progress.
        ...
        """
        update_kwargs_for_key(
            kwargs, "params", {"broadcasterID": broadcaster_id, "showHidden": show_hidden, "showPending": show_pending}
        )
        return cls.get(
            join_url_path(URL_PATH, "webcasts", "lite"),
            parse_func=lambda res: [models.WebcastLite.parse(rec) for rec in parse_node(res).results],
            **kwargs,
        )
    ...
    def get_filter_options(
        cls, broadcaster_id: str, include_unpublished: bool = False, **kwargs
    ) -> Optional[models.FilterOptions]:
        ...
        """
        update_kwargs_for_key(kwargs, "params", {"includeUnpublished": include_unpublished})
    ...
    def get_speaker_sermon_counts_for_broadcaster(
        ...
        """
        update_kwargs_for_key(
            kwargs, "params", {"broadcasterID": broadcaster_id, "includeUnpublished": include_unpublished}
        )
        return cls.get(
