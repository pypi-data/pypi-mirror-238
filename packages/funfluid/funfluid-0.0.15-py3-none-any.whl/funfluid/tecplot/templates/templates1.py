...
def plot1(data_v="", data_par=""):
    ...
    tp.active_frame().plot().contour(0).levels.reset_levels(
        [-1e-05, -8e-06, -6e-06, -4e-06, -2e-06, 0, 2e-06, 4e-06, 6e-06, 8e-06,
         1e-05, 1.2e-05, 1.4e-05, 1.6e-05, 1.8e-05, 2e-05])
    ...
    tp.active_frame().plot().streamtraces.add(seed_point=[418.777, 222.196], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.color = Color.White
    tp.active_frame().plot().streamtraces.add(seed_point=[385.465, 201.455], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[412.492, 178.828], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[402.121, 290.078], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[409.978, 321.505], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[420.034, 285.05], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[445.804, 208.054], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[427.577, 274.05], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[411.235, 236.024], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[409.349, 262.423], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[364.723, 215.911], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[349.324, 275.936], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[321.355, 180.085], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[318.841, 315.219], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[399.921, 333.761], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[402.121, 165.943], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[470.631, 251.423], stream_type=Streamtrace.TwoDLine)
...
def plot2(data_v="", data_par=""):
    ...
    tp.active_frame().plot().contour(0).levels.reset_levels([-4, -3.5, -3, -2.5, -2, -1.5, -1, -0.5, 0, 0.5])
    ...
    tp.active_frame().plot().streamtraces.timing.reset_delta()
    tp.active_frame().plot().show_streamtraces = True
    tp.active_frame().plot().streamtraces.add(seed_point=[346.81, 250.795], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[349.01, 222.511], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[343.982, 239.481], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[357.495, 273.108], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[337.068, 266.194], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[436.062, 267.765], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[414.378, 308.62], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[436.69, 237.596], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[443.29, 208.369], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[414.692, 173.799], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[475.345, 183.227], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[356.867, 206.483], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[356.552, 287.878], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[445.176, 285.05], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[457.746, 252.68], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[399.293, 201.141], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.color = Color.White
    ...
    tp.active_frame().plot().streamtraces.add(seed_point=[340.211, 307.991], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[462.46, 311.762], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[460.575, 190.141], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[350.267, 188.884], stream_type=Streamtrace.TwoDLine)
    tp.active_frame().plot().streamtraces.add(seed_point=[405.578, 185.742], stream_type=Streamtrace.TwoDLine)
    tp.macro.execute_command('''$!Pick SetMouseMode
      MouseMode = Select''')
    tp.macro.execute_command('''$!Pick AddAtPosition
      X = 2.16952155936
