...
class Builder(object):
    ...
    def set_cpu(self, cpu):
        ...
        if self.CPU in CkcoreCPU:
            ...
            if self.CPU == 'e902':
                set_rv_cpu_flag(flags, 'rv32ecxthead', 'ilp32e')
            if self.CPU == 'e902m':
                set_rv_cpu_flag(flags, 'rv32emcxthead', 'ilp32e')
            if self.CPU == 'e902t':
                set_rv_cpu_flag(flags, 'rv32ecxtheadse', 'ilp32e')
            if self.CPU == 'e902mt':
                set_rv_cpu_flag(flags, 'rv32emcxtheadse', 'ilp32e')
            if self.CPU == 'e906':
                set_rv_cpu_flag(flags, 'rv32imac_xtheade', 'ilp32', 'medlow', 'e906')
            if self.CPU == 'e906f':
                set_rv_cpu_flag(flags, 'rv32imafc_xtheade', 'ilp32f', 'medlow', 'e906')
            if self.CPU == 'e906fd':
                set_rv_cpu_flag(flags, 'rv32imafdc_xtheade', 'ilp32d', 'medlow', 'e906')
            if self.CPU == 'e906p':
                set_rv_cpu_flag(flags, 'rv32imacp_zpn_zpsfoperand_xtheade', 'ilp32', 'medlow', 'e906')
            if self.CPU == 'e906fp':
                set_rv_cpu_flag(flags, 'rv32imafcp_zpn_zpsfoperand_xtheade', 'ilp32f', 'medlow', 'e906')
            if self.CPU == 'e906fdp':
                set_rv_cpu_flag(flags, 'rv32imafdcp_zpn_zpsfoperand_xtheade', 'ilp32d', 'medlow', 'e906')
            if self.CPU == 'e907':
                set_rv_cpu_flag(flags, 'rv32imac_xtheade', 'ilp32', 'medlow', 'e907')
            if self.CPU == 'e907f':
                set_rv_cpu_flag(flags, 'rv32imafc_xtheade', 'ilp32f', 'medlow', 'e907')
            if self.CPU == 'e907fd':
                set_rv_cpu_flag(flags, 'rv32imafdc_xtheade', 'ilp32d', 'medlow', 'e907')
            if self.CPU == 'e907p':
                set_rv_cpu_flag(flags, 'rv32imacp_zpn_zpsfoperand_xtheade', 'ilp32', 'medlow', 'e907')
            if self.CPU == 'e907fp':
                set_rv_cpu_flag(flags, 'rv32imafcp_zpn_zpsfoperand_xtheade', 'ilp32f', 'medlow', 'e907')
            if self.CPU == 'e907fdp':
                set_rv_cpu_flag(flags, 'rv32imafdcp_zpn_zpsfoperand_xtheade', 'ilp32d', 'medlow', 'e907')
            if self.CPU == 'c906':
            ...
            if self.CPU == 'c908':
                set_rv_cpu_flag(flags, 'rv64imafdc_zihintpause_zfh_zba_zbb_zbc_zbs_xtheadc', 'lp64d', 'medany', 'c908')
            if self.CPU == 'c908v':
                set_rv_cpu_flag(flags, 'rv64imafdcv_zihintpause_zfh_zba_zbb_zbc_zbs_xtheadc', 'lp64d', 'medany', 'c908')
            if self.CPU == 'c908i':
                set_rv_cpu_flag(flags, 'rv64imac_zihintpause_zba_zbb_zbc_zbs_xtheadc', 'lp64', 'medany', 'c908')
            if self.CPU == 'c908-rv32':
                set_rv_cpu_flag(flags, 'rv32imafdc_zihintpause_zfh_zba_zbb_zbc_zbs_xtheadc', 'ilp32d', 'medany', 'c908')
            if self.CPU == 'c908v-rv32':
                set_rv_cpu_flag(flags, 'rv32imafdcv_zihintpause_zfh_zba_zbb_zbc_zbs_xtheadc', 'ilp32d', 'medany', 'c908')
            if self.CPU == 'c910':
                set_rv_cpu_flag(flags, 'rv64imafdcxtheadc', 'lp64d', 'medany', 'c910')
            if self.CPU == 'c910v2':
                set_rv_cpu_flag(flags, 'rv64imafdc_zicbom_zicbop_zicboz_zicond_zihintntl_zihintpause_zawrs_zfa_zfbfmin_zfh_zca_zcb_zcd_zba_zbb_zbc_zbs_svinval_svpbmt_xtheadc', 'lp64d', 'medany', 'c910')
            if self.CPU == 'c920':
                set_rv_cpu_flag(flags, 'rv64imafdcv_zvamo_zvlsseg_xtheadc', 'lp64d', 'medany', 'c920')
            if self.CPU == 'c920v2':
                set_rv_cpu_flag(flags, 'rv64imafdcv_zicbom_zicbop_zicboz_zicond_zihintntl_zihintpause_zawrs_zfa_zfbfmin_zfh_zca_zcb_zcd_zba_zbb_zbc_zbs_zvfbfmin_zvfbfwma_svinval_svpbmt_xtheadc_xtheadvdot', 'lp64d', 'medany', 'c920')
            if self.CPU == 'r910':
                set_rv_cpu_flag(flags, 'rv64imafdc_zfh_xtheadc', 'lp64d', 'medany', 'r910')
            if self.CPU == 'r920':
                set_rv_cpu_flag(flags, 'rv64imafdc_v0p7_zfh_zvamo0p7_zvlsseg0p7_xtheadc', 'lp64d', 'medany', 'r920')
