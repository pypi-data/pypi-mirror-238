...
class Node(APIObjectInterface):
    ...
    def create(
        ...
        *,
        ...
        # Create node object and create and set attributes on TaskCollection
        # class
        ...
        # Get node object and set attributes on local class

        url = f"/api/v1/{ENDPOINT_NODES}/{obj.object_id}"
