...
class CrmLead(models.Model):
    ...
    def validate_remesa(self):
        ...
        for iban in self.lead_line_ids.mapped("iban"):
            if not self._get_bank_from_iban(iban):
    ...
    def _get_bank_from_iban(self, iban):
        self.ensure_one()
    ...
    @retry_on_error(retries=20, delay=300, errors=[InvalidEndpoint, ConnectionError, SocketError])  # noqa
