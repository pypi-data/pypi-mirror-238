...
class BenchlingWrapper:
    ...
    def get_sequencing_samples_for_specimens(self,
                                             ...
                                             ) -> tuple[list[list[CustomEntity]], pd.DataFrame]:
        """
        ...
        :return: a list of lists of sequencing sample objects
        ...
        for run_name in run_names_benchling:
            ...
            if save:
                ...
                samples_for_project_df.to_csv(f'benchling_data/{run_name}_filtered_samples.csv',
                                              index=False, header=['Sequencing Sample for Project'])
                other_samples.to_csv(f'benchling_data/{run_name}_outlier_samples.csv', index=False,
                                     header=['Other Sequencing Samples'])
    ...
    def get_qc1_for_sequencing_samples(self,
        ...
        qc1_df['Total Deduplicated Percentage'] = get_field_from_objects_list(objects=qc1_objects,
                                                                              field_name=
        ...
        qc1_df['%Multiple_hits_multiple_genomes'] = get_field_from_objects_list(objects=qc1_objects,
                                                                                field_name=
