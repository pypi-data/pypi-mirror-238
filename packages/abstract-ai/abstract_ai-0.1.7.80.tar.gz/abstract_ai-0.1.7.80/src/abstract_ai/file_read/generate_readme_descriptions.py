...
def construct_layout(files_list,window_size):
    ...
    mass_files = [
        ...
        [make_component("Button",'Clear Selection'), make_component("Button",'add')]
    ]
    layout = [mass_files]
    ...
    layout.append([make_component("Button",'Submit'),make_component('Button','Review'), make_component("Button",'Exit')])
    return layout
