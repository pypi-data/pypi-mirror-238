...
from guardrail.firewall.input_detectors.anonymize import (
    Anonymize,
...
class SensitivePII(Detector):
    """
    A class used to detect sensitive (PII) data in the output of a language model.

    This class uses the Presidio Analyzer Engine and predefined internal patterns (sensitive_patterns.json) to analyze the output for specified entity types.
    ...
    def __init__(
        ...
        Parameters:
           entity_types (Optional[List[str]]): The entity types to look for in the output. Defaults to all entity types.
