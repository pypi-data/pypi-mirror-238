...
from .tools import google_search, local_search

class knowledge_qa_pipeline(pipeline):
    def __init__(self, foundation_model, snippet_cnt, search_type, data_link=None, embedding_link=None, data=None):
        ...
        if(search_type == 'online'):
            ...
            self.tool = local_search(snippet_cnt = snippet_cnt, data=data, data_link=data_link, embedding_link=embedding_link)
    ...
    async def run_with_tool_live(self, responses):
        ...
        for claims_in_response in claims_in_responses:
            ...
            print("Search claims: ", search_outputs_for_claims)
