...
from guardrail.firewall.output_detectors.factuality_detector.utils import OpenAIEmbedWrapper

class local_search():
    def __init__(self, snippet_cnt, data_link, data=None, embedding_link=None):
        self.snippet_cnt = snippet_cnt
        self.data_link = data_link
        self.embedding_link = embedding_link
        self.openai_embed = OpenAIEmbedWrapper()
        self.data = None
        self.embedding = None
