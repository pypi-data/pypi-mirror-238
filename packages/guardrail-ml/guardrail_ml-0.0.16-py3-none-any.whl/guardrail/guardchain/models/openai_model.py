...
from guardchain.agent.message import (
    BaseMessage,
    UserMessage,
    AIMessage,
    SystemMessage,
...
from guardchain.models.base_model import (
    LLMResult,
    Generation,
    BaseLanguageModel,
)
from guardchain.tools.base_tool import Tool
...
class OpenAIModel(BaseLanguageModel):
    ...
    Example:
        .. code-block:: python
            ...
            from guardchain.models.chat_openai import ChatOpenAI
            openai = ChatOpenAI()
    """
