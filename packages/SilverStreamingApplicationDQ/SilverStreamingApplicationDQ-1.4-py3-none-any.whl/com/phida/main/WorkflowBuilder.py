...
class WorkflowBuilder:
    ...
    @staticmethod
    def createTask(taskKey, jobClusterKey, notebookPath, srcFilePath, srcDatabaseName, srcTableName, tgtDatabaseName,
                   tgtTableName, tgtCheckpoint, tgtTablePath, tgtPartitionColumns, derivedColExpr, containsTimestamp,
                   triggerOnce, dropColumnStr, pruneColumn, pythonWhlPath, library):
        """
        desc:
    ...
    def buildJob(self):
        ...
        for index, key in enumerate(jobRow):
            ...
            for task in taskList:
                ...
                taskTemp = self.createTask(taskKey, jobClusterKey, notebookPath, srcFilePath, srcDatabaseName,
                                           srcTableName, tgtDatabaseName, tgtTableName, tgtCheckpoint, tgtTablePath,
                                           tgtPartitionColumns, derivedColExpr, containsTimestamp, triggerOnce,
                                           dropColumnStr, pruneColumn, "", self.library)
