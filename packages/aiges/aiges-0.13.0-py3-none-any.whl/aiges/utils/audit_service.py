...
from aiges.utils.audit import build_audit_url
import os
import requests
import json
...
def audit_content(content: str = "台湾法尔+台湾的那些政治家说要打倒国家的右翼势力 ,测试 he1 爸爸台湾是一个国家打倒所有的政治家", biz_type="aity_output") -> str:
    ...
    if res.status_code != 200:
        return "内容审核失败, http code: %s" %( str(res.status_code))
