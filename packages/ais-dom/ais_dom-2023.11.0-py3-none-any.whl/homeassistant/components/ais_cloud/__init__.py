...
class AisCloudWS:
    def __init__(self, hass):
        ...
        self.cache_key_path = "/data/data/com.termux/files/home/AIS/.dom/"
    ...
    def audio_type(self, nature):
        try:
            ...
            _LOGGER.error("Can't connect to AIS WS!!! " + str(e))
            ...
            if ais_global.has_root():
                try:
                    subprocess.check_output(
                        'su -c "chmod -R 755 /data/data/com.termux/files/home/AIS"',
                        shell=True,  # nosec
                    )
                except Exception as e:
