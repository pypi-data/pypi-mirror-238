...
from homeassistant.components import ais_ai_service
...
async def async_setup(hass, config):
    ...
    async def get_favorites_service(call):
    ...
    async def play_bookmark_service(call):
    ...
    async def play_favorite_service(call):
    ...
    async def delete_bookmark_service(call):
    ...
    async def delete_favorite_service(call):
    ...
    ais_ai_service.async_register(
        hass, INTENT_ADD_FAVORITE, ["Dodaj do ulubionych", "Do ulubionych", "Lubię to"]
    )
    ais_ai_service.async_register(
        hass, INTENT_ADD_BOOKMARK, ["Dodaj zakładkę", "Zakładka"]
    )
    ais_ai_service.async_register(
        hass, INTENT_LAST_BOOKMARKS, ["Jakie mam zakładki", "Jakie są zakładki"]
    )
    ais_ai_service.async_register(
        hass,
...
class BookmarksData:
    ...
    async def async_load(self):
        ...
        await self.hass.async_add_job(load)
...
class ListTopBookmarkIntent(intent.IntentHandler):
    ...
    async def async_handle(self, intent_obj):
        ...
        response.async_set_speech(answer)
        await hass.services.async_call("ais_ai_service", "say_it", {"text": answer})
        return response
