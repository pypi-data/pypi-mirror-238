...
if [ ! -e "/data/data/com.termux/files/home/AIS/www/img" ] ; then
    mkdir -p /data/data/com.termux/files/home/AIS/www/img
fi
...
if [ ! -e "/data/data/com.termux/files/home/AIS/.dom/rclone.conf" ] ; then
    touch "/data/data/com.termux/files/home/AIS/.dom/rclone.conf"
fi

# ln -s /sdcard/dom dysk-wewnętrzny


if [ ! -e "/data/data/com.termux/dom_cloud_drives" ] ; then
    mkdir -p /data/data/com.termux/dom_cloud_drives
fi

if [ ! -e "/data/data/com.termux/files/home/dom/dyski-zdalne" ] ; then
    ln -s /data/data/com.termux/dom_cloud_drives/  /data/data/com.termux/files/home/dom/dyski-zdalne
fi

if [ ! -e "/data/data/com.termux/files/home/dom/dyski-wymienne" ] ; then
     mkdir -p /data/data/com.termux/files/home/dom/dyski-wymienne
fi
