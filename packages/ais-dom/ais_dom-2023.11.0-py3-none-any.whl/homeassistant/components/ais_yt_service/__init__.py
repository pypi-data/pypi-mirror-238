...
class YouTubeData:
    ...
    def process_select_track_uri(self, call):
        ...
        media_url = None
        try:
            local_extractor_version = ais_updater.get_package_version("yt-dlp")
            ...
            if "yt-dlp==" + cloud_extractor_version != local_extractor_version:
                self.hass.services.call(
                    "ais_updater",
                    "upgrade_package",
                    {"package": "yt-dlp", "version": cloud_extractor_version},
                )
        ...
        if all_ok:
            ...
            _LOGGER.info("media_content_id: " + url + track["uri"])
            self.hass.services.call(
                "media_extractor",
                "play_media",
                {
