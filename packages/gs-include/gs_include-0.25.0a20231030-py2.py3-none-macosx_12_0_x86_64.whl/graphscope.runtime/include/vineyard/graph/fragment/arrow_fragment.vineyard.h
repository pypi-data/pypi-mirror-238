...
class __attribute__((annotate("vineyard"))) ArrowFragment
  ...
  public:
    void Construct(const ObjectMeta& meta) override {
        ...
        meta.GetKeyValue("local_vertex_map_", this->local_vertex_map_);
        ...
        this->ie_boffsets_lists_.resize(meta.GetKeyValue<size_t>("__ie_boffsets_lists_-size"));
        for (size_t __idx = 0; __idx < this->ie_boffsets_lists_.size(); ++__idx) {
            for (size_t __idy = 0; __idy < meta.GetKeyValue<size_t>(
                    "__ie_boffsets_lists_-" + std::to_string(__idx) + "-size"); ++__idy) {
                this->ie_boffsets_lists_[__idx].emplace_back(std::dynamic_pointer_cast<Int64Array>(
                    meta.GetMember("__ie_boffsets_lists_-" + std::to_string(__idx) + "-" + std::to_string(__idy))));
            }
        }
        this->oe_boffsets_lists_.resize(meta.GetKeyValue<size_t>("__oe_boffsets_lists_-size"));
        for (size_t __idx = 0; __idx < this->oe_boffsets_lists_.size(); ++__idx) {
            for (size_t __idy = 0; __idy < meta.GetKeyValue<size_t>(
                    "__oe_boffsets_lists_-" + std::to_string(__idx) + "-size"); ++__idy) {
                this->oe_boffsets_lists_[__idx].emplace_back(std::dynamic_pointer_cast<Int64Array>(
                    meta.GetMember("__oe_boffsets_lists_-" + std::to_string(__idx) + "-" + std::to_string(__idy))));
            }
        }
...
public:
 ...
 public:
  ...
  fid_t GetFragId(const vid_t& gid) const { return vid_parser_.GetFid(gid); }
  ...
  GetIncomingAdjList(const vertex_t& v, label_id_t e_label) const {
    ...
    return compact_adj_list_t(
        ptr + boffset_array[v_offset], ptr + boffset_array[v_offset + 1],
 ...
 private:
  ...
  __attribute__((annotate("shared"))) bool local_vertex_map_;
  ...
  __attribute__((annotate("shared"))) List<List<std::shared_ptr<Int64Array>>> ie_boffsets_lists_,
      oe_boffsets_lists_;
  ...
  template <typename _OID_T, typename _VID_T, typename VDATA_T,
            typename EDATA_T, typename _VERTEX_MAP_T, bool _COMPACT>
...
class ArrowFragmentBaseBuilder: public ObjectBuilder {
  public:
    ...
    explicit ArrowFragmentBaseBuilder(
        ...
        this->set_local_vertex_map_(__value.local_vertex_map_);
        ...
        this->ie_boffsets_lists_.resize(__value.ie_boffsets_lists_.size());
        for (size_t __idx = 0; __idx < __value.ie_boffsets_lists_.size(); ++__idx) {
            this->ie_boffsets_lists_[__idx].resize(__value.ie_boffsets_lists_[__idx].size());
            for (size_t __idy = 0; __idy < __value.ie_boffsets_lists_[__idx].size(); ++__idy) {
                this->ie_boffsets_lists_[__idx][__idy] = __value.ie_boffsets_lists_[__idx][__idy];
            }
        }
        this->oe_boffsets_lists_.resize(__value.oe_boffsets_lists_.size());
        for (size_t __idx = 0; __idx < __value.oe_boffsets_lists_.size(); ++__idx) {
            this->oe_boffsets_lists_[__idx].resize(__value.oe_boffsets_lists_[__idx].size());
            for (size_t __idy = 0; __idy < __value.oe_boffsets_lists_[__idx].size(); ++__idy) {
                this->oe_boffsets_lists_[__idx][__idy] = __value.oe_boffsets_lists_[__idx][__idy];
            }
        }
    ...
    Status _Seal(Client& client, std::shared_ptr<Object>& object) override {
        ...
        __value->local_vertex_map_ = local_vertex_map_;
        __value->meta_.AddKeyValue("local_vertex_map_", __value->local_vertex_map_);
        ...
        // using __ie_boffsets_lists__value_type = typename List<List<std::shared_ptr<Int64Array>>>::value_type::value_type::element_type;
        using __ie_boffsets_lists__value_type = typename decltype(__value->ie_boffsets_lists_)::value_type::value_type::element_type;

        size_t __ie_boffsets_lists__idx = 0;
        __value->ie_boffsets_lists_.resize(ie_boffsets_lists_.size());
        for (auto &__ie_boffsets_lists__value_vec: ie_boffsets_lists_) {
            size_t __ie_boffsets_lists__idy = 0;
            __value->meta_.AddKeyValue("__ie_boffsets_lists_-" + std::to_string(__ie_boffsets_lists__idx) + "-size", __ie_boffsets_lists__value_vec.size());
            for (auto &__ie_boffsets_lists__value: __ie_boffsets_lists__value_vec) {
                auto __value_ie_boffsets_lists_ = std::dynamic_pointer_cast<__ie_boffsets_lists__value_type>(
                    __ie_boffsets_lists__value->_Seal(client));
                __value->ie_boffsets_lists_[__ie_boffsets_lists__idx].emplace_back(__value_ie_boffsets_lists_);
                __value->meta_.AddMember("__ie_boffsets_lists_-" + std::to_string(__ie_boffsets_lists__idx) + "-" + std::to_string(__ie_boffsets_lists__idy),
                                         __value_ie_boffsets_lists_);
                __value_nbytes += __value_ie_boffsets_lists_->nbytes();
                __ie_boffsets_lists__idy += 1;
            }
            __ie_boffsets_lists__idx += 1;
        }
        __value->meta_.AddKeyValue("__ie_boffsets_lists_-size", __value->ie_boffsets_lists_.size());

        // using __oe_boffsets_lists__value_type = typename List<List<std::shared_ptr<Int64Array>>>::value_type::value_type::element_type;
        using __oe_boffsets_lists__value_type = typename decltype(__value->oe_boffsets_lists_)::value_type::value_type::element_type;

        size_t __oe_boffsets_lists__idx = 0;
        __value->oe_boffsets_lists_.resize(oe_boffsets_lists_.size());
        for (auto &__oe_boffsets_lists__value_vec: oe_boffsets_lists_) {
            size_t __oe_boffsets_lists__idy = 0;
            __value->meta_.AddKeyValue("__oe_boffsets_lists_-" + std::to_string(__oe_boffsets_lists__idx) + "-size", __oe_boffsets_lists__value_vec.size());
            for (auto &__oe_boffsets_lists__value: __oe_boffsets_lists__value_vec) {
                auto __value_oe_boffsets_lists_ = std::dynamic_pointer_cast<__oe_boffsets_lists__value_type>(
                    __oe_boffsets_lists__value->_Seal(client));
                __value->oe_boffsets_lists_[__oe_boffsets_lists__idx].emplace_back(__value_oe_boffsets_lists_);
                __value->meta_.AddMember("__oe_boffsets_lists_-" + std::to_string(__oe_boffsets_lists__idx) + "-" + std::to_string(__oe_boffsets_lists__idy),
                                         __value_oe_boffsets_lists_);
                __value_nbytes += __value_oe_boffsets_lists_->nbytes();
                __oe_boffsets_lists__idy += 1;
            }
            __oe_boffsets_lists__idx += 1;
        }
        __value->meta_.AddKeyValue("__oe_boffsets_lists_-size", __value->oe_boffsets_lists_.size());
  ...
  protected:
    ...
    std::vector<std::vector<std::shared_ptr<ObjectBase>>> ie_boffsets_lists_;
    std::vector<std::vector<std::shared_ptr<ObjectBase>>> oe_boffsets_lists_;
    ...
    void set_local_vertex_map_(bool const &local_vertex_map__) {
        this->local_vertex_map_ = local_vertex_map__;
    }
    ...
    void set_ie_boffsets_lists_(std::vector<std::vector<std::shared_ptr<ObjectBase>>> const &ie_boffsets_lists__) {
        this->ie_boffsets_lists_ = ie_boffsets_lists__;
    }
    void set_ie_boffsets_lists_(size_t const idx, std::vector<std::shared_ptr<ObjectBase>> const &ie_boffsets_lists__) {
        if (idx >= this->ie_boffsets_lists_.size()) {
            this->ie_boffsets_lists_.resize(idx + 1);
        }
        this->ie_boffsets_lists_[idx] = ie_boffsets_lists__;
    }
    void set_ie_boffsets_lists_(size_t const idx, size_t const idy,
                          std::shared_ptr<ObjectBase> const &ie_boffsets_lists__) {
        if (idx >= this->ie_boffsets_lists_.size()) {
            this->ie_boffsets_lists_.resize(idx + 1);
        }
        if (idy >= this->ie_boffsets_lists_[idx].size()) {
            this->ie_boffsets_lists_[idx].resize(idy + 1);
        }
        this->ie_boffsets_lists_[idx][idy] = ie_boffsets_lists__;
    }
    void add_ie_boffsets_lists_(std::vector<std::shared_ptr<ObjectBase>> const &ie_boffsets_lists__) {
        this->ie_boffsets_lists_.emplace_back(ie_boffsets_lists__);
    }
    void remove_ie_boffsets_lists_(const size_t ie_boffsets_lists__index_) {
        this->ie_boffsets_lists_.erase(this->ie_boffsets_lists_.begin() + ie_boffsets_lists__index_);
    }
    void remove_ie_boffsets_lists_(const size_t ie_boffsets_lists__index_, const size_t ie_boffsets_lists__inner_index_) {
        auto &ie_boffsets_lists__inner_ = this->ie_boffsets_lists_[ie_boffsets_lists__index_];
        ie_boffsets_lists__inner_.erase(ie_boffsets_lists__inner_.begin() + ie_boffsets_lists__inner_index_);
    }

    void set_oe_boffsets_lists_(std::vector<std::vector<std::shared_ptr<ObjectBase>>> const &oe_boffsets_lists__) {
        this->oe_boffsets_lists_ = oe_boffsets_lists__;
    }
    void set_oe_boffsets_lists_(size_t const idx, std::vector<std::shared_ptr<ObjectBase>> const &oe_boffsets_lists__) {
        if (idx >= this->oe_boffsets_lists_.size()) {
            this->oe_boffsets_lists_.resize(idx + 1);
        }
        this->oe_boffsets_lists_[idx] = oe_boffsets_lists__;
    }
    void set_oe_boffsets_lists_(size_t const idx, size_t const idy,
                          std::shared_ptr<ObjectBase> const &oe_boffsets_lists__) {
        if (idx >= this->oe_boffsets_lists_.size()) {
            this->oe_boffsets_lists_.resize(idx + 1);
        }
        if (idy >= this->oe_boffsets_lists_[idx].size()) {
            this->oe_boffsets_lists_[idx].resize(idy + 1);
        }
        this->oe_boffsets_lists_[idx][idy] = oe_boffsets_lists__;
    }
    void add_oe_boffsets_lists_(std::vector<std::shared_ptr<ObjectBase>> const &oe_boffsets_lists__) {
        this->oe_boffsets_lists_.emplace_back(oe_boffsets_lists__);
    }
    void remove_oe_boffsets_lists_(const size_t oe_boffsets_lists__index_) {
        this->oe_boffsets_lists_.erase(this->oe_boffsets_lists_.begin() + oe_boffsets_lists__index_);
    }
    void remove_oe_boffsets_lists_(const size_t oe_boffsets_lists__index_, const size_t oe_boffsets_lists__inner_index_) {
        auto &oe_boffsets_lists__inner_ = this->oe_boffsets_lists_[oe_boffsets_lists__index_];
        oe_boffsets_lists__inner_.erase(oe_boffsets_lists__inner_.begin() + oe_boffsets_lists__inner_index_);
    }
