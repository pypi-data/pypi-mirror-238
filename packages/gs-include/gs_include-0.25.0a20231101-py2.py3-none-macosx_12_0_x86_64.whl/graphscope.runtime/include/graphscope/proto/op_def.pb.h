...
class OpDef_AttrEntry_DoNotUse final : public ::google::protobuf::internal::MapEntry<OpDef_AttrEntry_DoNotUse, 
    ::int32_t, ::gs::rpc::AttrValue,
    ::google::protobuf::internal::WireFormatLite::TYPE_INT32,
    ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE> {
public:
  typedef ::google::protobuf::internal::MapEntry<OpDef_AttrEntry_DoNotUse, 
    ::int32_t, ::gs::rpc::AttrValue,
    ::google::protobuf::internal::WireFormatLite::TYPE_INT32,
...
class OpDef final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gs.rpc.OpDef) */ {
 public:
 ...
 private:
  ...
  static const ::google::protobuf::internal::TcParseTable<3, 7, 4, 31, 2> _table_;
...
class OpResult_Meta final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gs.rpc.OpResult.Meta) */ {
 public:
  inline OpResult_Meta() : OpResult_Meta(nullptr) {}
  ~OpResult_Meta() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR OpResult_Meta(::google::protobuf::internal::ConstantInitialized);
...
class OpResult final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gs.rpc.OpResult) */ {
 public:
  inline OpResult() : OpResult(nullptr) {}
  ~OpResult() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR OpResult(::google::protobuf::internal::ConstantInitialized);
 ...
 private:
  ...
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<3, 6, 2, 36, 2> _table_;
  template <typename T> friend class ::google::protobuf::Arena::InternalHelper;
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  struct Impl_ {
...
class DagDef final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gs.rpc.DagDef) */ {
 public:
  inline DagDef() : DagDef(nullptr) {}
  ~DagDef() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR DagDef(::google::protobuf::internal::ConstantInitialized);
  ...
  ::google::protobuf::RepeatedPtrField< ::gs::rpc::OpDef >*
      mutable_op();
  private:
  ...
  ::gs::rpc::OpDef* add_op();
  const ::google::protobuf::RepeatedPtrField< ::gs::rpc::OpDef >&
      op() const;
...
inline ::google::protobuf::RepeatedPtrField<std::string>* OpDef::mutable_parents() {
...
inline const ::google::protobuf::Map<::int32_t, ::gs::rpc::AttrValue>& OpDef::attr() const {
...
inline ::google::protobuf::Map<::int32_t, ::gs::rpc::AttrValue>* OpDef::mutable_attr() {
...
inline void OpResult::set_allocated_meta(::gs::rpc::OpResult_Meta* value) {
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::gs::rpc::OpResult_Meta*>(_impl_.meta_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena =
        ::google::protobuf::Arena::InternalGetOwningArena(reinterpret_cast<::gs::rpc::OpResult_Meta*>(value));
    if (message_arena != submessage_arena) {
      value = ::google::protobuf::internal::GetOwnedMessage(message_arena, value, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000001u;
