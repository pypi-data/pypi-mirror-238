# Form implementation generated from reading ui file 'src/eric7/WebBrowser/FeaturePermissions/FeaturePermissionsDialog.ui'
#
...
class Ui_FeaturePermissionsDialog(object):
    def setupUi(self, FeaturePermissionsDialog):
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=FeaturePermissionsDialog)
        ...
        self.removeButton = QtWidgets.QPushButton(parent=FeaturePermissionsDialog)
        self.removeButton.setObjectName("removeButton")
        self.verticalLayout_3.addWidget(self.removeButton)
        self.removeAllButton = QtWidgets.QPushButton(parent=FeaturePermissionsDialog)
        self.removeAllButton.setObjectName("removeAllButton")
        self.verticalLayout_3.addWidget(self.removeAllButton)
        self.gridLayout.addLayout(self.verticalLayout_3, 0, 1, 1, 1)
        self.tabWidget = QtWidgets.QTabWidget(parent=FeaturePermissionsDialog)
