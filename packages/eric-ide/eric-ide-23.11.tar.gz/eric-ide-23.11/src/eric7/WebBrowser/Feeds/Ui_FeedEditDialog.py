# Form implementation generated from reading ui file 'src/eric7/WebBrowser/Feeds/FeedEditDialog.ui'
#
...
class Ui_FeedEditDialog(object):
    def setupUi(self, FeedEditDialog):
        ...
        self.label = QtWidgets.QLabel(parent=FeedEditDialog)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 0, 0, 1, 2)
        self.label_2 = QtWidgets.QLabel(parent=FeedEditDialog)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 1, 0, 1, 1)
        self.titleEdit = QtWidgets.QLineEdit(parent=FeedEditDialog)
        self.titleEdit.setObjectName("titleEdit")
        self.gridLayout.addWidget(self.titleEdit, 1, 1, 1, 1)
        self.label_3 = QtWidgets.QLabel(parent=FeedEditDialog)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 2, 0, 1, 1)
        self.urlEdit = QtWidgets.QLineEdit(parent=FeedEditDialog)
        self.urlEdit.setObjectName("urlEdit")
        self.gridLayout.addWidget(self.urlEdit, 2, 1, 1, 1)
        self.verticalLayout.addLayout(self.gridLayout)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=FeedEditDialog)
