# Form implementation generated from reading ui file 'src/eric7/WebBrowser/OpenSearch/OpenSearchEditDialog.ui'
#
...
class Ui_OpenSearchEditDialog(object):
    def setupUi(self, OpenSearchEditDialog):
        ...
        self.label_2 = QtWidgets.QLabel(parent=OpenSearchEditDialog)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 0, 0, 1, 1)
        self.nameEdit = QtWidgets.QLineEdit(parent=OpenSearchEditDialog)
        self.nameEdit.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.nameEdit.setReadOnly(True)
        self.nameEdit.setObjectName("nameEdit")
        self.gridLayout.addWidget(self.nameEdit, 0, 1, 1, 1)
        self.label_3 = QtWidgets.QLabel(parent=OpenSearchEditDialog)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 1, 0, 1, 1)
        self.descriptionEdit = QtWidgets.QLineEdit(parent=OpenSearchEditDialog)
        self.descriptionEdit.setObjectName("descriptionEdit")
        self.gridLayout.addWidget(self.descriptionEdit, 1, 1, 1, 1)
        self.label_5 = QtWidgets.QLabel(parent=OpenSearchEditDialog)
        self.label_5.setObjectName("label_5")
        self.gridLayout.addWidget(self.label_5, 2, 0, 1, 1)
        self.imageEdit = QtWidgets.QLineEdit(parent=OpenSearchEditDialog)
        self.imageEdit.setObjectName("imageEdit")
        self.gridLayout.addWidget(self.imageEdit, 2, 1, 1, 1)
        self.verticalLayout.addLayout(self.gridLayout)
        self.label_4 = QtWidgets.QLabel(parent=OpenSearchEditDialog)
        self.label_4.setObjectName("label_4")
        self.verticalLayout.addWidget(self.label_4)
        self.searchEdit = QtWidgets.QLineEdit(parent=OpenSearchEditDialog)
        self.searchEdit.setObjectName("searchEdit")
        self.verticalLayout.addWidget(self.searchEdit)
        self.label_6 = QtWidgets.QLabel(parent=OpenSearchEditDialog)
        self.label_6.setObjectName("label_6")
        self.verticalLayout.addWidget(self.label_6)
        self.suggestionsEdit = QtWidgets.QLineEdit(parent=OpenSearchEditDialog)
        self.suggestionsEdit.setObjectName("suggestionsEdit")
        self.verticalLayout.addWidget(self.suggestionsEdit)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=OpenSearchEditDialog)
