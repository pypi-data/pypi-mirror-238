# Form implementation generated from reading ui file 'src/eric7/PluginManager/PluginDetailsDialog.ui'
#
...
class Ui_PluginDetailsDialog(object):
    def setupUi(self, PluginDetailsDialog):
        ...
        self.label = QtWidgets.QLabel(parent=PluginDetailsDialog)
        self.label.setObjectName("label")
        self.gridlayout.addWidget(self.label, 0, 0, 1, 1)
        self.moduleNameEdit = QtWidgets.QLineEdit(parent=PluginDetailsDialog)
        ...
        self.label_2 = QtWidgets.QLabel(parent=PluginDetailsDialog)
        self.label_2.setObjectName("label_2")
        self.gridlayout.addWidget(self.label_2, 1, 0, 1, 1)
        self.moduleFileNameEdit = QtWidgets.QLineEdit(parent=PluginDetailsDialog)
        ...
        self.autoactivateCheckBox = QtWidgets.QCheckBox(parent=PluginDetailsDialog)
        ...
        self.activeCheckBox = QtWidgets.QCheckBox(parent=PluginDetailsDialog)
        ...
        self.label_3 = QtWidgets.QLabel(parent=PluginDetailsDialog)
        self.label_3.setObjectName("label_3")
        self.gridlayout.addWidget(self.label_3, 3, 0, 1, 1)
        self.pluginNameEdit = QtWidgets.QLineEdit(parent=PluginDetailsDialog)
        ...
        self.label_4 = QtWidgets.QLabel(parent=PluginDetailsDialog)
        self.label_4.setObjectName("label_4")
        self.gridlayout.addWidget(self.label_4, 4, 0, 1, 1)
        self.versionEdit = QtWidgets.QLineEdit(parent=PluginDetailsDialog)
        ...
        self.label_5 = QtWidgets.QLabel(parent=PluginDetailsDialog)
        self.label_5.setObjectName("label_5")
        self.gridlayout.addWidget(self.label_5, 5, 0, 1, 1)
        self.authorEdit = QtWidgets.QLineEdit(parent=PluginDetailsDialog)
        ...
        self.label_6 = QtWidgets.QLabel(parent=PluginDetailsDialog)
        ...
        self.descriptionEdit = QtWidgets.QTextEdit(parent=PluginDetailsDialog)
        ...
        self.label_7 = QtWidgets.QLabel(parent=PluginDetailsDialog)
        ...
        self.errorEdit = QtWidgets.QTextEdit(parent=PluginDetailsDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=PluginDetailsDialog)
