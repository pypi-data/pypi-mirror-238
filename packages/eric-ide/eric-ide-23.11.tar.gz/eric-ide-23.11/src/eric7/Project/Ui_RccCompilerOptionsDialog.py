# Form implementation generated from reading ui file 'src/eric7/Project/RccCompilerOptionsDialog.ui'
#
...
class Ui_RccCompilerOptionsDialog(object):
    def setupUi(self, RccCompilerOptionsDialog):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=RccCompilerOptionsDialog)
        ...
        self.thresholdSpinBox = QtWidgets.QSpinBox(parent=self.groupBox)
        ...
        self.compressionSpinBox = QtWidgets.QSpinBox(parent=self.groupBox)
        ...
        self.disableCheckBox = QtWidgets.QCheckBox(parent=self.groupBox)
        ...
        self.label = QtWidgets.QLabel(parent=RccCompilerOptionsDialog)
        self.label.setObjectName("label")
        self.horizontalLayout.addWidget(self.label)
        self.rootEdit = QtWidgets.QLineEdit(parent=RccCompilerOptionsDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=RccCompilerOptionsDialog)
