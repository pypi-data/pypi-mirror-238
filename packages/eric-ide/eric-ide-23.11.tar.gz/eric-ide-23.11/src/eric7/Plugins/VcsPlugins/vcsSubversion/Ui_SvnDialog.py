# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsSubversion/SvnDialog.ui'
#
...
class Ui_SvnDialog(object):
    def setupUi(self, SvnDialog):
        ...
        self.outputGroup = QtWidgets.QGroupBox(parent=SvnDialog)
        ...
        self.errorGroup = QtWidgets.QGroupBox(parent=SvnDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.inputGroup = QtWidgets.QGroupBox(parent=SvnDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=SvnDialog)
