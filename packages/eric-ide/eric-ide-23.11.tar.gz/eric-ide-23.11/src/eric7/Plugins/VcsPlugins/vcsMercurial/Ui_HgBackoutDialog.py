# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsMercurial/HgBackoutDialog.ui'
#
...
class Ui_HgBackoutDialog(object):
    def setupUi(self, HgBackoutDialog):
        ...
        self.branchButton = QtWidgets.QRadioButton(parent=self.revisionGroup)
        self.branchButton.setObjectName("branchButton")
        self.gridLayout.addWidget(self.branchButton, 3, 0, 1, 1)
        self.branchCombo = QtWidgets.QComboBox(parent=self.revisionGroup)
        ...
        self.bookmarkButton = QtWidgets.QRadioButton(parent=self.revisionGroup)
        self.bookmarkButton.setObjectName("bookmarkButton")
        self.gridLayout.addWidget(self.bookmarkButton, 4, 0, 1, 1)
        self.bookmarkCombo = QtWidgets.QComboBox(parent=self.revisionGroup)
        ...
        self.expressionButton = QtWidgets.QRadioButton(parent=self.revisionGroup)
        self.expressionButton.setObjectName("expressionButton")
        self.gridLayout.addWidget(self.expressionButton, 5, 0, 1, 1)
        self.expressionEdit = QtWidgets.QLineEdit(parent=self.revisionGroup)
        ...
        self.noneButton = QtWidgets.QRadioButton(parent=self.revisionGroup)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(parent=HgBackoutDialog)
        ...
        self.mergeCheckBox = QtWidgets.QCheckBox(parent=HgBackoutDialog)
        self.mergeCheckBox.setObjectName("mergeCheckBox")
        self.verticalLayout_2.addWidget(self.mergeCheckBox)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=HgBackoutDialog)
        ...
        HgBackoutDialog.setTabOrder(self.bookmarkCombo, self.expressionButton)
        HgBackoutDialog.setTabOrder(self.expressionButton, self.expressionEdit)
        HgBackoutDialog.setTabOrder(self.expressionEdit, self.noneButton)
    ...
    def retranslateUi(self, HgBackoutDialog):
        ...
        self.expressionButton.setText(_translate("HgBackoutDialog", "Expression:"))
        self.expressionEdit.setToolTip(_translate("HgBackoutDialog", "Enter a revision set expression"))
