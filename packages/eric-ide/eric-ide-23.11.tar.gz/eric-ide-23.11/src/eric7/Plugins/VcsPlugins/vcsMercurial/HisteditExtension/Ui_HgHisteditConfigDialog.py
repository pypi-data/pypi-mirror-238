# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsMercurial/HisteditExtension/HgHisteditConfigDialog.ui'
#
...
class Ui_HgHisteditConfigDialog(object):
    def setupUi(self, HgHisteditConfigDialog):
        ...
        HgHisteditConfigDialog.resize(400, 477)
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=HgHisteditConfigDialog)
        self.groupBox.setObjectName("groupBox")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.groupBox)
        self.verticalLayout.setObjectName("verticalLayout")
        self.defaultButton = QtWidgets.QRadioButton(parent=self.groupBox)
        ...
        self.outgoingButton = QtWidgets.QRadioButton(parent=self.groupBox)
        self.outgoingButton.setObjectName("outgoingButton")
        self.verticalLayout.addWidget(self.outgoingButton)
        self.revisionButton = QtWidgets.QRadioButton(parent=self.groupBox)
        ...
        self.revisionGroupBox = QtWidgets.QGroupBox(parent=self.groupBox)
        ...
        self.numberSpinBox = QtWidgets.QSpinBox(parent=self.revisionGroupBox)
        ...
        self.bookmarkButton = QtWidgets.QRadioButton(parent=self.revisionGroupBox)
        self.bookmarkButton.setObjectName("bookmarkButton")
        self.gridLayout.addWidget(self.bookmarkButton, 4, 0, 1, 1)
        self.bookmarkCombo = QtWidgets.QComboBox(parent=self.revisionGroupBox)
        ...
        self.expressionButton = QtWidgets.QRadioButton(parent=self.revisionGroupBox)
        self.expressionButton.setObjectName("expressionButton")
        self.gridLayout.addWidget(self.expressionButton, 5, 0, 1, 1)
        self.expressionEdit = QtWidgets.QLineEdit(parent=self.revisionGroupBox)
        ...
        self.forceCheckBox = QtWidgets.QCheckBox(parent=HgHisteditConfigDialog)
        ...
        self.keepCheckBox = QtWidgets.QCheckBox(parent=HgHisteditConfigDialog)
        self.keepCheckBox.setObjectName("keepCheckBox")
        self.verticalLayout_2.addWidget(self.keepCheckBox)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=HgHisteditConfigDialog)
        ...
        HgHisteditConfigDialog.setTabOrder(self.bookmarkCombo, self.expressionButton)
        HgHisteditConfigDialog.setTabOrder(self.expressionButton, self.expressionEdit)
        HgHisteditConfigDialog.setTabOrder(self.expressionEdit, self.forceCheckBox)
    ...
    def retranslateUi(self, HgHisteditConfigDialog):
        ...
        self.expressionButton.setText(_translate("HgHisteditConfigDialog", "Expression:"))
        self.expressionEdit.setToolTip(_translate("HgHisteditConfigDialog", "Enter a revision set expression"))
