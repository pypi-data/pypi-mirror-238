# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsMercurial/HgBundleDialog.ui'
#
...
class Ui_HgBundleDialog(object):
    def setupUi(self, HgBundleDialog):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=HgBundleDialog)
        self.groupBox.setObjectName("groupBox")
        self.gridLayout = QtWidgets.QGridLayout(self.groupBox)
        self.gridLayout.setObjectName("gridLayout")
        self.multipleButton = QtWidgets.QRadioButton(parent=self.groupBox)
        self.multipleButton.setObjectName("multipleButton")
        self.gridLayout.addWidget(self.multipleButton, 0, 0, 1, 1)
        self.multipleEdit = QtWidgets.QPlainTextEdit(parent=self.groupBox)
        ...
        self.label_2 = QtWidgets.QLabel(parent=HgBundleDialog)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_2.addWidget(self.label_2)
        self.baseRevisionsEdit = QtWidgets.QPlainTextEdit(parent=HgBundleDialog)
        ...
        self.label = QtWidgets.QLabel(parent=HgBundleDialog)
        self.label.setObjectName("label")
        self.horizontalLayout.addWidget(self.label)
        self.compressionCombo = QtWidgets.QComboBox(parent=HgBundleDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.allCheckBox = QtWidgets.QCheckBox(parent=HgBundleDialog)
        self.allCheckBox.setObjectName("allCheckBox")
        self.verticalLayout.addWidget(self.allCheckBox)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=HgBundleDialog)
