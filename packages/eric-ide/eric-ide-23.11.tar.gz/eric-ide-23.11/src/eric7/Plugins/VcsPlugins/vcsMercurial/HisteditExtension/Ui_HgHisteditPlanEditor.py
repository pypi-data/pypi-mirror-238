# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsMercurial/HisteditExtension/HgHisteditPlanEditor.ui'
#
...
class Ui_HgHisteditPlanEditor(object):
    def setupUi(self, HgHisteditPlanEditor):
        ...
        self.splitter = QtWidgets.QSplitter(parent=HgHisteditPlanEditor)
        ...
        self.planTreeWidget = QtWidgets.QTreeWidget(parent=self.groupBox)
        ...
        self.infoEdit = QtWidgets.QPlainTextEdit(parent=self.groupBox_2)
        self.infoEdit.setReadOnly(True)
        self.infoEdit.setObjectName("infoEdit")
        self.verticalLayout.addWidget(self.infoEdit)
        self.verticalLayout_3.addWidget(self.splitter)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=HgHisteditPlanEditor)
