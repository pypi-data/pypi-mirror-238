# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsMercurial/HgBookmarksListDialog.ui'
#
...
class Ui_HgBookmarksListDialog(object):
    def setupUi(self, HgBookmarksListDialog):
        ...
        self.bookmarksList = QtWidgets.QTreeWidget(parent=HgBookmarksListDialog)
        ...
        self.errorGroup = QtWidgets.QGroupBox(parent=HgBookmarksListDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=HgBookmarksListDialog)
