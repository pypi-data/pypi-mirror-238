# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsGit/GitDialog.ui'
#
...
class Ui_GitDialog(object):
    def setupUi(self, GitDialog):
        ...
        self.outputGroup = QtWidgets.QGroupBox(parent=GitDialog)
        ...
        self.statusLabel = QtWidgets.QLabel(parent=GitDialog)
        self.statusLabel.setObjectName("statusLabel")
        self.vboxlayout.addWidget(self.statusLabel)
        self.errorGroup = QtWidgets.QGroupBox(parent=GitDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.inputGroup = QtWidgets.QGroupBox(parent=GitDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=GitDialog)
