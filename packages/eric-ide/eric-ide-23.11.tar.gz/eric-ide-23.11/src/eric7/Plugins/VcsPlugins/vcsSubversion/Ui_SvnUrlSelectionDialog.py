# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsSubversion/SvnUrlSelectionDialog.ui'
#
...
class Ui_SvnUrlSelectionDialog(object):
    def setupUi(self, SvnUrlSelectionDialog):
        ...
        self.summaryCheckBox = QtWidgets.QCheckBox(parent=SvnUrlSelectionDialog)
        self.summaryCheckBox.setObjectName("summaryCheckBox")
        self.vboxlayout.addWidget(self.summaryCheckBox)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=SvnUrlSelectionDialog)
