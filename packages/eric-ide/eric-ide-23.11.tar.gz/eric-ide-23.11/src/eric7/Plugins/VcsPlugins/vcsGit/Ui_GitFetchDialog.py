# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsGit/GitFetchDialog.ui'
#
...
class Ui_GitFetchDialog(object):
    def setupUi(self, GitFetchDialog):
        ...
        self.label = QtWidgets.QLabel(parent=GitFetchDialog)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 0, 0, 1, 1)
        self.remotesComboBox = QtWidgets.QComboBox(parent=GitFetchDialog)
        self.remotesComboBox.setObjectName("remotesComboBox")
        self.gridLayout.addWidget(self.remotesComboBox, 0, 1, 1, 1)
        self.remoteEdit = QtWidgets.QLineEdit(parent=GitFetchDialog)
        ...
        self.label_2 = QtWidgets.QLabel(parent=GitFetchDialog)
        ...
        self.updateButton = QtWidgets.QPushButton(parent=GitFetchDialog)
        self.updateButton.setObjectName("updateButton")
        self.verticalLayout.addWidget(self.updateButton)
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.verticalLayout.addItem(spacerItem)
        self.gridLayout.addLayout(self.verticalLayout, 2, 0, 1, 1)
        self.remoteBranchesList = QtWidgets.QListWidget(parent=GitFetchDialog)
        ...
        self.label_3 = QtWidgets.QLabel(parent=GitFetchDialog)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 3, 0, 1, 1)
        self.localBranchComboBox = QtWidgets.QComboBox(parent=GitFetchDialog)
