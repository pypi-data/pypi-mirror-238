# Form implementation generated from reading ui file 'src/eric7/Plugins/WizardPlugins/MessageBoxWizard/MessageBoxWizardDialog.ui'
#
...
class Ui_MessageBoxWizardDialog(object):
    def setupUi(self, MessageBoxWizardDialog):
        ...
        self.rWarning = QtWidgets.QRadioButton(parent=self.groupBox)
        ...
        self.rCritical = QtWidgets.QRadioButton(parent=self.groupBox)
        ...
        self.rAbout = QtWidgets.QRadioButton(parent=self.groupBox)
        ...
        self.rAboutQt = QtWidgets.QRadioButton(parent=self.groupBox)
        ...
        self.standardButtons = QtWidgets.QGroupBox(parent=MessageBoxWizardDialog)
        ...
        self.TextLabel1_2 = QtWidgets.QLabel(parent=self.standardButtons)
        self.TextLabel1_2.setObjectName("TextLabel1_2")
        self.hboxlayout1.addWidget(self.TextLabel1_2)
        self.defaultCombo = QtWidgets.QComboBox(parent=self.standardButtons)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=MessageBoxWizardDialog)
