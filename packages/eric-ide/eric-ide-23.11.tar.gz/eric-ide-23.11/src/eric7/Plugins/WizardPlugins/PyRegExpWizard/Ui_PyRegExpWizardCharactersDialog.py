# Form implementation generated from reading ui file 'src/eric7/Plugins/WizardPlugins/PyRegExpWizard/PyRegExpWizardCharactersDialog.ui'
#
...
class Ui_PyRegExpWizardCharactersDialog(object):
    def setupUi(self, PyRegExpWizardCharactersDialog):
        ...
        self.negativeCheckBox = QtWidgets.QCheckBox(parent=PyRegExpWizardCharactersDialog)
        self.negativeCheckBox.setObjectName("negativeCheckBox")
        self.vboxlayout.addWidget(self.negativeCheckBox)
        self.groupBox = QtWidgets.QGroupBox(parent=PyRegExpWizardCharactersDialog)
        ...
        self.singlesBox = QtWidgets.QGroupBox(parent=PyRegExpWizardCharactersDialog)
        ...
        self.rangesBox = QtWidgets.QGroupBox(parent=PyRegExpWizardCharactersDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=PyRegExpWizardCharactersDialog)
