# Form implementation generated from reading ui file 'src/eric7/Plugins/WizardPlugins/QRegularExpressionWizard/QRegularExpressionWizardRepeatDialog.ui'
#
...
class Ui_QRegularExpressionWizardRepeatDialog(object):
    def setupUi(self, QRegularExpressionWizardRepeatDialog):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=QRegularExpressionWizardRepeatDialog)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(parent=QRegularExpressionWizardRepeatDialog)
        self.groupBox_2.setObjectName("groupBox_2")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.groupBox_2)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.greedyButton = QtWidgets.QRadioButton(parent=self.groupBox_2)
        self.greedyButton.setObjectName("greedyButton")
        self.verticalLayout_2.addWidget(self.greedyButton)
        self.possessiveButton = QtWidgets.QRadioButton(parent=self.groupBox_2)
        self.possessiveButton.setObjectName("possessiveButton")
        self.verticalLayout_2.addWidget(self.possessiveButton)
        self.lazyButton = QtWidgets.QRadioButton(parent=self.groupBox_2)
        self.lazyButton.setObjectName("lazyButton")
        self.verticalLayout_2.addWidget(self.lazyButton)
        self.verticalLayout.addWidget(self.groupBox_2)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=QRegularExpressionWizardRepeatDialog)
