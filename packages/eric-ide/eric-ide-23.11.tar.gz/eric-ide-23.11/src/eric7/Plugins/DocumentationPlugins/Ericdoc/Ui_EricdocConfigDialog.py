# Form implementation generated from reading ui file 'src/eric7/Plugins/DocumentationPlugins/Ericdoc/EricdocConfigDialog.ui'
#
...
class Ui_EricdocConfigDialog(object):
    def setupUi(self, EricdocConfigDialog):
        ...
        self.startDirPicker = EricPathPicker(parent=self.generalTab)
        ...
        self.horizontalLayout.addWidget(self.startDirPicker)
        self.verticalLayout_2.addLayout(self.horizontalLayout)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.TextLabel6 = QtWidgets.QLabel(parent=self.generalTab)
        self.TextLabel6.setObjectName("TextLabel6")
        self.horizontalLayout_2.addWidget(self.TextLabel6)
        self.outputDirPicker = EricPathPicker(parent=self.generalTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.textLabel1_3 = QtWidgets.QLabel(parent=self.generalTab)
        self.textLabel1_3.setObjectName("textLabel1_3")
        self.hboxlayout.addWidget(self.textLabel1_3)
        self.sourceExtEdit = QtWidgets.QLineEdit(parent=self.generalTab)
        ...
        self.recursionCheckBox = QtWidgets.QCheckBox(parent=self.generalTab)
        self.recursionCheckBox.setObjectName("recursionCheckBox")
        self.hboxlayout1.addWidget(self.recursionCheckBox)
        self.noindexCheckBox = QtWidgets.QCheckBox(parent=self.generalTab)
        ...
        self.noemptyCheckBox = QtWidgets.QCheckBox(parent=self.generalTab)
        ...
        self.excludeFilesEdit = QtWidgets.QLineEdit(parent=self.generalTab)
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(parent=self.styleTab)
        self.groupBox_3.setObjectName("groupBox_3")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.groupBox_3)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.cssPicker = EricPathPicker(parent=self.groupBox_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.qtHelpGroup = QtWidgets.QGroupBox(parent=self.qtHelpTab)
        ...
        self.gridLayout.setObjectName("gridLayout")
        self.TextLabel6_2 = QtWidgets.QLabel(parent=self.qtHelpGroup)
        self.TextLabel6_2.setObjectName("TextLabel6_2")
        self.gridLayout.addWidget(self.TextLabel6_2, 0, 0, 1, 1)
        self.qtHelpDirPicker = EricPathPicker(parent=self.qtHelpGroup)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_2 = QtWidgets.QLabel(parent=self.qtHelpGroup)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 1, 0, 1, 1)
        self.qtHelpNamespaceEdit = QtWidgets.QLineEdit(parent=self.qtHelpGroup)
        self.qtHelpNamespaceEdit.setObjectName("qtHelpNamespaceEdit")
        self.gridLayout.addWidget(self.qtHelpNamespaceEdit, 1, 1, 1, 1)
        self.label_3 = QtWidgets.QLabel(parent=self.qtHelpGroup)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 2, 0, 1, 1)
        self.qtHelpFolderEdit = QtWidgets.QLineEdit(parent=self.qtHelpGroup)
        self.qtHelpFolderEdit.setObjectName("qtHelpFolderEdit")
        self.gridLayout.addWidget(self.qtHelpFolderEdit, 2, 1, 1, 1)
        self.label_4 = QtWidgets.QLabel(parent=self.qtHelpGroup)
        self.label_4.setObjectName("label_4")
        self.gridLayout.addWidget(self.label_4, 3, 0, 1, 1)
        self.qtHelpFilterNameEdit = QtWidgets.QLineEdit(parent=self.qtHelpGroup)
        self.qtHelpFilterNameEdit.setObjectName("qtHelpFilterNameEdit")
        self.gridLayout.addWidget(self.qtHelpFilterNameEdit, 3, 1, 1, 1)
        self.label_5 = QtWidgets.QLabel(parent=self.qtHelpGroup)
        self.label_5.setObjectName("label_5")
        self.gridLayout.addWidget(self.label_5, 4, 0, 1, 1)
        self.qtHelpFilterAttributesEdit = QtWidgets.QLineEdit(parent=self.qtHelpGroup)
        ...
        self.label_6 = QtWidgets.QLabel(parent=self.qtHelpGroup)
        self.label_6.setObjectName("label_6")
        self.gridLayout.addWidget(self.label_6, 5, 0, 1, 1)
        self.qtHelpTitleEdit = QtWidgets.QLineEdit(parent=self.qtHelpGroup)
        self.qtHelpTitleEdit.setObjectName("qtHelpTitleEdit")
        self.gridLayout.addWidget(self.qtHelpTitleEdit, 5, 1, 1, 1)
        self.qtHelpGenerateCollectionCheckBox = QtWidgets.QCheckBox(parent=self.qtHelpGroup)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=EricdocConfigDialog)
        ...
        EricdocConfigDialog.setTabOrder(self.tabWidget, self.startDirPicker)
        EricdocConfigDialog.setTabOrder(self.startDirPicker, self.outputDirPicker)
    ...
    def retranslateUi(self, EricdocConfigDialog):
        ...
        self.label_7.setText(_translate("EricdocConfigDialog", "Start Directory:"))
        self.startDirPicker.setToolTip(_translate("EricdocConfigDialog", "Enter the start directory for the documentation"))
