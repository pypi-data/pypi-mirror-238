...
class Ui_TranslatorPage(object):
    def setupUi(self, TranslatorPage):
        ...
        TranslatorPage.resize(500, 1389)
        ...
        self.groupBox_8 = QtWidgets.QGroupBox(parent=TranslatorPage)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(parent=TranslatorPage)
        ...
        self.groupBox_5 = QtWidgets.QGroupBox(parent=TranslatorPage)
        ...
        self.groupBox_7 = QtWidgets.QGroupBox(parent=TranslatorPage)
        ...
        self.groupBox_10 = QtWidgets.QGroupBox(parent=TranslatorPage)
        ...
        self.groupBox_6 = QtWidgets.QGroupBox(parent=TranslatorPage)
        ...
        self.groupBox_4 = QtWidgets.QGroupBox(parent=TranslatorPage)
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(parent=TranslatorPage)
        ...
        TranslatorPage.setTabOrder(self.pronounceCheckBox, self.deeplKeyEdit)
        ...
        TranslatorPage.setTabOrder(self.ibmKeyEdit, self.libreUrlEdit)
        TranslatorPage.setTabOrder(self.libreUrlEdit, self.libreKeyEdit)
        TranslatorPage.setTabOrder(self.libreKeyEdit, self.msSubscriptionKeyEdit)
        TranslatorPage.setTabOrder(self.msSubscriptionKeyEdit, self.msSubscriptionRegionEdit)
        TranslatorPage.setTabOrder(self.msSubscriptionRegionEdit, self.mymemoryEmailEdit)
    ...
    def retranslateUi(self, TranslatorPage):
        ...
        self.groupBox_8.setTitle(_translate("TranslatorPage", "DeepL"))
        self.label_8.setText(_translate("TranslatorPage", "Key:"))
        self.deeplKeyEdit.setToolTip(_translate("TranslatorPage", "Enter your DeepL Pro or DeepL Free API key"))
        ...
        self.groupBox_10.setTitle(_translate("TranslatorPage", "LibreTranslate"))
        self.label_11.setText(_translate("TranslatorPage", "URL:"))
        self.libreUrlEdit.setToolTip(_translate("TranslatorPage", "Enter the URL of your LibreTranslate server."))
        self.label_12.setText(_translate("TranslatorPage", "API Key:"))
        self.libreKeyEdit.setToolTip(_translate("TranslatorPage", "Enter your LibreTranslate API key"))
        self.groupBox_6.setTitle(_translate("TranslatorPage", "Microsoft Azure"))
        self.label_9.setText(_translate("TranslatorPage", "Subscription Region:"))
        ...
        self.msSubscriptionRegionEdit.setToolTip(_translate("TranslatorPage", "Enter the subscription region of the text translator service"))
