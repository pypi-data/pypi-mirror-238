# Form implementation generated from reading ui file 'src/eric7/Preferences/ConfigurationPages/EditorCalltipsPage.ui'
#
...
class Ui_EditorCalltipsPage(object):
    def setupUi(self, EditorCalltipsPage):
        ...
        self.headerLabel = QtWidgets.QLabel(parent=EditorCalltipsPage)
        self.headerLabel.setObjectName("headerLabel")
        self.verticalLayout_3.addWidget(self.headerLabel)
        self.line18 = QtWidgets.QFrame(parent=EditorCalltipsPage)
        ...
        self.ctEnabledCheckBox = QtWidgets.QCheckBox(parent=EditorCalltipsPage)
        self.ctEnabledCheckBox.setObjectName("ctEnabledCheckBox")
        self.verticalLayout_3.addWidget(self.ctEnabledCheckBox)
        self.frame = QtWidgets.QFrame(parent=EditorCalltipsPage)
        ...
        self.calltipsVisibleBox = QtWidgets.QGroupBox(parent=EditorCalltipsPage)
        self.calltipsVisibleBox.setObjectName("calltipsVisibleBox")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.calltipsVisibleBox)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.ctVisibleSlider = QtWidgets.QSlider(parent=self.calltipsVisibleBox)
        ...
        self.lCDNumber5 = QtWidgets.QLCDNumber(parent=self.calltipsVisibleBox)
        ...
        self.verticalLayout_3.addWidget(self.calltipsVisibleBox)
        self.calltipsPositionBox = QtWidgets.QGroupBox(parent=EditorCalltipsPage)
        ...
        self.positionComboBox = QtWidgets.QComboBox(parent=self.calltipsPositionBox)
        ...
        self.calltipsColorsBox = QtWidgets.QGroupBox(parent=EditorCalltipsPage)
        self.calltipsColorsBox.setObjectName("calltipsColorsBox")
        self.gridLayout = QtWidgets.QGridLayout(self.calltipsColorsBox)
        self.gridLayout.setObjectName("gridLayout")
        self.TextLabel2_2_2_2 = QtWidgets.QLabel(parent=self.calltipsColorsBox)
        self.TextLabel2_2_2_2.setObjectName("TextLabel2_2_2_2")
        self.gridLayout.addWidget(self.TextLabel2_2_2_2, 0, 0, 1, 1)
        self.calltipsBackgroundButton = QtWidgets.QPushButton(parent=self.calltipsColorsBox)
        ...
        self.TextLabel2_2_2_3 = QtWidgets.QLabel(parent=self.calltipsColorsBox)
        self.TextLabel2_2_2_3.setObjectName("TextLabel2_2_2_3")
        self.gridLayout.addWidget(self.TextLabel2_2_2_3, 1, 0, 1, 1)
        self.calltipsForegroundButton = QtWidgets.QPushButton(parent=self.calltipsColorsBox)
        ...
        self.TextLabel2_2_2_4 = QtWidgets.QLabel(parent=self.calltipsColorsBox)
        self.TextLabel2_2_2_4.setObjectName("TextLabel2_2_2_4")
        self.gridLayout.addWidget(self.TextLabel2_2_2_4, 2, 0, 1, 1)
        self.calltipsHighlightButton = QtWidgets.QPushButton(parent=self.calltipsColorsBox)
        ...
        self.verticalLayout_3.addWidget(self.calltipsColorsBox)
        self.pluginsBox = QtWidgets.QGroupBox(parent=EditorCalltipsPage)
        self.pluginsBox.setObjectName("pluginsBox")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.pluginsBox)
        self.verticalLayout.setObjectName("verticalLayout")
        self.ctScintillaCheckBox = QtWidgets.QCheckBox(parent=self.pluginsBox)
        self.ctScintillaCheckBox.setObjectName("ctScintillaCheckBox")
        self.verticalLayout.addWidget(self.ctScintillaCheckBox)
        self.verticalLayout_3.addWidget(self.pluginsBox)
    ...
    def retranslateUi(self, EditorCalltipsPage):
        ...
        self.calltipsVisibleBox.setTitle(_translate("EditorCalltipsPage", "Visible Calltips"))
        ...
        self.calltipsColorsBox.setTitle(_translate("EditorCalltipsPage", "Colors"))
        ...
        self.pluginsBox.setTitle(_translate("EditorCalltipsPage", "Plug-In Behavior"))
