...
class Ui_EditorSearchPage(object):
    def setupUi(self, EditorSearchPage):
        ...
        EditorSearchPage.resize(576, 498)
        ...
        self.quicksearchCheckBox = QtWidgets.QCheckBox(parent=EditorSearchPage)
        ...
        self.quicksearchMarkersEnabledCheckBox = QtWidgets.QCheckBox(parent=self.searckMarkersBox)
        ...
        self.verticalLayout_2.addWidget(self.searckMarkersBox)
        ...
        EditorSearchPage.setTabOrder(self.quicksearchCheckBox, self.occurrencesMarkersEnabledCheckBox)
