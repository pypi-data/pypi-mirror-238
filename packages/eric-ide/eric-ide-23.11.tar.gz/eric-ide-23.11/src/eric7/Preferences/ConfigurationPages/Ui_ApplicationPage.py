...
class Ui_ApplicationPage(object):
    def setupUi(self, ApplicationPage):
        ...
        ApplicationPage.resize(589, 748)
        ...
        self.crashSessionEnabledCheckBox = QtWidgets.QCheckBox(parent=ApplicationPage)
        ...
        self.openCrashSessionCheckBox = QtWidgets.QCheckBox(parent=self.groupBox_3)
        ...
        ApplicationPage.setTabOrder(self.upgraderDelaySpinBox, self.systemEmailClientCheckBox)
