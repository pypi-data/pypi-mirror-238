# Form implementation generated from reading ui file 'src/eric7/Preferences/ConfigurationPages/CooperationPage.ui'
#
...
class Ui_CooperationPage(object):
    def setupUi(self, CooperationPage):
        ...
        self.headerLabel = QtWidgets.QLabel(parent=CooperationPage)
        self.headerLabel.setObjectName("headerLabel")
        self.verticalLayout_2.addWidget(self.headerLabel)
        self.line11 = QtWidgets.QFrame(parent=CooperationPage)
        ...
        self.otherPortsCheckBox = QtWidgets.QCheckBox(parent=self.serverGroup)
        self.otherPortsCheckBox.setObjectName("otherPortsCheckBox")
        self.gridLayout.addWidget(self.otherPortsCheckBox, 2, 0, 1, 3)
        self.label_2 = QtWidgets.QLabel(parent=self.serverGroup)
        self.label_2.setEnabled(False)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 3, 0, 1, 1)
        self.portToTrySpin = QtWidgets.QSpinBox(parent=self.serverGroup)
        ...
        self.connectionsGroup = QtWidgets.QGroupBox(parent=CooperationPage)
        ...
        self.autoAcceptCheckBox = QtWidgets.QCheckBox(parent=self.connectionsGroup)
        ...
        self.bannedUsersGroup = QtWidgets.QGroupBox(parent=CooperationPage)
        ...
        self.bannedUsersList = QtWidgets.QListWidget(parent=self.bannedUsersGroup)
        ...
        self.deleteBannedUsersButton = QtWidgets.QPushButton(parent=self.bannedUsersGroup)
        ...
        self.bannedUserEdit = QtWidgets.QLineEdit(parent=self.bannedUsersGroup)
        self.bannedUserEdit.setObjectName("bannedUserEdit")
        self.gridLayout_2.addWidget(self.bannedUserEdit, 1, 1, 1, 1)
        self.addBannedUserButton = QtWidgets.QPushButton(parent=self.bannedUsersGroup)
