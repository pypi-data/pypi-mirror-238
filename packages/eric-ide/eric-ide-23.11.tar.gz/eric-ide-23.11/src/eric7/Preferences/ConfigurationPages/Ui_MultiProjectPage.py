# Form implementation generated from reading ui file 'src/eric7/Preferences/ConfigurationPages/MultiProjectPage.ui'
#
...
class Ui_MultiProjectPage(object):
    def setupUi(self, MultiProjectPage):
        ...
        self.headerLabel = QtWidgets.QLabel(parent=MultiProjectPage)
        self.headerLabel.setObjectName("headerLabel")
        self.verticalLayout.addWidget(self.headerLabel)
        self.line8 = QtWidgets.QFrame(parent=MultiProjectPage)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(parent=MultiProjectPage)
        self.groupBox_2.setObjectName("groupBox_2")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.groupBox_2)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.workspacePicker = EricPathPicker(parent=self.groupBox_2)
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=MultiProjectPage)
        self.groupBox.setObjectName("groupBox")
        self.vboxlayout = QtWidgets.QVBoxLayout(self.groupBox)
        self.vboxlayout.setObjectName("vboxlayout")
        self.openMainAutomaticallyCheckBox = QtWidgets.QCheckBox(parent=self.groupBox)
        self.openMainAutomaticallyCheckBox.setObjectName("openMainAutomaticallyCheckBox")
        self.vboxlayout.addWidget(self.openMainAutomaticallyCheckBox)
        self.verticalLayout.addWidget(self.groupBox)
        self.groupBox_6 = QtWidgets.QGroupBox(parent=MultiProjectPage)
        self.groupBox_6.setObjectName("groupBox_6")
        self.vboxlayout1 = QtWidgets.QVBoxLayout(self.groupBox_6)
        self.vboxlayout1.setObjectName("vboxlayout1")
        self.multiProjectTimestampCheckBox = QtWidgets.QCheckBox(parent=self.groupBox_6)
        ...
        self.groupBox_7 = QtWidgets.QGroupBox(parent=MultiProjectPage)
        ...
        self.multiProjectRecentSpinBox = QtWidgets.QSpinBox(parent=self.groupBox_7)
        ...
        MultiProjectPage.setTabOrder(self.workspacePicker, self.openMainAutomaticallyCheckBox)
        MultiProjectPage.setTabOrder(self.openMainAutomaticallyCheckBox, self.multiProjectTimestampCheckBox)
    ...
    def retranslateUi(self, MultiProjectPage):
        ...
        self.groupBox.setTitle(_translate("MultiProjectPage", "Main Project"))
        self.openMainAutomaticallyCheckBox.setToolTip(_translate("MultiProjectPage", "Select to open the main project automatically upon opening the multiproject"))
        self.openMainAutomaticallyCheckBox.setText(_translate("MultiProjectPage", "Open main project automatically"))
