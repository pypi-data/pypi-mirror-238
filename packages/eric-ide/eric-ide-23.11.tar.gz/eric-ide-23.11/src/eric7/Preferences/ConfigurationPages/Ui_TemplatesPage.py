# Form implementation generated from reading ui file 'src/eric7/Preferences/ConfigurationPages/TemplatesPage.ui'
#
...
class Ui_TemplatesPage(object):
    def setupUi(self, TemplatesPage):
        ...
        self.headerLabel = QtWidgets.QLabel(parent=TemplatesPage)
        self.headerLabel.setObjectName("headerLabel")
        self.verticalLayout.addWidget(self.headerLabel)
        self.line11_2_2_2_2_2 = QtWidgets.QFrame(parent=TemplatesPage)
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=TemplatesPage)
        self.groupBox.setObjectName("groupBox")
        self.vboxlayout = QtWidgets.QVBoxLayout(self.groupBox)
        self.vboxlayout.setObjectName("vboxlayout")
        self.templatesAutoOpenGroupsCheckBox = QtWidgets.QCheckBox(parent=self.groupBox)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(parent=TemplatesPage)
        self.groupBox_2.setObjectName("groupBox_2")
        self.vboxlayout1 = QtWidgets.QVBoxLayout(self.groupBox_2)
        self.vboxlayout1.setObjectName("vboxlayout1")
        self.hboxlayout = QtWidgets.QHBoxLayout()
        self.hboxlayout.setObjectName("hboxlayout")
        self.textLabel1_19 = QtWidgets.QLabel(parent=self.groupBox_2)
        self.textLabel1_19.setObjectName("textLabel1_19")
        self.hboxlayout.addWidget(self.textLabel1_19)
        self.templatesSeparatorCharEdit = QtWidgets.QLineEdit(parent=self.groupBox_2)
        ...
        self.templatesMultiDialogButton = QtWidgets.QRadioButton(parent=self.groupBox_3)
        ...
        self.templatesSingleDialogButton = QtWidgets.QRadioButton(parent=self.groupBox_3)
        ...
        self.groupBox_4 = QtWidgets.QGroupBox(parent=TemplatesPage)
        self.groupBox_4.setObjectName("groupBox_4")
        self.vboxlayout3 = QtWidgets.QVBoxLayout(self.groupBox_4)
        self.vboxlayout3.setObjectName("vboxlayout3")
        self.templatesToolTipCheckBox = QtWidgets.QCheckBox(parent=self.groupBox_4)
        ...
        self.groupBox_5 = QtWidgets.QGroupBox(parent=TemplatesPage)
        self.groupBox_5.setObjectName("groupBox_5")
        self.gridLayout = QtWidgets.QGridLayout(self.groupBox_5)
        self.gridLayout.setObjectName("gridLayout")
        self.editorFontButton = QtWidgets.QPushButton(parent=self.groupBox_5)
        self.editorFontButton.setObjectName("editorFontButton")
        self.gridLayout.addWidget(self.editorFontButton, 0, 0, 1, 1)
        self.editorFontSample = QtWidgets.QLineEdit(parent=self.groupBox_5)
