# Form implementation generated from reading ui file 'src/eric7/Preferences/ConfigurationPages/EditorExportersPage.ui'
#
...
class Ui_EditorExportersPage(object):
    def setupUi(self, EditorExportersPage):
        ...
        self.headerLabel = QtWidgets.QLabel(parent=EditorExportersPage)
        self.headerLabel.setObjectName("headerLabel")
        self.verticalLayout_10.addWidget(self.headerLabel)
        self.line1 = QtWidgets.QFrame(parent=EditorExportersPage)
        ...
        self.TextLabel1_3 = QtWidgets.QLabel(parent=EditorExportersPage)
        self.TextLabel1_3.setObjectName("TextLabel1_3")
        self.hboxlayout.addWidget(self.TextLabel1_3)
        self.exportersCombo = QtWidgets.QComboBox(parent=EditorExportersPage)
        ...
        self.stackedWidget = QtWidgets.QStackedWidget(parent=EditorExportersPage)
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(parent=self.odtPage)
        self.groupBox_3.setTitle("")
        self.groupBox_3.setObjectName("groupBox_3")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.groupBox_3)
        self.verticalLayout.setObjectName("verticalLayout")
        self.odtWysiwygCheckBox = QtWidgets.QCheckBox(parent=self.groupBox_3)
        self.odtWysiwygCheckBox.setObjectName("odtWysiwygCheckBox")
        self.verticalLayout.addWidget(self.odtWysiwygCheckBox)
        self.odtStylesCheckBox = QtWidgets.QCheckBox(parent=self.groupBox_3)
        self.odtStylesCheckBox.setObjectName("odtStylesCheckBox")
        self.verticalLayout.addWidget(self.odtStylesCheckBox)
        self.odtTabsCheckBox = QtWidgets.QCheckBox(parent=self.groupBox_3)
        ...
        self.groupBox_4 = QtWidgets.QGroupBox(parent=self.pdfPage)
        ...
        self.pdfMagnificationSlider = QtWidgets.QSlider(parent=self.groupBox_4)
        ...
        self.pdfMagnificationLCD = QtWidgets.QLCDNumber(parent=self.groupBox_4)
        ...
        self.pdfFontCombo = QtWidgets.QComboBox(parent=self.groupBox_4)
        ...
        self.pdfPageSizeCombo = QtWidgets.QComboBox(parent=self.groupBox_4)
        ...
        self.gridlayout.setObjectName("gridlayout")
        self.pdfMarginTopSpin = QtWidgets.QSpinBox(parent=self.groupBox)
        ...
        self.pdfMarginLeftSpin = QtWidgets.QSpinBox(parent=self.groupBox)
        ...
        self.pdfMarginRightSpin = QtWidgets.QSpinBox(parent=self.groupBox)
        ...
        self.pdfMarginBottomSpin = QtWidgets.QSpinBox(parent=self.groupBox)
        ...
        self.groupBox_5 = QtWidgets.QGroupBox(parent=self.rtfPage)
        self.groupBox_5.setTitle("")
        self.groupBox_5.setObjectName("groupBox_5")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.groupBox_5)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.rtfWysiwygCheckBox = QtWidgets.QCheckBox(parent=self.groupBox_5)
        ...
        self.rtfFontButton = QtWidgets.QPushButton(parent=self.groupBox_5)
        self.rtfFontButton.setObjectName("rtfFontButton")
        self.hboxlayout1.addWidget(self.rtfFontButton)
        self.rtfFontSample = QtWidgets.QLineEdit(parent=self.groupBox_5)
        ...
        self.rtfTabsCheckBox = QtWidgets.QCheckBox(parent=self.groupBox_5)
