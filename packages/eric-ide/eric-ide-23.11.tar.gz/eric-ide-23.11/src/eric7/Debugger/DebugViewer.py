...
class DebugViewer(QWidget):
    ...
    def __clientLine(self, fn, line, debuggerId, threadName):  # noqa: U100
        """
    ...
    def __clientException(
        self,
        exceptionType,  # noqa: U100
        exceptionMessage,  # noqa: U100
        stackTrace,  # noqa: U100
        debuggerId,
        threadName,
    ):
        """
    ...
    def __debuggerSelected(self, current, previous):  # noqa: U100
        """
