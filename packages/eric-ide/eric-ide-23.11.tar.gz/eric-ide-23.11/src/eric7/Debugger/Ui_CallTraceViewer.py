# Form implementation generated from reading ui file 'src/eric7/Debugger/CallTraceViewer.ui'
#
...
class Ui_CallTraceViewer(object):
    def setupUi(self, CallTraceViewer):
        ...
        self.startTraceButton = QtWidgets.QToolButton(parent=CallTraceViewer)
        ...
        self.stopTraceButton = QtWidgets.QToolButton(parent=CallTraceViewer)
        ...
        self.stopCheckBox = QtWidgets.QCheckBox(parent=CallTraceViewer)
        ...
        self.resizeButton = QtWidgets.QToolButton(parent=CallTraceViewer)
        ...
        self.clearButton = QtWidgets.QToolButton(parent=CallTraceViewer)
        self.clearButton.setText("Clear")
        self.clearButton.setObjectName("clearButton")
        self.horizontalLayout.addWidget(self.clearButton)
        self.saveButton = QtWidgets.QToolButton(parent=CallTraceViewer)
        self.saveButton.setText("Save")
        self.saveButton.setObjectName("saveButton")
        self.horizontalLayout.addWidget(self.saveButton)
        self.verticalLayout.addLayout(self.horizontalLayout)
        self.callTrace = QtWidgets.QTreeWidget(parent=CallTraceViewer)
