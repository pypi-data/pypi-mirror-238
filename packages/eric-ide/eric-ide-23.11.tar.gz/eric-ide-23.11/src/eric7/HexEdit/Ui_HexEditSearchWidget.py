# Form implementation generated from reading ui file 'src/eric7/HexEdit/HexEditSearchWidget.ui'
#
...
class Ui_HexEditSearchWidget(object):
    def setupUi(self, HexEditSearchWidget):
        ...
        self.closeButton = QtWidgets.QToolButton(parent=HexEditSearchWidget)
        self.closeButton.setText("")
        self.closeButton.setObjectName("closeButton")
        self.horizontalLayout_2.addWidget(self.closeButton)
        self.label = QtWidgets.QLabel(parent=HexEditSearchWidget)
        self.label.setObjectName("label")
        self.horizontalLayout_2.addWidget(self.label)
        self.findFormatCombo = QtWidgets.QComboBox(parent=HexEditSearchWidget)
        self.findFormatCombo.setObjectName("findFormatCombo")
        self.horizontalLayout_2.addWidget(self.findFormatCombo)
        self.findtextCombo = QtWidgets.QComboBox(parent=HexEditSearchWidget)
        ...
        self.findPrevButton = QtWidgets.QToolButton(parent=HexEditSearchWidget)
        self.findPrevButton.setObjectName("findPrevButton")
        self.horizontalLayout.addWidget(self.findPrevButton)
        self.findNextButton = QtWidgets.QToolButton(parent=HexEditSearchWidget)
