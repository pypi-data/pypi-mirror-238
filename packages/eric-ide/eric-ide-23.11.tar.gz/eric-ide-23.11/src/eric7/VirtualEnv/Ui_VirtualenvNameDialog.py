# Form implementation generated from reading ui file 'src/eric7/VirtualEnv/VirtualenvNameDialog.ui'
#
...
class Ui_VirtualenvNameDialog(object):
    def setupUi(self, VirtualenvNameDialog):
        ...
        self.envsList = QtWidgets.QListWidget(parent=VirtualenvNameDialog)
        ...
        self.label = QtWidgets.QLabel(parent=VirtualenvNameDialog)
        self.label.setObjectName("label")
        self.verticalLayout.addWidget(self.label)
        self.nameEdit = QtWidgets.QLineEdit(parent=VirtualenvNameDialog)
        self.nameEdit.setClearButtonEnabled(True)
        self.nameEdit.setObjectName("nameEdit")
        self.verticalLayout.addWidget(self.nameEdit)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=VirtualenvNameDialog)
