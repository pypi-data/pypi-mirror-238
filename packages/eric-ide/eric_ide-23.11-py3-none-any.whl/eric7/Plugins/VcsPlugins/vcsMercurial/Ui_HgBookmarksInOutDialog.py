# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsMercurial/HgBookmarksInOutDialog.ui'
#
...
class Ui_HgBookmarksInOutDialog(object):
    def setupUi(self, HgBookmarksInOutDialog):
        ...
        self.bookmarksList = QtWidgets.QTreeWidget(parent=HgBookmarksInOutDialog)
        ...
        self.errorGroup = QtWidgets.QGroupBox(parent=HgBookmarksInOutDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=HgBookmarksInOutDialog)
