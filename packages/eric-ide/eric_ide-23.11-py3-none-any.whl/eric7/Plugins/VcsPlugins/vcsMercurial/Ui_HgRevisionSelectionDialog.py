# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsMercurial/HgRevisionSelectionDialog.ui'
#
...
class Ui_HgRevisionSelectionDialog(object):
    def setupUi(self, HgRevisionSelectionDialog):
        ...
        HgRevisionSelectionDialog.resize(400, 342)
        ...
        self.gridLayout.addWidget(self.noneButton, 7, 0, 1, 3)
        self.verticalLayout.addWidget(self.groupBox)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=HgRevisionSelectionDialog)
        ...
        HgRevisionSelectionDialog.setTabOrder(self.bookmarkCombo, self.expressionButton)
        HgRevisionSelectionDialog.setTabOrder(self.expressionButton, self.expressionEdit)
        HgRevisionSelectionDialog.setTabOrder(self.expressionEdit, self.tipButton)
    ...
    def retranslateUi(self, HgRevisionSelectionDialog):
        ...
        self.expressionButton.setText(_translate("HgRevisionSelectionDialog", "Expression:"))
        self.expressionEdit.setToolTip(_translate("HgRevisionSelectionDialog", "Enter a revision set expression"))
