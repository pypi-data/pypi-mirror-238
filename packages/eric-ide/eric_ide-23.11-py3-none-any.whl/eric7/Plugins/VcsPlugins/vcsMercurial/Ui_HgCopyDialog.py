# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsMercurial/HgCopyDialog.ui'
#
...
class Ui_HgCopyDialog(object):
    def setupUi(self, HgCopyDialog):
        ...
        self.sourceEdit = QtWidgets.QLineEdit(parent=HgCopyDialog)
        ...
        self.textLabel2 = QtWidgets.QLabel(parent=HgCopyDialog)
        self.textLabel2.setObjectName("textLabel2")
        self.gridLayout.addWidget(self.textLabel2, 1, 0, 1, 1)
        self.targetPicker = EricPathPicker(parent=HgCopyDialog)
        ...
        self.forceCheckBox = QtWidgets.QCheckBox(parent=HgCopyDialog)
        self.forceCheckBox.setObjectName("forceCheckBox")
        self.gridLayout.addWidget(self.forceCheckBox, 2, 0, 1, 2)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=HgCopyDialog)
