# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsGit/GitRemoteCredentialsDialog.ui'
#
...
class Ui_GitRemoteCredentialsDialog(object):
    def setupUi(self, GitRemoteCredentialsDialog):
        ...
        self.nameEdit = QtWidgets.QLineEdit(parent=GitRemoteCredentialsDialog)
        self.nameEdit.setToolTip("")
        self.nameEdit.setReadOnly(True)
        self.nameEdit.setObjectName("nameEdit")
        self.gridLayout.addWidget(self.nameEdit, 0, 1, 1, 1)
        self.label_2 = QtWidgets.QLabel(parent=GitRemoteCredentialsDialog)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 1, 0, 1, 1)
        self.urlEdit = QtWidgets.QLineEdit(parent=GitRemoteCredentialsDialog)
        self.urlEdit.setToolTip("")
        self.urlEdit.setReadOnly(True)
        self.urlEdit.setObjectName("urlEdit")
        self.gridLayout.addWidget(self.urlEdit, 1, 1, 1, 1)
        self.groupBox = QtWidgets.QGroupBox(parent=GitRemoteCredentialsDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=GitRemoteCredentialsDialog)
