# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsGit/GitStashBrowserDialog.ui'
#
...
class Ui_GitStashBrowserDialog(object):
    def setupUi(self, GitStashBrowserDialog):
        ...
        self.stashList = QtWidgets.QTreeWidget(parent=GitStashBrowserDialog)
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=GitStashBrowserDialog)
        ...
        self.errorGroup = QtWidgets.QGroupBox(parent=GitStashBrowserDialog)
        ...
        self.inputGroup = QtWidgets.QGroupBox(parent=GitStashBrowserDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=GitStashBrowserDialog)
