# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsGit/GitSubmoduleAddDialog.ui'
#
...
class Ui_GitSubmoduleAddDialog(object):
    def setupUi(self, GitSubmoduleAddDialog):
        ...
        self.TextLabel2 = QtWidgets.QLabel(parent=GitSubmoduleAddDialog)
        self.TextLabel2.setObjectName("TextLabel2")
        self.gridLayout.addWidget(self.TextLabel2, 0, 0, 1, 1)
        self.submoduleUrlCombo = QtWidgets.QComboBox(parent=GitSubmoduleAddDialog)
        ...
        self.submoduleUrlButton = QtWidgets.QToolButton(parent=GitSubmoduleAddDialog)
        self.submoduleUrlButton.setObjectName("submoduleUrlButton")
        self.gridLayout.addWidget(self.submoduleUrlButton, 0, 2, 1, 1)
        self.submoduleUrlClearHistoryButton = QtWidgets.QToolButton(parent=GitSubmoduleAddDialog)
        ...
        self.TextLabel4 = QtWidgets.QLabel(parent=GitSubmoduleAddDialog)
        self.TextLabel4.setObjectName("TextLabel4")
        self.gridLayout.addWidget(self.TextLabel4, 1, 0, 1, 1)
        self.submoduleDirEdit = QtWidgets.QLineEdit(parent=GitSubmoduleAddDialog)
        self.submoduleDirEdit.setObjectName("submoduleDirEdit")
        self.gridLayout.addWidget(self.submoduleDirEdit, 1, 1, 1, 1)
        self.submoduleDirButton = QtWidgets.QToolButton(parent=GitSubmoduleAddDialog)
        self.submoduleDirButton.setObjectName("submoduleDirButton")
        self.gridLayout.addWidget(self.submoduleDirButton, 1, 2, 1, 1)
        self.label = QtWidgets.QLabel(parent=GitSubmoduleAddDialog)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 2, 0, 1, 1)
        self.branchEdit = QtWidgets.QLineEdit(parent=GitSubmoduleAddDialog)
        self.branchEdit.setObjectName("branchEdit")
        self.gridLayout.addWidget(self.branchEdit, 2, 1, 1, 1)
        self.label_2 = QtWidgets.QLabel(parent=GitSubmoduleAddDialog)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 3, 0, 1, 1)
        self.nameEdit = QtWidgets.QLineEdit(parent=GitSubmoduleAddDialog)
        self.nameEdit.setObjectName("nameEdit")
        self.gridLayout.addWidget(self.nameEdit, 3, 1, 1, 1)
        self.forceCheckBox = QtWidgets.QCheckBox(parent=GitSubmoduleAddDialog)
        self.forceCheckBox.setObjectName("forceCheckBox")
        self.gridLayout.addWidget(self.forceCheckBox, 4, 0, 1, 2)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=GitSubmoduleAddDialog)
