# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsSubversion/SvnCommitDialog.ui'
#
...
class Ui_SvnCommitDialog(object):
    def setupUi(self, SvnCommitDialog):
        ...
        self.logGroup = QtWidgets.QGroupBox(parent=SvnCommitDialog)
        ...
        self.changeListsGroup = QtWidgets.QGroupBox(parent=SvnCommitDialog)
        ...
        self.changeLists = QtWidgets.QListWidget(parent=self.changeListsGroup)
        self.changeLists.setObjectName("changeLists")
        self.verticalLayout_2.addWidget(self.changeLists)
        self.keepChangeListsCheckBox = QtWidgets.QCheckBox(parent=self.changeListsGroup)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=SvnCommitDialog)
