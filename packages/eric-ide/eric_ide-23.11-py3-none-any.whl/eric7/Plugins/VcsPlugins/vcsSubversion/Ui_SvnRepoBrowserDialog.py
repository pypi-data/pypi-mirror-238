# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsSubversion/SvnRepoBrowserDialog.ui'
#
...
class Ui_SvnRepoBrowserDialog(object):
    def setupUi(self, SvnRepoBrowserDialog):
        ...
        self.label = QtWidgets.QLabel(parent=SvnRepoBrowserDialog)
        self.label.setObjectName("label")
        self.gridlayout.addWidget(self.label, 0, 0, 1, 1)
        self.urlCombo = QtWidgets.QComboBox(parent=SvnRepoBrowserDialog)
        ...
        self.repoTree = QtWidgets.QTreeWidget(parent=SvnRepoBrowserDialog)
        ...
        self.errorGroup = QtWidgets.QGroupBox(parent=SvnRepoBrowserDialog)
        ...
        self.inputGroup = QtWidgets.QGroupBox(parent=SvnRepoBrowserDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=SvnRepoBrowserDialog)
