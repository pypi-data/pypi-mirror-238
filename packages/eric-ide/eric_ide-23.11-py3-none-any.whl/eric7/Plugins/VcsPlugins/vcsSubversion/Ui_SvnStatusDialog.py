# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsSubversion/SvnStatusDialog.ui'
#
...
class Ui_SvnStatusDialog(object):
    def setupUi(self, SvnStatusDialog):
        ...
        self.label = QtWidgets.QLabel(parent=SvnStatusDialog)
        self.label.setObjectName("label")
        self.horizontalLayout_2.addWidget(self.label)
        self.statusFilterCombo = QtWidgets.QComboBox(parent=SvnStatusDialog)
        ...
        self.statusList = QtWidgets.QTreeWidget(parent=SvnStatusDialog)
        ...
        self.inputGroup = QtWidgets.QGroupBox(parent=SvnStatusDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=SvnStatusDialog)
