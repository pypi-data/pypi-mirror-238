# Form implementation generated from reading ui file 'src/eric7/Plugins/VcsPlugins/vcsSubversion/SvnTagDialog.ui'
#
...
class Ui_SvnTagDialog(object):
    def setupUi(self, SvnTagDialog):
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=SvnTagDialog)
        self.buttonBox.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Cancel|QtWidgets.QDialogButtonBox.StandardButton.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.gridlayout.addWidget(self.buttonBox, 2, 0, 1, 2)
        self.tagCombo = QtWidgets.QComboBox(parent=SvnTagDialog)
        ...
        self.TextLabel1 = QtWidgets.QLabel(parent=SvnTagDialog)
        self.TextLabel1.setObjectName("TextLabel1")
        self.gridlayout.addWidget(self.TextLabel1, 0, 0, 1, 1)
        self.TagActionGroup = QtWidgets.QGroupBox(parent=SvnTagDialog)
        self.TagActionGroup.setObjectName("TagActionGroup")
        self.vboxlayout = QtWidgets.QVBoxLayout(self.TagActionGroup)
        self.vboxlayout.setObjectName("vboxlayout")
        self.createRegularButton = QtWidgets.QRadioButton(parent=self.TagActionGroup)
        ...
        self.deleteRegularButton = QtWidgets.QRadioButton(parent=self.TagActionGroup)
