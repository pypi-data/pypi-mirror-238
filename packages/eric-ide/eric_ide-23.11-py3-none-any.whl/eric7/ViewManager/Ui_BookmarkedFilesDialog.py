# Form implementation generated from reading ui file 'src/eric7/ViewManager/BookmarkedFilesDialog.ui'
#
...
class Ui_BookmarkedFilesDialog(object):
    def setupUi(self, BookmarkedFilesDialog):
        ...
        self.filesList = QtWidgets.QListWidget(parent=BookmarkedFilesDialog)
        ...
        self.addButton = QtWidgets.QPushButton(parent=BookmarkedFilesDialog)
        self.addButton.setEnabled(False)
        self.addButton.setObjectName("addButton")
        self.gridLayout.addWidget(self.addButton, 0, 2, 1, 1)
        self.changeButton = QtWidgets.QPushButton(parent=BookmarkedFilesDialog)
        self.changeButton.setEnabled(False)
        self.changeButton.setObjectName("changeButton")
        self.gridLayout.addWidget(self.changeButton, 1, 2, 1, 1)
        self.deleteButton = QtWidgets.QPushButton(parent=BookmarkedFilesDialog)
        self.deleteButton.setEnabled(False)
        self.deleteButton.setObjectName("deleteButton")
        self.gridLayout.addWidget(self.deleteButton, 2, 2, 1, 1)
        self.upButton = QtWidgets.QPushButton(parent=BookmarkedFilesDialog)
        self.upButton.setEnabled(False)
        self.upButton.setObjectName("upButton")
        self.gridLayout.addWidget(self.upButton, 3, 2, 1, 1)
        self.downButton = QtWidgets.QPushButton(parent=BookmarkedFilesDialog)
        ...
        self.TextLabel1 = QtWidgets.QLabel(parent=BookmarkedFilesDialog)
        self.TextLabel1.setObjectName("TextLabel1")
        self.gridLayout.addWidget(self.TextLabel1, 6, 0, 1, 1)
        self.filePicker = EricPathPicker(parent=BookmarkedFilesDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=BookmarkedFilesDialog)
