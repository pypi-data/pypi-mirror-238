# Form implementation generated from reading ui file 'src/eric7/Preferences/ConfigurationPages/IrcPage.ui'
#
...
class Ui_IrcPage(object):
    def setupUi(self, IrcPage):
        ...
        self.shutdownGroup = QtWidgets.QGroupBox(parent=IrcPage)
        self.shutdownGroup.setObjectName("shutdownGroup")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.shutdownGroup)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.confirmShutdownCheckBox = QtWidgets.QCheckBox(parent=self.shutdownGroup)
