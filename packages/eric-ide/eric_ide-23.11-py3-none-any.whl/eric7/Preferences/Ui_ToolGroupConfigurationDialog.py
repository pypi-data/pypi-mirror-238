# Form implementation generated from reading ui file 'src/eric7/Preferences/ToolGroupConfigurationDialog.ui'
#
...
class Ui_ToolGroupConfigurationDialog(object):
    def setupUi(self, ToolGroupConfigurationDialog):
        ...
        self.deleteButton = QtWidgets.QPushButton(parent=ToolGroupConfigurationDialog)
        self.deleteButton.setEnabled(False)
        self.deleteButton.setObjectName("deleteButton")
        self.gridlayout.addWidget(self.deleteButton, 3, 2, 1, 1)
        self.addButton = QtWidgets.QPushButton(parent=ToolGroupConfigurationDialog)
        self.addButton.setObjectName("addButton")
        self.gridlayout.addWidget(self.addButton, 1, 2, 1, 1)
        self.TextLabel2 = QtWidgets.QLabel(parent=ToolGroupConfigurationDialog)
        self.TextLabel2.setObjectName("TextLabel2")
        self.gridlayout.addWidget(self.TextLabel2, 7, 0, 1, 1)
        self.changeButton = QtWidgets.QPushButton(parent=ToolGroupConfigurationDialog)
        ...
        self.newButton = QtWidgets.QPushButton(parent=ToolGroupConfigurationDialog)
        self.newButton.setObjectName("newButton")
        self.gridlayout.addWidget(self.newButton, 0, 2, 1, 1)
        self.upButton = QtWidgets.QPushButton(parent=ToolGroupConfigurationDialog)
        self.upButton.setEnabled(False)
        self.upButton.setObjectName("upButton")
        self.gridlayout.addWidget(self.upButton, 4, 2, 1, 1)
        self.downButton = QtWidgets.QPushButton(parent=ToolGroupConfigurationDialog)
        self.downButton.setEnabled(False)
        self.downButton.setObjectName("downButton")
        self.gridlayout.addWidget(self.downButton, 5, 2, 1, 1)
        self.groupsList = QtWidgets.QListWidget(parent=ToolGroupConfigurationDialog)
        self.groupsList.setObjectName("groupsList")
        self.gridlayout.addWidget(self.groupsList, 0, 0, 7, 2)
        self.nameEdit = QtWidgets.QLineEdit(parent=ToolGroupConfigurationDialog)
        self.nameEdit.setObjectName("nameEdit")
        self.gridlayout.addWidget(self.nameEdit, 7, 1, 1, 1)
        self.vboxlayout.addLayout(self.gridlayout)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=ToolGroupConfigurationDialog)
