# Form implementation generated from reading ui file 'src/eric7/UI/EmailDialog.ui'
#
...
class Ui_EmailDialog(object):
    def setupUi(self, EmailDialog):
        ...
        self.mainSplitter = QtWidgets.QSplitter(parent=EmailDialog)
        self.mainSplitter.setOrientation(QtCore.Qt.Orientation.Vertical)
        self.mainSplitter.setObjectName("mainSplitter")
        self.messageGroup = QtWidgets.QGroupBox(parent=self.mainSplitter)
        ...
        self.textLabel1 = QtWidgets.QLabel(parent=self.messageGroup)
        self.textLabel1.setObjectName("textLabel1")
        self.hboxlayout.addWidget(self.textLabel1)
        self.subject = QtWidgets.QLineEdit(parent=self.messageGroup)
        self.subject.setObjectName("subject")
        self.hboxlayout.addWidget(self.subject)
        self.verticalLayout.addLayout(self.hboxlayout)
        self.msgLabel = QtWidgets.QLabel(parent=self.messageGroup)
        self.msgLabel.setObjectName("msgLabel")
        self.verticalLayout.addWidget(self.msgLabel)
        self.message = EricSpellCheckedTextEdit(parent=self.messageGroup)
        ...
        self.attachmentsGroup = QtWidgets.QGroupBox(parent=self.mainSplitter)
        ...
        self.attachments = QtWidgets.QTreeWidget(parent=self.attachmentsGroup)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.addButton = QtWidgets.QPushButton(parent=self.attachmentsGroup)
        self.addButton.setObjectName("addButton")
        self.vboxlayout.addWidget(self.addButton)
        self.deleteButton = QtWidgets.QPushButton(parent=self.attachmentsGroup)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=EmailDialog)
