# Form implementation generated from reading ui file 'src/eric7/Project/UserPropertiesDialog.ui'
#
...
class Ui_UserPropertiesDialog(object):
    def setupUi(self, UserPropertiesDialog):
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(parent=UserPropertiesDialog)
        ...
        self.vcsGroup = QtWidgets.QGroupBox(parent=UserPropertiesDialog)
        self.vcsGroup.setObjectName("vcsGroup")
        self._4 = QtWidgets.QVBoxLayout(self.vcsGroup)
        self._4.setObjectName("_4")
        self.vcsInterfaceCombo = QtWidgets.QComboBox(parent=self.vcsGroup)
        self.vcsInterfaceCombo.setObjectName("vcsInterfaceCombo")
        self._4.addWidget(self.vcsInterfaceCombo)
        self.vcsInterfaceDefaultCheckBox = QtWidgets.QCheckBox(parent=self.vcsGroup)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=UserPropertiesDialog)
