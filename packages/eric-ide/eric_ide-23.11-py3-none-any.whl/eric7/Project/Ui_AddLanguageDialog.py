# Form implementation generated from reading ui file 'src/eric7/Project/AddLanguageDialog.ui'
#
...
class Ui_AddLanguageDialog(object):
    def setupUi(self, AddLanguageDialog):
        ...
        self.languageLabel = QtWidgets.QLabel(parent=AddLanguageDialog)
        self.languageLabel.setObjectName("languageLabel")
        self.hboxlayout.addWidget(self.languageLabel)
        self.languageCombo = QtWidgets.QComboBox(parent=AddLanguageDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=AddLanguageDialog)
