# Form implementation generated from reading ui file 'src/eric7/Project/AddFileDialog.ui'
#
...
class Ui_AddFileDialog(object):
    def setupUi(self, AddFileDialog):
        ...
        self.sourceFileLabel = QtWidgets.QLabel(parent=AddFileDialog)
        self.sourceFileLabel.setObjectName("sourceFileLabel")
        self.gridLayout.addWidget(self.sourceFileLabel, 0, 0, 1, 1)
        self.sourceFilesPicker = EricPathPicker(parent=AddFileDialog)
        ...
        self.targetDirLabel = QtWidgets.QLabel(parent=AddFileDialog)
        self.targetDirLabel.setObjectName("targetDirLabel")
        self.gridLayout.addWidget(self.targetDirLabel, 1, 0, 1, 1)
        self.targetDirPicker = EricPathPicker(parent=AddFileDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.sourcecodeCheckBox = QtWidgets.QCheckBox(parent=AddFileDialog)
        self.sourcecodeCheckBox.setObjectName("sourcecodeCheckBox")
        self.verticalLayout.addWidget(self.sourcecodeCheckBox)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=AddFileDialog)
