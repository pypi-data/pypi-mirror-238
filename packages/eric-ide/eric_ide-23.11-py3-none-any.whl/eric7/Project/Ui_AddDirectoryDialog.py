# Form implementation generated from reading ui file 'src/eric7/Project/AddDirectoryDialog.ui'
#
...
class Ui_AddDirectoryDialog(object):
    def setupUi(self, AddDirectoryDialog):
        ...
        self.textLabel1 = QtWidgets.QLabel(parent=AddDirectoryDialog)
        self.textLabel1.setObjectName("textLabel1")
        self.gridLayout.addWidget(self.textLabel1, 0, 0, 1, 1)
        self.filterComboBox = QtWidgets.QComboBox(parent=AddDirectoryDialog)
        self.filterComboBox.setObjectName("filterComboBox")
        self.gridLayout.addWidget(self.filterComboBox, 0, 1, 1, 1)
        self.sourceDirLabel = QtWidgets.QLabel(parent=AddDirectoryDialog)
        self.sourceDirLabel.setObjectName("sourceDirLabel")
        self.gridLayout.addWidget(self.sourceDirLabel, 1, 0, 1, 1)
        self.sourceDirPicker = EricPathPicker(parent=AddDirectoryDialog)
        ...
        self.targetDirLabel = QtWidgets.QLabel(parent=AddDirectoryDialog)
        self.targetDirLabel.setObjectName("targetDirLabel")
        self.gridLayout.addWidget(self.targetDirLabel, 2, 0, 1, 1)
        self.targetDirPicker = EricPathPicker(parent=AddDirectoryDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.recursiveCheckBox = QtWidgets.QCheckBox(parent=AddDirectoryDialog)
        self.recursiveCheckBox.setObjectName("recursiveCheckBox")
        self.gridLayout.addWidget(self.recursiveCheckBox, 3, 0, 1, 2)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=AddDirectoryDialog)
