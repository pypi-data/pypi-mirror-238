# Form implementation generated from reading ui file 'src/eric7/WebBrowser/Download/DownloadAskActionDialog.ui'
#
...
class Ui_DownloadAskActionDialog(object):
    def setupUi(self, DownloadAskActionDialog):
        ...
        self.label_3 = QtWidgets.QLabel(parent=DownloadAskActionDialog)
        self.label_3.setObjectName("label_3")
        self.verticalLayout.addWidget(self.label_3)
        self.gridLayout_2 = QtWidgets.QGridLayout()
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.label_4 = QtWidgets.QLabel(parent=DownloadAskActionDialog)
        self.label_4.setText("")
        self.label_4.setObjectName("label_4")
        self.gridLayout_2.addWidget(self.label_4, 0, 0, 1, 1)
        self.infoLabel = QtWidgets.QLabel(parent=DownloadAskActionDialog)
        self.infoLabel.setText("")
        self.infoLabel.setWordWrap(True)
        self.infoLabel.setObjectName("infoLabel")
        self.gridLayout_2.addWidget(self.infoLabel, 0, 1, 1, 2)
        self.label_5 = QtWidgets.QLabel(parent=DownloadAskActionDialog)
        self.label_5.setObjectName("label_5")
        self.gridLayout_2.addWidget(self.label_5, 1, 1, 1, 1)
        self.typeLabel = QtWidgets.QLabel(parent=DownloadAskActionDialog)
        ...
        self.label_6 = QtWidgets.QLabel(parent=DownloadAskActionDialog)
        self.label_6.setObjectName("label_6")
        self.gridLayout_2.addWidget(self.label_6, 2, 1, 1, 1)
        self.siteLabel = QtWidgets.QLabel(parent=DownloadAskActionDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_2 = QtWidgets.QLabel(parent=DownloadAskActionDialog)
        self.label_2.setText("")
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 1, 0, 1, 1)
        self.openButton = QtWidgets.QRadioButton(parent=DownloadAskActionDialog)
        self.openButton.setObjectName("openButton")
        self.gridLayout.addWidget(self.openButton, 1, 1, 1, 1)
        self.scanButton = QtWidgets.QRadioButton(parent=DownloadAskActionDialog)
        ...
        self.saveButton = QtWidgets.QRadioButton(parent=DownloadAskActionDialog)
        self.saveButton.setChecked(True)
        self.saveButton.setObjectName("saveButton")
        self.gridLayout.addWidget(self.saveButton, 3, 1, 1, 1)
        self.label = QtWidgets.QLabel(parent=DownloadAskActionDialog)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 0, 0, 1, 2)
        self.verticalLayout.addLayout(self.gridLayout)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=DownloadAskActionDialog)
