# Form implementation generated from reading ui file 'src/eric7/WebBrowser/Sync/SyncCheckPage.ui'
#
...
class Ui_SyncCheckPage(object):
    def setupUi(self, SyncCheckPage):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=SyncCheckPage)
        ...
        self.handlerLabel = QtWidgets.QLabel(parent=self.groupBox)
        ...
        self.infoLabel = QtWidgets.QLabel(parent=self.groupBox)
        self.infoLabel.setText("Host:")
        self.infoLabel.setObjectName("infoLabel")
        self.gridLayout.addWidget(self.infoLabel, 1, 0, 1, 1)
        self.infoDataLabel = QtWidgets.QLabel(parent=self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(parent=SyncCheckPage)
        ...
        self.bookmarkLabel = EricAnimatedLabel(parent=self.groupBox_2)
        self.bookmarkLabel.setObjectName("bookmarkLabel")
        self.gridLayout_2.addWidget(self.bookmarkLabel, 0, 1, 1, 1)
        self.bookmarkMsgLabel = QtWidgets.QLabel(parent=self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.historyLabel = EricAnimatedLabel(parent=self.groupBox_2)
        self.historyLabel.setObjectName("historyLabel")
        self.gridLayout_2.addWidget(self.historyLabel, 1, 1, 1, 1)
        self.historyMsgLabel = QtWidgets.QLabel(parent=self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.passwordsLabel = EricAnimatedLabel(parent=self.groupBox_2)
        self.passwordsLabel.setObjectName("passwordsLabel")
        self.gridLayout_2.addWidget(self.passwordsLabel, 2, 1, 1, 1)
        self.passwordsMsgLabel = QtWidgets.QLabel(parent=self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.userAgentsLabel = EricAnimatedLabel(parent=self.groupBox_2)
        self.userAgentsLabel.setObjectName("userAgentsLabel")
        self.gridLayout_2.addWidget(self.userAgentsLabel, 3, 1, 1, 1)
        self.userAgentsMsgLabel = QtWidgets.QLabel(parent=self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.speedDialLabel = EricAnimatedLabel(parent=self.groupBox_2)
        self.speedDialLabel.setObjectName("speedDialLabel")
        self.gridLayout_2.addWidget(self.speedDialLabel, 4, 1, 1, 2)
        self.speedDialMsgLabel = QtWidgets.QLabel(parent=self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.syncErrorLabel = QtWidgets.QLabel(parent=self.groupBox_2)
