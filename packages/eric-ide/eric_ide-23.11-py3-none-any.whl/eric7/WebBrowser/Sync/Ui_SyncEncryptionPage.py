# Form implementation generated from reading ui file 'src/eric7/WebBrowser/Sync/SyncEncryptionPage.ui'
#
...
class Ui_SyncEncryptionPage(object):
    def setupUi(self, SyncEncryptionPage):
        ...
        self.encryptionGroupBox = QtWidgets.QGroupBox(parent=SyncEncryptionPage)
        ...
        self.label_3 = QtWidgets.QLabel(parent=self.encryptionGroupBox)
        self.label_3.setWordWrap(True)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 0, 0, 1, 2)
        self.reencryptCheckBox = QtWidgets.QCheckBox(parent=self.encryptionGroupBox)
        self.reencryptCheckBox.setObjectName("reencryptCheckBox")
        self.gridLayout.addWidget(self.reencryptCheckBox, 1, 0, 1, 2)
        self.label = QtWidgets.QLabel(parent=self.encryptionGroupBox)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 2, 0, 1, 1)
        self.encryptionKeyEdit = QtWidgets.QLineEdit(parent=self.encryptionGroupBox)
        ...
        self.label_2 = QtWidgets.QLabel(parent=self.encryptionGroupBox)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 3, 0, 1, 1)
        self.encryptionKeyAgainEdit = QtWidgets.QLineEdit(parent=self.encryptionGroupBox)
        ...
        self.passwordMeter = EricPasswordMeter(parent=self.encryptionGroupBox)
        self.passwordMeter.setObjectName("passwordMeter")
        self.gridLayout.addWidget(self.passwordMeter, 4, 0, 1, 2)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.label_4 = QtWidgets.QLabel(parent=self.encryptionGroupBox)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout.addWidget(self.label_4)
        self.keySizeComboBox = QtWidgets.QComboBox(parent=self.encryptionGroupBox)
        ...
        self.errorLabel = QtWidgets.QLabel(parent=self.encryptionGroupBox)
        self.errorLabel.setStyleSheet("color : red;")
        self.errorLabel.setWordWrap(True)
        self.errorLabel.setObjectName("errorLabel")
        self.gridLayout.addWidget(self.errorLabel, 6, 0, 1, 2)
        self.loginsOnlyCheckBox = QtWidgets.QCheckBox(parent=self.encryptionGroupBox)
