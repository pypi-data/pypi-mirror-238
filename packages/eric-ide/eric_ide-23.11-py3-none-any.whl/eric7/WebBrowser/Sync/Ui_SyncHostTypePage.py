# Form implementation generated from reading ui file 'src/eric7/WebBrowser/Sync/SyncHostTypePage.ui'
#
...
class Ui_SyncHostTypePage(object):
    def setupUi(self, SyncHostTypePage):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=SyncHostTypePage)
        self.groupBox.setObjectName("groupBox")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.groupBox)
        self.verticalLayout.setObjectName("verticalLayout")
        self.ftpRadioButton = QtWidgets.QRadioButton(parent=self.groupBox)
        self.ftpRadioButton.setObjectName("ftpRadioButton")
        self.verticalLayout.addWidget(self.ftpRadioButton)
        self.directoryRadioButton = QtWidgets.QRadioButton(parent=self.groupBox)
