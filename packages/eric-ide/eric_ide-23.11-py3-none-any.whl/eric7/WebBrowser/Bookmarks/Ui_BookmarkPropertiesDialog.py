# Form implementation generated from reading ui file 'src/eric7/WebBrowser/Bookmarks/BookmarkPropertiesDialog.ui'
#
...
class Ui_BookmarkPropertiesDialog(object):
    def setupUi(self, BookmarkPropertiesDialog):
        ...
        self.label_2 = QtWidgets.QLabel(parent=BookmarkPropertiesDialog)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 0, 0, 1, 1)
        self.nameEdit = QtWidgets.QLineEdit(parent=BookmarkPropertiesDialog)
        self.nameEdit.setObjectName("nameEdit")
        self.gridLayout.addWidget(self.nameEdit, 0, 1, 1, 1)
        self.addressLabel = QtWidgets.QLabel(parent=BookmarkPropertiesDialog)
        self.addressLabel.setObjectName("addressLabel")
        self.gridLayout.addWidget(self.addressLabel, 1, 0, 1, 1)
        self.addressEdit = QtWidgets.QLineEdit(parent=BookmarkPropertiesDialog)
        self.addressEdit.setObjectName("addressEdit")
        self.gridLayout.addWidget(self.addressEdit, 1, 1, 1, 1)
        self.label = QtWidgets.QLabel(parent=BookmarkPropertiesDialog)
        ...
        self.descriptionEdit = EricSpellCheckedPlainTextEdit(parent=BookmarkPropertiesDialog)
        self.descriptionEdit.setObjectName("descriptionEdit")
        self.gridLayout.addWidget(self.descriptionEdit, 2, 1, 1, 1)
        self.visitedLabel = QtWidgets.QLabel(parent=BookmarkPropertiesDialog)
        self.visitedLabel.setText("")
        self.visitedLabel.setObjectName("visitedLabel")
        self.gridLayout.addWidget(self.visitedLabel, 3, 1, 1, 1)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=BookmarkPropertiesDialog)
