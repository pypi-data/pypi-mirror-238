# Form implementation generated from reading ui file 'src/eric7/WebBrowser/AdBlock/AdBlockDialog.ui'
#
...
class Ui_AdBlockDialog(object):
    def setupUi(self, AdBlockDialog):
        ...
        self.adBlockGroup = QtWidgets.QGroupBox(parent=AdBlockDialog)
        ...
        self.iconLabel = QtWidgets.QLabel(parent=self.adBlockGroup)
        ...
        self.searchEdit = QtWidgets.QLineEdit(parent=self.adBlockGroup)
        self.searchEdit.setClearButtonEnabled(True)
        self.searchEdit.setObjectName("searchEdit")
        self.gridLayout.addWidget(self.searchEdit, 1, 1, 1, 1)
        self.verticalLayout.addLayout(self.gridLayout)
        self.subscriptionsTabWidget = QtWidgets.QTabWidget(parent=self.adBlockGroup)
        ...
        self.actionButton = QtWidgets.QToolButton(parent=self.adBlockGroup)
        ...
        self.label = QtWidgets.QLabel(parent=self.adBlockGroup)
        self.label.setObjectName("label")
        self.horizontalLayout.addWidget(self.label)
        self.updateSpinBox = QtWidgets.QSpinBox(parent=self.adBlockGroup)
        ...
        self.useLimitedEasyListCheckBox = QtWidgets.QCheckBox(parent=self.adBlockGroup)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=AdBlockDialog)
