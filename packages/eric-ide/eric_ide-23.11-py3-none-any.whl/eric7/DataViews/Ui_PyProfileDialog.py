# Form implementation generated from reading ui file 'src/eric7/DataViews/PyProfileDialog.ui'
#
...
class Ui_PyProfileDialog(object):
    def setupUi(self, PyProfileDialog):
        ...
        self.resultList = QtWidgets.QTreeWidget(parent=PyProfileDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(3)
        ...
        self.summaryList = QtWidgets.QTreeWidget(parent=PyProfileDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.checkProgress = QtWidgets.QProgressBar(parent=PyProfileDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=PyProfileDialog)
