...
class AztecParameters(Assist.BaseJavaClass):
      ...
      def setCodeTextEncoding(self, codeTextEncoding):
            ...
            """
            print("DEPRECATED")
            self.getJavaClass().setCodeTextEncoding(codeTextEncoding)
...
class AztecExtCodetextBuilder(ExtCodetextBuilder):
      """!
       ...
       \code
       #create codetext
       textBuilder = AztecExtCodetextBuilder()
       textBuilder.addECICodetext(ECIEncodings.Win1251, "Will")
       textBuilder.addECICodetext(ECIEncodings.UTF8, "犬Right狗")
       textBuilder.addECICodetext(ECIEncodings.UTF16BE, "犬Power狗")
       textBuilder.addPlainCodetext("Plain text")
...
class TwoDComponentType(Enum):
      ...
      \code
      codetext = "(01)03212345678906/(21)A1B2C3D4E5F6G7H8"
      generator = BarcodeGenerator(EncodeTypes.GS_1_COMPOSITE_BAR, codetext)
...
class MaxiCodeEncodeMode(Enum):
      ...
      # generate
      generator = BarcodeGenerator(EncodeTypes.MaxiCode, codetext)
...
class AztecEncodeMode(Enum):
      """!
       Encoding mode for Aztec barcodes.
        ...
        codetext = strBld
        generator = BarcodeGenerator(EncodeTypes.AZTEC, codetext)
        ...
        generator.getParameters().getBarcode().getCodeTextParameters().setTwoDDisplayText("My Text")
        generator.save("test.bmp", BarcodeImageFormat.BM)
        \endcode
      """
      ##  Encode codetext with value set in the ECIEncoding property.
      AUTO = 0
