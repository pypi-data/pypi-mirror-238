...
@overload
def square_sum(operand: NonConstantColumnConvertibleOrLevel, /) -> MeasureDescription:
    ...
...
def square_sum(
    ...
    *,
    ...
    return agg(operand, plugin_key="SQ_SUM", scope=scope)  # type: ignore[arg-type] # pyright: ignore[reportGeneralTypeIssues]
