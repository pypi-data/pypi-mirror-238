...
_API_SNAPSHOT_PATH = Path(__file__).parent / "data" / "api.json"
...
def decorate_api(decorator: Callable[[Callable[_P, _R]], Callable[_P, _R]], /) -> None:
    api_snapshot: _ApiSnapshot = json.loads(_API_SNAPSHOT_PATH.read_bytes())
