...
class SampleMarketDataProvider(mx.MarketDataProvider):
    ...
    def initialize(self):
        ...
        zerocurve1 = { 
            ...
            'businessDayConvention': utils.businessDayConventionToString(mx.ModifiedFollowing),
            'compounding': utils.compoundingToString(mx.Compounded)
        }
