...
Welcome to `biocgenerics` contributor's guide.
...
If you experience bugs or general issues with `biocgenerics`, please have a look
...
You can help improve `biocgenerics` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`biocgenerics` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `biocgenerics`'s files. While this mechanism can
...
```
conda create -n biocgenerics python=3 six virtualenv pytest pytest-cov
conda activate biocgenerics
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/biocgenerics.git
   cd biocgenerics
   ```
...
5. Install [pre-commit]:
   ...
   `biocgenerics` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/biocgenerics
[issue tracker]: https://github.com/<USERNAME>/biocgenerics/issues
