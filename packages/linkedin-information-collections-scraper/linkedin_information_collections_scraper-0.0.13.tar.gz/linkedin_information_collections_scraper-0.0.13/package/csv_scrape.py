...
BASE_APTH = Path(__file__).resolve().absolute().parent

# driver = webdriver.Chrome()


class WebscrapeCsv:
    cookies_file_path = BASE_APTH / "cookies.pkl"
    ...
    def convert_to_json_file(self, all_details):
        ...
        with open("products.json", "a+") as profiles:
        ...
        while True:
            ...
            for profile in profiles_links:
                ...
                with open("products2.csv", "a+") as profiles_file:
                    writer = csv.writer(profiles_file)
...
# webscrape = Webscrape("saidishadow@gmail.com", "aziz1234", keyword)
# webscrape.logIn()
# webscrape.collect_information()

# logIn("saidishadow@gmail.com", "aziz1234")
# collect_information(keyword)
