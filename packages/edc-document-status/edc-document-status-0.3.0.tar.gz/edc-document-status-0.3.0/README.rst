...
.. |actions| image:: https://github.com/clinicedc/edc-document-status/workflows/build/badge.svg?branch=develop
  :target: https://github.com/clinicedc/edc-document-status/actions?query=workflow:build
