from agl_base_db.utils.hashs import get_video_hash
import subprocess
from django.core.files import File
from django.core.management.base import BaseCommand
from agl_base_db.models import LegacyVideo
import os
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for mkv_file in mkv_files:
            ...
            video = LegacyVideo.objects.create(name=video_name, video_hash=video_hash)
            ...
            with open(mp4_file, 'rb') as f:
                ...
                video.video.save(video_name + ".mp4", django_file)

            video.initialize_video_specs(self.file)
