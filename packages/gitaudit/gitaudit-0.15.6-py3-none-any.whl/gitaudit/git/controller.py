...
class Git:
    ...
    def log_parentlog(self, end_ref, start_ref=None, first_parent=False, instance_class=ChangeLogEntry):
        ...
        Args:
            ...
            instance_class (ChangeLogEntry, optional): ChangeLogEntry class to use for parsing the
