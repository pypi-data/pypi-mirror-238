...
export class Root {
    ...
    return [
      h("limel-flex-container", { class: "actionpad-container" },
        h("button", { class: "getaccept-button", onClick: this.openDialog },
          h("img", { src: "https://static-vue-rc.getaccept.com/img/integrations/logo_only.png" }),
      ...
      h("limel-dialog", { open: this.isOpen, closingActions: { escapeKey: true, scrimClick: false }, onClose: () => {
        ...
        h("div", { class: "ga-version" },
          h("span", null, "Version: 1.2.5"))),
    ];
  }
  ...
  renderLogo(compact) {
    ...
    return (h("div", { class: classes },
      h("img", { onClick: this.handleLogoClick, src: "https://static-vue-rc.getaccept.com/img/integrations/logo-inverted.png", class: "logo" })));
  }
  showWorkflow() {
