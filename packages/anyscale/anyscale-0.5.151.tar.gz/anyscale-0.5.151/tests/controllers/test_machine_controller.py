...
from frontend.cli.anyscale.controllers.machine_controller import MachineController
...
def test_list_machines(mock_auth_api_client, cloud_id: str) -> None:
    ...
    output = machine_controller.list_machines(cloud_id=cloud_id, cloud=None)
