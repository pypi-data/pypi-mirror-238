...
from frontend.cli.anyscale.utils.ray_version_utils import get_alias_for_base_image_name
...
def test_get_alias_for_base_image_name(base_image_name, expected_result):
    result = get_alias_for_base_image_name(base_image_name)
