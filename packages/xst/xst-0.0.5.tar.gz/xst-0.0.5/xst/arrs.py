# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/00_arrs.ipynb.
...
# %% ../nbs/00_arrs.ipynb 10
try:
    import numpy as np
except ModuleNotFoundError:
    np = None

# %% ../nbs/00_arrs.ipynb 12
...
from xtr.call import attrfunc, applyfns
from ain import ain

# %% ../nbs/00_arrs.ipynb 14
#| export


# %% ../nbs/00_arrs.ipynb 17
class chain(ain): ...
...
# %% ../nbs/00_arrs.ipynb 19
def arrchain(x, funcs, *args, **kwargs): 
    return applyfns(x, funcs, isarr, *args, **kwargs)

# %% ../nbs/00_arrs.ipynb 20
def try2arr(a) -> NPArray:
    try: return a if isarr(a) else np.array(a)
    except: return a

# %% ../nbs/00_arrs.ipynb 22
