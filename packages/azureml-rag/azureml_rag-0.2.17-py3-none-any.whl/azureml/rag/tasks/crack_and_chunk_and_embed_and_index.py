...
def crack_and_chunk_and_embed_and_index(
    ...
    with EmbeddingsContainer.mount_and_load(embeddings_cache, activity_logger) as embeddings_container:
        ...
        if embeddings_cache is not None:
            ...
            new_snapshot_dir = str(Path(embeddings_cache) / snapshot_name)
        ...
        if index_type == "acs":
            ...
            mlindex = embeddings_container.write_as_faiss_mlindex(output_path, engine="azureml.rag.indexes.faiss.FaissAndDocStore")
