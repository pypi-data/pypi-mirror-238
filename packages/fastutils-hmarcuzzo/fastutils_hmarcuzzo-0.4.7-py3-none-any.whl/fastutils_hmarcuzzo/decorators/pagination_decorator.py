...
class PaginationWithSearchProvider(object):
    def __init__(
        ...
        self.search = Depends(self._search_query())
        self.sort = Depends(self._sort_query())
        self.columns = Depends(self._columns_query())
        self.search_all = Depends(self._search_all_query())
