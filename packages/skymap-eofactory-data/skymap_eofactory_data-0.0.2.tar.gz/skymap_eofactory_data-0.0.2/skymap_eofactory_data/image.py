...
class Image(Data):
    ...
    def all(self, workspace_id=None, region=None, page=-1, order_by='created_at', order='desc'):
        params = {
            'page': page,
            'order_by': order_by,
            'order': order,
    ...
    def download(self, id, file_path=None, workspace_id=None, region=None):
        ...
        if file_path is None:
            ...
            os.makedirs(file_path, exist_ok=True) #path: path/to/directory
