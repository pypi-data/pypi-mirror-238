...
class AbstractEnumerable(Iterable[Tuple[_TK, _TV]], Generic[_TK, _TV], metaclass=ABCMeta):
    ...
    @overload # iterlist
    def Except(self, exceptFunc:Callable[[_TV],_TFV], *value:_TV) -> "AbstractEnumerable[_TV]": ...
    @overload # iteritem
    def Except(self, exceptFunc:Callable[[int,_TV],_TFV], *value:_TV) -> "AbstractEnumerable[_TV]": ...
    @overload # iterdict
    def Except(self, exceptFunc:Callable[[_TK,_TV],_TFV], *value:_TV) -> "AbstractEnumerable[_TK,_TV]": ...
    @abstractmethod
    def Except(self, exceptFunc, *value): ...
