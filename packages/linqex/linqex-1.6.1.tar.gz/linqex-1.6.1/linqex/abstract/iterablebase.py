...
class AbstractEnumerableBase(Iterable[Tuple[_TK, _TV]], Generic[_TK, _TV], metaclass=ABCMeta):
    ...
    @overload # iterlist
    def Except(self, exceptFunc:Callable[[_TV],_TFV], *value:_TV) -> List[_TV]: ...
    @overload # iteritem
    def Except(self, exceptFunc:Callable[[int,_TV],_TFV], *value:_TV) -> List[_TV]: ...
    @overload # iterdict
    def Except(self, exceptFunc:Callable[[_TK,_TV],_TFV], *value:_TV) -> Dict[_TK,_TV]: ...
    @abstractmethod
