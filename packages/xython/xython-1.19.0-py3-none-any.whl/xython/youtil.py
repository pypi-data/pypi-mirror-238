# -*- coding: utf-8 -*-
import shutil, pickle  # 내장모듈
import inspect, re, string  # 내장모듈
import os  # 내장모듈
import random  # 내장모듈
...
import win32api, win32gui, math, win32con
...
class youtil():
	...
	def append_input_value_in_list_2d(self, input_list_2d, input_value):
		"""
	...
	def change_list_1d_to_list_2d_group_by_step(self, input_data, input_no):
		"""
	...
	def change_list_1d_to_one_text_with_chainword(self, input_list, chain_word=" ,"):
		"""
	...
	def change_all_list_1d_value_to_lower(self, input_list_1d):
		"""
	...
	def change_all_list_1d_value_to_upper(self, input_list_1d):
		"""
	...
	def get_same_value_in_list_2d(self, input_list_1d_1, input_list_1d_2):
		"""
		2차원의 자료안에서 입력값이 같은것을 찾아내기
	...
	def get_same_value_list(self, input_list_1d_1, input_list_1d_2):
		"""
	...
	def group_input_List3d_by_index_no(self, input_list3d, index_no = 4):
		...
		for input_list_2d in input_list3d:
			sorted_input_list_2d = self.sort_list_2d_by_index(input_list_2d, index_no)
			grouped_list3d = self.group_input_list_2d_by_index_no(sorted_input_list_2d, index_no)
			result = result + grouped_list3d
		return result
	...
	def move_list_2d_by_index_old(self, input_list_2d, input_no_list):
		"""
		입력형태 : 2차원리스트, [[옮길것, 옮기고싶은자리].....]
		...
		for before, after in input_no_list:
			for no in range(len(input_list_2d)):
				if before < after:
					after = after - 1
				value = input_list_2d[no][before]
				del input_list_2d[no][before]
				input_list_2d[no].insert(int(after), value)
		return input_list_2d
	...
	def split_input_hangul_as_jamo(self, text):
		"""
		# 한글자의 한글을 자음과 모음으로 구분해 주는것
