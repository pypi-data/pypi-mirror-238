...
## Aerosol Property (day-time only)
 Latest version: Version 3.0 (Level 2), Version 3.1 (Level 3)
...
### Wild Fire 
 H08_YYYYMMDD_hhmm_LLWLFVER_FLDK.xxxxx_yyyyy.csv
...
# About Sea Surface Temperature Algorithm:
 Y. Kurihara, Submitted: A quasi-physical sea surface temperature method for
 the split-window data from the Second-generation Global Imager (SGLI) onboard
 the Global Change Observation Mission-Climate (GCOM-C) satellite
