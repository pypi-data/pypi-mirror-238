...
class {{ className }}EntityTest {
    ...
    void testJpaAnnotations() throws NoSuchFieldException {
        Class<{{ className }}Entity> entityClass = {{ className }}Entity.class;
        assertNotNull(entityClass.getAnnotation(Entity.class));

        Field idField = entityClass.getDeclaredField("id");
        assertNotNull(idField.getAnnotation(Id.class));
        assertNotNull(idField.getAnnotation(GeneratedValue.class));
        assertNotNull(idField.getAnnotation(GenericGenerator.class));
    }
