...
from Bdrl.helpers.basic import edit_or_reply, get_user
from Bdrl.helpers.tools import get_text
...
@Client.on_message(filters.command("revert", prefix) & filters.me)
