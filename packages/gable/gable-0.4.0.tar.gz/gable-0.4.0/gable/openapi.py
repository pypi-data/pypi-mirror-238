...
class InferContractFromDataAssetResponse(BaseModel):
    contractId: Optional[UUID] = Field(
        None, description="Unique identifier for the contract in UUID format"
    )
    ...
    contractSpec: Optional[Dict[str, Any]] = Field(None, description="contract spec")
    contractSpecRaw: Optional[str] = Field(None, description="contract spec raw json")
