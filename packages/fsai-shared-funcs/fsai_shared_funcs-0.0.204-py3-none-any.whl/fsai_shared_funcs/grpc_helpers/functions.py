...
def get_grpc_data(stub_api_fn, request_data=None, type="proto"):
    # Setup the request data
    request_data = get_request_data(request_data)

    # Wait for a response
    response = stub_api_fn(request_data)
...
async def get_grpc_data_async(stub_api_fn, request_data=None, type="proto"):
    # Setup the request data
    request_data = get_request_data(request_data)

    # Wait for a response
    response = await stub_api_fn(request_data)
...
def get_grpc_data_stream(stub_api_fn, request=None, type="proto"):
    # Setup the request data
    request_data = get_request_data(request_data)

    # Wait for a response
    response = stub_api_fn(request)
...
async def get_grpc_data_stream_async(stub_api_fn, request=None, type="proto"):
    # Setup the request data
    request_data = get_request_data(request_data)

    # Wait for a response
    response = await stub_api_fn(request)
