...
class ML3PlatformClientImpl:
    ...
    def _validate_remote_source(
        data_source: RemoteDataSource, error_code: str
    ...
    def update_data_schema(
        self, task_id: str, data_schema: DataSchema
    ) -> None:
        """
        update_data_schema implementation
        """
        payload = UpdateDataSchemaRequest(
            task_id=task_id, data_schema=data_schema
        )
        ...
        if response.status_code != 200:
            self._default_exception_handler(
                response=response, exception_type=UpdateDataSchemaException
            )
    ...
    def _add_remote_historical_data(
        ...
        (
            ...
            features_data_source, "ADD_HISTORICAL_DATA_FORMAT_ERROR"
        )
        (
            targets_remote_path,
            targets_ds_type,
        ) = ML3PlatformClientImpl._validate_remote_source(
            targets_data_source, "ADD_HISTORICAL_DATA_FORMAT_ERROR"
        )
    ...
    def _add_remote_model_reference(
        ...
        (
            ...
            features_data_source, "ADD_MODEL_REFERENCE_FORMAT_ERROR"
        )
        (
            targets_remote_path,
            targets_ds_type,
        ) = ML3PlatformClientImpl._validate_remote_source(
            targets_data_source, "ADD_MODEL_REFERENCE_FORMAT_ERROR"
        )
    ...
    def _add_remote_production_data(
        ...
        if features_data_source is not None:
            (
                ...
                features_data_source, "ADD_MODEL_PRODUCTION_FORMAT_ERROR"
            )
            features_data_source_info = DataSourceInfo(
                dataset_type=features_data_source.dataset_type,
                file_type=FileType.CSV,
        ...
        if targets_data_source is not None:
            (
                ...
                targets_data_source, "ADD_MODEL_PRODUCTION_FORMAT_ERROR"
            )
            targets_data_source_info = DataSourceInfo(
                dataset_type=targets_data_source.dataset_type,
                file_type=FileType.CSV,
    ...
    def _add_remote_kpi_data(
        ...
        (
            ...
            kpi_data_source, "ADD_KPI_DATA_FORMAT_ERROR"
        )
    ...
    def create_detection_event_rule(
        ...
        actions: List[
            Union[DiscordNotificationAction, SlackNotificationAction]
        ],
    ) -> str:
        """
    ...
    def update_detection_event_rule(
        ...
        actions: Optional[
            List[Union[DiscordNotificationAction, SlackNotificationAction]]
        ] = None,
    ):
        """
