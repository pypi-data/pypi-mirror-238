...
class Gelu {
 public:
  /// Optional attribute setters for Gelu
  struct Attrs {
    /// Defaults to false
    TF_MUST_USE_RESULT Attrs Approximate(bool x) {
      Attrs ret = *this;
      ret.approximate_ = x;
      return ret;
    }
  ...
  Gelu(const ::tensorflow::Scope& scope, ::tensorflow::Input features);
  Gelu(const ::tensorflow::Scope& scope, ::tensorflow::Input features, const
     Gelu::Attrs& attrs);
  ...
  static Attrs Approximate(bool x) {
    return Attrs().Approximate(x);
  }
...
///
/// Returns:
/// * `Output`: The backprops tensor.
class GeluGrad {
 public:
  /// Optional attribute setters for GeluGrad
  struct Attrs {
    /// Defaults to false
    TF_MUST_USE_RESULT Attrs Approximate(bool x) {
      Attrs ret = *this;
  ...
  GeluGrad(const ::tensorflow::Scope& scope, ::tensorflow::Input gradients,
         ::tensorflow::Input features);
  GeluGrad(const ::tensorflow::Scope& scope, ::tensorflow::Input gradients,
         ::tensorflow::Input features, const GeluGrad::Attrs& attrs);
  operator ::tensorflow::Output() const { return backprops; }
  operator ::tensorflow::Input() const { return backprops; }
  ::tensorflow::Node* node() const { return backprops.node(); }
