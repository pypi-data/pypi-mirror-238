...
class FusionBackendConfig final :
 ...
 public:
  ...
  const ::tensorflow::AutotuneResult_TritonGemmKey& triton_gemm_config() const;
  PROTOBUF_NODISCARD ::tensorflow::AutotuneResult_TritonGemmKey* release_triton_gemm_config();
  ::tensorflow::AutotuneResult_TritonGemmKey* mutable_triton_gemm_config();
  void set_allocated_triton_gemm_config(::tensorflow::AutotuneResult_TritonGemmKey* triton_gemm_config);
  private:
  const ::tensorflow::AutotuneResult_TritonGemmKey& _internal_triton_gemm_config() const;
  ::tensorflow::AutotuneResult_TritonGemmKey* _internal_mutable_triton_gemm_config();
  public:
  void unsafe_arena_set_allocated_triton_gemm_config(
      ::tensorflow::AutotuneResult_TritonGemmKey* triton_gemm_config);
  ::tensorflow::AutotuneResult_TritonGemmKey* unsafe_arena_release_triton_gemm_config();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::tensorflow::AutotuneResult_TritonGemmKey* triton_gemm_config_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_tensorflow_2fcompiler_2fxla_2fservice_2fgpu_2fbackend_5fconfigs_2eproto;
...
inline const ::tensorflow::AutotuneResult_TritonGemmKey& FusionBackendConfig::_internal_triton_gemm_config() const {
  const ::tensorflow::AutotuneResult_TritonGemmKey* p = _impl_.triton_gemm_config_;
  return p != nullptr ? *p : reinterpret_cast<const ::tensorflow::AutotuneResult_TritonGemmKey&>(
      ::tensorflow::_AutotuneResult_TritonGemmKey_default_instance_);
}
inline const ::tensorflow::AutotuneResult_TritonGemmKey& FusionBackendConfig::triton_gemm_config() const {
...
inline ::tensorflow::AutotuneResult_TritonGemmKey* FusionBackendConfig::release_triton_gemm_config() {
  
  ::tensorflow::AutotuneResult_TritonGemmKey* temp = _impl_.triton_gemm_config_;
...
inline ::tensorflow::AutotuneResult_TritonGemmKey* FusionBackendConfig::unsafe_arena_release_triton_gemm_config() {
...
inline ::tensorflow::AutotuneResult_TritonGemmKey* FusionBackendConfig::_internal_mutable_triton_gemm_config() {
  
  if (_impl_.triton_gemm_config_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::AutotuneResult_TritonGemmKey>(GetArenaForAllocation());
    _impl_.triton_gemm_config_ = p;
  }
  return _impl_.triton_gemm_config_;
}
inline ::tensorflow::AutotuneResult_TritonGemmKey* FusionBackendConfig::mutable_triton_gemm_config() {
  ::tensorflow::AutotuneResult_TritonGemmKey* _msg = _internal_mutable_triton_gemm_config();
  // @@protoc_insertion_point(field_mutable:xla.gpu.FusionBackendConfig.triton_gemm_config)
  return _msg;
}
inline void FusionBackendConfig::set_allocated_triton_gemm_config(::tensorflow::AutotuneResult_TritonGemmKey* triton_gemm_config) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.triton_gemm_config_);
  }
