...
class OsTrConfDataTest(unittest.TestCase):
    ...
    def test_undocumented(self):
        self.assertEqual(self.conf.undocumented, [0] * 13)
        expected = [random.randint(0, 255) for _ in range(13)]
        self.conf.undocumented = expected
        self.assertEqual(self.conf.undocumented, expected)
