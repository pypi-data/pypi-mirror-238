...
class OsTrConfData:
    ...
    def __init__(self, embedded_peripherals: Optional[List[Union[EmbedPeripherals, int]]] = None,
        ...
        Args:
            ...
            undocumented (List[int]): Undocumented data bytes.
        """
    ...
    def _validate_undocumented(undocumented: List[int]) -> None:
        ...
        Args:
            undocumented (List[int]): Undocumented data bytes.
        Raises:
            RequestParameterInvalidValueError: If undocumented does not contain 13 values or if values are not
    ...
    @property
    def undocumented(self) -> List[int]:
        """:obj:`list` of :obj:`int`: Undocumented data bytes.
