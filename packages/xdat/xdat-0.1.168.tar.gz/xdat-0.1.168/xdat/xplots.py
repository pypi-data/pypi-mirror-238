...
def plot_corr_heatmap(df, title='Correlation Heatmap', fontsize=12, pad=12, cmap='BrBG', figsize=(15,15), show=True, as_xpptx=None):
    """
...
def plot_counts_2d(df, x, y, title='Counts', fontsize=12, pad=12, cmap='BrBG', figsize=(6,6), show=True, as_xpptx=None):
    ...
    hm = sns.heatmap(df_p, annot=True, cmap=cmap, fmt='d')
    hm.set_title(title, fontdict={'fontsize': fontsize}, pad=pad)
    plt.tight_layout()
