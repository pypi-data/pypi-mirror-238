...
class KNeighborsMixinTrain(neighbors._base.KNeighborsMixin):
    """
    The problem with KNN is that "training" score is biased (up to perfection) because nearest neighbor is always self. This is can remedied by ignoring the nearest neighbor (on the training set only.)
    """
