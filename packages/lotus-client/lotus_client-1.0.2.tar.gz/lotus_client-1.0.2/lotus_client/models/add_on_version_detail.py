...
class AddOnVersionDetail(object):
    ...
    swagger_types = {
        ...
        'status': 'str',
        'currency': 'AllOfAddOnVersionDetailCurrency',
    ...
    def __init__(self, recurring_charges=None, components=None, features=None, status=None, currency=None, active_instances=None, invoice_when=None, billing_frequency=None, addon_type=None):  # noqa: E501
        """AddOnVersionDetail - a model defined in Swagger"""  # noqa: E501
    ...
    def recurring_charges(self):
        """Gets the recurring_charges of this AddOnVersionDetail.  # noqa: E501


        :return: The recurring_charges of this AddOnVersionDetail.  # noqa: E501
    ...
    def recurring_charges(self, recurring_charges):
        """Sets the recurring_charges of this AddOnVersionDetail.


        :param recurring_charges: The recurring_charges of this AddOnVersionDetail.  # noqa: E501
    ...
    @property
    def components(self):
        """Gets the components of this AddOnVersionDetail.  # noqa: E501


        :return: The components of this AddOnVersionDetail.  # noqa: E501
    ...
    def components(self, components):
        """Sets the components of this AddOnVersionDetail.


        :param components: The components of this AddOnVersionDetail.  # noqa: E501
    ...
    @property
    def features(self):
        """Gets the features of this AddOnVersionDetail.  # noqa: E501


        :return: The features of this AddOnVersionDetail.  # noqa: E501
        :rtype: list[Feature]
        """
    ...
    def features(self, features):
        """Sets the features of this AddOnVersionDetail.


        :param features: The features of this AddOnVersionDetail.  # noqa: E501
        :type: list[Feature]
        """
        if features is None:
    ...
    @property
    def status(self):
        """Gets the status of this AddOnVersionDetail.  # noqa: E501
        ...
        * `active` - Active * `retiring` - Retiring * `grandfathered` - Grandfathered * `deleted` - Deleted * `inactive` - Inactive * `not_started` - Not Started  # noqa: E501
        ...
        :return: The status of this AddOnVersionDetail.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this AddOnVersionDetail.

        * `active` - Active * `retiring` - Retiring * `grandfathered` - Grandfathered * `deleted` - Deleted * `inactive` - Inactive * `not_started` - Not Started  # noqa: E501

        :param status: The status of this AddOnVersionDetail.  # noqa: E501
        :type: str
        """
        if status is None:
    ...
    @property
    def currency(self):
        """Gets the currency of this AddOnVersionDetail.  # noqa: E501

        Currency of the plan. Can only be null if the flat fee is 0 and all components are of type free.  # noqa: E501

        :return: The currency of this AddOnVersionDetail.  # noqa: E501
        :rtype: AllOfAddOnVersionDetailCurrency
        """
        return self._currency

    @currency.setter
    def currency(self, currency):
        """Sets the currency of this AddOnVersionDetail.

        Currency of the plan. Can only be null if the flat fee is 0 and all components are of type free.  # noqa: E501

        :param currency: The currency of this AddOnVersionDetail.  # noqa: E501
        :type: AllOfAddOnVersionDetailCurrency
        """
        if currency is None:
    ...
    def active_instances(self):
        """Gets the active_instances of this AddOnVersionDetail.  # noqa: E501

        The number of active instances of this version of the add-on plan.  # noqa: E501

        :return: The active_instances of this AddOnVersionDetail.  # noqa: E501
        :rtype: int
        """
    ...
    def active_instances(self, active_instances):
        """Sets the active_instances of this AddOnVersionDetail.

        The number of active instances of this version of the add-on plan.  # noqa: E501

        :param active_instances: The active_instances of this AddOnVersionDetail.  # noqa: E501
        :type: int
        """
    ...
    def invoice_when(self):
        """Gets the invoice_when of this AddOnVersionDetail.  # noqa: E501

        * `invoice_on_attach` - invoice_on_attach * `invoice_on_subscription_end` - invoice_on_subscription_end  # noqa: E501

        :return: The invoice_when of this AddOnVersionDetail.  # noqa: E501
        :rtype: str
        """
    ...
    def invoice_when(self, invoice_when):
        """Sets the invoice_when of this AddOnVersionDetail.

        * `invoice_on_attach` - invoice_on_attach * `invoice_on_subscription_end` - invoice_on_subscription_end  # noqa: E501

        :param invoice_when: The invoice_when of this AddOnVersionDetail.  # noqa: E501
        :type: str
        """
    ...
    def billing_frequency(self):
        """Gets the billing_frequency of this AddOnVersionDetail.  # noqa: E501

        * `one_time` - one_time * `recurring` - recurring  # noqa: E501

        :return: The billing_frequency of this AddOnVersionDetail.  # noqa: E501
        :rtype: str
        """
    ...
    def billing_frequency(self, billing_frequency):
        """Sets the billing_frequency of this AddOnVersionDetail.

        * `one_time` - one_time * `recurring` - recurring  # noqa: E501

        :param billing_frequency: The billing_frequency of this AddOnVersionDetail.  # noqa: E501
        :type: str
        """
    ...
    @property
    def addon_type(self):
        """Gets the addon_type of this AddOnVersionDetail.  # noqa: E501


        :return: The addon_type of this AddOnVersionDetail.  # noqa: E501
        :rtype: str
        """
    ...
    def addon_type(self, addon_type):
        """Sets the addon_type of this AddOnVersionDetail.


        :param addon_type: The addon_type of this AddOnVersionDetail.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AddOnVersionDetail, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddOnVersionDetail):
            return False
