...
class OrganizationUser(object):
    ...
    def __init__(self, username=None, email=None, role=None, status='Active'):  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this OrganizationUser.  # noqa: E501

        * `Active` - Active * `Invited` - Invited  # noqa: E501

        :return: The status of this OrganizationUser.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this OrganizationUser.

        * `Active` - Active * `Invited` - Invited  # noqa: E501

        :param status: The status of this OrganizationUser.  # noqa: E501
        :type: str
        """
        allowed_values = ["Active", "Invited"]  # noqa: E501
