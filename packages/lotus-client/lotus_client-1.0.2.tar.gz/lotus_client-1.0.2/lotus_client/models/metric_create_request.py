...
class MetricCreateRequest(object):
    ...
    swagger_types = {
        ...
        'is_cost_metric': 'bool',
        'custom_sql': 'str',
        'categorical_filters': 'list[CategoricalFilterDetailRequest]',
        'numeric_filters': 'list[NumericFilterDetailRequest]'
    }
    ...
    def __init__(self, event_name=None, property_name=None, usage_aggregation_type=None, billable_aggregation_type=None, granularity=None, event_type=None, metric_type=None, metric_name=None, proration=None, properties=None, is_cost_metric=False, custom_sql=None, categorical_filters=None, numeric_filters=None):  # noqa: E501
        """MetricCreateRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def event_name(self):
        """Gets the event_name of this MetricCreateRequest.  # noqa: E501

        Name of the event that this metric is tracking.  # noqa: E501

        :return: The event_name of this MetricCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def event_name(self, event_name):
        """Sets the event_name of this MetricCreateRequest.

        Name of the event that this metric is tracking.  # noqa: E501

        :param event_name: The event_name of this MetricCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def property_name(self):
        """Gets the property_name of this MetricCreateRequest.  # noqa: E501
        ...
        :return: The property_name of this MetricCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def property_name(self, property_name):
        """Sets the property_name of this MetricCreateRequest.

        The name of the property of the event that should be used for this metric. Doesn't apply if the metric is of type 'counter' with an aggregation of count.  # noqa: E501

        :param property_name: The property_name of this MetricCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def usage_aggregation_type(self):
        """Gets the usage_aggregation_type of this MetricCreateRequest.  # noqa: E501
        ...
        :return: The usage_aggregation_type of this MetricCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def usage_aggregation_type(self, usage_aggregation_type):
        """Sets the usage_aggregation_type of this MetricCreateRequest.

        The type of aggregation that should be used for this metric. Please refer to our documentation for an explanation of the different types.  * `count` - Count * `sum` - Sum * `max` - Max * `unique` - Unique * `latest` - Latest * `average` - Average  # noqa: E501

        :param usage_aggregation_type: The usage_aggregation_type of this MetricCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def billable_aggregation_type(self):
        """Gets the billable_aggregation_type of this MetricCreateRequest.  # noqa: E501

        * `count` - Count * `sum` - Sum * `max` - Max * `unique` - Unique * `latest` - Latest * `average` - Average  # noqa: E501

        :return: The billable_aggregation_type of this MetricCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def billable_aggregation_type(self, billable_aggregation_type):
        """Sets the billable_aggregation_type of this MetricCreateRequest.

        * `count` - Count * `sum` - Sum * `max` - Max * `unique` - Unique * `latest` - Latest * `average` - Average  # noqa: E501

        :param billable_aggregation_type: The billable_aggregation_type of this MetricCreateRequest.  # noqa: E501
        :type: str
        """
        allowed_values = ["count", "sum", "max", "unique", "latest", "average", ""]  # noqa: E501
    ...
    def granularity(self):
        """Gets the granularity of this MetricCreateRequest.  # noqa: E501
        ...
        :return: The granularity of this MetricCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def granularity(self, granularity):
        """Sets the granularity of this MetricCreateRequest.

        The granularity of the metric. Only applies to metrics of type 'gauge' or 'rate'.  * `seconds` - Second * `minutes` - Minute * `hours` - Hour * `days` - Day * `months` - Month * `quarters` - Quarter * `years` - Year * `total` - Total  # noqa: E501

        :param granularity: The granularity of this MetricCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def event_type(self):
        """Gets the event_type of this MetricCreateRequest.  # noqa: E501
        ...
        :return: The event_type of this MetricCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def event_type(self, event_type):
        """Sets the event_type of this MetricCreateRequest.

        Used only for metrics of type 'gauge'. Please refer to our documentation for an explanation of the different types.  * `delta` - Delta * `total` - Total  # noqa: E501

        :param event_type: The event_type of this MetricCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def metric_type(self):
        """Gets the metric_type of this MetricCreateRequest.  # noqa: E501
        ...
        :return: The metric_type of this MetricCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def metric_type(self, metric_type):
        """Sets the metric_type of this MetricCreateRequest.

        The type of metric that this is. Please refer to our documentation for an explanation of the different types.  * `counter` - Counter * `rate` - Rate * `custom` - Custom * `gauge` - Gauge  # noqa: E501

        :param metric_type: The metric_type of this MetricCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def metric_name(self):
        """Gets the metric_name of this MetricCreateRequest.  # noqa: E501


        :return: The metric_name of this MetricCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def metric_name(self, metric_name):
        """Sets the metric_name of this MetricCreateRequest.


        :param metric_name: The metric_name of this MetricCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def proration(self):
        """Gets the proration of this MetricCreateRequest.  # noqa: E501
        ...
        :return: The proration of this MetricCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def proration(self, proration):
        """Sets the proration of this MetricCreateRequest.

        The proration of the metric. Only applies to metrics of type 'gauge'.  * `seconds` - Second * `minutes` - Minute * `hours` - Hour * `days` - Day * `months` - Month * `quarters` - Quarter * `years` - Year * `total` - Total  # noqa: E501

        :param proration: The proration of this MetricCreateRequest.  # noqa: E501
        :type: str
        """
        allowed_values = ["seconds", "minutes", "hours", "days", "months", "quarters", "years", "total", ""]  # noqa: E501
    ...
    @property
    def properties(self):
        """Gets the properties of this MetricCreateRequest.  # noqa: E501


        :return: The properties of this MetricCreateRequest.  # noqa: E501
    ...
    def properties(self, properties):
        """Sets the properties of this MetricCreateRequest.


        :param properties: The properties of this MetricCreateRequest.  # noqa: E501
    ...
    def is_cost_metric(self):
        """Gets the is_cost_metric of this MetricCreateRequest.  # noqa: E501

        Whether or not this metric is a cost metric (used to track costs to your business).  # noqa: E501

        :return: The is_cost_metric of this MetricCreateRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_cost_metric(self, is_cost_metric):
        """Sets the is_cost_metric of this MetricCreateRequest.

        Whether or not this metric is a cost metric (used to track costs to your business).  # noqa: E501

        :param is_cost_metric: The is_cost_metric of this MetricCreateRequest.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def custom_sql(self):
        """Gets the custom_sql of this MetricCreateRequest.  # noqa: E501
        ...
        :return: The custom_sql of this MetricCreateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def custom_sql(self, custom_sql):
        """Sets the custom_sql of this MetricCreateRequest.

        A custom SQL query that can be used to define the metric. Please refer to our documentation for more information.  # noqa: E501

        :param custom_sql: The custom_sql of this MetricCreateRequest.  # noqa: E501
        :type: str
        """
    ...
    def categorical_filters(self):
        """Gets the categorical_filters of this MetricCreateRequest.  # noqa: E501


        :return: The categorical_filters of this MetricCreateRequest.  # noqa: E501
        :rtype: list[CategoricalFilterDetailRequest]
        """
        return self._categorical_filters

    @categorical_filters.setter
    def categorical_filters(self, categorical_filters):
        """Sets the categorical_filters of this MetricCreateRequest.


        :param categorical_filters: The categorical_filters of this MetricCreateRequest.  # noqa: E501
        :type: list[CategoricalFilterDetailRequest]
        """
    ...
    def numeric_filters(self):
        """Gets the numeric_filters of this MetricCreateRequest.  # noqa: E501


        :return: The numeric_filters of this MetricCreateRequest.  # noqa: E501
        :rtype: list[NumericFilterDetailRequest]
        """
        return self._numeric_filters

    @numeric_filters.setter
    def numeric_filters(self, numeric_filters):
        """Sets the numeric_filters of this MetricCreateRequest.


        :param numeric_filters: The numeric_filters of this MetricCreateRequest.  # noqa: E501
        :type: list[NumericFilterDetailRequest]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MetricCreateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetricCreateRequest):
            return False
