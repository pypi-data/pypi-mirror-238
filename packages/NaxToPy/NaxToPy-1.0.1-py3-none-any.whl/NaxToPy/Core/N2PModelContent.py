...
class N2PModelContent:
    ...
    def __init__(self, path, parallelprocessing, solver=None):
        ...
        # N2PConnectors
        self.__cells_list += list(self.__connector_dict.values())
        t2 = time.time()
        ...
        if self.__vzmodel.InfoInputFileData is not None:
            ...
            lista_cards = []
            for card in n2pmodelimpudata:

                typecard = card.CardType.ToString()

                # Las tarjetas estan ordenadas alfabeticamente salvo grid, que es la primera por eficiencia.
                if typecard == "GRID":
                    lista_cards.append(GRID(card))
                elif typecard == "CBAR":
                    lista_cards.append(CBAR(card))
                elif typecard == "CBEAM":
                    lista_cards.append(CBEAM(card))
                elif typecard == "CBUSH":
                    lista_cards.append(CBUSH(card))
                elif typecard == "CELAS1":
                    lista_cards.append(CELAS1(card))
                elif typecard == "CELAS2":
                    lista_cards.append(CELAS2(card))
                elif typecard == "CELAS3":
                    lista_cards.append(CELAS3(card))
                elif typecard == "CELAS4":
                    lista_cards.append(CELAS4(card))
                elif typecard == "CFAST":
                    lista_cards.append(CFAST(card))
                elif typecard == "CHEXA_NASTRAN":
                    lista_cards.append(CHEXANAS(card))
                elif typecard == "CHEXA_OPTISTRUCT":
                    lista_cards.append(CHEXAOPT(card))
                elif typecard == "CONM2":
                    lista_cards.append(CONM2(card))
                elif typecard == "CORD1C":
                    lista_cards.append(CORD1C(card))
                elif typecard == "CORD1R":
                    lista_cards.append(CORD1R(card))
                elif typecard == "CORD1S":
                    lista_cards.append(CORD1S(card))
                elif typecard == "CORD2C":
                    lista_cards.append(CORD2C(card))
                elif typecard == "CORD2R":
                    lista_cards.append(CORD2R(card))
                elif typecard == "CORD2S":
                    lista_cards.append(CORD2S(card))
                elif typecard == "CPENTA_NASTRAN":
                    lista_cards.append(CPENTANAS(card))
                elif typecard == "CPENTA_OPTISTRUCT":
                    lista_cards.append(CPENTAOPT(card))
                elif typecard == "CPYRA":
                    lista_cards.append(CPYRA(card))
                elif typecard == "CQUAD4":
                    lista_cards.append(CQUAD4(card))
                elif typecard == "CQUAD8":
                    lista_cards.append(CQUAD8(card))
                elif typecard == "CROD":
                    lista_cards.append(CROD(card))
                elif typecard == "CSHEAR":
                    lista_cards.append(CSHEAR(card))
                elif typecard == "CTETRA_NASTRAN":
                    lista_cards.append(CTETRANAS(card))
                elif typecard == "CTETRA_OPTISTRUCT":
                    lista_cards.append(CTETRAOPT(card))
                elif typecard == "CTRIA3":
                    lista_cards.append(CTRIA3(card))
                elif typecard == "CTRIA6":
                    lista_cards.append(CTRIA6(card))
                elif typecard == "CWELD":
                    lista_cards.append(CWELD(card))
                elif typecard == "MAT10_NASTRAN":
                    lista_cards.append(MAT10NAS(card))
                elif typecard == "MAT10_OPTISTRUCT":
                    lista_cards.append(MAT10OPT(card))
                elif typecard == "MAT1_NASTRAN":
                    lista_cards.append(MAT1NAS(card))
                elif typecard == "MAT1_OPTISTRUCT":
                    lista_cards.append(MAT1OPT(card))
                elif typecard == "MAT2_NASTRAN":
                    lista_cards.append(MAT2NAS(card))
                elif typecard == "MAT2_OPTISTRUCT":
                    lista_cards.append(MAT2OPT(card))
                elif typecard == "MAT3":
                    lista_cards.append(MAT3(card))
                elif typecard == "MAT4":
                    lista_cards.append(MAT4(card))
                elif typecard == "MAT5":
                    lista_cards.append(MAT5(card))
                elif typecard == "MAT8":
                    lista_cards.append(MAT8(card))
                elif typecard == "MAT9_NASTRAN":
                    lista_cards.append(MAT9NAS(card))
                elif typecard == "MAT9_OPTISTRUCT":
                    lista_cards.append(MAT9OPT(card))
                elif typecard == "PBAR":
                    lista_cards.append(PBAR(card))
                elif typecard == "PBARL":
                    lista_cards.append(PBARL(card))
                elif typecard == "PBEAM":
                    lista_cards.append(PBEAM(card))
                elif typecard == "PBEAML":
                    lista_cards.append(PBEAML(card))
                elif typecard == "PBUSH_NASTRAN":
                    lista_cards.append(PBUSHNAS(card))
                elif typecard == "PBUSH_OPTISTRUCT":
                    lista_cards.append(PBUSHOPT(card))
                elif typecard == "PCOMP_NASTRAN":
                    lista_cards.append(PCOMPNAS(card))
                elif typecard == "PCOMP_OPTISTRUCT":
                    lista_cards.append(PCOMPOPT(card))
                elif typecard == "PELAS":
                    lista_cards.append(PELAS(card))
                elif typecard == "PFAST":
                    lista_cards.append(PFAST(card))
                elif typecard == "PLOTEL":
                    lista_cards.append(PLOTEL(card))
                elif typecard == "PLPLANE":
                    lista_cards.append(PLPLANE(card))
                elif typecard == "PMASS":
                    lista_cards.append(PMASS(card))
                elif typecard == "PROD":
                    lista_cards.append(PROD(card))
                elif typecard == "PSHEAR":
                    lista_cards.append(PSHEAR(card))
                elif typecard == "PSHELL_NASTRAN":
                    lista_cards.append(PSHELLNAS(card))
                elif typecard == "PSHELL_OPTISTRUCT":
                    lista_cards.append(PSHELLOPT(card))
                elif typecard == "PSOLID_NASTRAN":
                    lista_cards.append(PSOLIDNAS(card))
                elif typecard == "PSOLID_OPTISTRUCT":
                    lista_cards.append(PSOLIDOPT(card))
                elif typecard == "PWELD":
                    lista_cards.append(PWELD(card))
                else:
                    lista_cards.append(N2PCard(card))
    ...
    def get_elements(self, ids: Union[tuple[int, str], list, int] = 0) -> Union[N2PElement, list[N2PElement]]:
        ...
        try:
            ...
            if ids != 0 and isinstance(ids, int):
                if self.Solver == "Nastran" or self.Solver == "Optistruct" or self.Solver == "Ansys":
