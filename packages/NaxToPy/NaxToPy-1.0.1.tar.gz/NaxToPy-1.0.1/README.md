...
[![AppSource](https://img.shields.io/badge/AppSource-NaxTo-blue?logo=microsoft&logoColor=blue&labelColor=lightgrey)](https://appsource.microsoft.com/en-us/product/SaaS/idaerosolutionssl1685692009813.naxto?signInModalType=2&ctaType=1)
...
**NaxToPy** is the [**NaxTo**](https://appsource.microsoft.com/en-us/product/SaaS/idaerosolutionssl1685692009813.naxto?signInModalType=2&ctaType=1)
...
can read input files from Nastran (bdf, fem).
