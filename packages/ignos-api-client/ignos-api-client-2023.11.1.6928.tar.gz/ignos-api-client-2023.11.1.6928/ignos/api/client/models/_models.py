...
class MachineInactivityCriteriaDto(_serialization.Model):
    ...
    _validation = {
        "machine_external_id": {"required": True, "min_length": 1},
        "inactivity_period_in_minutes": {"required": True},
    }
...
class MachineInactivityCriteriaDtoAlertSubscriptionDto(_serialization.Model):
    ...
    _validation = {
        "id": {"required": True, "min_length": 1},
        "alert_type": {"required": True, "min_length": 1},
        "alert_category": {"required": True, "min_length": 1},
        "alert_name": {"required": True, "min_length": 1},
        "description": {"required": True, "min_length": 1},
...
class SubscriberDto(_serialization.Model):
    ...
    :ivar upn: Required.
    :vartype upn: str
    :ivar full_name: Required.
    :vartype full_name: str
    """

    _validation = {
        "id": {"required": True, "readonly": True, "min_length": 1},
        "upn": {"required": True, "readonly": True, "min_length": 1},
        "full_name": {"required": True, "readonly": True, "min_length": 1},
    }
