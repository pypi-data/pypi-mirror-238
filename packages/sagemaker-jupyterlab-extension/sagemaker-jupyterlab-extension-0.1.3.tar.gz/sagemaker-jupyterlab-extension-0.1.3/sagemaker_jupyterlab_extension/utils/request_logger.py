...
app_prefix = os.environ.get("SAGEMAKER_APP_TYPE", "jupyterlab")
...
"""
# We are pattern mathcing url bening with savitur as the current urls is generated with Savitur prefix. Update this to "JupyterLab" after pentest
# https://sim.amazon.com/issues/SAV-660
allowed_uri_patterns = [
    {
        "regex": re.compile(
            r"/%s/default/aws/sagemaker/api/(emr|instance|git)*" % app_prefix
        ),
    }
]
