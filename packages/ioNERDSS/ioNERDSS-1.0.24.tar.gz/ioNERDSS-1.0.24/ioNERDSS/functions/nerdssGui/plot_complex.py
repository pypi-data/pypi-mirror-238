...
class Ui_PlotComplex(object):
    def setupUi(self, PlotComplex):
        ...
        self.widget = MPLWidget(PlotComplex)
        self.widget.setGeometry(QtCore.QRect(110, 40, 511, 401))
        self.widget.setObjectName("widget")
        self.pushButtonSaveComplex = QtWidgets.QPushButton(PlotComplex)
        ...
        self.listWidgetComplex = QtWidgets.QListWidget(PlotComplex)
        self.listWidgetComplex.setGeometry(QtCore.QRect(10, 10, 91, 461))
        self.listWidgetComplex.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        self.listWidgetComplex.setObjectName("listWidgetComplex")
        self.pushButtonPlotComplex = QtWidgets.QPushButton(PlotComplex)
        ...
        self.pushButtonPlotComplexStoi = QtWidgets.QPushButton(PlotComplex)
