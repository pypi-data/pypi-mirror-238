...
class ConfUtil:
    ...
    def connect(cls, conf):
        try:
            ...
            msg = 'conf init failed, please check the config'
            if LogUtil.logger:
                LogUtil.error(msg, e)
            else:
                print(msg, e)
...
class InfluxUtil:
    ...
    def connect(cls, conf: dict):
        try:
            ...
            msg = 'influxdb init failed, please check the config'
            if LogUtil.logger:
                LogUtil.error(msg, e)
            else:
                print(msg, e)
...
class MysqlUtil:
    ...
    def connect(cls, conf: dict):
        try:
            ...
            msg = 'mysql init failed, please check the config'
            if LogUtil.logger:
                LogUtil.error(msg, e)
            else:
                print(msg, e)
...
class ShellUtil:
    ...
    @classmethod
    def _init(cls, conf: dict):
        if not cls.CONN or cls.CFID != UniUtil.get_uuid(conf):
            cls.connect(conf)
    ...
    def connect(cls, conf: dict):
        try:
            ...
            msg = 'shell init failed, please check the config'
            if LogUtil.logger:
                LogUtil.error(msg, e)
            else:
                print(msg, e)
...
class MinioUtil:
    ...
    def connect(cls, conf: dict):
        try:
            ...
            msg = 'minio init failed, please check the config'
            if LogUtil.logger:
                LogUtil.error(msg, e)
            else:
                print(msg, e)
...
class RedisUtil:
    ...
    def connect(cls, conf: dict):
        try:
            ...
            msg = 'redis init failed, please check the config'
            if LogUtil.logger:
                LogUtil.error(msg, e)
            else:
                print(msg, e)
