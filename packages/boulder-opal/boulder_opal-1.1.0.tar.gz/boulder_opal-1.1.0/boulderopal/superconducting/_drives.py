...
from boulderopal._validation.basic import ScalarDType
...
class RealOptimizableConstant(OptimizableCoefficient):
    ...
    def __post_init__(self) -> None:
        self.min = ScalarDType.REAL("min")(self.min)
        self.max = ScalarDType.REAL("max").gt(self.min, "min")(self.max)
...
class ComplexOptimizableConstant(OptimizableCoefficient):
    ...
    def __post_init__(self) -> None:
        self.max_modulus = ScalarDType.REAL("max_modulus").gt(0)(self.max_modulus)
...
class RealOptimizableSignal(OptimizableCoefficient):
    ...
    def __post_init__(self) -> None:
        self.count = ScalarDType.INT("count").gt(0)(self.count)
        self.min = ScalarDType.REAL("min")(self.min)
        self.max = ScalarDType.REAL("max").gt(self.min, "min")(self.max)
