...
from boulderopal._configuration.cloud import get_cloud_router
...
def show_activity_monitor(
    limit: int = 5, offset: int = 0, status: Optional[str] = None
) -> None:
    """
    ...
    limit = ScalarDType.INT("limit").ge(1).le(50)(limit)
