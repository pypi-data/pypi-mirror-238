...
def type_text(text, slow=False):
    low = 0.3 if slow else 0.15
    high = 0.5 if slow else 0.35
...
def get_input():
        ...
        if user_input.lower() in ["yes", "y"]:
            ...
            type_text(colored_ip, slow=True)
            type_text(" registered successfully. ")
        else: get_input()
