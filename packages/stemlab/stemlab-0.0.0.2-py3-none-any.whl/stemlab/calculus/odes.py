...
from ..core.errors import (
    ...
    VectorLengthError, IntegerError, NotInValuesError, NumericError
)
...
def int_odes(
    ...
    if len(time_span) == 2:
        if isinstance(time_span[0], (int, float)):
            ...
            raise NumericError(par_name='time_span[0]', user_input=time_span[0])
        
        if isinstance(time_span[1], (int, float)):
            tf = time_span[1]
        else:
            raise NumericError(par_name='time_span[1]', user_input=time_span[1])
