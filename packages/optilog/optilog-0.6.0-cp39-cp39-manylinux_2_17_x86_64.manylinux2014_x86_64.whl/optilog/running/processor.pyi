...
def parse_scenario(path: str, parsing_info: Union[ParsingInfo, Dict[str, ParsingInfo]], trim_path: str = ..., add_logs: bool = ..., simplify_index: bool = ..., time_scale: str = ...) -> pd.DataFrame:
    '''
