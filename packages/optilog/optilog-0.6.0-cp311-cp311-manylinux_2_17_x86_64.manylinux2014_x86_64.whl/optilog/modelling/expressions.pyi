...
class ExpressionProperties:
    ...
    def __init__(self, force_parenthesis: bool = ...) -> None: ...
...
class Expression:
    ...
    def distributive_cnf(self, debug: bool = ...): ...
    def assert_boolean_operands(self) -> None: ...
    def represent(self, parenthesis: Incomplete | None = ..., latex: bool = ...): ...
...
class Representor:
    ...
    @staticmethod
    def represent(root, father: Incomplete | None = ..., is_primary_operand: bool = ..., parenthesis: Incomplete | None = ..., latex: bool = ...): ...
    @staticmethod
