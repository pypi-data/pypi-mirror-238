...
class SMACScenario(AbstractConfigurator):
    ...
    def __init__(self, entrypoint: ENTRYPOINT_TYPE, constraints: ExecutionConstraints, run_obj: str, global_cfg: CONFIGURABLE_TYPE_LIST = ..., data_kwarg: str = ..., seed_kwarg: str = ..., input_data: str = ..., quality_regex: str = ..., cost_for_crash: float = ..., **scenario_kwargs) -> None:
        """
