...
class GGAScenario(AbstractConfigurator):
    ...
    seed: Incomplete
    def __init__(self, entrypoint: ENTRYPOINT_TYPE, constraints: ExecutionConstraints, run_obj: str, seed: int, cost_min: int, cost_max: int, global_cfg: CONFIGURABLE_TYPE_LIST = ..., eval_time_limit: int = ..., data_kwarg: str = ..., seed_kwarg: str = ..., input_data: str = ..., quality_regex: str = ..., default_as_elite: bool = ..., **scenario_kwargs) -> None:
        """
        ...
        """
    @staticmethod
    def get_instances_directory(scenario_dir): ...
