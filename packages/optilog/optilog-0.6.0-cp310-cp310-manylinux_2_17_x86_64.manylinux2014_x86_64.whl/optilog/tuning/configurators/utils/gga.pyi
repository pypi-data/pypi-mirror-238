from .generic import save_configs_generic as save_configs_generic
...
class GGAParser:
    ...
    def __init__(self, input_file: str) -> None:
        ...
        """
    def get_config(self, raise_if_incomplete: bool = ...) -> Dict[str, Any]:
        ...
        """
    def get_configs(self, raise_if_incomplete: bool = ...) -> Dict[str, Dict[str, Any]]:
        """Get the best config from the output of GGA.
