...
class PyiSAT:
    ...
    def add_clause(self, clause: List[int]):
        ...
        """
    def load_cnf(self, path: Union[str, Path], return_complete: bool = ...) -> CNF:
        """
        ...
        """
    def load_wcnf(self, path: Union[str, Path], return_complete: bool = ...) -> WCNF:
        """
    ...
    def set_prop_budget(self, budget: int):
        ...
        """
    def solve(self, assumptions: Optional[List[int]] = ...) -> Optional[bool]:
        """
        ...
        """
    def solve_limited(self, assumptions: Optional[List[int]] = ...) -> Optional[bool]:
        """
        ...
        """
    def solve_hard_limited(self, assumptions: Optional[List[int]] = ...) -> Optional[bool]:
        """
        ...
        :return: Returns the same as method :py:meth:`solve` and additionally returns None if the budget is exhausted.
        """
    def propagate(self, assumptions: Optional[List[int]] = ..., remove_assumptions: bool = ...) -> Tuple[bool, List[int]]:
        """
    ...
    def num_conflicts(self) -> int:
        ...
        """
    def set_decision_var(self, variable: int, dec: bool = ...):
        """
    ...
    def set_static_heuristic(self, heuristic: List[int]):
        ...
        """
    def enable_static_heuristic(self, enable: bool = ...):
        """
    ...
    def get_config() -> Dict[str, Dict]:
        ...
        """
    def set(self, key: str, value: Type[Union[int, float, bool, str]]):
        """
