...
from optilog.encoders.pb import Encoder as Encoder
...
class CNFPlusTranslator:
    ...
    def __init__(self, exprs: List[Expression]) -> None: ...
    def encode(self) -> List[Expression]: ...
    def get_reify_registry(self): ...
    def get_pb_registry(self): ...
...
class PBNorm:
    ...
    def trim_coeffs(pb_expr):
        ...
        """
    @staticmethod
    def simplify_coeffs(pb_expr): ...
    @staticmethod
    def is_trivially_false(pb_expr): ...
    @staticmethod
    def is_trivially_true(pb_expr): ...
