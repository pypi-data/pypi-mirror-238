from ._utils import MainThread as MainThread
from .formula import CNF as CNF, CNFPlus as CNFPlus, IDPool as IDPool
...
class CardEnc:
    ...
    """
    @classmethod
    def atmost(cls, lits, bound: int = ..., top_id: Incomplete | None = ..., vpool: Incomplete | None = ..., encoding=...):
        """
        ...
        """
    @classmethod
    def atleast(cls, lits, bound: int = ..., top_id: Incomplete | None = ..., vpool: Incomplete | None = ..., encoding=...):
        """
        ...
        """
    @classmethod
    def equals(cls, lits, bound: int = ..., top_id: Incomplete | None = ..., vpool: Incomplete | None = ..., encoding=...):
        """
...
class ITotalizer:
    ...
    rhs: Incomplete
    nof_new: int
    def __init__(self, lits=..., ubound: int = ..., top_id: Incomplete | None = ...) -> None:
        """
        Constructor.
        """
    def new(self, lits=..., ubound: int = ..., top_id: Incomplete | None = ...):
        """
    ...
    def __del__(self) -> None:
        ...
        Destructor.
        """
    def increase(self, ubound: int = ..., top_id: Incomplete | None = ...) -> None:
        """
        ...
        .. code-block:: python
            ...
            >>> t.delete()
        """
    def extend(self, lits=..., ubound: Incomplete | None = ..., top_id: Incomplete | None = ...):
        """
        ...
        .. code-block:: python
            ...
            >>> t.delete()
        """
    def merge_with(self, another, ubound: Incomplete | None = ..., top_id: Incomplete | None = ...) -> None:
        """
