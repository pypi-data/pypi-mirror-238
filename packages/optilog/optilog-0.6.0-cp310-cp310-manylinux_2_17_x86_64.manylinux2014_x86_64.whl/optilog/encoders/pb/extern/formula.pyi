from ._fileio import FileObject as FileObject
...
class IDPool:
    ...
    """
    def __init__(self, start_from: int = ..., occupied=...) -> None:
        """
        Constructor.
        """
    top: Incomplete
    obj2id: Incomplete
    id2obj: Incomplete
    def restart(self, start_from: int = ..., occupied=...):
        """
...
class CNF:
    ...
    clauses: Incomplete
    comments: Incomplete
    def __init__(self, from_file: Incomplete | None = ..., from_fp: Incomplete | None = ..., from_string: Incomplete | None = ..., from_clauses=..., from_aiger: Incomplete | None = ..., comment_lead=...) -> None:
        """
        Constructor.
        """
    def from_file(self, fname, comment_lead=..., compressed_with: str = ...) -> None:
        """
        ...
        """
    def from_fp(self, file_pointer, comment_lead=...) -> None:
        """
        ...
        .. code-block:: python
            ...
            ...     cnf2 = CNF(from_fp=fp)
        """
    def from_string(self, string, comment_lead=...) -> None:
        """
    ...
    inps: Incomplete
    outs: Incomplete
    def from_aiger(self, aig, vpool: Incomplete | None = ...) -> None:
        """
    ...
    def copy(self):
        ...
        .. code-block:: python
            ...
            2
        """
    def to_file(self, fname, comments: Incomplete | None = ..., compress_with: str = ...) -> None:
        """
        ...
        """
    def to_fp(self, file_pointer, comments: Incomplete | None = ...) -> None:
        """
    ...
    def weighted(self):
        ...
        .. code-block:: python
            ...
            [1, 1]
        """
    def negate(self, topv: Incomplete | None = ...):
        """
...
class WCNF:
    ...
    topw: int
    comments: Incomplete
    def __init__(self, from_file: Incomplete | None = ..., from_fp: Incomplete | None = ..., from_string: Incomplete | None = ..., comment_lead=...) -> None:
        """
        Constructor.
        """
    def from_file(self, fname, comment_lead=..., compressed_with: str = ...) -> None:
    ...
    def to_fp(self, file_pointer, comments: Incomplete | None = ...) -> None:
        ...
        """
    def append(self, clause, weight: Incomplete | None = ...) -> None:
        """
        ...
        .. code-block:: python
            ...
            [10, 20]
        """
    def extend(self, clauses, weights: Incomplete | None = ...) -> None:
        """
...
class CNFPlus(CNF):
    ...
    def to_fp(self, file_pointer, comments: Incomplete | None = ...) -> None:
        ...
        .. code-block:: python
            ...
            ...     cnf.to_fp(fp)  # writing to the file pointer
        """
    def append(self, clause, is_atmost: bool = ...) -> None:
        """
    ...
    **Note** that every cardinality constraint is assumed to be *hard*,
    ...
    def to_fp(self, file_pointer, comments: Incomplete | None = ...) -> None:
        ...
        .. code-block:: python
            ...
            ...     cnf.to_fp(fp)  # writing to the file pointer
        """
    def append(self, clause, weight: Incomplete | None = ..., is_atmost: bool = ...) -> None:
        """
