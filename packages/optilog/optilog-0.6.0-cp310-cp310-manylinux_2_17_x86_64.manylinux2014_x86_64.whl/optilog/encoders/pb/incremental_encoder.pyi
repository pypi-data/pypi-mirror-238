...
class FullIncrEncoder:
    ...
    Pb2cnf: Incomplete
    already_init: bool
    def __init__(self, literals: List[int], bound: int = ..., weights: Optional[List[int]] = ..., max_var: Optional[int] = ...) -> None:
        """
...
class IncrementalEncoder:
    ...
    *IncrementalEncoder* only supports *at most k* constraints.
    ...
    max_var: Incomplete
    encoding: Incomplete
    def __init__(self, literals: List[int], bound: int = ..., weights: Optional[List[int]] = ..., max_var: Optional[int] = ..., encoding: str = ...) -> None:
        """
        :param literals: List of literals
    ...
    def get_init_clauses(self) -> Tuple[int, List[List[int]]]:
        ...
        """
    @staticmethod
    def init(literals: List[int], bound: int = ..., weights: Optional[List[int]] = ..., max_var: Optional[int] = ..., encoding: str = ...) -> Tuple['IncrementalEncoder', int, List[List[int]]]:
        """
