...
def color(s, color, mode: int = ...): ...
def red(s): ...
def green(s): ...
def yellow(s): ...
def error(msg, exit: bool = ...) -> None: ...
def warn(msg) -> None: ...
def info(msg) -> None: ...
def in_repository(): ...
...
def refresh_cache(args, force: bool = ...) -> None: ...
...
def docker_build(args, docker_argv, tag, root, build_args=..., Dockerfile: Incomplete | None = ...) -> None: ...
