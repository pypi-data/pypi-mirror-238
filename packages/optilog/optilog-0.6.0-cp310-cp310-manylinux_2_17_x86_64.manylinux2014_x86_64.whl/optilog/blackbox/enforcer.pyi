...
from optilog.internalutils import get_program as get_program, none_parse_mem_units as none_parse_mem_units, none_parse_time_units as none_parse_time_units
...
class ExecutionConstraints:
    ...
    enforcer: Incomplete
    def __init__(self, enforcer: Enforcer, h_wall_time: int = ..., h_cpu_time: int = ..., h_virtual_memory: str = ..., h_real_memory: str = ..., s_wall_time: int = ..., s_cpu_time: int = ..., s_virtual_memory: str = ..., s_real_memory: str = ...) -> None:
        """
...
class RunSolver(Enforcer):
    ...
    def __init__(self, path: Path = ..., delay: int = ..., watcher_path: Union[str, Path] = ..., timestamp: bool = ...) -> None:
        """
