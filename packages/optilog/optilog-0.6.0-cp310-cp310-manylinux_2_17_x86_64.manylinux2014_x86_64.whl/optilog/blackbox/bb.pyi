import abc
from . import satex as satex
from .enforcer import DockerEnforcer as DockerEnforcer, ExecutionConstraints as ExecutionConstraints
from .satex import Repository as Repository
from _typeshed import Incomplete
from abc import ABC, abstractmethod
from enum import Enum
from optilog.formulas import CNF as CNF
from optilog.internalutils import get_program as get_program, is_exe as is_exe
from optilog.internalutils.utils import exists as exists
from optilog.tuning.basis import Parameter as Parameter
...
class BlackBox(ABC):
    ...
    def get_config(cls) -> Dict[str, Dict[str, str]]:
        ...
        """
    def set_default(cls, key: str, value, check_domain: bool = ...):
        """
    ...
    def get(self, key: str) -> Union[int, float, bool, str]:
        """Returns the value assigned to a given parameter name.

        :param key: Parameter name.
        :return: Parameter value.
        """
    def set(self, key: str, value, check_domain: bool = ...):
        """
...
class SystemBlackBox(ParsingBlackBox):
    ...
    def __init__(self, arguments: List[Union[str, BlackBoxArgument]], unbuffer: Union[str, bool] = ..., constraints: Optional[ExecutionConstraints] = ..., parsing_info: Optional['ParsingInfo'] = ...) -> None:
        """
    ...
    def format_config(self, args: List[str]):
        ...
        """
    def run(self, instance: str, seed: int = ..., constraints: ExecutionConstraints = ..., stdout: Union[str, BlackBoxRedirection] = ..., stderr: Union[str, BlackBoxRedirection] = ..., text: bool = ...):
...
class SatexBlackBox(ParsingBlackBox):
    ...
    constraints: Incomplete
    completed: Incomplete
    def __init__(self, solver: str, constraints: ExecutionConstraints = ...) -> None:
        """
        :param solver: Name of the solver to insantiate. See the method ``available_solvers``
        :param constraints: |constraints-param|
        """
    @staticmethod
    def available_solvers(pattern: Optional[str] = ...) -> List[str]:
        """
    ...
    @property
    def stderr(self): ...
    def run(self, instance: Union[str, CNF], constraints: ExecutionConstraints = ..., stdout: Union[str, BlackBoxRedirection] = ..., stderr: Union[str, BlackBoxRedirection] = ...):
        """
