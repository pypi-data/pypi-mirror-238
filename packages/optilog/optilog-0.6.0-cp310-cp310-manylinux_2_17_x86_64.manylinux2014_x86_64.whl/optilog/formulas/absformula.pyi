...
class VarManager:
    ...
    def new_var(self) -> int:
        ...
        """
    def get_lit(self, lit: Expression, insert: bool = ...) -> int:
        """
...
class AbsFormula(ABC, metaclass=abc.ABCMeta):
    ...
    def __init__(self, var_manager: Incomplete | None = ...) -> None: ...
    def to_dimacs(self, clause): ...
    def extend_vars(self, how_many: int) -> None:
        """|form-extendvars-description|
    ...
    def write_dimacs_file(self, file_path: str, *args, **kwargs) -> None:
        ...
        """
    def add_comment(self, comment: Union[str, List[str]]) -> None:
        """
