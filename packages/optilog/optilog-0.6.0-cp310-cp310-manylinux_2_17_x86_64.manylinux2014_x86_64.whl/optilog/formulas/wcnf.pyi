from .absformula import AbsFormula as AbsFormula, CNFException as CNFException, NewLineStreamer as NewLineStreamer
...
class WCNF(AbsFormula):
    ...
    def sum_soft_weights(self) -> Union[int, float]:
        """
    ...
    def num_clauses(self) -> int:
        ...
        """
    def top_weight(self) -> Union[int, float]:
        """
        :return: The weight for hard clauses = ``WCNF.sum_soft_weights + 1``.
        """
    def feasible(self, model: List[int]) -> Optional[bool]:
        """
    ...
    def add_clause(self, clause: List[int], weight: int = ...):
        ...
        .. code-block:: python
            ...
            1 3 0
        """
    def cost(self, assignment: List[int], inverse: bool = ...) -> Union[int, float]:
        """
        :param assignment: A (possibly partial) assignment for the WCNF formula.
        ...
        """
    def write_dimacs(self, stream: IO = ..., format: str = ...):
        '''
        ...
        '''
    def write_dimacs_file(self, file_path: str, format: str = ...) -> None:
        ...
        '''
    def shuffle(self, vars: bool = ..., soft_clauses: bool = ..., hard_clauses: bool = ..., literals: bool = ..., polarity: bool = ..., seed: int = ...) -> None:
        """
