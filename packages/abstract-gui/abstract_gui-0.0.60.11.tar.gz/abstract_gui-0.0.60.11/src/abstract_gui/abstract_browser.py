...
class AbstractBrowser:
    ...
    """
    def __init__(self, window_mgr=None,window=None):
        self.window_mgr = window_mgr
        if self.window_mgr and if hasattr(self.window_mgr, 'window'):
            self.window = self.window_mgr.window
        elif window_name and hasattr(self.window_mgr, 'get_window'):
            self.window=self.window_mgr.get_window(window_name=window_name)
        else:
