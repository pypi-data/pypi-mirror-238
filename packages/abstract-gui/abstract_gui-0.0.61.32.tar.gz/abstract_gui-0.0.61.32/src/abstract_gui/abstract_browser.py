...
class AbstractBrowser:
    ...
    def __init__(self, window_mgr=None,window_name=None,window=None):
        ...
        self.key_list = ['-CLEAR_LIST-','-ADD_TO_LIST-','-FILES_LIST-',"-FILES_BROWSER-","-DIR-","-DIRECTORY_BROWSER-","-FILES_LIST-","-SCAN_MODE_ALL-","-SELECT_HIGHLIGHTED-","-SCAN-", "-SELECT_HIGHLIGHTED-", "-MODE-", "-BROWSE_BACKWARDS-", "-BROWSE_FORWARDS-"]
