...
class AbstractBrowser:
    ...
    def __init__(self, window_mgr=None,window_name=None,window=None):
        ...
        self.key_list = ['-BROWSER_LIST-','-CLEAR_LIST-','-ADD_TO_LIST-','-FILE_LIST-',"-FILES_BROWSER-","-DIR-","-DIRECTORY_BROWSER-","-FILES_LIST-","-SCAN_MODE_ALL-","-SELECT_HIGHLIGHTED-","-SCAN-", "-SELECT_HIGHLIGHTED-", "-MODE-", "-BROWSE_BACKWARDS-", "-BROWSE_FORWARDS-"]
    ...
    def get_scan_browser_layout(section=None,extra_buttons=[]):
        ...
        [make_component("Text",'Directory to scan:'), make_component("InputText",os.getcwd(),key=text_to_key(text='dir',section=section)),
         ...
         make_component("FilesBrowse","Files", enable_events=True, key=text_to_key(text='file browser',section=section)),make_component("Checkbox",'all',default=True,key=text_to_key(text='scan mode all',section=section))], 
        [make_component("Listbox",[],size=(50, 10),key=text_to_key(text='files list',section=section),enable_events=True),
         make_component("Listbox",[],size=(50, 10),key=text_to_key(text='file list',section=section),enable_events=True)],
        ...
        make_component("Button","->",key=text_to_key(text='browse forwards',section=section),enable_events=True),make_component("Button","Add",key=text_to_key(text='add_to_list',section=section),enable_events=True),make_component("Button","Clear",key=text_to_key(text='clear list',section=section),enable_events=True)]+extra_buttons
        ]
