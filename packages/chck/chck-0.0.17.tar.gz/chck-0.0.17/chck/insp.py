...
# %% auto 0
__all__ = ['isp', 'isvarpos', 'isvarkwd', 'isself', 'isclsarg', 'ispself', 'ispcls', 'isempty', 'ispempty', 'iskwonly',
           'ispkwonly', 'isfunc', 'islambda']

# %% ../nbs/02_insp.ipynb 4
from inspect import Parameter, isfunction
