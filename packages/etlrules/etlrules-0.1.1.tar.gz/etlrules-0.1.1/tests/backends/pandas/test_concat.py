...
def test_vconcat_missing_col_right():
    left_df = DataFrame(data=[
        {"A": 1, "B": "b", "C": True, "D": "None"},
        {"A": 2, "B": "c", "C": False},
        {"A": 3, "B": "d", "C": True},
    ...
    with get_test_data(left_df, named_inputs={"left": left_df, "right": right_df}, named_output="result") as data:
        rule = VConcatRule(named_input_left="left", named_input_right="right", subset_columns=["A", "B"], named_output="result", strict=False)
...
def test_vconcat_missing_col_left():
    left_df = DataFrame(data=[
        {"A": 1, "B": "b", "C": True, "D": "None"},
        {"A": 2, "B": "c", "C": False},
        {"A": 3, "B": "d", "C": True},
    ...
    with get_test_data(left_df, named_inputs={"left": left_df, "right": right_df}, named_output="result") as data:
        rule = VConcatRule(named_input_left="left", named_input_right="right", subset_columns=["A", "F"], named_output="result", strict=False)
        with pytest.raises(MissingColumnError) as exc:
            rule.apply(data)
...
def test_vconcat_different_schema_non_strict():
    left_df = DataFrame(data=[
        {"A": 1, "B": "b", "C": True},
        {"A": 2, "B": "c", "C": False},
        {"A": 3, "B": "d", "C": True},
...
def test_hconcat_different_no_rows_strict():
    left_df = DataFrame(data=[
        {"A": 1, "B": "b", "C": True},
        {"A": 2, "B": "c", "C": False},
        {"A": 3, "B": "d", "C": True},
...
def test_hconcat_different_columns_with_same_name():
    left_df = DataFrame(data=[
        {"A": 1, "B": "b", "C": True},
        {"A": 2, "B": "c", "C": False},
        {"A": 3, "B": "d", "C": True},
...
def test_hconcat_different_no_rows_non_strict():
    left_df = DataFrame(data=[
        {"A": 1, "B": "b", "C": True},
        {"A": 2, "B": "c", "C": False},
        {"A": 3, "B": "d", "C": True},
    ...
    with get_test_data(left_df, named_inputs={"left": left_df, "right": right_df}, named_output="result") as data:
        rule = HConcatRule(named_input_left="left", named_input_right="right", named_output="result", strict=False)
        rule.apply(data)
        assert_frame_equal(data.get_named_output("result"), expected)
