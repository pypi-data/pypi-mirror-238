...
class ConnectionConfluentSchemaRegistryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] validate: If the connection should wait for validation.
        """
...
class ConnectionConfluentSchemaRegistry(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['ConnectionConfluentSchemaRegistrySslCertificateArgs']] ssl_certificate: The client certificate for the Confluent Schema Registry.. Can be supplied as either free text using `text` or reference to a secret object using `secret`.
        :param pulumi.Input[pulumi.InputType['ConnectionConfluentSchemaRegistrySslCertificateAuthorityArgs']] ssl_certificate_authority: The CA certificate for the Confluent Schema Registry.. Can be supplied as either free text using `text` or reference to a secret object using `secret`.
        ...
        :param pulumi.Input[str] url: The URL of the Confluent Schema Registry.
        :param pulumi.Input[pulumi.InputType['ConnectionConfluentSchemaRegistryUsernameArgs']] username: The username for the Confluent Schema Registry.. Can be supplied as either free text using `text` or reference to a secret object using `secret`.
        :param pulumi.Input[bool] validate: If the connection should wait for validation.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            url: Optional[pulumi.Input[str]] = None,
            username: Optional[pulumi.Input[pulumi.InputType['ConnectionConfluentSchemaRegistryUsernameArgs']]] = None,
            validate: Optional[pulumi.Input[bool]] = None) -> 'ConnectionConfluentSchemaRegistry':
        """
