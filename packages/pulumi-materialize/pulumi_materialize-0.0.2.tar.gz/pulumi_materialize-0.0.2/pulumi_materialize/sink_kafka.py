...
class SinkKafkaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] size: The size of the sink. If not specified, the `cluster_name` option must be specified.
    ...
    def size(self) -> Optional[pulumi.Input[str]]:
        """
        The size of the sink. If not specified, the `cluster_name` option must be specified.
        """
