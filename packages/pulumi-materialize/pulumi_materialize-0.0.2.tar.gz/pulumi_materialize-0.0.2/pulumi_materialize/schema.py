...
class SchemaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] database_name: The identifier for the schema database. Defaults to `MZ_DATABASE` environment variable if set or `materialize` if environment variable is not set.
    ...
    def database_name(self) -> Optional[pulumi.Input[str]]:
        """
        The identifier for the schema database. Defaults to `MZ_DATABASE` environment variable if set or `materialize` if environment variable is not set.
        """
