...
class SourceLoadgenArgs:
    def __init__(__self__, *,
                 ...
                 marketing_options: Optional[pulumi.Input[Sequence[pulumi.Input['SourceLoadgenMarketingOptionArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SourceLoadgenMarketingOptionArgs']]] marketing_options: Marketing Options.
    ...
    def marketing_options(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['SourceLoadgenMarketingOptionArgs']]]]:
        """
        Marketing Options.
        """
    ...
    def marketing_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SourceLoadgenMarketingOptionArgs']]]]):
...
class SourceLoadgen(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 database_name: Optional[pulumi.Input[str]] = None,
                 load_generator_type: Optional[pulumi.Input[str]] = None,
                 marketing_options: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SourceLoadgenMarketingOptionArgs']]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 ownership_role: Optional[pulumi.Input[str]] = None,
                 schema_name: Optional[pulumi.Input[str]] = None,
                 size: Optional[pulumi.Input[str]] = None,
        ...
        example_source_load_generator = materialize.SourceLoadgen("exampleSourceLoadGenerator",
            counter_options=[materialize.SourceLoadgenCounterOptionArgs(
                scale_factor=0.01,
                tick_interval="500ms",
            )],
        ...
        :param pulumi.Input[str] database_name: The identifier for the source database. Defaults to `MZ_DATABASE` environment variable if set or `materialize` if environment variable is not set.
        :param pulumi.Input[str] load_generator_type: The load generator types: [AUCTION MARKETING COUNTER TPCH].
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SourceLoadgenMarketingOptionArgs']]]] marketing_options: Marketing Options.
        :param pulumi.Input[str] name: The identifier for the source.
        :param pulumi.Input[str] ownership_role: The owernship role of the object.
        :param pulumi.Input[str] schema_name: The identifier for the source schema. Defaults to `public`.
        :param pulumi.Input[str] size: The size of the source. If not specified, the `cluster_name` option must be specified.
    ...
    @property
    @pulumi.getter(name="marketingOptions")
    def marketing_options(self) -> pulumi.Output[Optional[Sequence['outputs.SourceLoadgenMarketingOption']]]:
        """
        Marketing Options.
        """
        return pulumi.get(self, "marketing_options")
