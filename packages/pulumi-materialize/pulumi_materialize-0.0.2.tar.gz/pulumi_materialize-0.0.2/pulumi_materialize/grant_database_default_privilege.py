...
class GrantDatabaseDefaultPrivilege(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
         $ pulumi import materialize:index/grantDatabaseDefaultPrivilege:GrantDatabaseDefaultPrivilege example GRANT DEFAULT|CONNECTION|<grantee_id>|<target_role_id>|<database_id>||<privilege>
        ```
    ...
    def get(resource_name: str,
            ...
            grantee_name: Optional[pulumi.Input[str]] = None,
            privilege: Optional[pulumi.Input[str]] = None,
            target_role_name: Optional[pulumi.Input[str]] = None) -> 'GrantDatabaseDefaultPrivilege':
        """
