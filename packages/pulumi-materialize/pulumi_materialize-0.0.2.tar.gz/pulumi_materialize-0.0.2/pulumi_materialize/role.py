...
class RoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: The identifier for the role.
        """
        if name is not None:
...
class _RoleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] inherit: Grants the role the ability to inheritance of privileges of other roles. Unlike PostgreSQL, Materialize does not currently support `NOINHERIT`
        :param pulumi.Input[str] name: The identifier for the role.
        :param pulumi.Input[str] qualified_sql_name: The fully qualified name of the role.
        """
...
class Role(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
         $ pulumi import materialize:index/role:Role example_role <role_id>
        ```
    ...
    def get(resource_name: str,
            ...
            inherit: Optional[pulumi.Input[bool]] = None,
            name: Optional[pulumi.Input[str]] = None,
            qualified_sql_name: Optional[pulumi.Input[str]] = None) -> 'Role':
        """
    ...
    @property
    @pulumi.getter
    def inherit(self) -> pulumi.Output[bool]:
        """
        Grants the role the ability to inheritance of privileges of other roles. Unlike PostgreSQL, Materialize does not currently support `NOINHERIT`
        """
        return pulumi.get(self, "inherit")
