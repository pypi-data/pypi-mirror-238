...
__all__ = ['GrantSchemaDefaultPrivilegeArgs', 'GrantSchemaDefaultPrivilege']

@pulumi.input_type
class GrantSchemaDefaultPrivilegeArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a GrantSchemaDefaultPrivilege resource.
...
@pulumi.input_type
class _GrantSchemaDefaultPrivilegeState:
    def __init__(__self__, *,
                 database_name: Optional[pulumi.Input[str]] = None,
        ...
        """
        Input properties used for looking up and filtering GrantSchemaDefaultPrivilege resources.
        :param pulumi.Input[str] database_name: The default privilege will apply only to objects created in this database, if specified.
        :param pulumi.Input[str] grantee_name: The role name that will gain the default privilege. Use the `PUBLIC` pseudo-role to grant privileges to all roles.
        :param pulumi.Input[str] privilege: The privilege to grant to the object.
        :param pulumi.Input[str] target_role_name: The default privilege will apply to objects created by this role. If this is left blank, then the current role is assumed. Use the `PUBLIC` pseudo-role to target objects created by all roles.
...
class GrantSchemaDefaultPrivilege(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        ```sh
         $ pulumi import materialize:index/grantSchemaDefaultPrivilege:GrantSchemaDefaultPrivilege example GRANT DEFAULT|SCHEMA|<grantee_id>|<target_role_id>|<database_id>|<schema_id>|<privilege>
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: GrantSchemaDefaultPrivilegeArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Defines default privileges that will be applied to objects created in the future. It does not affect any existing objects.
        ...
        :param str resource_name: The name of the resource.
        :param GrantSchemaDefaultPrivilegeArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GrantSchemaDefaultPrivilegeArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GrantSchemaDefaultPrivilegeArgs.__new__(GrantSchemaDefaultPrivilegeArgs)
        ...
        super(GrantSchemaDefaultPrivilege, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            grantee_name: Optional[pulumi.Input[str]] = None,
            privilege: Optional[pulumi.Input[str]] = None,
            target_role_name: Optional[pulumi.Input[str]] = None) -> 'GrantSchemaDefaultPrivilege':
        """
        Get an existing GrantSchemaDefaultPrivilege resource's state with the given name, id, and optional extra
        ...
        __props__ = _GrantSchemaDefaultPrivilegeState.__new__(_GrantSchemaDefaultPrivilegeState)

        __props__.__dict__["database_name"] = database_name
        __props__.__dict__["grantee_name"] = grantee_name
        __props__.__dict__["privilege"] = privilege
        __props__.__dict__["target_role_name"] = target_role_name
        return GrantSchemaDefaultPrivilege(resource_name, opts=opts, __props__=__props__)
