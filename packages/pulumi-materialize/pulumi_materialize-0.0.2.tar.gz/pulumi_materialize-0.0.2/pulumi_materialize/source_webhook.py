...
class SourceWebhookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] include_headers: Include headers in the webhook.
...
class SourceWebhook(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
         $ pulumi import materialize:index/sourceWebhook:SourceWebhook example_source_webhook <source_id>
        ```
