...
__all__ = [
    ...
    'SourceLoadgenMarketingOptionArgs',
...
@pulumi.input_type
class SourceLoadgenMarketingOptionArgs:
    def __init__(__self__, *,
                 scale_factor: Optional[pulumi.Input[float]] = None,
                 tick_interval: Optional[pulumi.Input[str]] = None):
        """
...
class SourcePostgresPostgresConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] database_name: The postgres_connection database name.
        :param pulumi.Input[str] schema_name: The postgres_connection schema name.
        """
        pulumi.set(__self__, "name", name)
        if database_name is not None:
            pulumi.set(__self__, "database_name", database_name)
