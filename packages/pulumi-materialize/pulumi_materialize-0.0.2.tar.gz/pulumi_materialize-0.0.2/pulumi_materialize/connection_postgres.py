...
class ConnectionPostgres(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['ConnectionPostgresSslCertificateArgs']] ssl_certificate: The client certificate for the Postgres database.. Can be supplied as either free text using `text` or reference to a secret object using `secret`.
        :param pulumi.Input[pulumi.InputType['ConnectionPostgresSslCertificateAuthorityArgs']] ssl_certificate_authority: The CA certificate for the Postgres database.. Can be supplied as either free text using `text` or reference to a secret object using `secret`.
        :param pulumi.Input[pulumi.InputType['ConnectionPostgresSslKeyArgs']] ssl_key: The client key for the Postgres database.
        :param pulumi.Input[str] ssl_mode: The SSL mode for the Postgres database.
        :param pulumi.Input[pulumi.InputType['ConnectionPostgresUserArgs']] user: The Postgres database username.. Can be supplied as either free text using `text` or reference to a secret object using `secret`.
        :param pulumi.Input[bool] validate: If the connection should wait for validation.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            ssl_mode: Optional[pulumi.Input[str]] = None,
            user: Optional[pulumi.Input[pulumi.InputType['ConnectionPostgresUserArgs']]] = None,
            validate: Optional[pulumi.Input[bool]] = None) -> 'ConnectionPostgres':
        """
