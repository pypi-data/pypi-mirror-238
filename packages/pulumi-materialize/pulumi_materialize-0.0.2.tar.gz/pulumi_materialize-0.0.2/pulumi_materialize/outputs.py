...
@pulumi.output_type
class SourceLoadgenMarketingOption(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "scaleFactor":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in SourceLoadgenMarketingOption. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        SourceLoadgenMarketingOption.__key_warning(key)
        return super().__getitem__(key)
...
class SourcePostgresPostgresConnection(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str database_name: The postgres_connection database name.
        :param str schema_name: The postgres_connection schema name.
        """
        pulumi.set(__self__, "name", name)
        if database_name is not None:
            pulumi.set(__self__, "database_name", database_name)
    ...
    def database_name(self) -> Optional[str]:
        """
        The postgres_connection database name.
        """
        return pulumi.get(self, "database_name")
    ...
    def schema_name(self) -> Optional[str]:
        """
        The postgres_connection schema name.
        """
        return pulumi.get(self, "schema_name")
