...
class TableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] database_name: The identifier for the table database. Defaults to `MZ_DATABASE` environment variable if set or `materialize` if environment variable is not set.
        ...
        :param pulumi.Input[str] schema_name: The identifier for the table schema. Defaults to `public`.
        """
    ...
    def database_name(self) -> Optional[pulumi.Input[str]]:
        """
        The identifier for the table database. Defaults to `MZ_DATABASE` environment variable if set or `materialize` if environment variable is not set.
        """
    ...
    def schema_name(self) -> Optional[pulumi.Input[str]]:
        """
        The identifier for the table schema. Defaults to `public`.
        """
