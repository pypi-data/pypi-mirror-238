...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] disk: **Private Preview**. Whether or not the replicas of the managed cluster are *disk-backed replicas*.
    ...
    def disk(self) -> Optional[pulumi.Input[bool]]:
        """
        **Private Preview**. Whether or not the replicas of the managed cluster are *disk-backed replicas*.
        """
