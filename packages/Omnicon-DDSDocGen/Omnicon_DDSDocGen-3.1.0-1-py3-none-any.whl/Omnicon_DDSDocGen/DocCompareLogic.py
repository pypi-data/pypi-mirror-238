...
class DocCompareLogic:
    def __init__(self, progress_callback_function, logging_verbosity) -> None:
    ...
    def run_engine_and_generate_comparison(self,
        ...
        try:
            ...
            self.origin_engine_handler = OmniconEngineHandler(origin_dds_types_files, is_parse_ROS2_constants)
            self.new_engine_handler = OmniconEngineHandler(new_dds_types_files, is_parse_ROS2_constants)
