...
class DDSDocGen():
    def __init__(self, logging_verbosity: str = "WARNING",
        ...
        self.__document_generator = DocGenLogic.DocumentGenerator(progress_function, verbosity_upper)
        self.__document_comparator = DocCompareLogic.DocCompareLogic(progress_function, verbosity_upper)
