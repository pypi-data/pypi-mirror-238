...
# class SystemConfLevelView(PermissionRequiredMixin, generic.ObjectView):
#     permission_required = ('dcim.view_site', 'dcim.view_device')
#     queryset = SystemConfLevel.objects.all()
#
#
# class SystemConfLevelListView(PermissionRequiredMixin, generic.ObjectListView):
#     permission_required = ('dcim.view_site', 'dcim.view_device')
#     queryset = SystemConfLevel.objects.all()
#     table = tables.SystemConfLevelTable
#     filterset = filtersets.SystemConfLevelFilterSet
#     filterset_form = forms.SystemConfLevelFilterForm
#
#
# class SystemConfLevelEditView(PermissionRequiredMixin, generic.ObjectEditView):
#     permission_required = ('dcim.view_site', 'dcim.view_device')
#     queryset = SystemConfLevel.objects.all()
#     form = forms.SystemConfLevelForm
#
#     # template_name = 'netbox_software/SystemConfLevel_edit.html'
#
#
# class SystemConfLevelDeleteView(PermissionRequiredMixin, generic.ObjectDeleteView):
#     permission_required = ('dcim.view_site', 'dcim.view_device')
#     queryset = SystemConfLevel.objects.all()
