...
# class SystemConfLevelTable(NetBoxTable):
#     name = tables.TemplateColumn(template_code=TENANT_SYSTEMCONFLVL_LINK)
#
#     class Meta(NetBoxTable.Meta):
#         model = SystemConfLevel
#         fields = (
#             'pk', 'id', 'name', 'description', 'slug', 'created', 'last_updated', 'actions',
#         )
