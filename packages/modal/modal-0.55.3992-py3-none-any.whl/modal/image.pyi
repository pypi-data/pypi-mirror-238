...
class _Image(modal.object._Object):
    ...
    @staticmethod
    def _registry_setup_commands(tag: str, setup_dockerfile_commands: typing.List[str], add_python: typing.Union[str, None]) -> typing.List[str]:
        ...

    @staticmethod
    def from_registry(tag: str, *, setup_dockerfile_commands: typing.List[str] = [], force_build: bool = False, add_python: typing.Union[str, None] = None, **kwargs) -> _Image:
        ...

    @staticmethod
    def from_dockerhub(tag: str, setup_dockerfile_commands: typing.List[str] = [], force_build: bool = False, **kwargs):
        ...
...
class Image(modal.object.Object):
    ...
    @staticmethod
    def _from_args(base_images={}, context_files={}, dockerfile_commands: typing.Union[typing.List[str], typing.Callable[[], typing.List[str]]] = [], secrets: typing.Sequence[modal.secret.Secret] = [], gpu_config: typing.Union[modal_proto.api_pb2.GPUConfig, None] = None, build_function: typing.Union[modal.functions.Function, None] = None, context_mount: typing.Union[modal.mount.Mount, None] = None, image_registry_config: typing.Union[_ImageRegistryConfig, None] = None, force_build: bool = False, _namespace: int = 1):
        ...
    ...
    @staticmethod
    def from_registry(tag: str, *, setup_dockerfile_commands: typing.List[str] = [], force_build: bool = False, add_python: typing.Union[str, None] = None, **kwargs) -> Image:
        ...
