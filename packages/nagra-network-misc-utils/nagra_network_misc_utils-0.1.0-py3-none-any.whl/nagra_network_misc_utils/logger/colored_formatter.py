...
# Use ANSI escape code to color the console: https://en.wikipedia.org/wiki/ANSI_escape_code
import colorist
# from colorist import BgColor, Color, Effect
from colorama import Back as BgColor, Fore as Color, Style
...
COLORS = {
    ...
    "ERROR": mk_formatter(BgColor.RED, Style.BOLD, Color.BLACK),
}
...
def formatter_message(format=DEFAULT_FORMAT, use_color=True):
    ...
    """
    BOLD, RESET = (colorist.Effect.BOLD,
                   colorist.Effect.OFF) if use_color else ("", "")
