...
from pyconnectwise.endpoints.manage.ScheduleCalendarsIdCopyEndpoint import (
    ScheduleCalendarsIdCopyEndpoint,
)
from pyconnectwise.endpoints.manage.ScheduleCalendarsIdInfoEndpoint import (
    ScheduleCalendarsIdInfoEndpoint,
)
from pyconnectwise.endpoints.manage.ScheduleCalendarsIdUsagesEndpoint import (
    ScheduleCalendarsIdUsagesEndpoint,
)
...
class ScheduleCalendarsIdEndpoint(
    ...
    def patch(
        ...
        """
        return self._parse_one(
            Calendar, super()._make_request("PATCH", data=data, params=params).json()
        )
    ...
    def put(
        ...
        """
        return self._parse_one(
            Calendar, super()._make_request("PUT", data=data, params=params).json()
        )
