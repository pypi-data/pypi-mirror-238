...
class FinanceTaxcodesIdTaxcodelevelsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /finance/taxCodes/{id}/taxCodeLevels/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /finance/taxCodes/{id}/taxCodeLevels/count endpoint.
