...
class ProcurementPurchaseorderstatusesIdEmailtemplatesCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /procurement/purchaseorderstatuses/{id}/emailtemplates/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /procurement/purchaseorderstatuses/{id}/emailtemplates/count endpoint.
