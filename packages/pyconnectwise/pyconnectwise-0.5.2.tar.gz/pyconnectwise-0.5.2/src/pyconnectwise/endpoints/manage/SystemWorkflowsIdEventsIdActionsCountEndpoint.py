...
class SystemWorkflowsIdEventsIdActionsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /system/workflows/{id}/events/{id}/actions/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /system/workflows/{id}/events/{id}/actions/count endpoint.
