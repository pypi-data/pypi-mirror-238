...
class SystemPortalreportsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[PortalReport, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, PortalReport)
        IPuttable.__init__(self, PortalReport)
        IPatchable.__init__(self, PortalReport)
    ...
    def put(
        ...
        """
        return self._parse_one(
            PortalReport, super()._make_request("PUT", data=data, params=params).json()
        )
