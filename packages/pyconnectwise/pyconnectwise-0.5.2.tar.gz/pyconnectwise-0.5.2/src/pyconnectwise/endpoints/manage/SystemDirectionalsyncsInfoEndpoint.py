...
class SystemDirectionalsyncsInfoEndpoint(
    ConnectWiseEndpoint,
    IGettable[list[DirectionalSyncInfo], ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        self.count = self._register_child_endpoint(
            SystemDirectionalsyncsInfoCountEndpoint(client, parent_endpoint=self)
        )
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /system/directionalSyncs/info endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        data: JSON | None = None,
        params: ConnectWiseManageRequestParams | None = None,
    ) -> list[DirectionalSyncInfo]:
        """
        Performs a GET request against the /system/directionalSyncs/info endpoint.

        Parameters:
            data (dict[str, Any]): The data to send in the request body.
            params (dict[str, int | str]): The parameters to send in the request query string.
        Returns:
            list[DirectionalSyncInfo]: The parsed response data.
        """
