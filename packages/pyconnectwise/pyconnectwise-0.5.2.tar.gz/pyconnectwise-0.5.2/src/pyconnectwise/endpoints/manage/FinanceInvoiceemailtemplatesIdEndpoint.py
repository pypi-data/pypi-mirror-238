...
class FinanceInvoiceemailtemplatesIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[InvoiceEmailTemplate, ConnectWiseManageRequestParams],
    IPuttable[InvoiceEmailTemplate, ConnectWiseManageRequestParams],
    IPatchable[InvoiceEmailTemplate, ConnectWiseManageRequestParams],
