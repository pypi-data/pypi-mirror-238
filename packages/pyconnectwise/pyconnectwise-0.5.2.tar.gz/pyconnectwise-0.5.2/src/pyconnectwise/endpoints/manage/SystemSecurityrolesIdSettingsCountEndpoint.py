...
class SystemSecurityrolesIdSettingsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /system/securityRoles/{id}/settings/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /system/securityRoles/{id}/settings/count endpoint.
