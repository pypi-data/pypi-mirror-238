...
class ProcurementRmastatusesIdInfoEndpoint(
    ConnectWiseEndpoint,
    IGettable[RmaStatusInfo, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, RmaStatusInfo)
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /procurement/rmaStatuses/{id}/info endpoint and returns an initialized PaginatedResponse object.
