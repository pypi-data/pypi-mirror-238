...
class CompanyCompaniesIdCustomstatusnotesIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[CompanyCustomNote, ConnectWiseManageRequestParams],
    IPuttable[CompanyCustomNote, ConnectWiseManageRequestParams],
    IPatchable[CompanyCustomNote, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, CompanyCustomNote)
        IPuttable.__init__(self, CompanyCustomNote)
        IPatchable.__init__(self, CompanyCustomNote)
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /company/companies/{id}/customStatusNotes/{id} endpoint and returns an initialized PaginatedResponse object.
