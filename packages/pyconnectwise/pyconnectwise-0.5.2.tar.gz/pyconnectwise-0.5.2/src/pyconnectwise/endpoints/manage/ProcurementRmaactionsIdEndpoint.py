...
from pyconnectwise.endpoints.manage.ProcurementRmaactionsIdInfoEndpoint import (
    ProcurementRmaactionsIdInfoEndpoint,
)
...
class ProcurementRmaactionsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[RmaAction, ConnectWiseManageRequestParams],
    IPuttable[RmaAction, ConnectWiseManageRequestParams],
    IPatchable[RmaAction, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, RmaAction)
        IPuttable.__init__(self, RmaAction)
        IPatchable.__init__(self, RmaAction)
    ...
    def put(
        ...
        """
        return self._parse_one(
            RmaAction, super()._make_request("PUT", data=data, params=params).json()
        )
    ...
    def patch(
        ...
        """
        return self._parse_one(
            RmaAction, super()._make_request("PATCH", data=data, params=params).json()
        )
