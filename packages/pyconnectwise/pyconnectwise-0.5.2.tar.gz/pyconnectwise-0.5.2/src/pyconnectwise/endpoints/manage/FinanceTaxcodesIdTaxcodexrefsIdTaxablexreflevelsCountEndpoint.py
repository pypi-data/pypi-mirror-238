...
class FinanceTaxcodesIdTaxcodexrefsIdTaxablexreflevelsCountEndpoint(
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /finance/taxCodes/{id}/taxCodeXRefs/{id}/taxableXRefLevels/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /finance/taxCodes/{id}/taxCodeXRefs/{id}/taxableXRefLevels/count endpoint.
