...
from pyconnectwise.endpoints.manage.CompanyManagementIdLogEndpoint import (
    CompanyManagementIdLogEndpoint,
)
from pyconnectwise.endpoints.manage.CompanyManagementIdLogsEndpoint import (
    CompanyManagementIdLogsEndpoint,
)
...
class CompanyManagementIdEndpoint(
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        self.logs = self._register_child_endpoint(
        ...
        self.log = self._register_child_endpoint(
            CompanyManagementIdLogEndpoint(client, parent_endpoint=self)
        )
    ...
    def put(
        ...
        """
        return self._parse_one(
            Management, super()._make_request("PUT", data=data, params=params).json()
        )
    ...
    def patch(
        ...
        """
        return self._parse_one(
            Management, super()._make_request("PATCH", data=data, params=params).json()
        )
