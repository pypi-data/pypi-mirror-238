...
class ServiceTicketsIdNotesIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[ServiceNote, ConnectWiseManageRequestParams],
    IPuttable[ServiceNote, ConnectWiseManageRequestParams],
    IPatchable[ServiceNote, ConnectWiseManageRequestParams],
