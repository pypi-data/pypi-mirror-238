...
class FinanceAccountingUnpostedinvoicesIdTaxablelevelsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /finance/accounting/unpostedinvoices/{id}/taxableLevels/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /finance/accounting/unpostedinvoices/{id}/taxableLevels/count endpoint.
