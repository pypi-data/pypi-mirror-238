...
from pyconnectwise.endpoints.manage.CompanyCompaniesTypesIdUsagesEndpoint import (
    CompanyCompaniesTypesIdUsagesEndpoint,
)
...
class CompanyCompaniesTypesIdEndpoint(
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, CompanyType)
        IPuttable.__init__(self, CompanyType)
        IPatchable.__init__(self, CompanyType)
    ...
    def put(
        ...
        """
        return self._parse_one(
            CompanyType, super()._make_request("PUT", data=data, params=params).json()
        )
    ...
    def patch(
        ...
        """
        return self._parse_one(
            CompanyType, super()._make_request("PATCH", data=data, params=params).json()
        )
