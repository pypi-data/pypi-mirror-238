...
class ProjectProjecttemplatesIdProjecttemplateticketsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[ProjectTemplateTicket, ConnectWiseManageRequestParams],
    IPuttable[ProjectTemplateTicket, ConnectWiseManageRequestParams],
    IPatchable[ProjectTemplateTicket, ConnectWiseManageRequestParams],
