...
class ExpenseClassificationsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[Classification, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, Classification)
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /expense/classifications/{id} endpoint and returns an initialized PaginatedResponse object.
