...
class CompanyPortalconfigurationsIdProjectsetupsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[PortalConfigurationProjectSetup, ConnectWiseManageRequestParams],
    IPuttable[PortalConfigurationProjectSetup, ConnectWiseManageRequestParams],
    IPatchable[PortalConfigurationProjectSetup, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, PortalConfigurationProjectSetup)
