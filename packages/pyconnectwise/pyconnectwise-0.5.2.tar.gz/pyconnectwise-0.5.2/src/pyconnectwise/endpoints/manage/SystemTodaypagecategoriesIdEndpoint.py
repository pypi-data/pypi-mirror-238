...
class SystemTodaypagecategoriesIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[TodayPageCategory, ConnectWiseManageRequestParams],
    IPuttable[TodayPageCategory, ConnectWiseManageRequestParams],
    IPatchable[TodayPageCategory, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, TodayPageCategory)
        IPuttable.__init__(self, TodayPageCategory)
        IPatchable.__init__(self, TodayPageCategory)
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /system/todayPageCategories/{id} endpoint and returns an initialized PaginatedResponse object.
