...
from pyconnectwise.endpoints.manage.ProcurementAdjustmentsEndpoint import (
    ProcurementAdjustmentsEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementCatalogEndpoint import (
    ProcurementCatalogEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementCategoriesEndpoint import (
    ProcurementCategoriesEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementDirectionalsyncsEndpoint import (
    ProcurementDirectionalsyncsEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementManufacturersEndpoint import (
    ProcurementManufacturersEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementOnhandserialnumbersEndpoint import (
    ProcurementOnhandserialnumbersEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementPricingschedulesEndpoint import (
    ProcurementPricingschedulesEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementProductsEndpoint import (
    ProcurementProductsEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementPurchaseordersEndpoint import (
    ProcurementPurchaseordersEndpoint,
)
...
from pyconnectwise.endpoints.manage.ProcurementPurchasingdemandsEndpoint import (
    ProcurementPurchasingdemandsEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementRmaactionsEndpoint import (
    ProcurementRmaactionsEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementRmadispositionsEndpoint import (
    ProcurementRmadispositionsEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementRmastatusesEndpoint import (
    ProcurementRmastatusesEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementRmatagsEndpoint import (
    ProcurementRmatagsEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementSettingsEndpoint import (
    ProcurementSettingsEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementShipmentmethodsEndpoint import (
    ProcurementShipmentmethodsEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementSubcategoriesEndpoint import (
    ProcurementSubcategoriesEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementTypesEndpoint import (
    ProcurementTypesEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementUnitofmeasuresEndpoint import (
    ProcurementUnitofmeasuresEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementWarehousebinsEndpoint import (
    ProcurementWarehousebinsEndpoint,
)
from pyconnectwise.endpoints.manage.ProcurementWarehousesEndpoint import (
    ProcurementWarehousesEndpoint,
)
...
class ProcurementEndpoint(ConnectWiseEndpoint):
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        self.rma_actions = self._register_child_endpoint(
        ...
        self.rma_tags = self._register_child_endpoint(
        ...
        self.rma_statuses = self._register_child_endpoint(
