...
from pyconnectwise.endpoints.manage.ServiceSurveysIdUsagesListEndpoint import (
    ServiceSurveysIdUsagesListEndpoint,
)
...
class ServiceSurveysIdUsagesEndpoint(
    ConnectWiseEndpoint,
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        self.list = self._register_child_endpoint(
            ServiceSurveysIdUsagesListEndpoint(client, parent_endpoint=self)
        )
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /service/surveys/{id}/usages endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /service/surveys/{id}/usages endpoint.
