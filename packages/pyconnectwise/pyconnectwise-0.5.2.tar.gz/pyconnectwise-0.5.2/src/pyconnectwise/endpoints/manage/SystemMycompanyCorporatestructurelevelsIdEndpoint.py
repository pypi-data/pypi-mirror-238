...
class SystemMycompanyCorporatestructurelevelsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[CorporateStructureLevel, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, CorporateStructureLevel)
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /system/myCompany/corporateStructureLevels/{id} endpoint and returns an initialized PaginatedResponse object.
