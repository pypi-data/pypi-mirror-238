...
class CompanyMarketdescriptionsIdInfoEndpoint(
    ConnectWiseEndpoint,
    IGettable[MarketDescriptionInfo, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, MarketDescriptionInfo)
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /company/marketDescriptions/{id}/info endpoint and returns an initialized PaginatedResponse object.
