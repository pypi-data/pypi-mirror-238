...
class ServiceSlasIdPrioritiesCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /service/SLAs/{id}/priorities/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /service/SLAs/{id}/priorities/count endpoint.
