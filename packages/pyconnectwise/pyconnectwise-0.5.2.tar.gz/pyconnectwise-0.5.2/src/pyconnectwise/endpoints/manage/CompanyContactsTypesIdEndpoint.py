...
from pyconnectwise.endpoints.manage.CompanyContactsTypesIdInfoEndpoint import (
    CompanyContactsTypesIdInfoEndpoint,
)
...
class CompanyContactsTypesIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[ContactType, ConnectWiseManageRequestParams],
    IPuttable[ContactType, ConnectWiseManageRequestParams],
    IPatchable[ContactType, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, ContactType)
        IPuttable.__init__(self, ContactType)
        IPatchable.__init__(self, ContactType)
    ...
    def get(
        ...
        return self._parse_one(
            ContactType, super()._make_request("GET", data=data, params=params).json()
        )
    ...
    def put(
        ...
        """
        return self._parse_one(
            ContactType, super()._make_request("PUT", data=data, params=params).json()
        )
    ...
    def patch(
        ...
        """
        return self._parse_one(
            ContactType, super()._make_request("PATCH", data=data, params=params).json()
        )
