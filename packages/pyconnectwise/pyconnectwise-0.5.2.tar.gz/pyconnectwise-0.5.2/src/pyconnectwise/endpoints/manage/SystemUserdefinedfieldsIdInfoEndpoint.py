...
class SystemUserdefinedfieldsIdInfoEndpoint(
    ConnectWiseEndpoint,
    IGettable[UserDefinedFieldInfo, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, UserDefinedFieldInfo)
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /system/userDefinedFields/{id}/info endpoint and returns an initialized PaginatedResponse object.
