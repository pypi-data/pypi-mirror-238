...
class SystemCustomreportsIdParametersCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /system/customReports/{id}/parameters/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /system/customReports/{id}/parameters/count endpoint.
