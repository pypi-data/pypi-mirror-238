...
class SystemWorkflowactionsIdAutomateparametersIdEndpoint(
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, WorkflowActionAutomateParameter)
        IPuttable.__init__(self, WorkflowActionAutomateParameter)
        IPatchable.__init__(self, WorkflowActionAutomateParameter)
