...
class ServiceSurveysIdQuestionsIdOptionsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[SurveyOption, ConnectWiseManageRequestParams],
    IPuttable[SurveyOption, ConnectWiseManageRequestParams],
    IPatchable[SurveyOption, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, SurveyOption)
        IPuttable.__init__(self, SurveyOption)
        IPatchable.__init__(self, SurveyOption)
    ...
    def put(
        ...
        """
        return self._parse_one(
            SurveyOption, super()._make_request("PUT", data=data, params=params).json()
        )
