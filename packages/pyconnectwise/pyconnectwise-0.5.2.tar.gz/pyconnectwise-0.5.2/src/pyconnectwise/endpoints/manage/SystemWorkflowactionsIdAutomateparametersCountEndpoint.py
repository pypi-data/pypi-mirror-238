...
class SystemWorkflowactionsIdAutomateparametersCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /system/workflowActions/{id}/automateParameters/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /system/workflowActions/{id}/automateParameters/count endpoint.
