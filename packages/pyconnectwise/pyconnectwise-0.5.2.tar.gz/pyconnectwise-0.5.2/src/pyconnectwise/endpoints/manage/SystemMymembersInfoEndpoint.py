...
class SystemMymembersInfoEndpoint(
    ConnectWiseEndpoint,
    IGettable[MyMemberInfo, ConnectWiseManageRequestParams],
    IPaginateable[MyMemberInfo, ConnectWiseManageRequestParams],
):
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ConnectWiseEndpoint.__init__(
            self, client, "info", parent_endpoint=parent_endpoint
        )
        IGettable.__init__(self, MyMemberInfo)
        IPaginateable.__init__(self, MyMemberInfo)
