...
from pyconnectwise.endpoints.manage.SalesActivitiesTypesCountEndpoint import (
    SalesActivitiesTypesCountEndpoint,
)
from pyconnectwise.endpoints.manage.SalesActivitiesTypesIdEndpoint import (
    SalesActivitiesTypesIdEndpoint,
)
...
class SalesActivitiesTypesEndpoint(
    ...
    def id(self, id: int) -> SalesActivitiesTypesIdEndpoint:  # noqa: A002
        """
    ...
    def post(
        ...
        return self._parse_one(
            ActivityType, super()._make_request("POST", data=data, params=params).json()
        )
