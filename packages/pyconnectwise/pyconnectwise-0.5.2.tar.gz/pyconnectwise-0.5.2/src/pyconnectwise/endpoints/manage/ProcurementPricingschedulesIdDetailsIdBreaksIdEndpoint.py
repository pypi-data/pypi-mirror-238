...
class ProcurementPricingschedulesIdDetailsIdBreaksIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[PricingBreak, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, PricingBreak)
        IPuttable.__init__(self, PricingBreak)
        IPatchable.__init__(self, PricingBreak)
    ...
    def put(
        ...
        """
        return self._parse_one(
            PricingBreak, super()._make_request("PUT", data=data, params=params).json()
        )
