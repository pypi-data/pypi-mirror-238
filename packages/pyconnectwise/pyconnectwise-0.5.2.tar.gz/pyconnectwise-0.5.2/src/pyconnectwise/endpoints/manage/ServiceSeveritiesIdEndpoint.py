...
class ServiceSeveritiesIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[Severity, ConnectWiseManageRequestParams],
    IPuttable[Severity, ConnectWiseManageRequestParams],
    IPatchable[Severity, ConnectWiseManageRequestParams],
