...
class TimeTimeperiodsetupsIdPeriodsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /time/timePeriodSetups/{id}/periods/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /time/timePeriodSetups/{id}/periods/count endpoint.
