...
from pyconnectwise.endpoints.manage.SalesCommissionsIdUsagesListEndpoint import (
    SalesCommissionsIdUsagesListEndpoint,
)
...
class SalesCommissionsIdUsagesEndpoint(
    ConnectWiseEndpoint,
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        self.list = self._register_child_endpoint(
            SalesCommissionsIdUsagesListEndpoint(client, parent_endpoint=self)
        )
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /sales/commissions/{id}/usages endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /sales/commissions/{id}/usages endpoint.
