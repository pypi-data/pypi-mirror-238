...
class FinanceTaxcodesIdWorkroleexemptionsIdTaxableworkrolelevelsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[TaxableWorkRoleLevel, ConnectWiseManageRequestParams],
    IPuttable[TaxableWorkRoleLevel, ConnectWiseManageRequestParams],
    IPatchable[TaxableWorkRoleLevel, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, TaxableWorkRoleLevel)
        IPuttable.__init__(self, TaxableWorkRoleLevel)
        IPatchable.__init__(self, TaxableWorkRoleLevel)
