...
class CompanyManageddevicesintegrationsIdInfoEndpoint(
    ConnectWiseEndpoint,
    IGettable[ManagedDevicesIntegrationInfo, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, ManagedDevicesIntegrationInfo)
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /company/managedDevicesIntegrations/{id}/info endpoint and returns an initialized PaginatedResponse object.
