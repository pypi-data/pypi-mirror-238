...
class SystemSurveysIdQuestionsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[SurveyQuestion, ConnectWiseManageRequestParams],
    IPuttable[SurveyQuestion, ConnectWiseManageRequestParams],
    IPatchable[SurveyQuestion, ConnectWiseManageRequestParams],
