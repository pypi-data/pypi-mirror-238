...
from pyconnectwise.endpoints.manage.ScheduleDetailsEndpoint import (
    ScheduleDetailsEndpoint,
)
from pyconnectwise.endpoints.manage.ScheduleEntriesEndpoint import (
    ScheduleEntriesEndpoint,
)
from pyconnectwise.endpoints.manage.ScheduleHolidaylistsEndpoint import (
    ScheduleHolidaylistsEndpoint,
)
from pyconnectwise.endpoints.manage.SchedulePortalcalendarsEndpoint import (
    SchedulePortalcalendarsEndpoint,
)
from pyconnectwise.endpoints.manage.ScheduleRemindertimesEndpoint import (
    ScheduleRemindertimesEndpoint,
)
from pyconnectwise.endpoints.manage.ScheduleStatusesEndpoint import (
...
class ScheduleEndpoint(ConnectWiseEndpoint):
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        self.reminder_times = self._register_child_endpoint(
            ScheduleRemindertimesEndpoint(client, parent_endpoint=self)
        )
        self.holiday_lists = self._register_child_endpoint(
            ScheduleHolidaylistsEndpoint(client, parent_endpoint=self)
        )
