...
class FinanceTaxcodesIdTaxcodexrefsEndpoint(
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ConnectWiseEndpoint.__init__(
            self, client, "taxCodeXRefs", parent_endpoint=parent_endpoint
        )
    ...
    def id(self, id: int) -> FinanceTaxcodesIdTaxcodexrefsIdEndpoint:  # noqa: A002
        """
        ...
        """
        child = FinanceTaxcodesIdTaxcodexrefsIdEndpoint(
    ...
    def post(
        ...
        return self._parse_one(
            TaxCodeXRef, super()._make_request("POST", data=data, params=params).json()
        )
