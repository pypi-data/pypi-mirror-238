...
class FinanceTaxcodesIdTaxcodexrefsIdTaxablexreflevelsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[TaxableXRefLevel, ConnectWiseManageRequestParams],
    IPuttable[TaxableXRefLevel, ConnectWiseManageRequestParams],
    IPatchable[TaxableXRefLevel, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, TaxableXRefLevel)
        IPuttable.__init__(self, TaxableXRefLevel)
        IPatchable.__init__(self, TaxableXRefLevel)
