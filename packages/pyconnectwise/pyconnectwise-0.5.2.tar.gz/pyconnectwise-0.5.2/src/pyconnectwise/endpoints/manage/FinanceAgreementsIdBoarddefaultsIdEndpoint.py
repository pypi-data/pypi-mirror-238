...
class FinanceAgreementsIdBoarddefaultsIdEndpoint(
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, BoardDefault)
        IPuttable.__init__(self, BoardDefault)
        IPatchable.__init__(self, BoardDefault)
    ...
    def put(
        ...
        """
        return self._parse_one(
            BoardDefault, super()._make_request("PUT", data=data, params=params).json()
        )
