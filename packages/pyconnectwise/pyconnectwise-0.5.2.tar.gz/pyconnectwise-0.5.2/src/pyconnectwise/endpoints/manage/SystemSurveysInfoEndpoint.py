...
from pyconnectwise.endpoints.manage.SystemSurveysInfoCountEndpoint import (
    SystemSurveysInfoCountEndpoint,
)
...
class SystemSurveysInfoEndpoint(
    ...
    def get(
        ...
        return self._parse_many(
            SurveyInfo, super()._make_request("GET", data=data, params=params).json()
        )
