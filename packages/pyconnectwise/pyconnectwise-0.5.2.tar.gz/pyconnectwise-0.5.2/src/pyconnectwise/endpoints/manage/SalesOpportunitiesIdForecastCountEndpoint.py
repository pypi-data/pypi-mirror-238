...
class SalesOpportunitiesIdForecastCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /sales/opportunities/{id}/forecast/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /sales/opportunities/{id}/forecast/count endpoint.
