...
class ServiceKnowledgebasesubcategoriesCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /service/knowledgeBaseSubCategories/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /service/knowledgeBaseSubCategories/count endpoint.
