...
class ProcurementWarehousebinsIdInventoryonhandCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /procurement/warehouseBins/{id}/inventoryOnHand/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /procurement/warehouseBins/{id}/inventoryOnHand/count endpoint.
