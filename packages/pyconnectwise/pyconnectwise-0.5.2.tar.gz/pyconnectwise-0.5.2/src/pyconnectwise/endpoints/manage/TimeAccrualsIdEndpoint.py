...
from pyconnectwise.endpoints.manage.TimeAccrualsIdDetailsEndpoint import (
    TimeAccrualsIdDetailsEndpoint,
)
...
class TimeAccrualsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[TimeAccrual, ConnectWiseManageRequestParams],
    ...
    def put(
        ...
        """
        return self._parse_one(
            TimeAccrual, super()._make_request("PUT", data=data, params=params).json()
        )
    ...
    def patch(
        ...
        """
        return self._parse_one(
            TimeAccrual, super()._make_request("PATCH", data=data, params=params).json()
        )
