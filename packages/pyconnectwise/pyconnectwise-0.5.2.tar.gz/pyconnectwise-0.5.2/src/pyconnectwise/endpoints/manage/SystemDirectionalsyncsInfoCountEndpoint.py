...
class SystemDirectionalsyncsInfoCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /system/directionalSyncs/info/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /system/directionalSyncs/info/count endpoint.
