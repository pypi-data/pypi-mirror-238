...
class ProcurementCatalogIdInventoryCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /procurement/catalog/{id}/inventory/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /procurement/catalog/{id}/inventory/count endpoint.
