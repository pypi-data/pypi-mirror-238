...
class FinanceTaxcodesIdProducttypeexemptionsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[ProductTypeExemption, ConnectWiseManageRequestParams],
    IPuttable[ProductTypeExemption, ConnectWiseManageRequestParams],
