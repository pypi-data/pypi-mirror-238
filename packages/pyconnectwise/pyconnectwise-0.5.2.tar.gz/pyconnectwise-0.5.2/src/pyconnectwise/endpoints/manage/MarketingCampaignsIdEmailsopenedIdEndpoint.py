...
class MarketingCampaignsIdEmailsopenedIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[EmailOpened, ConnectWiseManageRequestParams],
    IPuttable[EmailOpened, ConnectWiseManageRequestParams],
    IPatchable[EmailOpened, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, EmailOpened)
    ...
    def put(
        ...
        """
        return self._parse_one(
            EmailOpened, super()._make_request("PUT", data=data, params=params).json()
        )
    ...
    def patch(
        ...
        """
        return self._parse_one(
            EmailOpened, super()._make_request("PATCH", data=data, params=params).json()
        )
