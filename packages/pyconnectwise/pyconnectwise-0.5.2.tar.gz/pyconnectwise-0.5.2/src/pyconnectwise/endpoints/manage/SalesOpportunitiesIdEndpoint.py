...
from pyconnectwise.endpoints.manage.SalesOpportunitiesIdContactsEndpoint import (
    SalesOpportunitiesIdContactsEndpoint,
)
...
from pyconnectwise.endpoints.manage.SalesOpportunitiesIdForecastEndpoint import (
    SalesOpportunitiesIdForecastEndpoint,
)
from pyconnectwise.endpoints.manage.SalesOpportunitiesIdNotesEndpoint import (
    SalesOpportunitiesIdNotesEndpoint,
)
from pyconnectwise.endpoints.manage.SalesOpportunitiesIdTeamEndpoint import (
    SalesOpportunitiesIdTeamEndpoint,
)
...
class SalesOpportunitiesIdEndpoint(
    ...
    def put(
        ...
        """
        return self._parse_one(
            Opportunity, super()._make_request("PUT", data=data, params=params).json()
        )
    ...
    def patch(
        ...
        """
        return self._parse_one(
            Opportunity, super()._make_request("PATCH", data=data, params=params).json()
        )
