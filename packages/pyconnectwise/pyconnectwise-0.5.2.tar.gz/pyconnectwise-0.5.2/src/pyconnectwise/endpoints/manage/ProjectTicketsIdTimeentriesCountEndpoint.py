...
class ProjectTicketsIdTimeentriesCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /project/tickets/{id}/timeentries/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /project/tickets/{id}/timeentries/count endpoint.
