...
class SystemM365contactsyncNotifyerrorEndpoint(
    ConnectWiseEndpoint, IPostable[SuccessResponse, ConnectWiseManageRequestParams]
):
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ConnectWiseEndpoint.__init__(
            self, client, "notifyerror", parent_endpoint=parent_endpoint
        )
    ...
    def post(
        ...
        """
        Performs a POST request against the /system/m365contactsync/notifyerror endpoint.
