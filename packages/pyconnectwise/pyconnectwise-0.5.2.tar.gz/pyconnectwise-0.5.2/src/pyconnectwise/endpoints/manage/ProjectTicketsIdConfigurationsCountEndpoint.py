...
class ProjectTicketsIdConfigurationsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /project/tickets/{id}/configurations/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /project/tickets/{id}/configurations/count endpoint.
