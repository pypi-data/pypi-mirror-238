...
class SystemReportcardsIdDetailsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[ReportCardDetail, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, ReportCardDetail)
        IPuttable.__init__(self, ReportCardDetail)
        IPatchable.__init__(self, ReportCardDetail)
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /system/reportCards/{id}/details/{id} endpoint and returns an initialized PaginatedResponse object.
