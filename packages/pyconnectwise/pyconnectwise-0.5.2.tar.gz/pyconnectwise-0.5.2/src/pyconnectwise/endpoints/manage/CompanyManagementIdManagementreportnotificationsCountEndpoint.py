...
class CompanyManagementIdManagementreportnotificationsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /company/management/{id}/managementReportNotifications/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /company/management/{id}/managementReportNotifications/count endpoint.
