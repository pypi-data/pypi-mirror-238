...
class ProcurementRmadispositionsInfoEndpoint(
    ConnectWiseEndpoint,
    IGettable[list[RmaDispositionInfo], ConnectWiseManageRequestParams],
    IPaginateable[RmaDispositionInfo, ConnectWiseManageRequestParams],
):
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ConnectWiseEndpoint.__init__(
            self, client, "info", parent_endpoint=parent_endpoint
        )
        IGettable.__init__(self, list[RmaDispositionInfo])
        IPaginateable.__init__(self, RmaDispositionInfo)
