...
class FinanceAgreementsIdWorkroleexclusionsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /finance/agreements/{id}/workRoleExclusions/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /finance/agreements/{id}/workRoleExclusions/count endpoint.
