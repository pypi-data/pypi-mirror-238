...
class SalesRolesIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[Role, ConnectWiseManageRequestParams],
    IPuttable[Role, ConnectWiseManageRequestParams],
    IPatchable[Role, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, Role)
        IPuttable.__init__(self, Role)
        IPatchable.__init__(self, Role)
    ...
    def put(
        ...
        """
        return self._parse_one(
            Role, super()._make_request("PUT", data=data, params=params).json()
        )
    ...
    def patch(
        ...
        """
        return self._parse_one(
            Role, super()._make_request("PATCH", data=data, params=params).json()
        )
