...
class SalesOrdersStatusesIdInfoEndpoint(
    ConnectWiseEndpoint,
    IGettable[OrderStatusInfo, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, OrderStatusInfo)
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /sales/orders/statuses/{id}/info endpoint and returns an initialized PaginatedResponse object.
