...
from pyconnectwise.endpoints.manage.SystemReportcardsInfoCountEndpoint import (
    SystemReportcardsInfoCountEndpoint,
)
...
class SystemReportcardsInfoEndpoint(
    ConnectWiseEndpoint,
    IGettable[list[ReportCardInfo], ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, list[ReportCardInfo])
    ...
    def get(
        ...
        """
        Performs a GET request against the /system/reportCards/info endpoint.

        Parameters:
            data (dict[str, Any]): The data to send in the request body.
            params (dict[str, int | str]): The parameters to send in the request query string.
        Returns:
            list[ReportCardInfo]: The parsed response data.
        """
