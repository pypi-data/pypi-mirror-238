...
class SystemEmailexclusionsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[EmailExclusion, ConnectWiseManageRequestParams],
    IPuttable[EmailExclusion, ConnectWiseManageRequestParams],
    IPatchable[EmailExclusion, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, EmailExclusion)
        IPuttable.__init__(self, EmailExclusion)
        IPatchable.__init__(self, EmailExclusion)
