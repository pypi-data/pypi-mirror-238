...
class SystemMyaccountIdSkillsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /system/myAccount/{id}/skills/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /system/myAccount/{id}/skills/count endpoint.
