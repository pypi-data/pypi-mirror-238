...
class CompanyContactsyncCompanysyncIdEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /company/contactsync/companysync/{id} endpoint and returns an initialized PaginatedResponse object.
