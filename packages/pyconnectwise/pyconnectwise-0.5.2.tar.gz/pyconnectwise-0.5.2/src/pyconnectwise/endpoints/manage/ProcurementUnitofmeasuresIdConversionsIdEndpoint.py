...
class ProcurementUnitofmeasuresIdConversionsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[Conversion, ConnectWiseManageRequestParams],
    IPuttable[Conversion, ConnectWiseManageRequestParams],
    IPatchable[Conversion, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, Conversion)
        IPuttable.__init__(self, Conversion)
        IPatchable.__init__(self, Conversion)
    ...
    def put(
        ...
        """
        return self._parse_one(
            Conversion, super()._make_request("PUT", data=data, params=params).json()
        )
    ...
    def patch(
        ...
        """
        return self._parse_one(
            Conversion, super()._make_request("PATCH", data=data, params=params).json()
        )
