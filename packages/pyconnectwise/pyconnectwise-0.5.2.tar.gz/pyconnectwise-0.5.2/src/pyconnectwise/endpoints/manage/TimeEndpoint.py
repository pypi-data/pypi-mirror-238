...
from pyconnectwise.endpoints.manage.TimeActivitystopwatchesEndpoint import (
    TimeActivitystopwatchesEndpoint,
)
from pyconnectwise.endpoints.manage.TimeChargecodesEndpoint import (
    TimeChargecodesEndpoint,
)
...
from pyconnectwise.endpoints.manage.TimeSchedulestopwatchesEndpoint import (
    TimeSchedulestopwatchesEndpoint,
)
from pyconnectwise.endpoints.manage.TimeSheetsEndpoint import TimeSheetsEndpoint
from pyconnectwise.endpoints.manage.TimeTicketstopwatchesEndpoint import (
    TimeTicketstopwatchesEndpoint,
)
from pyconnectwise.endpoints.manage.TimeTimeperiodsetupsEndpoint import (
    TimeTimeperiodsetupsEndpoint,
)
...
class TimeEndpoint(ConnectWiseEndpoint):
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        self.sheets = self._register_child_endpoint(
        ...
        self.work_types = self._register_child_endpoint(
