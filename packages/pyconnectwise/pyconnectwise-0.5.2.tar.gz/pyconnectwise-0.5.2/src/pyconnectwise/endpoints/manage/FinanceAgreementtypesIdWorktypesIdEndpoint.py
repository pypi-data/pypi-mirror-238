...
class FinanceAgreementtypesIdWorktypesIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[AgreementTypeWorkType, ConnectWiseManageRequestParams],
    IPuttable[AgreementTypeWorkType, ConnectWiseManageRequestParams],
    IPatchable[AgreementTypeWorkType, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, AgreementTypeWorkType)
        IPuttable.__init__(self, AgreementTypeWorkType)
        IPatchable.__init__(self, AgreementTypeWorkType)
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /finance/agreementTypes/{id}/worktypes/{id} endpoint and returns an initialized PaginatedResponse object.
