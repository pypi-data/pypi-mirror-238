...
class MarketingCampaignsIdLinksclickedIdEndpoint(
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, LinkClicked)
        IPuttable.__init__(self, LinkClicked)
        IPatchable.__init__(self, LinkClicked)
    ...
    def put(
        ...
        """
        return self._parse_one(
            LinkClicked, super()._make_request("PUT", data=data, params=params).json()
        )
    ...
    def patch(
        ...
        """
        return self._parse_one(
            LinkClicked, super()._make_request("PATCH", data=data, params=params).json()
        )
