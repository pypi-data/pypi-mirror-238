...
class ProcurementPurchaseorderstatusesIdNotificationsIdEndpoint(
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, PurchaseOrderStatusNotification)
        IPuttable.__init__(self, PurchaseOrderStatusNotification)
        IPatchable.__init__(self, PurchaseOrderStatusNotification)
