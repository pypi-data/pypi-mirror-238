...
class MarketingCampaignsIdActivitiesCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /marketing/campaigns/{id}/activities/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /marketing/campaigns/{id}/activities/count endpoint.
