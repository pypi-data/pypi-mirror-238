...
class MarketingGroupsInfoEndpoint(
    ConnectWiseEndpoint,
    IGettable[list[GroupInfo], ConnectWiseManageRequestParams],
    IPaginateable[GroupInfo, ConnectWiseManageRequestParams],
):
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ConnectWiseEndpoint.__init__(
            self, client, "info", parent_endpoint=parent_endpoint
        )
        IGettable.__init__(self, list[GroupInfo])
        IPaginateable.__init__(self, GroupInfo)
