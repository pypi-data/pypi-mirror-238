...
class ProcurementPricingschedulesIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[PricingSchedule, ConnectWiseManageRequestParams],
    IPuttable[PricingSchedule, ConnectWiseManageRequestParams],
    IPatchable[PricingSchedule, ConnectWiseManageRequestParams],
