...
class SystemAuthanvilsTestconnectionEndpoint(
    ConnectWiseEndpoint,
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ConnectWiseEndpoint.__init__(
            self, client, "testConnection", parent_endpoint=parent_endpoint
        )
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /system/authAnvils/testConnection endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /system/authAnvils/testConnection endpoint.
