...
class ServiceTicketsIdAttachchildrenEndpoint(
    ConnectWiseEndpoint, IPostable[SuccessResponse, ConnectWiseManageRequestParams]
):
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ConnectWiseEndpoint.__init__(
            self, client, "attachChildren", parent_endpoint=parent_endpoint
        )
    ...
    def post(
        ...
        """
        Performs a POST request against the /service/tickets/{id}/attachChildren endpoint.
