...
from pyconnectwise.endpoints.manage.CompanyTeamrolesInfoCountEndpoint import (
    CompanyTeamrolesInfoCountEndpoint,
)
...
class CompanyTeamrolesInfoEndpoint(
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        self.count = self._register_child_endpoint(
            CompanyTeamrolesInfoCountEndpoint(client, parent_endpoint=self)
        )
