...
class ServiceSlasIdPrioritiesIdEndpoint(
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, SLAPriority)
        IPuttable.__init__(self, SLAPriority)
        IPatchable.__init__(self, SLAPriority)
    ...
    def put(
        ...
        """
        return self._parse_one(
            SLAPriority, super()._make_request("PUT", data=data, params=params).json()
        )
    ...
    def patch(
        ...
        """
        return self._parse_one(
            SLAPriority, super()._make_request("PATCH", data=data, params=params).json()
        )
