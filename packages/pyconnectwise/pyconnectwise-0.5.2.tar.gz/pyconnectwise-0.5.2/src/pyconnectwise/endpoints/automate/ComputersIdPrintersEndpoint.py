...
class ComputersIdPrintersEndpoint(
    ConnectWiseEndpoint,
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, list[LabTechComputerPrinter])
        IPaginateable.__init__(self, LabTechComputerPrinter)
