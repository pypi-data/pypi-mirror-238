from pyconnectwise.endpoints.automate.PatchactionsDeployallapprovedEndpoint import (
    PatchactionsDeployallapprovedEndpoint,
)
from pyconnectwise.endpoints.automate.PatchactionsDeployallsecurityEndpoint import (
    PatchactionsDeployallsecurityEndpoint,
)
from pyconnectwise.endpoints.automate.PatchactionsReattemptfailedEndpoint import (
    PatchactionsReattemptfailedEndpoint,
)
from pyconnectwise.endpoints.automate.PatchactionsSettopilotstageEndpoint import (
    PatchactionsSettopilotstageEndpoint,
)
...
from pyconnectwise.endpoints.automate.PatchactionsSettoteststageEndpoint import (
    PatchactionsSettoteststageEndpoint,
)
