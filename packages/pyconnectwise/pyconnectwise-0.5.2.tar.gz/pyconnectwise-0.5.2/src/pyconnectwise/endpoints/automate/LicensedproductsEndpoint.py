...
class LicensedproductsEndpoint(
    ConnectWiseEndpoint,
    IGettable[list[LabTechLicensedProduct], ConnectWiseAutomateRequestParams],
    IPaginateable[LabTechLicensedProduct, ConnectWiseAutomateRequestParams],
):
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ConnectWiseEndpoint.__init__(
            self, client, "Licensedproducts", parent_endpoint=parent_endpoint
        )
        IGettable.__init__(self, list[LabTechLicensedProduct])
        IPaginateable.__init__(self, LabTechLicensedProduct)
