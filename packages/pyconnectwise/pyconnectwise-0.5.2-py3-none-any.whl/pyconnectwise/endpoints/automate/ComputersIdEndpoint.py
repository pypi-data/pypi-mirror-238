from pyconnectwise.endpoints.automate.ComputersIdAlertsEndpoint import (
    ComputersIdAlertsEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdAlertsuspensionsEndpoint import (
    ComputersIdAlertsuspensionsEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdBiosEndpoint import (
    ComputersIdBiosEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdCommandexecuteEndpoint import (
    ComputersIdCommandexecuteEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdCommandhistoryEndpoint import (
    ComputersIdCommandhistoryEndpoint,
)
...
from pyconnectwise.endpoints.automate.ComputersIdDevicesEndpoint import (
    ComputersIdDevicesEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdDriversEndpoint import (
    ComputersIdDriversEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdDrivesEndpoint import (
...
from pyconnectwise.endpoints.automate.ComputersIdMicrosoftupdatesEndpoint import (
    ComputersIdMicrosoftupdatesEndpoint,
)
...
from pyconnectwise.endpoints.automate.ComputersIdMonitorsEndpoint import (
    ComputersIdMonitorsEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdOperatingsystemEndpoint import (
    ComputersIdOperatingsystemEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdPatchingstatsEndpoint import (
    ComputersIdPatchingstatsEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdPatchjobsEndpoint import (
    ComputersIdPatchjobsEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdPrintersEndpoint import (
    ComputersIdPrintersEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdProcessorsEndpoint import (
    ComputersIdProcessorsEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdRunningscriptsEndpoint import (
    ComputersIdRunningscriptsEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdScheduledscriptsEndpoint import (
    ComputersIdScheduledscriptsEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdScheduledtasksEndpoint import (
    ComputersIdScheduledtasksEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdScripthistoryEndpoint import (
    ComputersIdScripthistoryEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdSensorsEndpoint import (
    ComputersIdSensorsEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdServicesEndpoint import (
    ComputersIdServicesEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdSoftwareEndpoint import (
    ComputersIdSoftwareEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdSystemslotsEndpoint import (
    ComputersIdSystemslotsEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdThirdpartypatchesEndpoint import (
    ComputersIdThirdpartypatchesEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdUpsEndpoint import (
    ComputersIdUpsEndpoint,
)
from pyconnectwise.endpoints.automate.ComputersIdVideocardsEndpoint import (
    ComputersIdVideocardsEndpoint,
)
...
class ComputersIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[LabTechComputer, ConnectWiseAutomateRequestParams],
