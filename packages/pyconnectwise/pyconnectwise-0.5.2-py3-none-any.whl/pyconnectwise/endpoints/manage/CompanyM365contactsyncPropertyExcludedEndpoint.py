...
class CompanyM365contactsyncPropertyExcludedEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /company/m365contactsync/property/excluded endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /company/m365contactsync/property/excluded endpoint.
