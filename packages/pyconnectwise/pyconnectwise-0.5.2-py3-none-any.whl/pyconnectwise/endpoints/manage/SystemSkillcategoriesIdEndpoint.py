...
class SystemSkillcategoriesIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[SkillCategory, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, SkillCategory)
        IPuttable.__init__(self, SkillCategory)
        IPatchable.__init__(self, SkillCategory)
    ...
    def put(
        ...
        """
        return self._parse_one(
            SkillCategory, super()._make_request("PUT", data=data, params=params).json()
        )
