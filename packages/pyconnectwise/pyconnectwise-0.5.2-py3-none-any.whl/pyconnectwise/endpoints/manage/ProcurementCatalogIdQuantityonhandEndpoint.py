...
class ProcurementCatalogIdQuantityonhandEndpoint(
    ConnectWiseEndpoint,
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ConnectWiseEndpoint.__init__(
            self, client, "quantityOnHand", parent_endpoint=parent_endpoint
        )
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /procurement/catalog/{id}/quantityOnHand endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /procurement/catalog/{id}/quantityOnHand endpoint.
