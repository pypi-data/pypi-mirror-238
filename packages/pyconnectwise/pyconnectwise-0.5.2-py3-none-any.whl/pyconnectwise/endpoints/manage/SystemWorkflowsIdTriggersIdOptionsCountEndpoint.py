...
class SystemWorkflowsIdTriggersIdOptionsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /system/workflows/{id}/triggers/{id}/options/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /system/workflows/{id}/triggers/{id}/options/count endpoint.
