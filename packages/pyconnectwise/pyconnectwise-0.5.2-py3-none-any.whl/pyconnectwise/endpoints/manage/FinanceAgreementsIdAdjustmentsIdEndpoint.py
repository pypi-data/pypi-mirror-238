...
class FinanceAgreementsIdAdjustmentsIdEndpoint(
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, AgreementAdjustment)
        IPuttable.__init__(self, AgreementAdjustment)
        IPatchable.__init__(self, AgreementAdjustment)
