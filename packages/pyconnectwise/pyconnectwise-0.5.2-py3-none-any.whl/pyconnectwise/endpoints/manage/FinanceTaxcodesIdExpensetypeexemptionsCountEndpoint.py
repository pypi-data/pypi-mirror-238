...
class FinanceTaxcodesIdExpensetypeexemptionsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /finance/taxCodes/{id}/expenseTypeExemptions/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /finance/taxCodes/{id}/expenseTypeExemptions/count endpoint.
