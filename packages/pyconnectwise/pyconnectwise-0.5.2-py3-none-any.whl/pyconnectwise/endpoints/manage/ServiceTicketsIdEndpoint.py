...
from pyconnectwise.endpoints.manage.ServiceTicketsIdActivitiesEndpoint import (
    ServiceTicketsIdActivitiesEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceTicketsIdAllnotesEndpoint import (
    ServiceTicketsIdAllnotesEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceTicketsIdAttachchildrenEndpoint import (
    ServiceTicketsIdAttachchildrenEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceTicketsIdConfigurationsEndpoint import (
    ServiceTicketsIdConfigurationsEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceTicketsIdConvertEndpoint import (
    ServiceTicketsIdConvertEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceTicketsIdDocumentsEndpoint import (
    ServiceTicketsIdDocumentsEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceTicketsIdInfoEndpoint import (
    ServiceTicketsIdInfoEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceTicketsIdMergeEndpoint import (
    ServiceTicketsIdMergeEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceTicketsIdNotesEndpoint import (
    ServiceTicketsIdNotesEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceTicketsIdProductsEndpoint import (
    ServiceTicketsIdProductsEndpoint,
)
...
from pyconnectwise.endpoints.manage.ServiceTicketsIdTasksEndpoint import (
    ServiceTicketsIdTasksEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceTicketsIdTimeentriesEndpoint import (
    ServiceTicketsIdTimeentriesEndpoint,
)
...
class ServiceTicketsIdEndpoint(
    ...
    def put(
        ...
        """
        return self._parse_one(
            Ticket, super()._make_request("PUT", data=data, params=params).json()
        )
    ...
    def patch(
        ...
        """
        return self._parse_one(
            Ticket, super()._make_request("PATCH", data=data, params=params).json()
        )
