...
class ScheduleEntriesIdDetailsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /schedule/entries/{id}/details/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /schedule/entries/{id}/details/count endpoint.
