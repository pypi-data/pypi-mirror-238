...
class ServiceBoardsIdAutoassignresourcesIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[BoardAutoAssignResource, ConnectWiseManageRequestParams],
    IPuttable[BoardAutoAssignResource, ConnectWiseManageRequestParams],
    IPatchable[BoardAutoAssignResource, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, BoardAutoAssignResource)
        IPuttable.__init__(self, BoardAutoAssignResource)
        IPatchable.__init__(self, BoardAutoAssignResource)
