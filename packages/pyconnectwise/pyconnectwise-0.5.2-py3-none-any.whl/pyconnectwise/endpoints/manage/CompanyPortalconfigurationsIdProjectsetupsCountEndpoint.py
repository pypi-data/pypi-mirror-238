...
class CompanyPortalconfigurationsIdProjectsetupsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /company/portalConfigurations/{id}/projectSetups/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /company/portalConfigurations/{id}/projectSetups/count endpoint.
