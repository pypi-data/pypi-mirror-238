...
class SystemEmailconnectorsIdParsingstylesCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /system/emailConnectors/{id}/parsingStyles/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /system/emailConnectors/{id}/parsingStyles/count endpoint.
