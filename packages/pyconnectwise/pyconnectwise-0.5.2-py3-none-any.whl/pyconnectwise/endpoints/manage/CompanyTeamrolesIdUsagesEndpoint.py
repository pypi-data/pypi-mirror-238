...
from pyconnectwise.endpoints.manage.CompanyTeamrolesIdUsagesListEndpoint import (
    CompanyTeamrolesIdUsagesListEndpoint,
)
...
class CompanyTeamrolesIdUsagesEndpoint(
    ConnectWiseEndpoint,
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        self.list = self._register_child_endpoint(
            CompanyTeamrolesIdUsagesListEndpoint(client, parent_endpoint=self)
        )
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /company/teamRoles/{id}/usages endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /company/teamRoles/{id}/usages endpoint.
