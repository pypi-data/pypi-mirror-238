...
class ScheduleTypesIdInfoEndpoint(
    ConnectWiseEndpoint,
    IGettable[ScheduleTypeInfo, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, ScheduleTypeInfo)
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /schedule/types/{id}/info endpoint and returns an initialized PaginatedResponse object.
