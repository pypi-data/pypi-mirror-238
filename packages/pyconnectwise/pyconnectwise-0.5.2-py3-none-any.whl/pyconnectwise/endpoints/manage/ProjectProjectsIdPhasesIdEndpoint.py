...
class ProjectProjectsIdPhasesIdEndpoint(
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, ProjectPhase)
        IPuttable.__init__(self, ProjectPhase)
        IPatchable.__init__(self, ProjectPhase)
