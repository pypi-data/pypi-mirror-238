...
class CompanyOwnershiptypesIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[OwnershipType, ConnectWiseManageRequestParams],
    IPuttable[OwnershipType, ConnectWiseManageRequestParams],
    IPatchable[OwnershipType, ConnectWiseManageRequestParams],
