...
class CompanyConfigurationsTypesIdUsagesListEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /company/configurations/types/{id}/usages/list endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /company/configurations/types/{id}/usages/list endpoint.
