...
class ProcurementUnitofmeasuresIdConversionsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /procurement/unitOfMeasures/{id}/conversions/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /procurement/unitOfMeasures/{id}/conversions/count endpoint.
