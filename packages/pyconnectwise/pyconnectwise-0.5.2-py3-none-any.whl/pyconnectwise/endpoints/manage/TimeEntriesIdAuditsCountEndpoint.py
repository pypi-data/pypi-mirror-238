...
class TimeEntriesIdAuditsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /time/entries/{id}/audits/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /time/entries/{id}/audits/count endpoint.
