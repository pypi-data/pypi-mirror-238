...
class FinanceInfoCurrencycodesIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[CurrencyCode, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, CurrencyCode)
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /finance/info/currencyCodes/{id} endpoint and returns an initialized PaginatedResponse object.
