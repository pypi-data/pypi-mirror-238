...
class MarketingCampaignsIdFormssubmittedIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[FormSubmitted, ConnectWiseManageRequestParams],
    IPuttable[FormSubmitted, ConnectWiseManageRequestParams],
    IPatchable[FormSubmitted, ConnectWiseManageRequestParams],
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /marketing/campaigns/{id}/formsSubmitted/{id} endpoint and returns an initialized PaginatedResponse object.
