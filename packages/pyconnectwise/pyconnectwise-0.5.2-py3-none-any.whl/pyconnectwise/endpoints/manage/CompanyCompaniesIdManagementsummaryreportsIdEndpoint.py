...
class CompanyCompaniesIdManagementsummaryreportsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[CompanyManagementSummary, ConnectWiseManageRequestParams],
    IPuttable[CompanyManagementSummary, ConnectWiseManageRequestParams],
    IPatchable[CompanyManagementSummary, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, CompanyManagementSummary)
        IPuttable.__init__(self, CompanyManagementSummary)
        IPatchable.__init__(self, CompanyManagementSummary)
