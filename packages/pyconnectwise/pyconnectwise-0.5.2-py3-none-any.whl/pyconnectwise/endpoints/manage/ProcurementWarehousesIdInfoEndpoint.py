...
class ProcurementWarehousesIdInfoEndpoint(
    ConnectWiseEndpoint,
    IGettable[WarehouseInfo, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, WarehouseInfo)
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /procurement/warehouses/{id}/info endpoint and returns an initialized PaginatedResponse object.
