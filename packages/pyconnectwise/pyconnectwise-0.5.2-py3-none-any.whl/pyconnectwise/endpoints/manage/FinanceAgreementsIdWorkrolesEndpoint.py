...
from pyconnectwise.endpoints.manage.FinanceAgreementsIdWorkrolesIdEndpoint import (
    FinanceAgreementsIdWorkrolesIdEndpoint,
)
...
class FinanceAgreementsIdWorkrolesEndpoint(
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, list[AgreementWorkRole])
        IPostable.__init__(self, AgreementWorkRole)
    ...
    def id(self, id: int) -> FinanceAgreementsIdWorkrolesIdEndpoint:  # noqa: A002
        """
        ...
        """
        child = FinanceAgreementsIdWorkrolesIdEndpoint(
