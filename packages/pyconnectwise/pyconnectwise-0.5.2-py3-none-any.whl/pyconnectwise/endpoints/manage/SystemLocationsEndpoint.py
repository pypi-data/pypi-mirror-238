...
class SystemLocationsEndpoint(
    ConnectWiseEndpoint,
    IGettable[list[Location], ConnectWiseManageRequestParams],
    IPostable[Location, ConnectWiseManageRequestParams],
    ...
    def id(self, id: int) -> SystemLocationsIdEndpoint:  # noqa: A002
        """
