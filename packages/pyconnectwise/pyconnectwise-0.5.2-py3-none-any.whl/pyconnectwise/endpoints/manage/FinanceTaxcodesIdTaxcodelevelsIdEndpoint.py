...
class FinanceTaxcodesIdTaxcodelevelsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[TaxCodeLevel, ConnectWiseManageRequestParams],
    IPuttable[TaxCodeLevel, ConnectWiseManageRequestParams],
    IPatchable[TaxCodeLevel, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, TaxCodeLevel)
        IPuttable.__init__(self, TaxCodeLevel)
        IPatchable.__init__(self, TaxCodeLevel)
