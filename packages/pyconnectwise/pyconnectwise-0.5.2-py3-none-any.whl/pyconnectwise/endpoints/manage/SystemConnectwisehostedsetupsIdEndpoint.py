...
class SystemConnectwisehostedsetupsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[ConnectWiseHostedSetup, ConnectWiseManageRequestParams],
    IPuttable[ConnectWiseHostedSetup, ConnectWiseManageRequestParams],
    IPatchable[ConnectWiseHostedSetup, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, ConnectWiseHostedSetup)
        IPuttable.__init__(self, ConnectWiseHostedSetup)
        IPatchable.__init__(self, ConnectWiseHostedSetup)
