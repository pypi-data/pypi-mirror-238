...
class ExpenseReportsIdAuditsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[ExpenseReportAudit, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, ExpenseReportAudit)
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /expense/reports/{id}/audits/{id} endpoint and returns an initialized PaginatedResponse object.
