...
class CompanyConfigurationsTypesIdQuestionsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[ConfigurationTypeQuestion, ConnectWiseManageRequestParams],
    IPuttable[ConfigurationTypeQuestion, ConnectWiseManageRequestParams],
    IPatchable[ConfigurationTypeQuestion, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, ConfigurationTypeQuestion)
        IPuttable.__init__(self, ConfigurationTypeQuestion)
        IPatchable.__init__(self, ConfigurationTypeQuestion)
