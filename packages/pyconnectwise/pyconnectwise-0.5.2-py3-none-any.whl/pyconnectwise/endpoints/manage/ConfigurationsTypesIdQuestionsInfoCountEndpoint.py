...
class ConfigurationsTypesIdQuestionsInfoCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /configurations/types/{id}/questions/info/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /configurations/types/{id}/questions/info/count endpoint.
