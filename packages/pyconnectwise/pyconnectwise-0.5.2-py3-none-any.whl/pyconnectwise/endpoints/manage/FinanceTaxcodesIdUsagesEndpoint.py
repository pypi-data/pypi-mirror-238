...
from pyconnectwise.endpoints.manage.FinanceTaxcodesIdUsagesListEndpoint import (
    FinanceTaxcodesIdUsagesListEndpoint,
)
...
class FinanceTaxcodesIdUsagesEndpoint(
    ConnectWiseEndpoint,
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        self.list = self._register_child_endpoint(
            FinanceTaxcodesIdUsagesListEndpoint(client, parent_endpoint=self)
        )
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /finance/taxCodes/{id}/usages endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /finance/taxCodes/{id}/usages endpoint.
