...
class ServiceBoardsIdAutoassignresourcesCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /service/boards/{id}/autoAssignResources/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /service/boards/{id}/autoAssignResources/count endpoint.
