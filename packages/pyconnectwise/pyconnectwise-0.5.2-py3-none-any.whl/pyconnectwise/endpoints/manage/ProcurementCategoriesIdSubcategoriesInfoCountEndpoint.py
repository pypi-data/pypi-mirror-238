...
class ProcurementCategoriesIdSubcategoriesInfoCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /procurement/categories/{id}/subcategories/info/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /procurement/categories/{id}/subcategories/info/count endpoint.
