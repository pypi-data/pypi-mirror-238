...
from pyconnectwise.endpoints.manage.ServiceEmailtemplatesEndpoint import (
    ServiceEmailtemplatesEndpoint,
)
...
from pyconnectwise.endpoints.manage.ServiceKnowledgebasearticlesEndpoint import (
    ServiceKnowledgebasearticlesEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceKnowledgebasecategoriesEndpoint import (
    ServiceKnowledgebasecategoriesEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceKnowledgebasesettingsEndpoint import (
    ServiceKnowledgebasesettingsEndpoint,
)
...
from pyconnectwise.endpoints.manage.ServiceLocationsEndpoint import (
    ServiceLocationsEndpoint,
)
from pyconnectwise.endpoints.manage.ServicePrioritiesEndpoint import (
    ServicePrioritiesEndpoint,
)
from pyconnectwise.endpoints.manage.ServicePriorityEndpoint import (
    ServicePriorityEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceSchedulingEndpoint import (
    ServiceSchedulingEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceServicesignoffEndpoint import (
    ServiceServicesignoffEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceSeveritiesEndpoint import (
    ServiceSeveritiesEndpoint,
)
...
from pyconnectwise.endpoints.manage.ServiceTeammembersEndpoint import (
    ServiceTeammembersEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceTeamsEndpoint import ServiceTeamsEndpoint
from pyconnectwise.endpoints.manage.ServiceTemplatesEndpoint import (
    ServiceTemplatesEndpoint,
)
from pyconnectwise.endpoints.manage.ServiceTicketlinksEndpoint import (
    ServiceTicketlinksEndpoint,
)
...
class ServiceEndpoint(ConnectWiseEndpoint):
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        self.info = self._register_child_endpoint(
            ServiceInfoEndpoint(client, parent_endpoint=self)
        )
        ...
        self.s_l_as = self._register_child_endpoint(
        ...
        self.ticket_links = self._register_child_endpoint(
        ...
        self.scheduling = self._register_child_endpoint(
            ServiceSchedulingEndpoint(client, parent_endpoint=self)
        )
        self.ticket_syncs = self._register_child_endpoint(
        ...
        self.priority = self._register_child_endpoint(
            ServicePriorityEndpoint(client, parent_endpoint=self)
        )
