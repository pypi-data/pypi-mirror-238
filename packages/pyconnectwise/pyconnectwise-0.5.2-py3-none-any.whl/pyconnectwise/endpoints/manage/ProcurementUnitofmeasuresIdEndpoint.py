...
class ProcurementUnitofmeasuresIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[UnitOfMeasure, ConnectWiseManageRequestParams],
    IPuttable[UnitOfMeasure, ConnectWiseManageRequestParams],
    IPatchable[UnitOfMeasure, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, UnitOfMeasure)
        IPuttable.__init__(self, UnitOfMeasure)
        IPatchable.__init__(self, UnitOfMeasure)
