...
class ProjectTicketsIdTasksIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[TicketTask, ConnectWiseManageRequestParams],
    IPuttable[TicketTask, ConnectWiseManageRequestParams],
    IPatchable[TicketTask, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, TicketTask)
        IPuttable.__init__(self, TicketTask)
        IPatchable.__init__(self, TicketTask)
    ...
    def put(
        ...
        """
        return self._parse_one(
            TicketTask, super()._make_request("PUT", data=data, params=params).json()
        )
    ...
    def patch(
        ...
        """
        return self._parse_one(
            TicketTask, super()._make_request("PATCH", data=data, params=params).json()
        )
