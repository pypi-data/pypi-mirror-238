...
class ServiceServicesignoffIdSignoffcustomfieldsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /service/serviceSignoff/{id}/signoffcustomfields/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /service/serviceSignoff/{id}/signoffcustomfields/count endpoint.
