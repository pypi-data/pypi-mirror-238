...
class SystemContactsyncMonitoringTypeIdEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /system/contactsync/monitoring/type/{id} endpoint and returns an initialized PaginatedResponse object.
