...
from pyconnectwise.endpoints.manage.SystemMembersTypesInfoCountEndpoint import (
    SystemMembersTypesInfoCountEndpoint,
)
...
class SystemMembersTypesInfoEndpoint(
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, list[MemberTypeInfo])
