...
class ServiceTicketsIdConvertEndpoint(
    ...
    def post(
        ...
        """
        Performs a POST request against the /service/tickets/{id}/convert endpoint.
