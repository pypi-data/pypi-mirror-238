...
from pyconnectwise.endpoints.manage.SystemSsousersCountEndpoint import (
    SystemSsousersCountEndpoint,
)
from pyconnectwise.endpoints.manage.SystemSsousersIdEndpoint import (
    SystemSsousersIdEndpoint,
)
...
class SystemSsousersEndpoint(
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ConnectWiseEndpoint.__init__(
            self, client, "ssoUsers", parent_endpoint=parent_endpoint
        )
    ...
    def id(self, id: int) -> SystemSsousersIdEndpoint:  # noqa: A002
        """
    ...
    def get(
        ...
        return self._parse_many(
            SsoUser, super()._make_request("GET", data=data, params=params).json()
        )
