...
class SalesScheduleHolidaylistsIdHolidaysInfoCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /sales/schedule/holidaylists/{id}/holidays/info/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /sales/schedule/holidaylists/{id}/holidays/info/count endpoint.
