...
class FinanceGlaccountsMappedtypesCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /finance/glAccounts/mappedTypes/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /finance/glAccounts/mappedTypes/count endpoint.
