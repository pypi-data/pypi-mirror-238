...
from pyconnectwise.endpoints.manage.CompanyManagementbackupsCountEndpoint import (
    CompanyManagementbackupsCountEndpoint,
)
from pyconnectwise.endpoints.manage.CompanyManagementbackupsIdEndpoint import (
    CompanyManagementbackupsIdEndpoint,
)
...
class CompanyManagementbackupsEndpoint(
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ConnectWiseEndpoint.__init__(
            self, client, "managementBackups", parent_endpoint=parent_endpoint
        )
    ...
    def id(self, id: int) -> CompanyManagementbackupsIdEndpoint:  # noqa: A002
        """
