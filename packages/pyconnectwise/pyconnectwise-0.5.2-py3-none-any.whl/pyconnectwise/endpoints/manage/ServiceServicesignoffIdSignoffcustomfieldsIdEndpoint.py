...
class ServiceServicesignoffIdSignoffcustomfieldsIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[ServiceSignoffCustomField, ConnectWiseManageRequestParams],
    IPuttable[ServiceSignoffCustomField, ConnectWiseManageRequestParams],
    IPatchable[ServiceSignoffCustomField, ConnectWiseManageRequestParams],
