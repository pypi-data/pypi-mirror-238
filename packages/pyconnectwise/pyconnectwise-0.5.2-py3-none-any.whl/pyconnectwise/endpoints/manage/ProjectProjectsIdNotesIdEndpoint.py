...
class ProjectProjectsIdNotesIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[ProjectNote, ConnectWiseManageRequestParams],
    ...
    def put(
        ...
        """
        return self._parse_one(
            ProjectNote, super()._make_request("PUT", data=data, params=params).json()
        )
    ...
    def patch(
        ...
        """
        return self._parse_one(
            ProjectNote, super()._make_request("PATCH", data=data, params=params).json()
        )
