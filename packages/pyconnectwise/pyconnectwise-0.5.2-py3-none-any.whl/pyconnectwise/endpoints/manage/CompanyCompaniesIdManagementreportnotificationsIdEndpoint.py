...
class CompanyCompaniesIdManagementreportnotificationsIdEndpoint(
    ConnectWiseEndpoint,
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, ManagementReportNotification)
        IPuttable.__init__(self, ManagementReportNotification)
        IPatchable.__init__(self, ManagementReportNotification)
