...
class CompanyContactsyncCompanyIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[M365ContactSyncCompany, ConnectWiseManageRequestParams],
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /company/contactsync/company/{id} endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /company/contactsync/company/{id} endpoint.
