...
class SalesSalesteamsIdMembersCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /sales/salesTeams/{id}/members/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /sales/salesTeams/{id}/members/count endpoint.
