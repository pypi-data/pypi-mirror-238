...
from pyconnectwise.endpoints.manage.ProjectPhasestatusesIdUsagesEndpoint import (
    ProjectPhasestatusesIdUsagesEndpoint,
)
...
class ProjectPhasestatusesIdEndpoint(
    ConnectWiseEndpoint,
    IGettable[PhaseStatus, ConnectWiseManageRequestParams],
    IPuttable[PhaseStatus, ConnectWiseManageRequestParams],
    IPatchable[PhaseStatus, ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, PhaseStatus)
        IPuttable.__init__(self, PhaseStatus)
        IPatchable.__init__(self, PhaseStatus)
    ...
    def put(
        ...
        """
        return self._parse_one(
            PhaseStatus, super()._make_request("PUT", data=data, params=params).json()
        )
    ...
    def patch(
        ...
        """
        return self._parse_one(
            PhaseStatus, super()._make_request("PATCH", data=data, params=params).json()
        )
