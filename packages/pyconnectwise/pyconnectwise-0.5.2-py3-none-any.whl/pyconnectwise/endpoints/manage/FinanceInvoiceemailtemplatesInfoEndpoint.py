...
class FinanceInvoiceemailtemplatesInfoEndpoint(
    ConnectWiseEndpoint,
    IGettable[list[InvoiceEmailTemplateInfo], ConnectWiseManageRequestParams],
    ...
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        IGettable.__init__(self, list[InvoiceEmailTemplateInfo])
        IPaginateable.__init__(self, InvoiceEmailTemplateInfo)
