...
from pyconnectwise.endpoints.manage.SystemM365contactsyncIdEndpoint import (
    SystemM365contactsyncIdEndpoint,
)
from pyconnectwise.endpoints.manage.SystemM365contactsyncInfoEndpoint import (
    SystemM365contactsyncInfoEndpoint,
)
...
class SystemM365contactsyncEndpoint(ConnectWiseEndpoint):
    def __init__(self, client, parent_endpoint=None) -> None:  # noqa: ANN001
        ...
        self.info = self._register_child_endpoint(
            SystemM365contactsyncInfoEndpoint(client, parent_endpoint=self)
        )
    ...
    def id(self, id: int) -> SystemM365contactsyncIdEndpoint:  # noqa: A002
        """
