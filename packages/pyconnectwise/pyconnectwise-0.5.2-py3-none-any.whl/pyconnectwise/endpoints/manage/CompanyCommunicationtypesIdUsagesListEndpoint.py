...
class CompanyCommunicationtypesIdUsagesListEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /company/communicationTypes/{id}/usages/list endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /company/communicationTypes/{id}/usages/list endpoint.
