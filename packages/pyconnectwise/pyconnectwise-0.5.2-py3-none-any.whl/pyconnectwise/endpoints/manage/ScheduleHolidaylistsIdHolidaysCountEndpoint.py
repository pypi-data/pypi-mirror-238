...
class ScheduleHolidaylistsIdHolidaysCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /schedule/holidayLists/{id}/holidays/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /schedule/holidayLists/{id}/holidays/count endpoint.
