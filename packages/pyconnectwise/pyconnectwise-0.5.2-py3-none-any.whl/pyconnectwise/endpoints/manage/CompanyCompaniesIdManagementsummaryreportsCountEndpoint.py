...
class CompanyCompaniesIdManagementsummaryreportsCountEndpoint(
    ConnectWiseEndpoint,
    ...
    def paginated(
        ...
        """
        Performs a GET request against the /company/companies/{id}/managementSummaryReports/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(
        ...
        """
        Performs a GET request against the /company/companies/{id}/managementSummaryReports/count endpoint.
