...
def plateau_algorithm(G, from_edge, to_edge, k, epsilon, attribute, max_iter = 1000, path_epsilon_cutoff = False):
...
def plateau_algorithm_experimental(G, from_edge, to_edge, k, epsilon, attribute, max_iter = 1000, compute_in_subgraph = True, min_size_subgraph = 0.02, path_epsilon_cutoff = False):
