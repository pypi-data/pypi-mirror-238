...
def get_app():
    ...
    return build_app(False, os.environ.get("VERIFY_ACTOR_DOMAIN", "localhost:8000"))


def build_app(only_generate_config: bool, domain: str) -> Quart:
...
def verify_actor(only_generate_config, reload, port, domain):
    app = build_app(only_generate_config, domain)
