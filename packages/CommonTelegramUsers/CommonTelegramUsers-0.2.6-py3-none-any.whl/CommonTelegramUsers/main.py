...
def find(args: List[str|int], api_id: int, api_hash: str, name: str = "CTU", blacklist: Set[int] = set(), verbose: bool = False) -> Set[int]:
    ...
    with app:
        ...
        for chat in args[1:]:
            init: Set[int] = init & get_all_participants(app=app, chat=process_chat(chat), verbose=verbose)
