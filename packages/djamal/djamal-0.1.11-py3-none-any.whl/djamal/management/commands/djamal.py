...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("-H", "--skip-hooks", action="store_true", help="Don't run hooks")
    ...
    def handle(self, *args, **options):
        ...
        if command == "add_alias":
            ...
            self.execute_djamal_command_if_alias_exists(command, command_list, options)
    ...
    def execute_djamal_command_if_alias_exists(self, djamal_command, optional_args, options):
        full_command = self.construct_full_command(djamal_command, optional_args, options)
        subprocess.run(full_command, shell=True)

    def construct_full_command(self, djamal_command, optional_args, options):
        env_file_path = self.get_env_file_path()
...
Commands:
  ...
  djamal redeploy            # Deploy app to servers without bootstrapping servers, starting Traefik, pruning, and
