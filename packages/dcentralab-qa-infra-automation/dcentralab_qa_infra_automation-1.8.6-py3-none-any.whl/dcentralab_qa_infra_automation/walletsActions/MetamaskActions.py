...
from dcentralab_qa_infra_automation.pages.metamaskPages.MetamaskCongratulationPage import MetamaskCongratulationPage
from dcentralab_qa_infra_automation.pages.metamaskPages.MetamaskCreatePasswordPage import MetamaskCreatePasswordPage
from dcentralab_qa_infra_automation.pages.metamaskPages.MetamaskImportWallet import MetamaskImportWallet
...
class MetamaskActions(WalletsActionsInterface):
    ...
    def __init__(self, driver):
        ...
        self.metamask_import_wallet_page = MetamaskImportWallet(self.driver)
        self.metamask_create_wallet_password_page = MetamaskCreatePasswordPage(self.driver)
        self.metamask_congratulation_page = MetamaskCongratulationPage(self.driver)
