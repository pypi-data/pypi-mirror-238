...
class MetamaskActions(WalletsActionsInterface):
    ...
    def import_wallet(self):
        ...
        self.metamask_import_wallet_page.insert_secret_recovery_phrase(
            pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_0"),
            pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_1"),
            pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_2"),
            pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_3"),
            pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_4"),
            pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_5"),
            pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_6"),
            pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_7"),
            pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_8"),
            pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_9"),
            pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_10"),
            pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_11"))
