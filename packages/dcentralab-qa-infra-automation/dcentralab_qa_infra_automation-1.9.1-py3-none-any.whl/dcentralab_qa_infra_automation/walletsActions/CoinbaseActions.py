...
class CoinbaseActions(WalletsActionsInterface):
    ...
    def __init__(self, driver):
        ...
        self.coinbase_receive_crypto_username_page = CoinbaseReceiveCryptoToUsernamePage(self.driver)
    ...
    def import_wallet(self):
        ...
        assert self.coinbase_receive_crypto_username_page.is_page_loaded()
