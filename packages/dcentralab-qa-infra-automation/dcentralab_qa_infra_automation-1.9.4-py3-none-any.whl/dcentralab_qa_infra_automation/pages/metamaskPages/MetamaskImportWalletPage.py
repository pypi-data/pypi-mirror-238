...
class MetamaskImportWalletPage(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.seed_phrase_0 = pytest.wallets_data.get(f"{pytest.data_driven.get('wallet')}").get(
            "SECRET_RECOVERY_PHRASE_0")
        self.seed_phrase_1 = pytest.wallets_data.get(f"{pytest.data_driven.get('wallet')}").get(
            "SECRET_RECOVERY_PHRASE_1")
        self.seed_phrase_2 = pytest.wallets_data.get(f"{pytest.data_driven.get('wallet')}").get(
            "SECRET_RECOVERY_PHRASE_2")
        self.seed_phrase_3 = pytest.wallets_data.get(f"{pytest.data_driven.get('wallet')}").get(
            "SECRET_RECOVERY_PHRASE_3")
        self.seed_phrase_4 = pytest.wallets_data.get(f"{pytest.data_driven.get('wallet')}").get(
            "SECRET_RECOVERY_PHRASE_4")
        self.seed_phrase_5 = pytest.wallets_data.get(f"{pytest.data_driven.get('wallet')}").get(
            "SECRET_RECOVERY_PHRASE_5")
        self.seed_phrase_6 = pytest.wallets_data.get(f"{pytest.data_driven.get('wallet')}").get(
            "SECRET_RECOVERY_PHRASE_6")
        self.seed_phrase_7 = pytest.wallets_data.get(f"{pytest.data_driven.get('wallet')}").get(
            "SECRET_RECOVERY_PHRASE_7")
        self.seed_phrase_8 = pytest.wallets_data.get(f"{pytest.data_driven.get('wallet')}").get(
            "SECRET_RECOVERY_PHRASE_8")
        self.seed_phrase_9 = pytest.wallets_data.get(f"{pytest.data_driven.get('wallet')}").get(
            "SECRET_RECOVERY_PHRASE_9")
        self.seed_phrase_10 = pytest.wallets_data.get(f"{pytest.data_driven.get('wallet')}").get(
            "SECRET_RECOVERY_PHRASE_10")
        self.seed_phrase_11 = pytest.wallets_data.get(f"{pytest.data_driven.get('wallet')}").get(
            "SECRET_RECOVERY_PHRASE_11")
