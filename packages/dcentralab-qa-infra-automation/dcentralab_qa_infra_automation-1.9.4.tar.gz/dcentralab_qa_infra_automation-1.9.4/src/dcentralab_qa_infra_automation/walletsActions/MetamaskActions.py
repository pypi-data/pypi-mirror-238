...
class MetamaskActions(WalletsActionsInterface):
    ...
    def __init__(self, driver):
        ...
        self.seed_phrase_0 = pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_0")
        self.seed_phrase_1 = pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_1")
        self.seed_phrase_2 = pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_2")
        self.seed_phrase_3 = pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_3")
        self.seed_phrase_4 = pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_4")
        self.seed_phrase_5 = pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_5")
        self.seed_phrase_6 = pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_6")
        self.seed_phrase_7 = pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_7")
        self.seed_phrase_8 = pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_8")
        self.seed_phrase_9 = pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_9")
        self.seed_phrase_10 = pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_10")
        self.seed_phrase_11 = pytest.wallet_data.get(pytest.data_driven.get("wallet")).get("secret_recovery_phrase_11")
    ...
    def import_wallet(self):
        ...
        self.metamask_import_wallet_page.insert_secret_recovery_phrase(self.seed_phrase_0, self.seed_phrase_1,
                                                                       self.seed_phrase_2, self.seed_phrase_3,
                                                                       self.seed_phrase_4, self.seed_phrase_5,
                                                                       self.seed_phrase_6, self.seed_phrase_7,
                                                                       self.seed_phrase_8, self.seed_phrase_9,
                                                                       self.seed_phrase_10, self.seed_phrase_11)
        ...
        assert self.metamask_wallet_install_completed_page.is_try_it_out_button_exist(), "Try it out button loaded"

        # Click on Try it out button
        self.metamask_wallet_install_completed_page.click_on_try_it_out_button()
