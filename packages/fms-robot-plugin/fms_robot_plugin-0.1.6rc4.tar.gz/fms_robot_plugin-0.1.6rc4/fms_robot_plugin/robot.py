...
from fms_robot_plugin.typings import LaserScan, Twist, Pose, Map, Status, RobotInfo
...
class Robot:
    ...
    def run(self):
        priority_topic = f"/robots/{self.robot_key}/priority"
        self.consumer(priority_topic).consume(self.on_set_priority)
