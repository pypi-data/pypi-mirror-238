...
project = "qoqo_strawberry_fields"
...
htmlhelp_basename = "qoqostrawberryfieldsdoc"
...
latex_documents = [
    (
        master_doc,
        "qoqo_strawberry_fields.tex",
        "qoqo_strawberry_fields Documentation",
...
man_pages = [
    (master_doc, "qoqo_strawberry_fields", "qoqo_strawberry_fields Documentation", [author], 1)
]
...
texinfo_documents = [
    (
        ...
        author,
        "qoqo_strawberry_fields",
        "Xanadu Strawberry Fields backend for qoqo quantum computing toolkit.",
        "Miscellaneous",
    ),
]
