...
<custom-style>
  <style is="custom-style">
...
</custom-style>`;n.setAttribute("style","display: none;"),document.head.appendChild(n.content);var i=document.createElement("style");i.textContent="[hidden] { display: none !important; }",document.head.appendChild(i)},25782:(t,e,o)=>{o(1449),o(65660),o(70019),o(97968);var n=o(9672),i=o(50856),r=o(33760);(0,n.k)({_template:i.d`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[r.U]})},33760:(t,e,o)=>{o.d(e,{U:()=>r});o(1449);var n=o(51644),i=o(26110);const r=[n.P,i.a,{hostAttributes:{role:"option",tabindex:"0"}}]},97968:(t,e,o)=>{o(65660),o(70019);const n=document.createElement("template");n.setAttribute("style","display: none;"),n.innerHTML="<dom-module id=\"paper-item-shared-styles\">\n  <template>\n    <style>\n      :host, .paper-item {\n        display: block;\n        position: relative;\n        min-height: var(--paper-item-min-height, 48px);\n        padding: 0px 16px;\n      }\n\n      .paper-item {\n        @apply --paper-font-subhead;\n        border:none;\n        outline: none;\n        background: white;\n        width: 100%;\n        text-align: left;\n      }\n\n      :host([hidden]), .paper-item[hidden] {\n        display: none !important;\n      }\n\n      :host(.iron-selected), .paper-item.iron-selected {\n        font-weight: var(--paper-item-selected-weight, bold);\n\n        @apply --paper-item-selected;\n      }\n\n      :host([disabled]), .paper-item[disabled] {\n        color: var(--paper-item-disabled-color, var(--disabled-text-color));\n\n        @apply --paper-item-disabled;\n      }\n\n      :host(:focus), .paper-item:focus {\n        position: relative;\n        outline: 0;\n\n        @apply --paper-item-focused;\n      }\n\n      :host(:focus):before, .paper-item:focus:before {\n        @apply --layout-fit;\n\n        background: currentColor;\n        content: '';\n        opacity: var(--dark-divider-opacity);\n        pointer-events: none;\n\n        @apply --paper-item-focused-before;\n      }\n    </style>\n  </template>\n</dom-module>",document.head.appendChild(n.content)},53973:(t,e,o)=>{o(1449),o(65660),o(97968);var n=o(9672),i=o(50856),r=o(33760);(0,n.k)({_template:i.d`
    ...
    <slot></slot>
`,is:"paper-item",behaviors:[r.U]})},51095:(t,e,o)=>{o(1449);var n=o(23823),i=o(9672),r=o(50856);(0,i.k)({_template:r.d`
    <style>
      :host {
        display: block;
        padding: 8px 0;
