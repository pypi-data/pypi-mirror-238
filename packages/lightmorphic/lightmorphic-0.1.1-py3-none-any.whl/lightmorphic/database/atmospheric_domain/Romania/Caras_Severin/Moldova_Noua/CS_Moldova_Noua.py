...
def get_atmospheric_data_CS_Moldova_Noua(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Caras_Severin/Moldova_Noua/Moldova_Noua_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Moldova Noua: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Caras_Severin/Moldova_Noua/Moldova_Noua_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Moldova Noua: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Moldova Noua'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Moldova Noua. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Moldova Noua is running.")
else:
        pass
