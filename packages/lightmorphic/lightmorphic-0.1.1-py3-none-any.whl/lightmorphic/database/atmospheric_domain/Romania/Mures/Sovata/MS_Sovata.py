...
def get_atmospheric_data_MS_Sovata(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Mures/Sovata/Sovata_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Sovata: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Mures/Sovata/Sovata_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Sovata: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Sovata'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Sovata. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Sovata is running.')
else:
        pass
