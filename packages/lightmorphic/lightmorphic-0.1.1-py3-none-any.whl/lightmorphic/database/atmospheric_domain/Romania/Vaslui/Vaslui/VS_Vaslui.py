...
def get_atmospheric_data_VS_Vaslui(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Vaslui/Vaslui/Vaslui_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Vaslui: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Vaslui/Vaslui/Vaslui_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Vaslui: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Vaslui'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Vaslui. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Vaslui is running.')
else:
        pass
