...
def get_atmospheric_data_VS_Barlad(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Vaslui/Barlad/Barlad_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Barlad: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Vaslui/Barlad/Barlad_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Barlad: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Barlad'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Barlad. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Barlad is running.')
else:
        pass
