...
def get_atmospheric_data_BR_Insuratei(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Braila/Insuratei/Insuratei_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Insuratei: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Braila/Insuratei/Insuratei_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Insuratei: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Insuratei'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Insuratei. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Insuratei is running.")
else:
        pass
