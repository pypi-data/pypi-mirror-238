...
def get_atmospheric_data_BR_Braila(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Braila/Braila/Braila_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Braila: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Braila/Braila/Braila_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Braila: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Braila'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Braila. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Braila is running.")
else:
        pass
