...
def get_atmospheric_data_CL_Fundulea(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Calarasi/Fundulea/Fundulea_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Fundulea: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Calarasi/Fundulea/Fundulea_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Fundulea: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Fundulea'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Fundulea. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Fundulea is running.")
else:
        pass
