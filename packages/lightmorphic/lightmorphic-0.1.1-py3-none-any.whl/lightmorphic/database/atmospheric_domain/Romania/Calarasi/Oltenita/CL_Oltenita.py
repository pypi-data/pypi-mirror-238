...
def get_atmospheric_data_CL_Oltenita(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Calarasi/Oltenita/Oltenita_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Oltenita: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Calarasi/Oltenita/Oltenita_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Oltenita: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Oltenita'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Oltenita. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Oltenita is running.")
else:
        pass
