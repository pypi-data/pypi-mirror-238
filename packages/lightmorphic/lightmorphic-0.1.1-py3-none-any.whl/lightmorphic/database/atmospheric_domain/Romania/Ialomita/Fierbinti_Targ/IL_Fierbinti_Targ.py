...
def get_atmospheric_data_IL_Fierbinti_Targ(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Ialomita/Fierbinti_Targ/Fierbinti_Targ_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Fierbinti Targ: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Ialomita/Fierbinti_Targ/Fierbinti_Targ_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Fierbinti Targ: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Fierbinti Targ'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Fierbinti Targ. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Fierbinti Targ is running.")
else:
        pass
