...
def get_atmospheric_data_TM_Buzias(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Timis/Buzias/Buzias_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Buzias: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Timis/Buzias/Buzias_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Buzias: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Buzias'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Buzias. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Buzias is running.')
else:
        pass
