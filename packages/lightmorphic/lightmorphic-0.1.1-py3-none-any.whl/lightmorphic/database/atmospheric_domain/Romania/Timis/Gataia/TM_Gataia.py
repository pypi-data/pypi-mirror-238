...
def get_atmospheric_data_TM_Gataia(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Timis/Gataia/Gataia_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Gataia: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Timis/Gataia/Gataia_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Gataia: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Gataia'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Gataia. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Gataia is running.')
else:
        pass
