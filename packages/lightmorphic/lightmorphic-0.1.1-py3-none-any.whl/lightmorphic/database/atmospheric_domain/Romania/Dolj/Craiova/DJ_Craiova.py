...
def get_atmospheric_data_DJ_Craiova(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Dolj/Craiova/Craiova_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Craiova: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Dolj/Craiova/Craiova_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Craiova: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Craiova'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Craiova. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Craiova is running.")
else:
        pass
