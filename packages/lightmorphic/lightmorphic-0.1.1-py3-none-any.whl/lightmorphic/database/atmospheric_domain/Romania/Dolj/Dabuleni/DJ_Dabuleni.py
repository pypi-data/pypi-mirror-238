...
def get_atmospheric_data_DJ_Dabuleni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Dolj/Dabuleni/Dabuleni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Dabuleni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Dolj/Dabuleni/Dabuleni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Dabuleni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Dabuleni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Dabuleni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Dabuleni is running.")
else:
        pass
