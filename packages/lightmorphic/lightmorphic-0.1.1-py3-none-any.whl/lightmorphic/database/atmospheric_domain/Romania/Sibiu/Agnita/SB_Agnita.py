...
def get_atmospheric_data_SB_Agnita(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Sibiu/Agnita/Agnita_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Agnita: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Sibiu/Agnita/Agnita_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Agnita: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Agnita'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Agnita. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Agnita is running.')
else:
        pass
