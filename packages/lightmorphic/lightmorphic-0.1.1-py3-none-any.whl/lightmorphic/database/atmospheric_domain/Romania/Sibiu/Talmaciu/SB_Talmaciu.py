...
def get_atmospheric_data_SB_Talmaciu(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Sibiu/Talmaciu/Talmaciu_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Talmaciu: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Sibiu/Talmaciu/Talmaciu_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Talmaciu: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Talmaciu'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Talmaciu. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Talmaciu is running.')
else:
        pass
