...
def get_atmospheric_data_MM_Seini(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Seini/Seini_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Seini: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Seini/Seini_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Seini: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Seini'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Seini. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Seini is running.')
else:
        pass
