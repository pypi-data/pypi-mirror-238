...
def get_atmospheric_data_MM_Borsa(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Borsa/Borsa_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Borsa: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Borsa/Borsa_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Borsa: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Borsa'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Borsa. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Borsa is running.')
else:
        pass
