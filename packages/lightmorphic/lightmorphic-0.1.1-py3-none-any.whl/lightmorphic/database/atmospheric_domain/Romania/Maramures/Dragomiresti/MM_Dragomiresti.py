...
def get_atmospheric_data_MM_Dragomiresti(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Dragomiresti/Dragomiresti_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Dragomiresti: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Dragomiresti/Dragomiresti_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Dragomiresti: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Dragomiresti'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Dragomiresti. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Dragomiresti is running.')
else:
        pass
