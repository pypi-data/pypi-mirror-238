...
def get_atmospheric_data_MM_Baia_Sprie(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Baia_Sprie/Baia_Sprie_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Baia Sprie: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Baia_Sprie/Baia_Sprie_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Baia Sprie: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Baia Sprie'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Baia Sprie. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Baia Sprie is running.')
else:
        pass
