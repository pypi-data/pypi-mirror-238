...
def get_atmospheric_data_MM_Sighetu_Marmatiei(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Sighetu_Marmatiei/Sighetu_Marmatiei_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Sighetu Marmatiei: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Sighetu_Marmatiei/Sighetu_Marmatiei_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Sighetu Marmatiei: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Sighetu Marmatiei'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Sighetu Marmatiei. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Sighetu Marmatiei is running.')
else:
        pass
