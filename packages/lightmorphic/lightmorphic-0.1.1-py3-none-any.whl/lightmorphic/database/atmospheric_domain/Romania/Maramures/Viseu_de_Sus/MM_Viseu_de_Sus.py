...
def get_atmospheric_data_MM_Viseu_de_Sus(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Viseu_de_Sus/Viseu_de_Sus_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Viseu de Sus: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Viseu_de_Sus/Viseu_de_Sus_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Viseu de Sus: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Viseu de Sus'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Viseu de Sus. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Viseu de Sus is running.')
else:
        pass
