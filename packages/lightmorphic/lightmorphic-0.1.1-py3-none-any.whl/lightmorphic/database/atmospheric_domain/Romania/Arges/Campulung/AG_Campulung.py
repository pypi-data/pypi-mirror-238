...
def get_atmospheric_data_AG_Campulung(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Arges/Campulung/Campulung_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Campulung: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Arges/Campulung/Campulung_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Campulung: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Campulung'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Campulung. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Campulung is running.")
else:
        pass
