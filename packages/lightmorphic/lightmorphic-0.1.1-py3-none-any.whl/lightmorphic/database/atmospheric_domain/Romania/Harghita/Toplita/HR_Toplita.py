...
def get_atmospheric_data_HR_Toplita(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Harghita/Toplita/Toplita_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Toplita: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Harghita/Toplita/Toplita_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Toplita: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Toplita'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Toplita. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Toplita is running.")
else:
        pass
