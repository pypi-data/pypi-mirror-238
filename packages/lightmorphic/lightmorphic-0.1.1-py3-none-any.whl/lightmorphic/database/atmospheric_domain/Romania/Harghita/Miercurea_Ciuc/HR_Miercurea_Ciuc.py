...
def get_atmospheric_data_HR_Miercurea_Ciuc(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Harghita/Miercurea_Ciuc/Miercurea_Ciuc_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Miercurea Ciuc: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Harghita/Miercurea_Ciuc/Miercurea_Ciuc_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Miercurea Ciuc: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Miercurea Ciuc'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Miercurea Ciuc. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Miercurea Ciuc is running.")
else:
        pass
