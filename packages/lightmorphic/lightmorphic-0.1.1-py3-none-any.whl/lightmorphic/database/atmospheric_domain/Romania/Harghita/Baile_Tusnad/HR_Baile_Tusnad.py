...
def get_atmospheric_data_HR_Baile_Tusnad(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Harghita/Baile_Tusnad/Baile_Tusnad_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Baile Tusnad: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Harghita/Baile_Tusnad/Baile_Tusnad_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Baile Tusnad: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Baile Tusnad'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Baile Tusnad. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Baile Tusnad is running.")
else:
        pass
