...
def get_atmospheric_data_HR_Balan(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Harghita/Balan/Balan_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Balan: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Harghita/Balan/Balan_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Balan: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Balan'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Balan. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Balan is running.")
else:
        pass
