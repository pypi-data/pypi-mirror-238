...
def get_atmospheric_data_HR_Odorheiu_Secuiesc(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Harghita/Odorheiu_Secuiesc/Odorheiu_Secuiesc_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Odorheiu Secuiesc: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Harghita/Odorheiu_Secuiesc/Odorheiu_Secuiesc_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Odorheiu Secuiesc: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Odorheiu Secuiesc'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Odorheiu Secuiesc. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Odorheiu Secuiesc is running.")
else:
        pass
