...
def get_atmospheric_data_HR_Vlahita(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Harghita/Vlahita/Vlahita_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Vlahita: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Harghita/Vlahita/Vlahita_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Vlahita: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Vlahita'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Vlahita. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Vlahita is running.")
else:
        pass
