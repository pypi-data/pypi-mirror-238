...
def get_atmospheric_data_SM_Satu_Mare(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Satu_Mare/Satu_Mare/Satu_Mare_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Satu Mare: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Satu_Mare/Satu_Mare/Satu_Mare_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Satu Mare: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Satu Mare'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Satu Mare. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Satu Mare is running.')
else:
        pass
