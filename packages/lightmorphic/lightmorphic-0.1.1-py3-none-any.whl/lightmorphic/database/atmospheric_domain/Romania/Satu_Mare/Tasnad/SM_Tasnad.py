...
def get_atmospheric_data_SM_Tasnad(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Satu_Mare/Tasnad/Tasnad_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Tasnad: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Satu_Mare/Tasnad/Tasnad_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Tasnad: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Tasnad'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Tasnad. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Tasnad is running.')
else:
        pass
