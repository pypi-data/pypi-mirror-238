...
def get_atmospheric_data_SM_Negresti_Oas(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Satu_Mare/Negresti_Oas/Negresti_Oas_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Negresti Oas: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Satu_Mare/Negresti_Oas/Negresti_Oas_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Negresti Oas: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Negresti Oas'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Negresti Oas. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Negresti Oas is running.')
else:
        pass
