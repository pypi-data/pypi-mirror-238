...
def get_atmospheric_data_SM_Carei(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Satu_Mare/Carei/Carei_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Carei: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Satu_Mare/Carei/Carei_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Carei: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Carei'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Carei. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Carei is running.')
else:
        pass
