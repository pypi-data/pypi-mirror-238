...
def get_atmospheric_data_DB_Targoviste(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Dambovita/Targoviste/Targoviste_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Targoviste: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Dambovita/Targoviste/Targoviste_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Targoviste: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Targoviste'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Targoviste. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Targoviste is running.")
else:
        pass
