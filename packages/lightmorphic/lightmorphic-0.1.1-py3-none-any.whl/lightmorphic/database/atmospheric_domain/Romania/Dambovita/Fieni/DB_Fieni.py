...
def get_atmospheric_data_DB_Fieni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Dambovita/Fieni/Fieni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Fieni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Dambovita/Fieni/Fieni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Fieni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Fieni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Fieni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Fieni is running.")
else:
        pass
