...
def get_atmospheric_data_DB_Pucioasa(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Dambovita/Pucioasa/Pucioasa_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Pucioasa: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Dambovita/Pucioasa/Pucioasa_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Pucioasa: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Pucioasa'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Pucioasa. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Pucioasa is running.")
else:
        pass
