...
def get_atmospheric_data_CT_Mangalia(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Mangalia/Mangalia_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Mangalia: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Mangalia/Mangalia_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Mangalia: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Mangalia'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Mangalia. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Mangalia is running.")
else:
        pass
