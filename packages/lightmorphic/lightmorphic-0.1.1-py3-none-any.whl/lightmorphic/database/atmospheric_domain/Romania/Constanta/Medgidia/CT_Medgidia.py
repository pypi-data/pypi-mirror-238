...
def get_atmospheric_data_CT_Medgidia(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Medgidia/Medgidia_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Medgidia: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Medgidia/Medgidia_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Medgidia: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Medgidia'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Medgidia. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Medgidia is running.")
else:
        pass
