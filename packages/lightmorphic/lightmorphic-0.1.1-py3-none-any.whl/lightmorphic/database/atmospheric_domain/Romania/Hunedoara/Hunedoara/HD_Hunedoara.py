...
def get_atmospheric_data_HD_Hunedoara(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Hunedoara/Hunedoara/Hunedoara_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Hunedoara: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Hunedoara/Hunedoara/Hunedoara_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Hunedoara: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Hunedoara'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Hunedoara. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Hunedoara is running.")
else:
        pass
