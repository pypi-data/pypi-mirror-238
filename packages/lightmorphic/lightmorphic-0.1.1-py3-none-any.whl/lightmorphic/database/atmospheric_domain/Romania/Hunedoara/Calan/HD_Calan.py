...
def get_atmospheric_data_HD_Calan(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Hunedoara/Calan/Calan_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Calan: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Hunedoara/Calan/Calan_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Calan: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Calan'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Calan. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Calan is running.")
else:
        pass
