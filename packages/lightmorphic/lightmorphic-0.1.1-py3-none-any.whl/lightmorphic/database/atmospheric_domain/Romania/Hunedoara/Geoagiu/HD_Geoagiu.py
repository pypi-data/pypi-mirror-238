...
def get_atmospheric_data_HD_Geoagiu(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Hunedoara/Geoagiu/Geoagiu_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Geoagiu: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Hunedoara/Geoagiu/Geoagiu_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Geoagiu: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Geoagiu'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Geoagiu. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Geoagiu is running.")
else:
        pass
