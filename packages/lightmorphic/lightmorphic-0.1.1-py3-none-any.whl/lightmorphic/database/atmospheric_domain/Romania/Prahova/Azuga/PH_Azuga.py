...
def get_atmospheric_data_PH_Azuga(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Azuga/Azuga_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Azuga: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Azuga/Azuga_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Azuga: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Azuga'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Azuga. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Azuga is running.')
else:
        pass
