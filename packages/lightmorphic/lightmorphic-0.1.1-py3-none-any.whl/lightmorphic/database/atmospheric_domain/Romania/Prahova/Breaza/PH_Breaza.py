...
def get_atmospheric_data_PH_Breaza(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Breaza/Breaza_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Breaza: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Breaza/Breaza_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Breaza: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Breaza'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Breaza. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Breaza is running.')
else:
        pass
