...
def get_atmospheric_data_PH_Comarnic(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Comarnic/Comarnic_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Comarnic: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Comarnic/Comarnic_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Comarnic: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Comarnic'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Comarnic. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Comarnic is running.')
else:
        pass
