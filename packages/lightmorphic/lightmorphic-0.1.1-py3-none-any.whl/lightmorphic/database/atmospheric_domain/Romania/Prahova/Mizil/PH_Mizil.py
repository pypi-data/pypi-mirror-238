...
def get_atmospheric_data_PH_Mizil(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Mizil/Mizil_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Mizil: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Mizil/Mizil_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Mizil: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Mizil'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Mizil. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Mizil is running.')
else:
        pass
