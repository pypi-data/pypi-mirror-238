...
def get_atmospheric_data_PH_Valenii_de_Munte(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Valenii_de_Munte/Valenii_de_Munte_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Valenii de Munte: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Valenii_de_Munte/Valenii_de_Munte_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Valenii de Munte: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Valenii de Munte'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Valenii de Munte. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Valenii de Munte is running.')
else:
        pass
