...
def get_atmospheric_data_PH_Campina(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Campina/Campina_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Campina: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Campina/Campina_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Campina: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Campina'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Campina. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Campina is running.')
else:
        pass
