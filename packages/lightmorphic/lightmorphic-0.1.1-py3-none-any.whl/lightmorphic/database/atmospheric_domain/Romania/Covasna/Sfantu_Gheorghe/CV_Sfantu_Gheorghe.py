...
def get_atmospheric_data_CV_Sfantu_Gheorghe(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Covasna/Sfantu_Gheorghe/Sfantu_Gheorghe_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Sfantu Gheorghe: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Covasna/Sfantu_Gheorghe/Sfantu_Gheorghe_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Sfantu Gheorghe: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Sfantu Gheorghe'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Sfantu Gheorghe. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Sfantu Gheorghe is running.")
else:
        pass
