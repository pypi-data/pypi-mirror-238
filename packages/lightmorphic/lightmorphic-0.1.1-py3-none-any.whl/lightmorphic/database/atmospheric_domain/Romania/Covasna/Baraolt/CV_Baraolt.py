...
def get_atmospheric_data_CV_Baraolt(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Covasna/Baraolt/Baraolt_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Baraolt: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Covasna/Baraolt/Baraolt_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Baraolt: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Baraolt'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Baraolt. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Baraolt is running.")
else:
        pass
