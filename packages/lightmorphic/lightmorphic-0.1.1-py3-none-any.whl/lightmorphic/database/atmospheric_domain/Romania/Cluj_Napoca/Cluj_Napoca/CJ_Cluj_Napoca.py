...
def get_atmospheric_data_CJ_Cluj_Napoca(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Cluj_Napoca/Cluj_Napoca/Cluj_Napoca_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Cluj Napoca: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Cluj_Napoca/Cluj_Napoca/Cluj_Napoca_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Cluj Napoca: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Cluj Napoca'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Cluj Napoca. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Cluj Napoca is running.")
else:
        pass
