...
def get_atmospheric_data_CJ_Gherla(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Cluj_Napoca/Gherla/Gherla_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Gherla: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Cluj_Napoca/Gherla/Gherla_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Gherla: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Gherla'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Gherla. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Gherla is running.")
else:
        pass
