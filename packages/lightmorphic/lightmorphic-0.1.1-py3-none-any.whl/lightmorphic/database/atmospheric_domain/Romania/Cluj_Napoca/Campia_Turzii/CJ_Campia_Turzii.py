...
def get_atmospheric_data_CJ_Campia_Turzii(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Cluj_Napoca/Campia_Turzii/Campia_Turzii_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Campia Turzii: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Cluj_Napoca/Campia_Turzii/Campia_Turzii_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Campia Turzii: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Campia Turzii'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Campia Turzii. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Campia Turzii is running.")
else:
        pass
