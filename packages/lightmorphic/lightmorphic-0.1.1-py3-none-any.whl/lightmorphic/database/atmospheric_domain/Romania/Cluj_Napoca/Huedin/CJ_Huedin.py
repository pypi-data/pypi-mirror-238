...
def get_atmospheric_data_CJ_Huedin(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Cluj_Napoca/Huedin/Huedin_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Huedin: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Cluj_Napoca/Huedin/Huedin_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Huedin: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Huedin'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Huedin. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Huedin is running.")
else:
        pass
