...
def get_atmospheric_data_OT_Potcoava(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Olt/Potcoava/Potcoava_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Potcoava: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Olt/Potcoava/Potcoava_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Potcoava: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Potcoava'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Potcoava. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Potcoava is running.')
else:
        pass
