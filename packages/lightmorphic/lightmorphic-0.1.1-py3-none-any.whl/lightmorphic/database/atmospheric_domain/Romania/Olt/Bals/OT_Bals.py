...
def get_atmospheric_data_OT_Bals(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Olt/Bals/Bals_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Bals: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Olt/Bals/Bals_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Bals: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Bals'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Bals. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Bals is running.')
else:
        pass
