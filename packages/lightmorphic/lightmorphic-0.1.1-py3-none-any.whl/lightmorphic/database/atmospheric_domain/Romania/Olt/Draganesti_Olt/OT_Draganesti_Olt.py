...
def get_atmospheric_data_OT_Draganesti_Olt(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Olt/Draganesti_Olt/Draganesti_Olt_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Draganesti Olt: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Olt/Draganesti_Olt/Draganesti_Olt_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Draganesti Olt: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Draganesti Olt'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Draganesti Olt. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Draganesti Olt is running.')
else:
        pass
