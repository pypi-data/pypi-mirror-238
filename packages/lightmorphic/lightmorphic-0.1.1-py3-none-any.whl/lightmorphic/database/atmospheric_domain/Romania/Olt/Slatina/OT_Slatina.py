...
def get_atmospheric_data_OT_Slatina(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Olt/Slatina/Slatina_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Slatina: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Olt/Slatina/Slatina_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Slatina: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Slatina'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Slatina. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Slatina is running.')
else:
        pass
