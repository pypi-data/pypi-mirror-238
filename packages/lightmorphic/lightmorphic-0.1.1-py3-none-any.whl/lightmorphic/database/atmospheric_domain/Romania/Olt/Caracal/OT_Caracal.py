...
def get_atmospheric_data_OT_Caracal(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Olt/Caracal/Caracal_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Caracal: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Olt/Caracal/Caracal_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Caracal: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Caracal'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Caracal. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Caracal is running.')
else:
        pass
