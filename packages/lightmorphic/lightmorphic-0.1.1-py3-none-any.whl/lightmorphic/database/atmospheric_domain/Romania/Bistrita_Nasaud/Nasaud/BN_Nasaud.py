...
def get_atmospheric_data_BN_Nasaud(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Bistrita_Nasaud/Nasaud/Nasaud_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Nasaud: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Bistrita_Nasaud/Nasaud/Nasaud_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Nasaud: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Nasaud'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Nasaud. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Nasaud is running.")
else:
        pass
