...
def get_atmospheric_data_SJ_Zalau(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Salaj/Zalau/Zalau_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Zalau: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Salaj/Zalau/Zalau_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Zalau: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Zalau'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Zalau. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Zalau is running.')
else:
        pass
