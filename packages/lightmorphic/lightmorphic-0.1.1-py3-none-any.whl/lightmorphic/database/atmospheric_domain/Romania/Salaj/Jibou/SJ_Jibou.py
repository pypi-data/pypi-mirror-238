...
def get_atmospheric_data_SJ_Jibou(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Salaj/Jibou/Jibou_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Jibou: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Salaj/Jibou/Jibou_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Jibou: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Jibou'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Jibou. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Jibou is running.')
else:
        pass
