...
def get_atmospheric_data_BC_Moinesti(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Bacau/Moinesti/Moinesti_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Moinesti: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Bacau/Moinesti/Moinesti_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Moinesti: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Moinesti'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Moinesti. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Moinesti is running.")
else:
        pass
