...
def get_atmospheric_data_BC_Buhusi(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Bacau/Buhusi/Buhusi_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Buhusi: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Bacau/Buhusi/Buhusi_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Buhusi: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Buhusi'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Buhusi. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Buhusi is running.")
else:
        pass
