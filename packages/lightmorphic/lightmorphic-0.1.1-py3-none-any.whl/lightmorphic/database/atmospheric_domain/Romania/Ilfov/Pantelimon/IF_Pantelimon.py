...
def get_atmospheric_data_IF_Pantelimon(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Ilfov/Pantelimon/Pantelimon_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Pantelimon: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Ilfov/Pantelimon/Pantelimon_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Pantelimon: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Pantelimon'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Pantelimon. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Pantelimon is running.')
else:
        pass
