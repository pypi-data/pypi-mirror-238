...
def get_atmospheric_data_IF_Voluntari(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Ilfov/Voluntari/Voluntari_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Voluntari: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Ilfov/Voluntari/Voluntari_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Voluntari: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Voluntari'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Voluntari. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Voluntari is running.')
else:
        pass
