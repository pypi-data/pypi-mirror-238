...
def get_atmospheric_data_IF_Otopeni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Ilfov/Otopeni/Otopeni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Otopeni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Ilfov/Otopeni/Otopeni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Otopeni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Otopeni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Otopeni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Otopeni is running.')
else:
        pass
