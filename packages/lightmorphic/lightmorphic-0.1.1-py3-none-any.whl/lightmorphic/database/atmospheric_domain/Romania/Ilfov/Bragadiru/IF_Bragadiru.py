...
def get_atmospheric_data_IF_Bragadiru(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Ilfov/Bragadiru/Bragadiru_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Bragadiru: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Ilfov/Bragadiru/Bragadiru_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Bragadiru: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)

#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Bragadiru'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Bragadiru. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Bragadiru is running.')
else:
        pass
