...
def get_atmospheric_data_IF_Popesti_Leordeni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Ilfov/Popesti_Leordeni/Popesti_Leordeni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Popesti Leordeni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Ilfov/Popesti_Leordeni/Popesti_Leordeni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Popesti Leordeni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Popesti Leordeni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Popesti Leordeni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Popesti Leordeni is running.')
else:
        pass
