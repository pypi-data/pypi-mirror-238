...
def get_atmospheric_data_IF_Buftea(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Ilfov/Buftea/Buftea_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Buftea: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Ilfov/Buftea/Buftea_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Buftea: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Buftea'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Buftea. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Buftea is running.')
else:
        pass
