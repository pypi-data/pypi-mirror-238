...
def get_atmospheric_data_BT_Darabani(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Botosani/Darabani/Darabani_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Darabani: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Botosani/Darabani/Darabani_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Darabani: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Darabani'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Darabani. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Darabani is running.")
else:
        pass
