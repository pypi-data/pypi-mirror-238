...
def get_atmospheric_data_TR_Rosiorii_de_Vede(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Teleorman/Rosiorii_de_Vede/Rosiorii_de_Vede_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Rosiorii de Vede: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Teleorman/Rosiorii_de_Vede/Rosiorii_de_Vede_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Rosiorii de Vede: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Rosiorii de Vede'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Rosiorii de Vede. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Rosiorii de Vede is running.')
else:
        pass
