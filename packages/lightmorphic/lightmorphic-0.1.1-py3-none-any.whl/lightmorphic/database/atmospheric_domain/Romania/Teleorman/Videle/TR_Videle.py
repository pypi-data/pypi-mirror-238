...
def get_atmospheric_data_TR_Videle(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Teleorman/Videle/Videle_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Videle: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Teleorman/Videle/Videle_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Videle: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Videle'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Videle. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Videle is running.')
else:
        pass
