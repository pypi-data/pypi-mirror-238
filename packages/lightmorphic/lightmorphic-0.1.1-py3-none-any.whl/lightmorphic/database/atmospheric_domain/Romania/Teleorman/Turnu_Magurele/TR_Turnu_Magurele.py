...
def get_atmospheric_data_TR_Turnu_Magurele(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Teleorman/Turnu_Magurele/Turnu_Magurele_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Turnu Magurele: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Teleorman/Turnu_Magurele/Turnu_Magurele_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Turnu Magurele: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Turnu Magurele'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Turnu Magurele. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Turnu Magurele is running.')
else:
        pass
