...
def get_atmospheric_data_TR_Zimnicea(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Teleorman/Zimnicea/Zimnicea_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Zimnicea: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Teleorman/Zimnicea/Zimnicea_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Zimnicea: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Zimnicea'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Zimnicea. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Zimnicea is running.')
else:
        pass
