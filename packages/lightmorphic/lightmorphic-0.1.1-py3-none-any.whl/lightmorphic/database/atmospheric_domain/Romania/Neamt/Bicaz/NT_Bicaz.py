...
def get_atmospheric_data_NT_Bicaz(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Neamt/Bicaz/Bicaz_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Bicaz: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Neamt/Bicaz/Bicaz_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Bicaz: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Bicaz'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Bicaz. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Bicaz is running.')
else:
        pass
