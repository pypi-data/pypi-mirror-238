...
def get_atmospheric_data_NT_Roman(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Neamt/Roman/Roman_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Roman: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Neamt/Roman/Roman_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Roman: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Roman'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Roman. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Roman is running.')
else:
        pass
