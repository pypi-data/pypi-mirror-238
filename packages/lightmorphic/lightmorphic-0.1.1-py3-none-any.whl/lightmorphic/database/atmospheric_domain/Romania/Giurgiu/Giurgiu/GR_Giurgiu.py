...
def get_atmospheric_data_GR_Giurgiu(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Giurgiu/Giurgiu/Giurgiu_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Giurgiu: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Giurgiu/Giurgiu/Giurgiu_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Giurgiu: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Giurgiu'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Giurgiu. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Giurgiu is running.")
else:
        pass
