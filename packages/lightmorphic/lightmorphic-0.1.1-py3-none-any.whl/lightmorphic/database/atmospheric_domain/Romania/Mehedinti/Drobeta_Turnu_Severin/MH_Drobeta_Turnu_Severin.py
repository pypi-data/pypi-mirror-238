...
def get_atmospheric_data_MH_Drobeta_Turnu_Severin(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Mehedinti/Drobeta_Turnu_Severin/Drobeta_Turnu_Severin_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Drobeta Turnu Severin: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Mehedinti/Drobeta_Turnu_Severin/Drobeta_Turnu_Severin_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Drobeta Turnu Severin: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Drobeta Turnu Severin'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Drobeta Turnu Severin. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Drobeta Turnu Severin is running.')
else:
        pass
