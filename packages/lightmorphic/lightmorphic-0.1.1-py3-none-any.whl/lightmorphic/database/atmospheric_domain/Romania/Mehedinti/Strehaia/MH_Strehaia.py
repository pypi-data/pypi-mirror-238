...
def get_atmospheric_data_MH_Strehaia(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Mehedinti/Strehaia/Strehaia_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Strehaia: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Mehedinti/Strehaia/Strehaia_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Strehaia: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Strehaia'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Strehaia. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Strehaia is running.')
else:
        pass
