...
def get_atmospheric_data_GJ_Targu_Jiu(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Gorj/Targu_Jiu/Targu_Jiu_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Targu Jiu: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Gorj/Targu_Jiu/Targu_Jiu_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Targu Jiu: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Targu Jiu'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Targu Jiu. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Targu Jiu is running.")
else:
        pass
