...
def get_atmospheric_data_AR_Pancota(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Arad/Pancota/Pancota_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Pancota: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Arad/Pancota/Pancota_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Pancota: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Pancota'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Pancota. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Pancota is running.")
else:
        pass
