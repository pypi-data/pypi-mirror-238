...
def get_atmospheric_data_AR_Nadlac(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Arad/Nadlac/Nadlac_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Nadlac: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Arad/Nadlac/Nadlac_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Nadlac: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Nadlac'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Nadlac. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Nadlac is running.")
else:
        pass
