...
def get_atmospheric_data_AR_Chisineu_Cris(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Arad/Chisineu_Cris/Chisineu_Cris_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Chisineu_Cris: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Arad/Chisineu_Cris/Chisineu_Cris_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Chisineu_Cris: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Chisineu Cris'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Chisineu Cris. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Chisineu Cris is running.")
else:
        pass
