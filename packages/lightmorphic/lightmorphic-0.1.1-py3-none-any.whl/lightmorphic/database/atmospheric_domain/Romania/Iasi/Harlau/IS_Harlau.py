...
def get_atmospheric_data_IS_Harlau(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Iasi/Harlau/Harlau_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Harlau: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Iasi/Harlau/Harlau_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Harlau: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Harlau'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Harlau. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Harlau is running')
else:
        pass
