...
def get_atmospheric_data_IS_Podu_Iloaiei(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Iasi/Podu_Iloaiei/Podu_Iloaiei_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Podu_Iloaiei: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Iasi/Podu_Iloaiei/Podu_Iloaiei_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Podu_Iloaiei: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)

#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Podu Iloaiei'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Podu Iloaiei. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Podu Iloaiei is running.')
else:
        pass
