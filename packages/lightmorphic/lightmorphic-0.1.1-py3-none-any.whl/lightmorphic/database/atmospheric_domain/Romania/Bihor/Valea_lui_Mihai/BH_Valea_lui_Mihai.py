...
def get_atmospheric_data_BH_Valea_lui_Mihai(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Bihor/Valea_lui_Mihai/Valea_lui_Mihai_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Valea_lui_Mihai: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Bihor/Valea_lui_Mihai/Valea_lui_Mihai_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Valea_lui_Mihai: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Valea lui Mihai'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Valea lui Mihai. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Valea lui Mihai is running.")
else:
        pass
