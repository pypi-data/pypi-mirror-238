...
def get_atmospheric_data_BH_Marghita(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Bihor/Marghita/Marghita_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Marghita: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Bihor/Marghita/Marghita_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Marghita: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Marghita'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Marghita. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Marghita is running.")
else:
        pass
