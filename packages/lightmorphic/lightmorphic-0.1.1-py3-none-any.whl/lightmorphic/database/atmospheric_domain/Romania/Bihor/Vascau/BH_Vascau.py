...
def get_atmospheric_data_BH_Vascau(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Bihor/Vascau/Vascau_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Vascau: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Bihor/Vascau/Vascau_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Vascau: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Vascau'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Vascau. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Vascau is running.")
else:
        pass
