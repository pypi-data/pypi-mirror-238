...
def get_atmospheric_data_BZ_Nehoiu(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Buzau/Nehoiu/Nehoiu_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Nehoiu: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Buzau/Nehoiu/Nehoiu_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Nehoiu: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Nehoiu'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Nehoiu. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Nehoiu is running.")
else:
        pass
