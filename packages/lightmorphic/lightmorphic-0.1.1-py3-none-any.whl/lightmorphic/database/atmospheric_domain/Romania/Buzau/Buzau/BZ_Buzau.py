...
def get_atmospheric_data_BZ_Buzau(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Buzau/Buzau/Buzau_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Buzau: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Buzau/Buzau/Buzau_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Buzau: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Buzau'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Buzau. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Buzau is running.")
else:
        pass
