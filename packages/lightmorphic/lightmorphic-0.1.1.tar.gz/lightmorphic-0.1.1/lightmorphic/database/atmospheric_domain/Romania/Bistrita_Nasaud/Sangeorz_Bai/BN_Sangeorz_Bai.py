...
def get_atmospheric_data_BN_Sangeorz_Bai(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Bistrita_Nasaud/Sangeorz_Bai/Sangeorz_Bai_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Sangeorz_Bai: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Bistrita_Nasaud/Sangeorz_Bai/Sangeorz_Bai_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Sangeorz_Bai: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Sangeorz Bai'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Sangeorz Bai. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Sangeorz Bai is running.")
else:
        pass
