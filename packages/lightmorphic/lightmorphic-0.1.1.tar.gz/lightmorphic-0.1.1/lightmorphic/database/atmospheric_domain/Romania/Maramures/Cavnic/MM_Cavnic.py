...
def get_atmospheric_data_MM_Cavnic(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Cavnic/Cavnic_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Cavnic: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Cavnic/Cavnic_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Cavnic: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Cavnic'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Cavnic. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Cavnic is running.')
else:
        pass
