...
def get_atmospheric_data_BH_Alesd(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Bihor/Alesd/Alesd_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Alesd: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Bihor/Alesd/Alesd_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Alesd: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Alesd'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Alesd. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Alesd is running.")
else:
        pass
