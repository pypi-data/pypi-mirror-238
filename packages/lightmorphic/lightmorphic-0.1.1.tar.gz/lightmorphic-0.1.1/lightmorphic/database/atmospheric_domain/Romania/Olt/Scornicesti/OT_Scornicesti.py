...
def get_atmospheric_data_OT_Scornicesti(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Olt/Scornicesti/Scornicesti_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Scornicesti: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Olt/Scornicesti/Scornicesti_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Scornicesti: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Scornicesti'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Scornicesti. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Scornicesti is running.')
else:
        pass
