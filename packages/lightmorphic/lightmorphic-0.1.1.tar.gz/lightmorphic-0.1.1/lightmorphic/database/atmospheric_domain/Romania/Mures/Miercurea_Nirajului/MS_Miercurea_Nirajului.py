...
def get_atmospheric_data_MS_Miercurea_Nirajului(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Mures/Miercurea_Nirajului/Miercurea_Nirajului_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Miercurea Nirajului: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Mures/Miercurea_Nirajului/Miercurea_Nirajului_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Miercurea Nirajului: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Miercurea Nirajului'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Miercurea Nirajului. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Miercurea Nirajului is running.')
else:
        pass
