...
def get_atmospheric_data_HD_Petrosani(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Hunedoara/Petrosani/Petrosani_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Petrosani: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Hunedoara/Petrosani/Petrosani_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Petrosani: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Petrosani'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Petrosani. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Petrosani is running.")
else:
        pass
