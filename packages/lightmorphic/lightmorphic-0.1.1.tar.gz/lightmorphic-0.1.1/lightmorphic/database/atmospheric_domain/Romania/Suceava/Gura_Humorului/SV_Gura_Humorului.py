...
def get_atmospheric_data_SV_Gura_Humorului(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Suceava/Gura_Humorului/Gura_Humorului_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Gura_Humorului: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Suceava/Gura_Humorului/Gura_Humorului_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Gura_Humorului: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Gura Humorului'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Gura Humorului. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Gura Humorului is running.')
else:
        pass
