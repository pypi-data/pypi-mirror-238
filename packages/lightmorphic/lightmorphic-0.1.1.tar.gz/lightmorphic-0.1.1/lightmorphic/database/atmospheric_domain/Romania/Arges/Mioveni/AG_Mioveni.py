...
def get_atmospheric_data_AG_Mioveni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Arges/Mioveni/Mioveni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Mioveni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Arges/Mioveni/Mioveni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Mioveni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Mioveni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Mioveni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Mioveni is running.")
else:
        pass
