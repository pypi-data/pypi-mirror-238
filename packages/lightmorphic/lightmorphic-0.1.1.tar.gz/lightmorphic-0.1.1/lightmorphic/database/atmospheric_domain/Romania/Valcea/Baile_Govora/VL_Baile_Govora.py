...
def get_atmospheric_data_VL_Baile_Govora(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Valcea/Baile_Govora/Baile_Govora_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Baile Govora: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Valcea/Baile_Govora/Baile_Govora_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Baile Govora: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Baile Govora'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Baile Govora. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Baile Govora is running.')
else:
        pass
