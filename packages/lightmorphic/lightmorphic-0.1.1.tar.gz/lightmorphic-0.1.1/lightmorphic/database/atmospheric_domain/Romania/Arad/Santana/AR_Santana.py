...
def get_atmospheric_data_AR_Santana(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Arad/Santana/Santana_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Santana: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Arad/Santana/Santana_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Santana: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Santana'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Santana. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Santana is running.")
else:
        pass
