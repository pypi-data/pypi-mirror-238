...
def get_atmospheric_data_MH_Baia_de_Arama(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Mehedinti/Baia_de_Arama/Baia_de_Arama_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Baia de Arama: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Mehedinti/Baia_de_Arama/Baia_de_Arama_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Baia de Arama: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Baia de Arama'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Baia de Arama. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Baia de Arama is running.')
else:
        pass
