...
def get_atmospheric_data_SB_Sibiu(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Sibiu/Sibiu/Sibiu_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Sibiu: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Sibiu/Sibiu/Sibiu_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Sibiu: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Sibiu'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Sibiu. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Sibiu is running.')
else:
        pass
