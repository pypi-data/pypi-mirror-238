...
def get_atmospheric_data_VL_Calimanesti(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Valcea/Calimanesti/Calimanesti_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Calimanesti: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Valcea/Calimanesti/Calimanesti_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Calimanesti: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Calimanesti'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Calimanesti. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Calimanesti is running.')
else:
        pass
