...
def get_atmospheric_data_GL_Galati(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Galati/Galati/Galati_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Galati: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Galati/Galati/Galati_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Galati: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Galati'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Galati. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Galati is running.")
else:
        pass
