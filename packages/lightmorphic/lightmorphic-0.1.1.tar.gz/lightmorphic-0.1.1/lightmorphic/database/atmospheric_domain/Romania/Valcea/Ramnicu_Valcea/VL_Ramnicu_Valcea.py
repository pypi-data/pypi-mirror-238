...
def get_atmospheric_data_VL_Ramnicu_Valcea(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Valcea/Ramnicu_Valcea/Ramnicu_Valcea_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Ramnicu Valcea: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Valcea/Ramnicu_Valcea/Ramnicu_Valcea_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Ramnicu Valcea: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Ramnicu Valcea'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Ramnicu Valcea. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Ramnicu Valcea is running.')
else:
        pass
