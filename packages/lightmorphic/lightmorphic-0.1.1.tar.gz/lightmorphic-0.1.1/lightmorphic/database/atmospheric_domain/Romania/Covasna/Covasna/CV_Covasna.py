...
def get_atmospheric_data_CV_Covasna(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Covasna/Covasna/Covasna_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Covasna: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Covasna/Covasna/Covasna_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Covasna: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Covasna'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Covasna. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Covasna is running.")
else:
        pass
