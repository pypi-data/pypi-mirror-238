...
def get_atmospheric_data_GJ_Rovinari(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Gorj/Rovinari/Rovinari_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Rovinari: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Gorj/Rovinari/Rovinari_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Rovinari: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Rovinari'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Rovinari. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Rovinari is running.")
else:
        pass
