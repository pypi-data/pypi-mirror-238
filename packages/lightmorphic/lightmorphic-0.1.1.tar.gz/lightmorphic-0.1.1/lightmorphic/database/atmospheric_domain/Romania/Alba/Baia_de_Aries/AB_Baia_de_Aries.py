...
def get_atmospheric_data_AB_Baia_de_Aries(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Alba/Baia_de_Aries/Baia_de_Aries_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Baia_de_Aries: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Alba/Baia_de_Aries/Baia_de_Aries_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Baia_de_Aries: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Baia de Aries'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Baia de Aries. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Baia de Aries is running.")
else:
        pass
