...
def get_atmospheric_data_TL_Macin(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Tulcea/Macin/Macin_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Macin: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Tulcea/Macin/Macin_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Macin: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Macin'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Macin. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Macin is running.')
else:
        pass
