...
def get_atmospheric_data_GR_Bolintin_Vale(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Giurgiu/Bolintin_Vale/Bolintin_Vale_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Bolintin Vale: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Giurgiu/Bolintin_Vale/Bolintin_Vale_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Bolintin Vale: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Bolintin Vale'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Bolintin Vale. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Bolintin Vale is running.")
else:
        pass
