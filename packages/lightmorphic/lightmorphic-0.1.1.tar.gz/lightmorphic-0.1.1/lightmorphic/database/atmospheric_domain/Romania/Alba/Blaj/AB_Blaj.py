...
def get_atmospheric_data_AB_Blaj(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Alba/Blaj/Blaj_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Blaj: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Alba/Blaj/Blaj_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Blaj: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Blaj'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Blaj. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Blaj is running.")
else:
        pass
