...
def get_atmospheric_data_TM_Timisoara(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Timis/Timisoara/Timisoara_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Timisoara: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Timis/Timisoara/Timisoara_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Timisoara: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Timisoara'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Timisoara. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Timisoara is running.')
else:
        pass
