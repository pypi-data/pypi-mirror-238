...
def get_atmospheric_data_VN_Panciu(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Vrancea/Panciu/Panciu_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Panciu: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Vrancea/Panciu/Panciu_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Panciu: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Panciu'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Panciu. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Panciu is running.')
else:
        pass
