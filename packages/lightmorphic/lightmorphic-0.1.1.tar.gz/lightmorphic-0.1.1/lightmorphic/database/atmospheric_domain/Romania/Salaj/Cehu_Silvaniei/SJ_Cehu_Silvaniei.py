...
def get_atmospheric_data_SJ_Cehu_Silvaniei(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Salaj/Cehu_Silvaniei/Cehu_Silvaniei_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Cehu Silvaniei: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Salaj/Cehu_Silvaniei/Cehu_Silvaniei_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Cehu Silvaniei: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Cehu Silvaniei'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Cehu Silvaniei. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Cehu Silvaniei is running.')
else:
        pass
