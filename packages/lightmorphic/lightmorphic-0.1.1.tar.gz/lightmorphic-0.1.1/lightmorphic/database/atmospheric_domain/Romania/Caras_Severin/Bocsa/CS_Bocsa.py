...
def get_atmospheric_data_CS_Bocsa(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Caras_Severin/Bocsa/Bocsa_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Bocsa: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Caras_Severin/Bocsa/Bocsa_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Bocsa: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Bocsa'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Bocsa. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Bocsa is running.")
else:
        pass
