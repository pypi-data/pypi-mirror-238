...
def get_atmospheric_data_TL_Babadag(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Tulcea/Babadag/Babadag_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Babadag: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Tulcea/Babadag/Babadag_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Babadag: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Babadag'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Babadag. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Babadag is running.')
else:
        pass
