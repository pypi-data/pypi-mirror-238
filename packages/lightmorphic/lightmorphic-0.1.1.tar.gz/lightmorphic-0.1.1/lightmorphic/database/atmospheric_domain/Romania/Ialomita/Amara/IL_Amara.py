...
def get_atmospheric_data_IL_Amara(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Ialomita/Amara/Amara_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Amara: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Ialomita/Amara/Amara_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Amara: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Amara'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Amara. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Amara is running.")
else:
        pass
