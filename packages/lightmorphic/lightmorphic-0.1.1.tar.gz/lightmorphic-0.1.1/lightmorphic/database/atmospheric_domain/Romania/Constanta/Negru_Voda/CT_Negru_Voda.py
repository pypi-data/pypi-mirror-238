...
def get_atmospheric_data_CT_Negru_Voda(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Negru_Voda/Negru_Voda_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Negru Voda: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Negru_Voda/Negru_Voda_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Negru Voda: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Negru Voda'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Negru Voda. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Negru Voda is running.")
else:
        pass
