...
def get_atmospheric_data_AB_Abrud(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Alba/Abrud/Abrud_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Abrud: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Alba/Abrud/Abrud_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Abrud: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Abrud'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Abrud. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Abrud is running.")
else:
        pass
