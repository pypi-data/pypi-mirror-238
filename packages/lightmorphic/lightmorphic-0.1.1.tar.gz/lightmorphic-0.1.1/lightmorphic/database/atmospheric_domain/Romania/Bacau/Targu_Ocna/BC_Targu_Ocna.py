...
def get_atmospheric_data_BC_Targu_Ocna(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Bacau/Targu_Ocna/Targu_Ocna_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Targu_Ocna: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Bacau/Targu_Ocna/Targu_Ocna_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Targu_Ocna: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Targu Ocna'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Targu Ocna. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Targu Ocna is running.")
else:
        pass
