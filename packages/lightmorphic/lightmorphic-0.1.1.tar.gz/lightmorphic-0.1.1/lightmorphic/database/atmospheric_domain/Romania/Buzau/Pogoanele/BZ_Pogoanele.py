...
def get_atmospheric_data_BZ_Pogoanele(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Buzau/Pogoanele/Pogoanele_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Pogoanele: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Buzau/Pogoanele/Pogoanele_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Pogoanele: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Pogoanele'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Pogoanele. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Pogoanele is running.")
else:
        pass
