...
def get_atmospheric_data_CT_Techirghiol(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Techirghiol/Techirghiol_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Techirghiol: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Techirghiol/Techirghiol_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Techirghiol: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Techirghiol'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Techirghiol. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Techirghiol is running.")
else:
        pass
