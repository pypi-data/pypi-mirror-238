...
def get_atmospheric_data_SV_Brosteni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Suceava/Brosteni/Brosteni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Brosteni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Suceava/Brosteni/Brosteni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Brosteni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Brosteni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Brosteni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Brosteni is running.')
else:
        pass
