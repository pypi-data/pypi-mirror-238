...
def get_atmospheric_data_IS_Pascani(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Iasi/Pascani/Pascani_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Pascani: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Iasi/Pascani/Pascani_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Pascani: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Pascani'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Pascani. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Pascani is running.')
else:
        pass
