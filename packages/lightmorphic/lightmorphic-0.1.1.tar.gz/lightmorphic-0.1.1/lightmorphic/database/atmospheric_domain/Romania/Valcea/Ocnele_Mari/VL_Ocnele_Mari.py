...
def get_atmospheric_data_VL_Ocnele_Mari(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Valcea/Ocnele_Mari/Ocnele_Mari_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Ocnele Mari: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Valcea/Ocnele_Mari/Ocnele_Mari_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Ocnele Mari: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Ocnele Mari'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Ocnele Mari. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Ocnele Mari is running.')
else:
        pass
