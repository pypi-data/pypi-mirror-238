...
def get_atmospheric_data_TM_Lugoj(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Timis/Lugoj/Lugoj_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Lugoj: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Timis/Lugoj/Lugoj_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Lugoj: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Lugoj'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Lugoj. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Lugoj is running.')
else:
        pass
