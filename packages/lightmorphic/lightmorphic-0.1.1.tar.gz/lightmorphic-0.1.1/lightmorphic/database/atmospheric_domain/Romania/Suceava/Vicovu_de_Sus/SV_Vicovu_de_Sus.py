...
def get_atmospheric_data_SV_Vicovu_de_Sus(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Suceava/Vicovu_de_Sus/Vicovu_de_Sus_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Vicovu de Sus: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Suceava/Vicovu_de_Sus/Vicovu_de_Sus_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Vicovu de Sus: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Vicovu de Sus'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Vicovu de Sus. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Vicovu de Sus is running.')
else:
        pass
