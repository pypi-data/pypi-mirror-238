...
def get_atmospheric_data_SM_Ardud(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Satu_Mare/Ardud/Ardud_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Ardud: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Satu_Mare/Ardud/Ardud_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Ardud: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Ardud'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Ardud. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Ardud is running.')
else:
        pass
