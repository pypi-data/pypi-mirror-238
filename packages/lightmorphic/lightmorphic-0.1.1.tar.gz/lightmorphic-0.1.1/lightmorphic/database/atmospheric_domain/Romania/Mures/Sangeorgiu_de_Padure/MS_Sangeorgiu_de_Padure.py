...
def get_atmospheric_data_MS_Sangeorgiu_de_Padure(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Mures/Sangeorgiu_de_Padure/Sangeorgiu_de_Padure_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Sangeorgiu de Padure: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Mures/Sangeorgiu_de_Padure/Sangeorgiu_de_Padure_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Sangeorgiu de Padure: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Sangeorgiu de Padure'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Sangeorgiu de Padure. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Sangeorgiu de Padure is running.')
else:
        pass
