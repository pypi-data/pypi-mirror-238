...
def get_atmospheric_data_AG_Curtea_de_Arges(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Arges/Curtea_de_Arges/Curtea_de_Arges_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Curtea_de_Arges: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Arges/Curtea_de_Arges/Curtea_de_Arges_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Curtea_de_Arges: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Curtea de Arges'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Curtea de Arges. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Curtea de Arges is running.")
else:
        pass
