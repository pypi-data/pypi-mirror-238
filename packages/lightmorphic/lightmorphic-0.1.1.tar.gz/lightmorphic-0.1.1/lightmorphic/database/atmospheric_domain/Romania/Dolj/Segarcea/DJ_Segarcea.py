...
def get_atmospheric_data_DJ_Segarcea(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Dolj/Segarcea/Segarcea_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Segarcea: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Dolj/Segarcea/Segarcea_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Segarcea: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Segarcea'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Segarcea. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Segarcea is running.")
else:
        pass
