...
def get_atmospheric_data_TM_Sannicolau_Mare(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Timis/Sannicolau_Mare/Sannicolau_Mare_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Sannicolau Mare: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Timis/Sannicolau_Mare/Sannicolau_Mare_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Sannicolau Mare: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Sannicolau Mare'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Sannicolau Mare. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Sannicolau Mare is running.')
else:
        pass
