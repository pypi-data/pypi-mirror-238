...
def get_atmospheric_data_IF_Chitila(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Ilfov/Chitila/Chitila_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Chitila: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Ilfov/Chitila/Chitila_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Chitila: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Chitila'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Chitila. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Chitila is running.')
else:
        pass
