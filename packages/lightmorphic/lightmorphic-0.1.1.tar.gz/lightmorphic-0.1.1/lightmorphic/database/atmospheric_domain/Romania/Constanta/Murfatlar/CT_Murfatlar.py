...
def get_atmospheric_data_CT_Murfatlar(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Murfatlar/Murfatlar_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Murfatlar: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Murfatlar/Murfatlar_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Murfatlar: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Murfatlar'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Murfatlar. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Murfatlar is running.")
else:
        pass
