...
def get_atmospheric_data_BT_Botosani(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Botosani/Botosani/Botosani_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Botosani: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Botosani/Botosani/Botosani_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Botosani: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Botosani'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Botosani. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Botosani is running.")
else:
        pass
