...
def get_atmospheric_data_PH_Boldesti_Scaeni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Boldesti_Scaeni/Boldesti_Scaeni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Boldesti Scaeni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Boldesti_Scaeni/Boldesti_Scaeni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Boldesti Scaeni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Boldesti Scaeni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Boldesti Scaeni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Boldesti Scaeni is running.')
else:
        pass
