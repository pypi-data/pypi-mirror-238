...
def get_atmospheric_data_BT_Flamanzi(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Botosani/Flamanzi/Flamanzi_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Flamanzi: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Botosani/Flamanzi/Flamanzi_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Flamanzi: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Flamanzi'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Flamanzi. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Flamanzi is running.")
else:
        pass
