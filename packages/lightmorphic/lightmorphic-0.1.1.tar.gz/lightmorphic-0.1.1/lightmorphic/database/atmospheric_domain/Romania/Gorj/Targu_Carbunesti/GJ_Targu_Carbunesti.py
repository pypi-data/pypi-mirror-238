...
def get_atmospheric_data_GJ_Targu_Carbunesti(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Gorj/Targu_Carbunesti/Targu_Carbunesti_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Targu Carbunesti: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Gorj/Targu_Carbunesti/Targu_Carbunesti_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Targu Carbunesti: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Targu Carbunesti'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Targu Carbunesti. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Targu Carbunesti is running.")
else:
        pass
