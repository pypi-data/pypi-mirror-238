...
def get_atmospheric_data_AB_Sebes(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Alba/Sebes/Sebes_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Sebes: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Alba/Sebes/Sebes_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Sebes: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Sebes'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Sebes. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Sebes is running.")
else:
        pass
