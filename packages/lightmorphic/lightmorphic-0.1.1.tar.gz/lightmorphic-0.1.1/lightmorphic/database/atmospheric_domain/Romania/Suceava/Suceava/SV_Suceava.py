...
def get_atmospheric_data_SV_Suceava(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Suceava/Suceava/Suceava_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Suceava: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Suceava/Suceava/Suceava_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Suceava: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Suceava'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Suceava. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Suceava is running.')
else:
        pass
