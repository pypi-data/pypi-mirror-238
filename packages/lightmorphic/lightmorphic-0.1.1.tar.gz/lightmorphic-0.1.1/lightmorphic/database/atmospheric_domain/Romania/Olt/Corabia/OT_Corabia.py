...
def get_atmospheric_data_OT_Corabia(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Olt/Corabia/Corabia_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Corabia: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Olt/Corabia/Corabia_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Corabia: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Corabia'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Corabia. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Corabia is running.')
else:
        pass
