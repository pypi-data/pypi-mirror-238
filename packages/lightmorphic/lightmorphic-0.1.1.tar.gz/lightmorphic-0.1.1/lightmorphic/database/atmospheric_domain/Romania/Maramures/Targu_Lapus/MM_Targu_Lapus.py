...
def get_atmospheric_data_MM_Targu_Lapus(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Targu_Lapus/Targu_Lapus_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Targu Lapus: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Targu_Lapus/Targu_Lapus_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Targu Lapus: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Targu Lapus'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Targu Lapus. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Targu Lapus is running.')
else:
        pass
