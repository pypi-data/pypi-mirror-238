...
def get_atmospheric_data_SB_Medias(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Sibiu/Medias/Medias_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Medias: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Sibiu/Medias/Medias_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Medias: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Medias'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Medias. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Medias is running.')
else:
        pass
