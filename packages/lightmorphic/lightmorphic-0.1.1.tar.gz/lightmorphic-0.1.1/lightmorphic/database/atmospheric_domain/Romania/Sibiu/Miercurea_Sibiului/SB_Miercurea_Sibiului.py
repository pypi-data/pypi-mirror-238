...
def get_atmospheric_data_SB_Miercurea_Sibiului(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Sibiu/Miercurea_Sibiului/Miercurea_Sibiului_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Miercurea Sibiului: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Sibiu/Miercurea_Sibiului/Miercurea_Sibiului_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Miercurea Sibiului: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Miercurea Sibiului'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Miercurea Sibiului. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Miercurea Sibiului is running.')
else:
        pass
