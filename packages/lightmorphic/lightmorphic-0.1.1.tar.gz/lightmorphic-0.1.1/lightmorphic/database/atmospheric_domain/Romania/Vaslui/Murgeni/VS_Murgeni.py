...
def get_atmospheric_data_VS_Murgeni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Vaslui/Murgeni/Murgeni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Murgeni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Vaslui/Murgeni/Murgeni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Murgeni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Murgeni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Murgeni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Murgeni is running.')
else:
        pass
