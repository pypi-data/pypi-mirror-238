...
def get_atmospheric_data_AB_Campeni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Alba/Campeni/Campeni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Campeni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Alba/Campeni/Campeni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Campeni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Campeni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Campeni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Campeni is running.")
else:
        pass
