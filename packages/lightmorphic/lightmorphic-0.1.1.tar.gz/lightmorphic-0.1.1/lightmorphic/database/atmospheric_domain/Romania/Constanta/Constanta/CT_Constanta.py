...
def get_atmospheric_data_CT_Constanta(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Constanta/Constanta_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Constanta: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Constanta/Constanta_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Constanta: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Constanta'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Constanta. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Constanta is running.")
else:
        pass
