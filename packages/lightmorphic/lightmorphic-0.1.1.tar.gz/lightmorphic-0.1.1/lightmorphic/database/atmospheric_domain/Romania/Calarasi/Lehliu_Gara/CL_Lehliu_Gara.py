...
def get_atmospheric_data_CL_Lehliu_Gara(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Calarasi/Lehliu_Gara/Lehliu_Gara_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Lehliu_Gara: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Calarasi/Lehliu_Gara/Lehliu_Gara_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Lehliu_Gara: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Lehliu Gara'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Lehliu Gara. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Lehliu Gara is running.")
else:
        pass
