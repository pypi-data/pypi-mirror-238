...
def get_atmospheric_data_BC_Slanic_Moldova(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Bacau/Slanic_Moldova/Slanic_Moldova_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Slanic_Moldova: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Bacau/Slanic_Moldova/Slanic_Moldova_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Slanic_Moldova: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Slanic Moldova'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Slanic Moldova. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Slanic Moldova is running.")
else:
        pass
