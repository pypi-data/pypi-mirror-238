...
def get_atmospheric_data_MH_Orsova(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Mehedinti/Orsova/Orsova_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Orsova: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Mehedinti/Orsova/Orsova_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Orsova: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Orsova'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Orsova. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Orsova is running.')
else:
        pass
