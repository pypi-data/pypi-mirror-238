...
def get_atmospheric_data_SV_Cajvana(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Suceava/Cajvana/Cajvana_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Cajvana: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Suceava/Cajvana/Cajvana_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Cajvana: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Cajvana'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Cajvana. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Cajvana is running.')
else:
        pass
