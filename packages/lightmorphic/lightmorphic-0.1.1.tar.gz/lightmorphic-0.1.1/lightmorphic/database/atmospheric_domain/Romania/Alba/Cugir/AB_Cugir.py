...
def get_atmospheric_data_AB_Cugir(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Alba/Cugir/Cugir_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Cugir: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Alba/Cugir/Cugir_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Cugir: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Cugir'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Cugir. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Cugir is running.")
else:
        pass
