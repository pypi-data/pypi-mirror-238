...
def get_atmospheric_data_TM_Ciacova(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Timis/Ciacova/Ciacova_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Ciacova: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Timis/Ciacova/Ciacova_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Ciacova: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Ciacova'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Ciacova. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Ciacova is running.')
else:
        pass
