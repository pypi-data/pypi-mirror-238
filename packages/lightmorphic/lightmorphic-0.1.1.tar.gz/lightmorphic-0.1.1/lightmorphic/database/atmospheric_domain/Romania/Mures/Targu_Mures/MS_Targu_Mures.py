...
def get_atmospheric_data_MS_Targu_Mures(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Mures/Targu_Mures/Targu_Mures_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Targu Mures: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Mures/Targu_Mures/Targu_Mures_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Targu Mures: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Targu Mures'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Targu Mures. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Targu Mures is running.')
else:
        pass
