...
def get_atmospheric_data_GJ_Bumbesti_Jiu(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Gorj/Bumbesti_Jiu/Bumbesti_Jiu_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Bumbesti Jiu: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Gorj/Bumbesti_Jiu/Bumbesti_Jiu_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Bumbesti Jiu: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Bumbesti Jiu'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Bumbesti Jiu. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Bumbesti Jiu is running.")
else:
        pass
