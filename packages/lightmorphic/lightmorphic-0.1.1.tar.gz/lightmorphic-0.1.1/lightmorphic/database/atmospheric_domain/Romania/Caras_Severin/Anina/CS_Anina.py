...
def get_atmospheric_data_CS_Anina(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Caras_Severin/Anina/Anina_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Anina: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Caras_Severin/Anina/Anina_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Anina: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Anina'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Anina. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Anina is running.")
else:
        pass
