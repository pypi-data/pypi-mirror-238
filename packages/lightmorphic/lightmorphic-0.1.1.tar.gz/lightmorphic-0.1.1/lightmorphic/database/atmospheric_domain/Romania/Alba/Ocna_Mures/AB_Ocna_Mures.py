...
def get_atmospheric_data_AB_Ocna_Mures(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Alba/Ocna_Mures/Ocna_Mures_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Ocna_Mures: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Alba/Ocna_Mures/Ocna_Mures_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Ocna_Mures: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Ocna Mures'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Ocna Mures. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Ocna Mures is running.")
else:
        pass
