...
def get_atmospheric_data_SB_Saliste(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Sibiu/Saliste/Saliste_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Saliste: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Sibiu/Saliste/Saliste_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Saliste: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Saliste'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Saliste. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Saliste is running.')
else:
        pass
