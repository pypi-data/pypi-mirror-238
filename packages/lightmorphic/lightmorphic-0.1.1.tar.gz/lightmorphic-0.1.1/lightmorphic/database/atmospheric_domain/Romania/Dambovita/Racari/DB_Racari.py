...
def get_atmospheric_data_DB_Racari(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Dambovita/Racari/Racari_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Racari: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Dambovita/Racari/Racari_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Racari: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Racari'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Racari. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Racari is running.")
else:
        pass
