...
def get_atmospheric_data_BH_Salonta(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Bihor/Salonta/Salonta_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Salonta: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Bihor/Salonta/Salonta_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Salonta: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Salonta'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Salonta. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Salonta is running.")
else:
        pass
