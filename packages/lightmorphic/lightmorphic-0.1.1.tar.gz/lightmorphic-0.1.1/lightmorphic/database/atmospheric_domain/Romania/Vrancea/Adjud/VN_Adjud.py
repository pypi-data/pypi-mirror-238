...
def get_atmospheric_data_VN_Adjud(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Vrancea/Adjud/Adjud_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Adjud: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Vrancea/Adjud/Adjud_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Adjud: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Adjud'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Adjud. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Adjud is running.')
else:
        pass
