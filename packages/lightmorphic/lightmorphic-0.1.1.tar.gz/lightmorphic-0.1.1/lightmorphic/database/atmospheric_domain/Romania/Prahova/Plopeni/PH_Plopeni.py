...
def get_atmospheric_data_PH_Plopeni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Plopeni/Plopeni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Plopeni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Plopeni/Plopeni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Plopeni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Plopeni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Plopeni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Plopeni is running.')
else:
        pass
