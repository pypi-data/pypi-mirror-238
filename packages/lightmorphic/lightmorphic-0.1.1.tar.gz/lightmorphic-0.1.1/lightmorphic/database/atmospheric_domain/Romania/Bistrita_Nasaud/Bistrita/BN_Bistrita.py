...
def get_atmospheric_data_BN_Bistrita(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Bistrita_Nasaud/Bistrita/Bistrita_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Bistrita: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Bistrita_Nasaud/Bistrita/Bistrita_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Bistrita: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Bistrita'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Bistrita. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Bistrita is running.")
else:
        pass
