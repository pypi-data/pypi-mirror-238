...
def get_atmospheric_data_CS_Baile_Herculane(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Caras_Severin/Baile_Herculane/Baile_Herculane_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Baile Herculane: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Caras_Severin/Baile_Herculane/Baile_Herculane_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Baile Herculane: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Baile Herculane'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Baile Herculane. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Baile Herculane is running.")
else:
        pass
