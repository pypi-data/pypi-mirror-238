...
def get_atmospheric_data_CT_Harsova(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Harsova/Harsova_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Harsova: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Harsova/Harsova_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Harsova: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Harsova'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Harsova. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Harsova is running.")
else:
        pass
