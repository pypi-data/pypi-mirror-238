...
def get_atmospheric_data_SV_Vatra_Dornei(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Suceava/Vatra_Dornei/Vatra_Dornei_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Vatra Dornei: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Suceava/Vatra_Dornei/Vatra_Dornei_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Vatra Dornei: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Vatra Dornei'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Vatra Dornei. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Vatra Dornei is running.')
else:
        pass
