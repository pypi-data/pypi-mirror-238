...
def get_atmospheric_data_BC_Darmanesti(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Bacau/Darmanesti/Darmanesti_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Darmanesti: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Bacau/Darmanesti/Darmanesti_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Darmanesti: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Darmanesti'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Darmanesti. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Darmanesti is running.")
else:
        pass
