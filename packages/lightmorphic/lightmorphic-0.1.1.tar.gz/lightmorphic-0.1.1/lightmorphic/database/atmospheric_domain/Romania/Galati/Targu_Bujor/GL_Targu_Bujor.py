...
def get_atmospheric_data_GL_Targu_Bujor(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Galati/Targu_Bujor/Targu_Bujor_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Targu Bujor: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Galati/Targu_Bujor/Targu_Bujor_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Targu Bujor: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Targu Bujor'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Targu Bujor. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Targu Bujor is running.")
else:
        pass
