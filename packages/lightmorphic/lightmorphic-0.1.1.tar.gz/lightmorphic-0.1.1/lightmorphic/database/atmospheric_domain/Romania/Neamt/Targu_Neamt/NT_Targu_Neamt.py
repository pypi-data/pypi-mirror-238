...
def get_atmospheric_data_NT_Targu_Neamt(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Neamt/Targu_Neamt/Targu_Neamt_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Targu Neamt: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Neamt/Targu_Neamt/Targu_Neamt_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Targu Neamt: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Targu Neamt'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Targu Neamt. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Targu Neamt is running.')
else:
        pass
