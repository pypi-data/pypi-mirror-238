...
def get_atmospheric_data_PH_Busteni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Busteni/Busteni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Busteni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Prahova/Busteni/Busteni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Busteni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Busteni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Busteni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Busteni is running.')
else:
        pass
