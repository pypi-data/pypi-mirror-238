...
def get_atmospheric_data_DJ_Filiasi(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Dolj/Filiasi/Filiasi_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Filiasi: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Dolj/Filiasi/Filiasi_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Filiasi: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Filiasi'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Filiasi. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Filiasi is running.")
else:
        pass
