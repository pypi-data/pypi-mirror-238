...
def get_atmospheric_data_IS_Targu_Frumos(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Iasi/Targu_Frumos/Targu_Frumos_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Targu_Frumos: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Iasi/Targu_Frumos/Targu_Frumos_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Targu_Frumos: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)

#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Targu Frumos'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Targu Frumos. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Targu Frumos is running.')
else:
        pass
