...
def get_atmospheric_data_SB_Copsa_Mica(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Sibiu/Copsa_Mica/Copsa_Mica_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Copsa Mica: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Sibiu/Copsa_Mica/Copsa_Mica_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Copsa Mica: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Copsa Mica'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Copsa Mica. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Copsa Mica is running.')
else:
        pass
