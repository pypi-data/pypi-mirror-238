...
def get_atmospheric_data_MS_Ungheni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Mures/Ungheni/Ungheni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Ungheni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Mures/Ungheni/Ungheni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Ungheni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Ungheni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Ungheni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Ungheni is running.')
else:
        pass
