...
def get_atmospheric_data_BR_Ianca(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Braila/Ianca/Ianca_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Ianca: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Braila/Ianca/Ianca_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Ianca: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Ianca'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Ianca. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Ianca is running.")
else:
        pass
