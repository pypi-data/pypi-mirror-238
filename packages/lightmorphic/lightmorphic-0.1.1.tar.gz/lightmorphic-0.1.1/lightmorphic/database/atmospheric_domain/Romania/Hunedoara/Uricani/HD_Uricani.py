...
def get_atmospheric_data_HD_Uricani(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Hunedoara/Uricani/Uricani_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Uricani: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Hunedoara/Uricani/Uricani_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Uricani: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Uricani'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Uricani. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Uricani is running.")
else:
        pass
