...
def get_atmospheric_data_TL_Isaccea(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Tulcea/Isaccea/Isaccea_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Isaccea: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Tulcea/Isaccea/Isaccea_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Isaccea: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Isaccea'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Isaccea. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Isaccea is running.')
else:
        pass
