...
def get_atmospheric_data_VL_Horezu(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Valcea/Horezu/Horezu_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Horezu: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Valcea/Horezu/Horezu_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Horezu: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Horezu'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Horezu. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Horezu is running.')
else:
        pass
