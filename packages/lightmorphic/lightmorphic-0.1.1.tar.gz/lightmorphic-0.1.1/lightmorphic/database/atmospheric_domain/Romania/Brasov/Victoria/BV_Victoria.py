...
def get_atmospheric_data_BV_Victoria(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Brasov/Victoria/Victoria_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Victoria: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Brasov/Victoria/Victoria_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Victoria: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Victoria'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Victoria. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Victoria is running.")
else:
        pass
