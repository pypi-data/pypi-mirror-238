...
def get_atmospheric_data_CT_Cernavoda(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Cernavoda/Cernavoda_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Cernavoda: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Cernavoda/Cernavoda_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Cernavoda: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Cernavoda'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Cernavoda. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Cernavoda is running.")
else:
        pass
