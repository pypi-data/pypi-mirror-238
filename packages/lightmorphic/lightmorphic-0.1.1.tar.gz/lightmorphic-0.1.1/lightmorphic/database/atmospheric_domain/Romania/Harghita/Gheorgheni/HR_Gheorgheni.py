...
def get_atmospheric_data_HR_Gheorgheni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Harghita/Gheorgheni/Gheorgheni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Gheorgheni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Harghita/Gheorgheni/Gheorgheni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Gheorgheni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Gheorgheni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Gheorgheni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Gheorgheni is running.")
else:
        pass
