...
def get_atmospheric_data_BV_Predeal(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Brasov/Predeal/Predeal_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Predeal: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Brasov/Predeal/Predeal_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Predeal: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Predeal'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Predeal. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Predeal is running.")
else:
        pass
