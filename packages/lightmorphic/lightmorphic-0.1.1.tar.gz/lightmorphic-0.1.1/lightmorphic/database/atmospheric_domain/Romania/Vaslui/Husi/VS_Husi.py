...
def get_atmospheric_data_VS_Husi(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Vaslui/Husi/Husi_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Husi: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Vaslui/Husi/Husi_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Husi: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Husi'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Husi. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Husi is running.')
else:
        pass
