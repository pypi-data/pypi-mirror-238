...
def get_atmospheric_data_MM_Tautii_Magheraus(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Tautii_Magheraus/Tautii_Magheraus_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Tautii Magheraus: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Maramures/Tautii_Magheraus/Tautii_Magheraus_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Tautii Magheraus: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Tautii Magheraus'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Tautii Magheraus. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Tautii Magheraus is running.')
else:
        pass
