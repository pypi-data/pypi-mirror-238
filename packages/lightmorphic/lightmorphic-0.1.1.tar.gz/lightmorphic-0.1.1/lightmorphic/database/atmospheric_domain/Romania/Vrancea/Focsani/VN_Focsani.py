...
def get_atmospheric_data_VN_Focsani(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Vrancea/Focsani/Focsani_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Focsani: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Vrancea/Focsani/Focsani_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Focsani: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Focsani'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Focsani. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Focsani is running.')
else:
        pass
