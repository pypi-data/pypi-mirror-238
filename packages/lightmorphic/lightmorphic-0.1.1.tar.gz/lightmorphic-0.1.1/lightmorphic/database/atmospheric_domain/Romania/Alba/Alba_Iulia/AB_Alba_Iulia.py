...
def get_atmospheric_data_AB_Alba_Iulia(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Alba/Alba_Iulia/Alba_Iulia_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Alba_Iulia: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Alba/Alba_Iulia/Alba_Iulia_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Alba_Iulia: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Alba Iulia'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Alba Iulia. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
    print("The atmospheric data for Alba Iulia is running.")
else:
    pass
