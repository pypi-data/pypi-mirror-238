...
def get_atmospheric_data_BZ_Ramnicu_Sarat(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Buzau/Ramnicu_Sarat/Ramnicu_Sarat_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Ramnicu_Sarat: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Buzau/Ramnicu_Sarat/Ramnicu_Sarat_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Ramnicu_Sarat: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Ramnicu Sarat'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Ramnicu Sarat. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Ramnicu Sarat is running.")
else:
        pass
