...
def get_atmospheric_data_CT_Navodari(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Navodari/Navodari_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Navodari: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Constanta/Navodari/Navodari_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Navodari: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Navodari'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Navodari. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Navodari is running.")
else:
        pass
