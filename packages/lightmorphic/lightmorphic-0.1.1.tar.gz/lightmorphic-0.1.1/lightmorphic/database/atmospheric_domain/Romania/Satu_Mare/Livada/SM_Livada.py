...
def get_atmospheric_data_SM_Livada(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Satu_Mare/Livada/Livada_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Livada: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Satu_Mare/Livada/Livada_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Livada: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Livada'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Livada. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Livada is running.')
else:
        pass
