...
def get_atmospheric_data_IL_Cazanesti(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Ialomita/Cazanesti/Cazanesti_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Cazanesti: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Ialomita/Cazanesti/Cazanesti_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Cazanesti: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Cazanesti'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Cazanesti. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Cazanesti is running.")
else:
        pass
