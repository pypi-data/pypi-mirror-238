...
def get_atmospheric_data_CS_Otelu_Rosu(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Caras_Severin/Otelu_Rosu/Otelu_Rosu_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Otelu Rosu: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Caras_Severin/Otelu_Rosu/Otelu_Rosu_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Otelu Rosu: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Otelu Rosu'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Otelu Rosu. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Otelu Rosu is running.")
else:
        pass
