...
def get_atmospheric_data_NT_Roznov(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Neamt/Roznov/Roznov_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Roznov: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Neamt/Roznov/Roznov_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Roznov: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Roznov'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Roznov. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Roznov is running.')
else:
        pass
