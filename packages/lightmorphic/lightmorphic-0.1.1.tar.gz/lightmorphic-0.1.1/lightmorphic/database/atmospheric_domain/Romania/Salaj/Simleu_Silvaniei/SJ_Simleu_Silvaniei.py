...
def get_atmospheric_data_SJ_Simleu_Silvaniei(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Salaj/Simleu_Silvaniei/Simleu_Silvaniei_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Simleu Silvaniei: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Salaj/Simleu_Silvaniei/Simleu_Silvaniei_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Simleu Silvaniei: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Simleu Silvaniei'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Simleu Silvaniei. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Simleu Silvaniei is running.')
else:
        pass
