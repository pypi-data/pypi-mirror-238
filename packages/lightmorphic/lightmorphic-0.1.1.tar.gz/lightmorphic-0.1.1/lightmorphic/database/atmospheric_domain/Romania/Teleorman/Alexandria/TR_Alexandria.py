...
def get_atmospheric_data_TR_Alexandria(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Teleorman/Alexandria/Alexandria_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Alexandria: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Teleorman/Alexandria/Alexandria_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Alexandria: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Alexandria'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Alexandria. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Alexandria is running.')
else:
        pass
