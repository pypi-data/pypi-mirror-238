...
def get_atmospheric_data_HD_Lupeni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Hunedoara/Lupeni/Lupeni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Lupeni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Hunedoara/Lupeni/Lupeni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Lupeni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Lupeni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Lupeni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Lupeni is running.")
else:
        pass
