...
def get_atmospheric_data_GL_Tecuci(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Galati/Tecuci/Tecuci_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Tecuci: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Galati/Tecuci/Tecuci_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Tecuci: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Tecuci'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Tecuci. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Tecuci is running.")
else:
        pass
