...
def get_atmospheric_data_BT_Bucecea(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Botosani/Bucecea/Bucecea_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Bucecea: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Botosani/Bucecea/Bucecea_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Bucecea: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Bucecea'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Bucecea. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Bucecea is running.")
else:
        pass
