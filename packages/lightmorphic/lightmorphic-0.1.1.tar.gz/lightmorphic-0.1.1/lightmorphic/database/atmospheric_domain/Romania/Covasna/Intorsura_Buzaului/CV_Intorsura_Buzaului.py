...
def get_atmospheric_data_CV_Intorsura_Buzaului(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Covasna/Intorsura_Buzaului/Intorsura_Buzaului_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Intorsura Buzaului: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Covasna/Intorsura_Buzaului/Intorsura_Buzaului_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Intorsura Buzaului: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Intorsura Buzaului'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Intorsura Buzaului. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Intorsura Buzaului is running.")
else:
        pass
