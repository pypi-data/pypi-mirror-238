...
def get_atmospheric_data_AG_Stefanesti(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Arges/Stefanesti/Stefanesti_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Stefanesti: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Arges/Stefanesti/Stefanesti_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Stefanesti: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Stefanesti'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Stefanesti(AG). Check if the appid is correct. ')
#************************************************************
