...
def get_atmospheric_data_BH_Sacueni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Bihor/Sacueni/Sacueni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Sacueni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Bihor/Sacueni/Sacueni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Sacueni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Sacueni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Sacueni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Sacueni is running.")
else:
        pass
