...
def get_atmospheric_data_SV_Liteni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Suceava/Liteni/Liteni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Liteni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Suceava/Liteni/Liteni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Liteni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Liteni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Liteni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print('The atmospheric data for Liteni is running.')
else:
        pass
