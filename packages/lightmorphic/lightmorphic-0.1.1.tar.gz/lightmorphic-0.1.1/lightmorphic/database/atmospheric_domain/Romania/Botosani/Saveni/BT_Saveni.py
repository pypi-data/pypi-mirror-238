...
def get_atmospheric_data_BT_Saveni(adress):
    try:
...
#************************************************************
        with open('lightmorphic/database/atmospheric_domain/Romania/Botosani/Saveni/Saveni_atmospheric_domain_archive_all.txt', 'a') as data_all:
                Y = ["Saveni: ", str(timp),"\n", str(weather_data), "\n","\n"]
                data_all.writelines(Y)

        with open('lightmorphic/database/atmospheric_domain/Romania/Botosani/Saveni/Saveni_atmospheric_domain_archive.txt', 'a') as data_file:
                X = ["Saveni: ", str(timp),"\n", varX, "\n"]
                data_file.writelines(X)
#************************************************************
        print('{}: successfully retrieved the atmospheric data.'.format('Saveni'))
    except Exception:
        print('\n !!!Error!!! \n Didn\'t retrieve the atmospheric data for Saveni. Check if the appid is correct. ')
#************************************************************
if __name__ == "__main__":
        print("The atmospheric data for Saveni is running.")
else:
        pass
