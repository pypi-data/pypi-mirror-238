...
class ClusterSecretResponse(object):
    ...
    def __init__(self, namespace=None, secret=None):  # noqa: E501
        """ClusterSecretResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def namespace(self):
        """Gets the namespace of this ClusterSecretResponse.  # noqa: E501

        Namespace to look for the Kubernetes secret definition in.  # noqa: E501

        :return: The namespace of this ClusterSecretResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        """Sets the namespace of this ClusterSecretResponse.

        Namespace to look for the Kubernetes secret definition in.  # noqa: E501

        :param namespace: The namespace of this ClusterSecretResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def secret(self):
        """Gets the secret of this ClusterSecretResponse.  # noqa: E501

        Name that identifies the Kubernetes secret.  # noqa: E501

        :return: The secret of this ClusterSecretResponse.  # noqa: E501
        :rtype: str
        """
        return self._secret
    ...
    def secret(self, secret):
        """Sets the secret of this ClusterSecretResponse.

        Name that identifies the Kubernetes secret.  # noqa: E501

        :param secret: The secret of this ClusterSecretResponse.  # noqa: E501
        :type: str
        """
        if secret is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClusterSecretResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterSecretResponse):
            return False
