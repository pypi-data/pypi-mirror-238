...
class ApplicationCreationRequest(object):
    ...
    def __init__(self, env=None, id=None, name=None):  # noqa: E501
        """ApplicationCreationRequest - a model defined in Swagger"""  # noqa: E501
        self._env = None
        self._id = None
        self._name = None
    ...
    @property
    def env(self):
        """Gets the env of this ApplicationCreationRequest.  # noqa: E501


        :return: The env of this ApplicationCreationRequest.  # noqa: E501
        :rtype: EnvironmentBaseRequest
        """
        return self._env

    @env.setter
    def env(self, env):
        """Sets the env of this ApplicationCreationRequest.


        :param env: The env of this ApplicationCreationRequest.  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this ApplicationCreationRequest.  # noqa: E501

        The ID which refers to a specific application.  # noqa: E501

        :return: The id of this ApplicationCreationRequest.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ApplicationCreationRequest.

        The ID which refers to a specific application.  # noqa: E501

        :param id: The id of this ApplicationCreationRequest.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def name(self):
        """Gets the name of this ApplicationCreationRequest.  # noqa: E501

        The Human-friendly name for the Application.  # noqa: E501

        :return: The name of this ApplicationCreationRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ApplicationCreationRequest.

        The Human-friendly name for the Application.  # noqa: E501

        :param name: The name of this ApplicationCreationRequest.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApplicationCreationRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApplicationCreationRequest):
            return False
