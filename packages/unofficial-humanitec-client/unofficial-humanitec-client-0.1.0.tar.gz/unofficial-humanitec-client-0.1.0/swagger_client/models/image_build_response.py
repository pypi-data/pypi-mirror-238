...
class ImageBuildResponse(object):
    ...
    def __init__(self, added_at=None, branch=None, commit=None, image=None, tags=None):  # noqa: E501
        """ImageBuildResponse - a model defined in Swagger"""  # noqa: E501
        self._added_at = None
        self._branch = None
        self._commit = None
        self._image = None
    ...
    @property
    def added_at(self):
        """Gets the added_at of this ImageBuildResponse.  # noqa: E501

        The time when the build was added to Humanitec.  # noqa: E501

        :return: The added_at of this ImageBuildResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def added_at(self, added_at):
        """Sets the added_at of this ImageBuildResponse.

        The time when the build was added to Humanitec.  # noqa: E501

        :param added_at: The added_at of this ImageBuildResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def branch(self):
        """Gets the branch of this ImageBuildResponse.  # noqa: E501

        The branch name of the branch the build was built on  # noqa: E501

        :return: The branch of this ImageBuildResponse.  # noqa: E501
        :rtype: str
        """
        return self._branch
    ...
    def branch(self, branch):
        """Sets the branch of this ImageBuildResponse.

        The branch name of the branch the build was built on  # noqa: E501

        :param branch: The branch of this ImageBuildResponse.  # noqa: E501
        :type: str
        """
        if branch is None:
    ...
    @property
    def commit(self):
        """Gets the commit of this ImageBuildResponse.  # noqa: E501

        The commit ID that this build was built from.  # noqa: E501

        :return: The commit of this ImageBuildResponse.  # noqa: E501
        :rtype: str
        """
        return self._commit
    ...
    def commit(self, commit):
        """Sets the commit of this ImageBuildResponse.

        The commit ID that this build was built from.  # noqa: E501

        :param commit: The commit of this ImageBuildResponse.  # noqa: E501
        :type: str
        """
        if commit is None:
    ...
    @property
    def image(self):
        """Gets the image of this ImageBuildResponse.  # noqa: E501

        The fully qualified Image URL including registry, repository and tag.  # noqa: E501

        :return: The image of this ImageBuildResponse.  # noqa: E501
        :rtype: str
        """
        return self._image
    ...
    def image(self, image):
        """Sets the image of this ImageBuildResponse.

        The fully qualified Image URL including registry, repository and tag.  # noqa: E501

        :param image: The image of this ImageBuildResponse.  # noqa: E501
        :type: str
        """
        if image is None:
    ...
    @property
    def tags(self):
        """Gets the tags of this ImageBuildResponse.  # noqa: E501

        The tag that the build was built from.  # noqa: E501

        :return: The tags of this ImageBuildResponse.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this ImageBuildResponse.

        The tag that the build was built from.  # noqa: E501

        :param tags: The tags of this ImageBuildResponse.  # noqa: E501
        :type: list[str]
        """
        if tags is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ImageBuildResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ImageBuildResponse):
            return False
