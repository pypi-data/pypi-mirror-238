...
class EnvironmentTypeResponse(object):
    ...
    def __init__(self, description=None, id=None):  # noqa: E501
        """EnvironmentTypeResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this EnvironmentTypeResponse.  # noqa: E501

        A Human-readable description of the Environment Type  # noqa: E501

        :return: The description of this EnvironmentTypeResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this EnvironmentTypeResponse.

        A Human-readable description of the Environment Type  # noqa: E501

        :param description: The description of this EnvironmentTypeResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this EnvironmentTypeResponse.  # noqa: E501

        The ID of the Environment Type. (Must be unique within an Organization.)  # noqa: E501

        :return: The id of this EnvironmentTypeResponse.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this EnvironmentTypeResponse.

        The ID of the Environment Type. (Must be unique within an Organization.)  # noqa: E501

        :param id: The id of this EnvironmentTypeResponse.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnvironmentTypeResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnvironmentTypeResponse):
            return False
