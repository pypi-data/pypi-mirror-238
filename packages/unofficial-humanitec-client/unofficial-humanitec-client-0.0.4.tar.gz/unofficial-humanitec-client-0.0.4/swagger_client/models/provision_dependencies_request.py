...
class ProvisionDependenciesRequest(object):
    ...
    def __init__(self, is_dependent=None, match_dependents=None):  # noqa: E501
        """ProvisionDependenciesRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def is_dependent(self):
        """Gets the is_dependent of this ProvisionDependenciesRequest.  # noqa: E501

        If the co-provisioned resource is dependendent on the current one.  # noqa: E501

        :return: The is_dependent of this ProvisionDependenciesRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_dependent(self, is_dependent):
        """Sets the is_dependent of this ProvisionDependenciesRequest.

        If the co-provisioned resource is dependendent on the current one.  # noqa: E501

        :param is_dependent: The is_dependent of this ProvisionDependenciesRequest.  # noqa: E501
        :type: bool
        """
    ...
    def match_dependents(self):
        """Gets the match_dependents of this ProvisionDependenciesRequest.  # noqa: E501

        If the resources dependant on the main resource, are also dependant on the co-provisioned one.  # noqa: E501

        :return: The match_dependents of this ProvisionDependenciesRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def match_dependents(self, match_dependents):
        """Sets the match_dependents of this ProvisionDependenciesRequest.

        If the resources dependant on the main resource, are also dependant on the co-provisioned one.  # noqa: E501

        :param match_dependents: The match_dependents of this ProvisionDependenciesRequest.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProvisionDependenciesRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProvisionDependenciesRequest):
            return False
