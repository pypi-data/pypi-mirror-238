...
class EnvironmentBaseRequest(object):
    ...
    def __init__(self, id=None, name=None, type=None):  # noqa: E501
        """EnvironmentBaseRequest - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
        self._type = None
    ...
    @property
    def id(self):
        """Gets the id of this EnvironmentBaseRequest.  # noqa: E501

        The ID the Environment is referenced as.  # noqa: E501

        :return: The id of this EnvironmentBaseRequest.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this EnvironmentBaseRequest.

        The ID the Environment is referenced as.  # noqa: E501

        :param id: The id of this EnvironmentBaseRequest.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def name(self):
        """Gets the name of this EnvironmentBaseRequest.  # noqa: E501

        The Human-friendly name for the Environment.  # noqa: E501

        :return: The name of this EnvironmentBaseRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this EnvironmentBaseRequest.

        The Human-friendly name for the Environment.  # noqa: E501

        :param name: The name of this EnvironmentBaseRequest.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def type(self):
        """Gets the type of this EnvironmentBaseRequest.  # noqa: E501

        The Environment Type. This is used for organizing and managing Environments.  # noqa: E501

        :return: The type of this EnvironmentBaseRequest.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this EnvironmentBaseRequest.

        The Environment Type. This is used for organizing and managing Environments.  # noqa: E501

        :param type: The type of this EnvironmentBaseRequest.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EnvironmentBaseRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnvironmentBaseRequest):
            return False
