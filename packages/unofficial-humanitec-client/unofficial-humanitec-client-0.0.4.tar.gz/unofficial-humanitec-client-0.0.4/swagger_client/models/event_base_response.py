...
class EventBaseResponse(object):
    ...
    def __init__(self, scope=None, type=None):  # noqa: E501
        """EventBaseResponse - a model defined in Swagger"""  # noqa: E501
        self._scope = None
        self._type = None
    ...
    @property
    def scope(self):
        """Gets the scope of this EventBaseResponse.  # noqa: E501

        Event scope  # noqa: E501

        :return: The scope of this EventBaseResponse.  # noqa: E501
        :rtype: str
        """
        return self._scope
    ...
    def scope(self, scope):
        """Sets the scope of this EventBaseResponse.

        Event scope  # noqa: E501

        :param scope: The scope of this EventBaseResponse.  # noqa: E501
        :type: str
        """
        if scope is None:
    ...
    @property
    def type(self):
        """Gets the type of this EventBaseResponse.  # noqa: E501

        Event type  # noqa: E501

        :return: The type of this EventBaseResponse.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this EventBaseResponse.

        Event type  # noqa: E501

        :param type: The type of this EventBaseResponse.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EventBaseResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EventBaseResponse):
            return False
