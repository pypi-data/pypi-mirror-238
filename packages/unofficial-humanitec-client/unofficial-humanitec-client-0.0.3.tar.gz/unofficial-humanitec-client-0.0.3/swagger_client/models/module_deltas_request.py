...
class ModuleDeltasRequest(object):
    ...
    """
    swagger_types = {
        'add': 'dict(str, ModuleRequest)',
        'remove': 'list[str]',
        'update': 'dict(str, list[UpdateActionRequest])'
    }
    ...
    def __init__(self, add=None, remove=None, update=None):  # noqa: E501
        """ModuleDeltasRequest - a model defined in Swagger"""  # noqa: E501
        self._add = None
        self._remove = None
        self._update = None
    ...
    @property
    def add(self):
        """Gets the add of this ModuleDeltasRequest.  # noqa: E501


        :return: The add of this ModuleDeltasRequest.  # noqa: E501
        :rtype: dict(str, ModuleRequest)
        """
        return self._add

    @add.setter
    def add(self, add):
        """Sets the add of this ModuleDeltasRequest.


        :param add: The add of this ModuleDeltasRequest.  # noqa: E501
        :type: dict(str, ModuleRequest)
        """
    ...
    @property
    def remove(self):
        """Gets the remove of this ModuleDeltasRequest.  # noqa: E501


        :return: The remove of this ModuleDeltasRequest.  # noqa: E501
        :rtype: list[str]
        """
        return self._remove
    ...
    def remove(self, remove):
        """Sets the remove of this ModuleDeltasRequest.


        :param remove: The remove of this ModuleDeltasRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def update(self):
        """Gets the update of this ModuleDeltasRequest.  # noqa: E501


        :return: The update of this ModuleDeltasRequest.  # noqa: E501
        :rtype: dict(str, list[UpdateActionRequest])
        """
        return self._update

    @update.setter
    def update(self, update):
        """Sets the update of this ModuleDeltasRequest.


        :param update: The update of this ModuleDeltasRequest.  # noqa: E501
        :type: dict(str, list[UpdateActionRequest])
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ModuleDeltasRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModuleDeltasRequest):
            return False
