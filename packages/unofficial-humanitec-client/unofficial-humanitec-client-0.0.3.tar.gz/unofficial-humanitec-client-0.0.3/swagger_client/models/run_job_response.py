...
import six
from swagger_client.models.run_job_list_response import RunJobListResponse  # noqa: F401,E501

class RunJobResponse(RunJobListResponse):
    ...
    if hasattr(RunJobListResponse, "swagger_types"):
        swagger_types.update(RunJobListResponse.swagger_types)

    attribute_map = {
        'steps': 'steps'
    }
    if hasattr(RunJobListResponse, "attribute_map"):
        attribute_map.update(RunJobListResponse.attribute_map)

    def __init__(self, steps=None, *args, **kwargs):  # noqa: E501
        """RunJobResponse - a model defined in Swagger"""  # noqa: E501
        self._steps = None
        self.discriminator = None
        if steps is not None:
            self.steps = steps
        RunJobListResponse.__init__(self, *args, **kwargs)

    @property
    def steps(self):
        """Gets the steps of this RunJobResponse.  # noqa: E501

        The collection of Steps that completed along with the current Step being executed.  # noqa: E501

        :return: The steps of this RunJobResponse.  # noqa: E501
        :rtype: list[RunJobStep]
        """
        return self._steps

    @steps.setter
    def steps(self, steps):
        """Sets the steps of this RunJobResponse.

        The collection of Steps that completed along with the current Step being executed.  # noqa: E501

        :param steps: The steps of this RunJobResponse.  # noqa: E501
        :type: list[RunJobStep]
        """
