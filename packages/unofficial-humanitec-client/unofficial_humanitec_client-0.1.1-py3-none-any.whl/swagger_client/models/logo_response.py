...
class LogoResponse(object):
    ...
    def __init__(self, dark_url=None, light_url=None):  # noqa: E501
        """LogoResponse - a model defined in Swagger"""  # noqa: E501
        self._dark_url = None
        self._light_url = None
        self.discriminator = None
        if dark_url is not None:
    ...
    @property
    def dark_url(self):
        """Gets the dark_url of this LogoResponse.  # noqa: E501


        :return: The dark_url of this LogoResponse.  # noqa: E501
        :rtype: str
        """
        return self._dark_url

    @dark_url.setter
    def dark_url(self, dark_url):
        """Sets the dark_url of this LogoResponse.


        :param dark_url: The dark_url of this LogoResponse.  # noqa: E501
        :type: str
        """

        self._dark_url = dark_url

    @property
    def light_url(self):
        """Gets the light_url of this LogoResponse.  # noqa: E501


        :return: The light_url of this LogoResponse.  # noqa: E501
        :rtype: str
        """
        return self._light_url

    @light_url.setter
    def light_url(self, light_url):
        """Sets the light_url of this LogoResponse.


        :param light_url: The light_url of this LogoResponse.  # noqa: E501
        :type: str
        """

        self._light_url = light_url
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LogoResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LogoResponse):
            return False
