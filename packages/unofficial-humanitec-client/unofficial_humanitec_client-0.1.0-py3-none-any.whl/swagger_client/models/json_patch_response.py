...
class JSONPatchResponse(object):
    ...
    def __init__(self, op=None, path=None, value=None):  # noqa: E501
        """JSONPatchResponse - a model defined in Swagger"""  # noqa: E501
        self._op = None
        self._path = None
        self._value = None
    ...
    @property
    def op(self):
        """Gets the op of this JSONPatchResponse.  # noqa: E501


        :return: The op of this JSONPatchResponse.  # noqa: E501
        :rtype: str
        """
        return self._op
    ...
    @op.setter
    def op(self, op):
        """Sets the op of this JSONPatchResponse.


        :param op: The op of this JSONPatchResponse.  # noqa: E501
        :type: str
        """
        if op is None:
    ...
    @property
    def path(self):
        """Gets the path of this JSONPatchResponse.  # noqa: E501


        :return: The path of this JSONPatchResponse.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this JSONPatchResponse.


        :param path: The path of this JSONPatchResponse.  # noqa: E501
        :type: str
        """
        if path is None:
    ...
    @property
    def value(self):
        """Gets the value of this JSONPatchResponse.  # noqa: E501


        :return: The value of this JSONPatchResponse.  # noqa: E501
        :rtype: object
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this JSONPatchResponse.


        :param value: The value of this JSONPatchResponse.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(JSONPatchResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JSONPatchResponse):
            return False
