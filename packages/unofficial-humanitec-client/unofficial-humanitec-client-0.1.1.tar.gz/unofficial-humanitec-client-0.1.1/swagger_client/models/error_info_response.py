...
class ErrorInfoResponse(object):
    ...
    def __init__(self, error=None):  # noqa: E501
        """ErrorInfoResponse - a model defined in Swagger"""  # noqa: E501
        self._error = None
    ...
    @property
    def error(self):
        """Gets the error of this ErrorInfoResponse.  # noqa: E501

        An error details  # noqa: E501

        :return: The error of this ErrorInfoResponse.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this ErrorInfoResponse.

        An error details  # noqa: E501

        :param error: The error of this ErrorInfoResponse.  # noqa: E501
        :type: str
        """
        if error is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ErrorInfoResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ErrorInfoResponse):
            return False
