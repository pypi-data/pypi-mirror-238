...
class TokenDefinitionRequest(object):
    ...
    def __init__(self, description=None, expires_at=None, id=None, type=None):  # noqa: E501
        """TokenDefinitionRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this TokenDefinitionRequest.  # noqa: E501

        A description of the token. (Optional)  # noqa: E501

        :return: The description of this TokenDefinitionRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this TokenDefinitionRequest.

        A description of the token. (Optional)  # noqa: E501

        :param description: The description of this TokenDefinitionRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def expires_at(self):
        """Gets the expires_at of this TokenDefinitionRequest.  # noqa: E501

        The time the token expires. If not set, the token will not expire. (Optional)  # noqa: E501

        :return: The expires_at of this TokenDefinitionRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def expires_at(self, expires_at):
        """Sets the expires_at of this TokenDefinitionRequest.

        The time the token expires. If not set, the token will not expire. (Optional)  # noqa: E501

        :param expires_at: The expires_at of this TokenDefinitionRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this TokenDefinitionRequest.  # noqa: E501

        Identifier of the token. Must be unique for the user.  # noqa: E501

        :return: The id of this TokenDefinitionRequest.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this TokenDefinitionRequest.

        Identifier of the token. Must be unique for the user.  # noqa: E501

        :param id: The id of this TokenDefinitionRequest.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def type(self):
        """Gets the type of this TokenDefinitionRequest.  # noqa: E501

        The type of the token. Can only be \"static\".  # noqa: E501

        :return: The type of this TokenDefinitionRequest.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TokenDefinitionRequest.

        The type of the token. Can only be \"static\".  # noqa: E501

        :param type: The type of this TokenDefinitionRequest.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TokenDefinitionRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TokenDefinitionRequest):
            return False
