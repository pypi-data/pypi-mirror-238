...
class ModuleDeltasResponse(object):
    ...
    def __init__(self, add=None, remove=None, update=None):  # noqa: E501
        """ModuleDeltasResponse - a model defined in Swagger"""  # noqa: E501
        self._add = None
        self._remove = None
        self._update = None
    ...
    @property
    def add(self):
        """Gets the add of this ModuleDeltasResponse.  # noqa: E501


        :return: The add of this ModuleDeltasResponse.  # noqa: E501
    ...
    @add.setter
    def add(self, add):
        """Sets the add of this ModuleDeltasResponse.


        :param add: The add of this ModuleDeltasResponse.  # noqa: E501
    ...
    @property
    def remove(self):
        """Gets the remove of this ModuleDeltasResponse.  # noqa: E501


        :return: The remove of this ModuleDeltasResponse.  # noqa: E501
        :rtype: list[str]
        """
        return self._remove
    ...
    def remove(self, remove):
        """Sets the remove of this ModuleDeltasResponse.


        :param remove: The remove of this ModuleDeltasResponse.  # noqa: E501
        :type: list[str]
        """
        if remove is None:
    ...
    @property
    def update(self):
        """Gets the update of this ModuleDeltasResponse.  # noqa: E501


        :return: The update of this ModuleDeltasResponse.  # noqa: E501
        :rtype: dict(str, list[UpdateActionResponse])
        """
        return self._update

    @update.setter
    def update(self, update):
        """Sets the update of this ModuleDeltasResponse.


        :param update: The update of this ModuleDeltasResponse.  # noqa: E501
        :type: dict(str, list[UpdateActionResponse])
        """
        if update is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ModuleDeltasResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModuleDeltasResponse):
            return False
