...
class EnvironmentRequest(object):
    ...
    @property
    def id(self):
        """Gets the id of this EnvironmentRequest.  # noqa: E501

        The ID the Environment is referenced as.  # noqa: E501

        :return: The id of this EnvironmentRequest.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this EnvironmentRequest.

        The ID the Environment is referenced as.  # noqa: E501

        :param id: The id of this EnvironmentRequest.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def type(self):
        """Gets the type of this EnvironmentRequest.  # noqa: E501

        The Environment Type. This is used for organizing and managing Environments.  # noqa: E501

        :return: The type of this EnvironmentRequest.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this EnvironmentRequest.

        The Environment Type. This is used for organizing and managing Environments.  # noqa: E501

        :param type: The type of this EnvironmentRequest.  # noqa: E501
        :type: str
        """
        if type is None:
