...
class DeployConditionResponse(object):
    ...
    def __init__(self, success=None, timeout=None, when=None):  # noqa: E501
        """DeployConditionResponse - a model defined in Swagger"""  # noqa: E501
        self._success = None
        self._timeout = None
        self._when = None
    ...
    @property
    def success(self):
        """Gets the success of this DeployConditionResponse.  # noqa: E501


        :return: The success of this DeployConditionResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def success(self, success):
        """Sets the success of this DeployConditionResponse.


        :param success: The success of this DeployConditionResponse.  # noqa: E501
        :type: str
        """
        if success is None:
    ...
    @property
    def timeout(self):
        """Gets the timeout of this DeployConditionResponse.  # noqa: E501


        :return: The timeout of this DeployConditionResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def timeout(self, timeout):
        """Sets the timeout of this DeployConditionResponse.


        :param timeout: The timeout of this DeployConditionResponse.  # noqa: E501
        :type: int
        """
        if timeout is None:
    ...
    @property
    def when(self):
        """Gets the when of this DeployConditionResponse.  # noqa: E501


        :return: The when of this DeployConditionResponse.  # noqa: E501
        :rtype: str
        """
        return self._when
    ...
    @when.setter
    def when(self, when):
        """Sets the when of this DeployConditionResponse.


        :param when: The when of this DeployConditionResponse.  # noqa: E501
        :type: str
        """
        if when is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeployConditionResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeployConditionResponse):
            return False
