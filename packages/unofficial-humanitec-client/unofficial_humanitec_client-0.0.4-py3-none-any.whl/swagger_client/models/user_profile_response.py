...
class UserProfileResponse(object):
    ...
    @property
    def created_at(self):
        """Gets the created_at of this UserProfileResponse.  # noqa: E501

        The time the user was first registered with Humanitec  # noqa: E501

        :return: The created_at of this UserProfileResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this UserProfileResponse.

        The time the user was first registered with Humanitec  # noqa: E501

        :param created_at: The created_at of this UserProfileResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this UserProfileResponse.  # noqa: E501

        The type of the account. Could be user, service or system  # noqa: E501

        :return: The type of this UserProfileResponse.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this UserProfileResponse.

        The type of the account. Could be user, service or system  # noqa: E501

        :param type: The type of this UserProfileResponse.  # noqa: E501
        :type: str
        """
        if type is None:
