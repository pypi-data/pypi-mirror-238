...
class ArtefactRequest(object):
    ...
    def __init__(self, id=None, name=None, type=None):  # noqa: E501
        """ArtefactRequest - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
        self._type = None
    ...
    @property
    def id(self):
        """Gets the id of this ArtefactRequest.  # noqa: E501

        The UUID of the Artefact.  # noqa: E501

        :return: The id of this ArtefactRequest.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ArtefactRequest.

        The UUID of the Artefact.  # noqa: E501

        :param id: The id of this ArtefactRequest.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def name(self):
        """Gets the name of this ArtefactRequest.  # noqa: E501

        The name of the Artefact.  # noqa: E501

        :return: The name of this ArtefactRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ArtefactRequest.

        The name of the Artefact.  # noqa: E501

        :param name: The name of this ArtefactRequest.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def type(self):
        """Gets the type of this ArtefactRequest.  # noqa: E501

        The type of the Artefact.  # noqa: E501

        :return: The type of this ArtefactRequest.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ArtefactRequest.

        The type of the Artefact.  # noqa: E501

        :param type: The type of this ArtefactRequest.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ArtefactRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArtefactRequest):
            return False
