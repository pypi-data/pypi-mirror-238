...
class UserProfileRequest(object):
    ...
    def __init__(self, created_at=None, email=None, id=None, name=None, type=None):  # noqa: E501
        """UserProfileRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def created_at(self):
        """Gets the created_at of this UserProfileRequest.  # noqa: E501

        The time the user was first registered with Humanitec  # noqa: E501

        :return: The created_at of this UserProfileRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this UserProfileRequest.

        The time the user was first registered with Humanitec  # noqa: E501

        :param created_at: The created_at of this UserProfileRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def email(self):
        """Gets the email of this UserProfileRequest.  # noqa: E501

        The email address of the user from the profile  # noqa: E501

        :return: The email of this UserProfileRequest.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this UserProfileRequest.

        The email address of the user from the profile  # noqa: E501

        :param email: The email of this UserProfileRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this UserProfileRequest.  # noqa: E501

        The User ID for this user  # noqa: E501

        :return: The id of this UserProfileRequest.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UserProfileRequest.

        The User ID for this user  # noqa: E501

        :param id: The id of this UserProfileRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this UserProfileRequest.  # noqa: E501

        The name the user goes by  # noqa: E501

        :return: The name of this UserProfileRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UserProfileRequest.

        The name the user goes by  # noqa: E501

        :param name: The name of this UserProfileRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this UserProfileRequest.  # noqa: E501

        The type of the account. Could be user, service or system  # noqa: E501

        :return: The type of this UserProfileRequest.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this UserProfileRequest.

        The type of the account. Could be user, service or system  # noqa: E501

        :param type: The type of this UserProfileRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserProfileRequest, dict):
