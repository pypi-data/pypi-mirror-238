...
_COMPUTE_CONFIG = Union[
    ...
    configs.TectonBatchComputeConfig,
]
...
class MaterializedFeatureView(FeatureView):
    ...
    @sdk_decorators.sdk_public_method(
        ...
        supports_skip_validation=(ComputeMode.SPARK, ComputeMode.DUCK_DB),
    )
    def get_historical_features(
        ...
        :type compute_mode: Optional[ComputeMode]
...
class BatchFeatureView(MaterializedFeatureView):
    ...
    def __init__(
        ...
        *,
        ...
        batch_compute: Optional[_COMPUTE_CONFIG] = None,
...
class StreamFeatureView(MaterializedFeatureView):
    ...
    def __init__(
        ...
        *,
        ...
        online_serving_index: Optional[Sequence[str]] = None,
        batch_compute: Optional[_COMPUTE_CONFIG] = None,
        stream_compute: Optional[_COMPUTE_CONFIG] = None,
        offline_store: Optional[Union[configs.ParquetConfig, configs.DeltaConfig]] = configs.ParquetConfig(),
        online_store: Optional[Union[configs.DynamoConfig, configs.RedisConfig, configs.BigtableConfig]] = None,
        monitor_freshness: bool = False,
        data_quality_enabled: Optional[bool] = None,
...
def _is_spark_config(config: Optional[_COMPUTE_CONFIG]) -> bool:
    if config is None:
        return False
...
def infer_batch_compute_mode(
    ...
    batch_compute_config: Optional[_COMPUTE_CONFIG],
    stream_compute_config: Optional[_COMPUTE_CONFIG],
) -> BatchComputeMode:
...
def _build_materialized_feature_view_args(
    ...
    batch_compute: Optional[_COMPUTE_CONFIG],
    stream_compute: Optional[_COMPUTE_CONFIG],
