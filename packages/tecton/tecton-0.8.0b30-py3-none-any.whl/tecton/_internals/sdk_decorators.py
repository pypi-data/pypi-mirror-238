...
def sdk_public_method(
    ...
    *,
    ...
    :param supports_skip_validation: The compute modes that support the "skip" validation mode for this method.
    """
            ...
            if requires_validation:
                ...
                if not fco_object._is_valid:
                    if conf.get_or_none("TECTON_VALIDATION_MODE") == validation_mode.ValidationMode.AUTOMATIC:
                        ...
                        and compute_mode.get_compute_mode() in supports_skip_validation
                    ):
                        logger.debug(
