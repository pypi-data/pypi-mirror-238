...
def whoami():
    ...
    if profile and isinstance(profile, okta.UserProfile):
        cli_utils.pprint_dict({"Tecton Endpoint": cli_utils.cluster_url()}, colwidth=16)
        ...
        cli_utils.pprint_dict({"Tecton Endpoint": cli_utils.cluster_url()}, colwidth=19)
        service_account = {
