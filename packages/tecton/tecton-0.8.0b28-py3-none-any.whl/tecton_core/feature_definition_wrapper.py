...
class FeatureDefinitionWrapper:
    ...
    def earliest_window_start(self) -> datetime.timedelta:
        ...
        return min(
            [
                TimeWindowSpec.from_data_proto(feature.time_window).window_start
    ...
    def earliest_anchor_time_from_window_start(self, window_start: Optional[datetime.timedelta] = None) -> int:
        if window_start is None:
            window_start = self.earliest_window_start
