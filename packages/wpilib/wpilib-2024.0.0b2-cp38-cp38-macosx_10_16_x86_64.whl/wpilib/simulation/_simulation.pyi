...
class ElevatorSim(LinearSystemSim_2_1_1):
    ...
    """
    @typing.overload
    def __init__(self, plant: wpimath._controls._controls.system.LinearSystem_2_1_1, gearbox: wpimath._controls._controls.plant.DCMotor, gearing: float, drumRadius: wpimath.units.meters, minHeight: wpimath.units.meters, maxHeight: wpimath.units.meters, simulateGravity: bool, startingHeight: wpimath.units.meters, measurementStdDevs: typing_extensions.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(1)] = [0.0]) -> None:
        """
...
class PWMSim:
    ...
    def registerPositionCallback(self, callback: typing.Callable[[str, HAL_Value], None], initialNotify: bool) -> CallbackStore:
        ...
        :returns: the CallbackStore object associated with this callback
        """
    def registerPulseMicrosecondCallback(self, callback: typing.Callable[[str, HAL_Value], None], initialNotify: bool) -> CallbackStore:
        """
...
class REVPHSim(PneumaticsBaseSim):
    ...
    def getSolenoidOutput(self, channel: int) -> bool:
        ...
    def registerCompressorConfigTypeCallback(self, callback: typing.Callable[[str, HAL_Value], None], initialNotify: bool) -> CallbackStore:
        """
        Register a callback to be run whenever the closed loop state changes.
...
class RoboRioSim:
    ...
    def getVInVoltage() -> wpimath.units.volts:
        ...
        """
    @staticmethod
    def registerBrownoutVoltageCallback(callback: typing.Callable[[str, HAL_Value], None], initialNotify: bool) -> CallbackStore:
        """
        ...
        """
    @staticmethod
    def registerCPUTempCallback(callback: typing.Callable[[str, HAL_Value], None], initialNotify: bool) -> CallbackStore:
        """
    ...
    def registerFPGAButtonCallback(callback: typing.Callable[[str, HAL_Value], None], initialNotify: bool) -> CallbackStore:
        ...
        """
    @staticmethod
    def registerTeamNumberCallback(callback: typing.Callable[[str, HAL_Value], None], initialNotify: bool) -> CallbackStore:
        """
