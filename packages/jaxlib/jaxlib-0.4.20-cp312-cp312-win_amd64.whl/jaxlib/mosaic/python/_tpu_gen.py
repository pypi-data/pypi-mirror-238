...
from jaxlib.mlir.dialects._ods_common import segmented_accessor as _ods_segmented_accessor, equally_sized_accessor as _ods_equally_sized_accessor, get_default_loc_context as _ods_get_default_loc_context, get_op_result_or_value as _get_op_result_or_value, get_op_results_or_values as _get_op_results_or_values, get_op_result_or_op_results as _get_op_result_or_op_results
...
def all_reduce(input, dim, kind, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def concatenate(output, sources, dimension, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def create_subelement_mask(output, from_, to, num_subelems, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def device_id(*, loc=None, ip=None) -> _ods_ir.OpResult:
...
def dynamic_gather(output, source, indices, dimension, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def sem_barrier(*, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(GetBarrierSemaphoreOp(loc=loc, ip=ip))
...
def iota(output, *, dimension=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def matmul(result, lhs, rhs, acc, *, transpose_lhs=None, transpose_rhs=None, precision=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def memref_slice(result, mem_ref, base_idx, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def pack_subelements(output, sources, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def region(results_, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def rotate(value, amount, dimension, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def trace(results_, message, level, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def unpack_subelements(output, source, index, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def unroll_vectors(output, input, *, loc=None, ip=None) -> _ods_ir.OpResult:
