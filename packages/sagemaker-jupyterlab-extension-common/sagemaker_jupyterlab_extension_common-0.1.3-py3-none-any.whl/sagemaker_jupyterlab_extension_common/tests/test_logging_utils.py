...
def test_operational_logger_valid_event_success(
    ...
    file = os.path.join(file_path, SERVER_LOG_FILE_NAME)
    ...
    remove_temp_file_and_env(file, LOGFILE_ENV_NAME, file_path)
...
def test_metric_logger(
    ...
    # Create a temporary log file for logger to write
    file_path = set_log_file_directory(LOGFILE_ENV_NAME)
    file = os.path.join(file_path, API_LOG_FILE_NAME)
...
def test_ui_event_logger_valid_event_success(
    ...
    # Create a temporary log file for performance logger
    file_path = set_log_file_directory(LOGFILE_ENV_NAME)
    perf_metrics_file = os.path.join(file_path, JUPYTERLAB_METRICS_LOG_FILE_NAME)
    ...
    data = get_last_entry(perf_metrics_file)
    ...
    # Remove the temp file
    remove_temp_file_and_env(perf_metrics_file, LOGFILE_ENV_NAME, file_path)
