...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, base_url=None, pulp_created=None, hidden=False, pulp_labels=None, name=None, pulp_href=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
