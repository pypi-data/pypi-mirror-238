...
setup(name='radware_octavia_yoga_driver',
      version='4.24.0-2',
      description='Octavia Radware driver for Openstack Yoga',
      ...
      url='https://pypi.python.org/pypi/radware_octavia_yoga_driver',
      author='Evgeny Fedoruk, Radware',
      author_email='evgenyf@radware.com',
      packages=['radware_octavia_yoga_driver'],
      zip_safe=False,
      cmdclass={'install': OverrideInstall,
                'configure': RadwareOctaviaDriverConfiguration},
      entry_points={
          'octavia.api.drivers': [
              'radware = radware_octavia_yoga_driver.octavia_provider_driver:RadwareOctaviaProviderDriver',
          ]})
