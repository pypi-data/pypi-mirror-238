...
class OverCallersBid(Hand):
    ...
    def _overcalls_at_one_level(self):
        ...
        elif self.opener_bid_one.name == '1NT' and self.hcp >= 15 and self.shape[0] >= 6:
            bid = Double('2069')
        # elif self._can_double():
        elif self.hcp + self.shape[0] >= 22:
            bid = Double('2026')
    ...
    def _overcall_suit_at_two_level(self):
        ...
        if self._has_strong_seven_card_suit():
            ...
            bid = Double('2034')
              ...
              self.suit_holding[self.opener_suit_one] == 0):
            bid = Double('2035')
    ...
    def _overcall_suit_after_weak_two(self):
        ...
        #     bid = self.next_level_bid(suit, '2045')
            ...
            bid = self.next_level_bid(self.longest_suit, '2046')
              ...
              self.hearts >= 5 and
              self.spades >= 5 and
              self.next_level(self.heart_suit) <= 4):
            bid = Double('2067')
    ...
    def _overcall_after_weak_three(self):
        ...
        if (self.shape == [5, 4, 4, 0] and
                self.suit_length(self.opener_suit_one) == 0):
            bid = Double('2048')
