...
class OverCallersThirdBid(Hand):
        ...
        if (my_first_bid.is_pass and my_second_bid._is_pass and advancers_last_bid.is_pass):
            ...
            bid = Pass('2832')
              ...
              advancers_first_bid.denomination == advancers_last_bid.denomination and
                self.hcp < 16):
            bid = Pass('2833')
        elif (self.partner_bid_one.is_value_call and self.advancer_bid_two.is_value_call and
            ...
            # ic(self.advancer_suit_one)
            # ic(self.suit_holding[self.advancer_suit_one])
    ...
    def _fifteen_points_advancer_bids_two_suits(self):
        ...
        if self.nt_level >= 6 and self.hcp >= 16 and self.is_semi_balanced:
            bid = Double('2838')
        elif self.bidding_above_game and self.can_double:
            bid = Double('2825')
        ...
        elif (self.advancer_suit_one != self.advancer_bid_two.denomination and
            ...
            bid = Pass('2823')
              ...
              self.hcp >= 15 and
              self.suit_holding[self._suit_preference()] >= 3):
    ...
    def _suit_preference(self):
        ...
        suit = None
        if (self.partner_bid_one.is_suit_call and
                (self.advancer_suit_one.is_major or
                 self.advancer_suit_one.is_minor)):
            suit_one = self.advancer_suit_one
